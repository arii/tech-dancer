import{A as Ye}from"./index-D7rbh8Gm.js";const gn=`---
type: post
draft: true
status: draft
...
`,Nn=Object.freeze(Object.defineProperty({__proto__:null,default:On},Symbol.toStringTag,{value:"Module"})),Bn=`---
type: post
draft: false
...
imageAlt: "Rhythmic architecture diagram showing WCS timing and the Boom-Tick pulse."
tags:
  - wcs
  - rhythm
  - technique
...
To understand the dance, you have to understand the pulse. The "Boom" and the "Tick" create the binary heartbeat of West Coast Swing.

\`\`\`mermaid
%%{init: {'theme': 'dark'}}%%
graph LR
    subgraph Pulse [The Boom-Tick Pulse]
        direction LR
        B1[1: Boom] --- T1[2: Tick] --- B2[3: Boom] --- T2[4: Tick] --- B3[5: Boom] --- T3[6: Tick] --- B4[7: Boom] --- T4[8: Tick]
    end
    style B1 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style B2 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style B3 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style B4 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style T1 fill:#f472b6,stroke:#f472b6,color:#020617
    style T2 fill:#f472b6,stroke:#f472b6,color:#020617
    style T3 fill:#f472b6,stroke:#f472b6,color:#020617
    style T4 fill:#f472b6,stroke:#f472b6,color:#020617
\`\`\`
...
![The Boom-Step Logo](/assets/posts/boomtick-and-b-thumb.svg "The B\\ logo represents the 'Boom-Step', the initiation of momentum on the first beat of a pattern.")
...
To better visualize how the Universal Unit System maps to our fundamental patterns, here are timing maps for common 6-beat and 8-beat structures. These maps show the alignment of musical beats (top row) with weight-change "dots" (bottom row).
...
%%{init: {'theme': 'dark'}}%%
graph TD
    subgraph SixCount [6-Count Rhythm Architecture]
        direction TB
        B1[1] --- B2[2] --- B3[3] --- BA[&] --- B4[4] --- B5[5] --- BB[&] --- B6[6]
        W1((•)) --- W2((•)) --- W3((•)) --- WA((•)) --- W4((•)) --- W5((•)) --- WB((•)) --- W6((•))
    ...
    style B1 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style B3 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style B5 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style B2 fill:#f472b6,stroke:#f472b6,color:#020617
    style B4 fill:#f472b6,stroke:#f472b6,color:#020617
    style B6 fill:#f472b6,stroke:#f472b6,color:#020617
\`\`\`
...
%%{init: {'theme': 'dark'}}%%
graph TD
    subgraph EightCount [8-Count Rhythm Architecture]
        direction TB
        B1[1] --- B2[2] --- B3[3] --- BA1[&] --- B4[4] --- B5[5] --- B6[6] --- B7[7] --- BA2[&] --- B8[8]
        W1((•)) --- W2((•)) --- W3((•)) --- WA((•)) --- W4((•)) --- W5((•)) --- W6((•)) --- W7((•)) --- WB((•)) --- W8((•))
    ...
    style B3 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style B5 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style B7 fill:#22d3ee,stroke:#22d3ee,color:#020617
    style B2 fill:#f472b6,stroke:#f472b6,color:#020617
    style B4 fill:#f472b6,stroke:#f472b6,color:#020617
    style B6 fill:#f472b6,stroke:#f472b6,color:#020617
    style B8 fill:#f472b6,stroke:#f472b6,color:#020617
\`\`\`
...
![BoomTick Branded Merchandise](/assets/posts/booomtick_merch.jpg "A collection of BoomTick merchandise including a 'NorCal Best Cal' t-shirt with a Golden Gate Bridge design, a 'Slot Era' mug, and branded shipping materials.")
...
`,En=Object.freeze(Object.defineProperty({__proto__:null,default:Bn},Symbol.toStringTag,{value:"Module"})),Pn=`---
type: post
...
`,Dn=Object.freeze(Object.defineProperty({__proto__:null,default:jn},Symbol.toStringTag,{value:"Module"})),Mn=`---
type: post
...
`,xn=Object.freeze(Object.defineProperty({__proto__:null,default:Rn},Symbol.toStringTag,{value:"Module"})),Wn=`---
type: post
...
`,Fn=Object.freeze(Object.defineProperty({__proto__:null,default:Wn},Symbol.toStringTag,{value:"Module"})),qn=`---
type: post
...
`);s=e,i=e+1,o=n[i]}return s}const De=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),Me=n=>/^(%|---|\.\.\.)/m.test(n);function gs(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let o=0,a=0;o<i;++o)if(n[o]===`
...
`,l+=2;a+=o,t[l+2]===" "&&(a+="\\"),l+=1,r=l+1}break;default:l+=1}return a=r?a+t.slice(r):t,s?a:je(a,o,Ce,De(e,!1))}function Ze(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
`)||/[ \t]\n|\n[ \t]/.test(n))return pe(n,e);const t=e.indent||(Me(n)?"  ":""),s="'"+n.replace(/'/g,"''").replace(/\n+/g,`$&
${t}`)+"'";return e.implicitKey?s:je(s,t,Rt,De(e,!1))}function ee(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=pe;else{const i=n.includes('"'),o=n.includes("'");i&&!o?s=Ze:o&&!i?s=pe:s=t?Ze:pe}return s(n,e)}let et;try{et=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{et=/\n+(?!\n|$)/g}function Oe({comment:n,type:e,value:t},s,i,o){const{blockQuote:a,commentString:r,lineWidth:l}=s.options;if(!a||/\n[\t ]+$/.test(t))return ee(t,s);const c=s.indent||(s.forceBlockIndent||Me(t)?"  ":""),d=a==="literal"?!0:a==="folded"||e===T.BLOCK_FOLDED?!1:e===T.BLOCK_LITERAL?!0:!gs(t,l,c.length);if(!t)return d?`|
`:`>
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let A=!1;const _=De(s,!0);a!=="folded"&&e!==T.BLOCK_FOLDED&&(_.onOverflow=()=>{A=!0});const y=je(`${w}${S}${m}`,c,Xe,_);if(!A)return`>${v}
${c}${y}`}return t=t.replace(/\n+/g,`$&${c}`),`|${v}
${c}${w}${t}${m}`}function ys(n,e,t,s){const{type:i,value:o}=n,{actualString:a,implicitKey:r,indent:l,indentStep:c,inFlow:d}=e;if(r&&o.includes(`
...
`+_:y.comment=_,A.comment=A.comment.substring(_.length+1)}}if(!a&&!v&&!A.found){const _=S?n(t,S,A,i):e(t,A.end,v,null,A,i);c.items.push(_),u=_.range[2],He(S)&&i(_.range,"BLOCK_IN_FLOW",Ge)}else{t.atKey=!0;const _=A.end,y=k?n(t,k,A,i):e(t,_,w,null,A,i);He(k)&&i(y.range,"BLOCK_IN_FLOW",Ge),t.atKey=!1;const B=ie(v??[],{flow:r,indicator:"map-value-ind",next:S,offset:y.range[2],onError:i,parentIndent:s.indent,startOnNewline:!1});if(B.found){if(!a&&!A.found&&t.options.strict){if(v)for(const E of v){if(E===B.found)break;if(E.type==="newline"){i(E,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}A.start<B.found.offset-1024&&i(B.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else S&&("source"in S&&S.source?.[0]===":"?i(S,"MISSING_CHAR",`Missing space after : in ${r}`):i(B.start,"MISSING_CHAR",`Missing , or : between ${r} items`));const q=S?n(t,S,B,i):B.found?e(t,B.end,v,null,B,i):null;q?He(S)&&i(q.range,"BLOCK_IN_FLOW",Ge):B.comment&&(y.comment?y.comment+=`
`+B.comment:y.comment=B.comment);const J=new L(y,q);if(t.options.keepSourceTokens&&(J.srcToken=b),a){const E=c;ln(t,E.items,y)&&i(_,"DUPLICATE_KEY","Map keys must be unique"),E.items.push(J)}else{const E=new j(t.schema);E.flow=!0,E.items.push(J);const bt=(q??y).range;E.range=[y.range[0],bt[1],bt[2]],c.items.push(E)}u=q?q.range[2]:B.end}}const h=a?"}":"]",[m,...g]=s.end;let f=u;if(m?.source===h)f=m.offset+m.source.length;else{const p=r[0].toUpperCase()+r.substring(1),b=d?`${p} must end with a ${h}`:`${p} in block collection must be sufficiently indented and end with a ${h}`;i(u,d?"MISSING_CHAR":"BAD_INDENT",b),m&&m.source.length!==1&&g.unshift(m)}if(g.length>0){const p=ke(g,f,t.options.strict,i);p.comment&&(c.comment?c.comment+=`
`+p.comment:c.comment=p.comment),c.range=[s.offset,f,p.offset]}else c.range=[s.offset,f,f];return c}function ze(n,e,t,s,i,o){const a=t.type==="block-map"?Ws(n,e,t,s,o):t.type==="block-seq"?Fs(n,e,t,s,o):qs(n,e,t,s,o),r=a.constructor;return i==="!"||i===r.tagName?(a.tag=r.tagName,a):(i&&(a.tag=i),a)}function Us(n,e,t,s,i){const o=s.tag,a=o?e.directives.tagName(o.source,h=>i(o,"TAG_RESOLVE_FAILED",h)):null;if(t.type==="block-seq"){const{anchor:h,newlineAfterProp:m}=s,g=h&&o?h.offset>o.offset?h:o:h??o;g&&(!m||m.offset<g.offset)&&i(g,"MISSING_CHAR","Missing newline after block sequence props")}const r=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!o||!a||a==="!"||a===j.tagName&&r==="map"||a===V.tagName&&r==="seq")return ze(n,e,t,i,a);let l=e.schema.tags.find(h=>h.tag===a&&h.collection===r);if(!l){const h=e.schema.knownTags[a];if(h?.collection===r)e.schema.tags.push(Object.assign({},h,{default:!1})),l=h;else return h?i(o,"BAD_COLLECTION_TYPE",`${h.tag} used for ${r} collection, but expects ${h.collection??"scalar"}`,!0):i(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${a}`,!0),ze(n,e,t,i,a)}const c=ze(n,e,t,i,a,l),d=l.resolve?.(c,h=>i(o,"TAG_RESOLVE_FAILED",h),e.options)??c,u=O(d)?d:new T(d);return u.range=c.range,u.tag=a,l?.format&&(u.format=l.format),u}function Ks(n,e,t){const s=e.offset,i=Gs(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const o=i.mode===">"?T.BLOCK_FOLDED:T.BLOCK_LITERAL,a=e.source?Hs(e.source):[];let r=a.length;for(let f=a.length-1;f>=0;--f){const p=a[f][1];if(p===""||p==="\r")r=f;else break}if(r===0){const f=i.chomp==="+"&&a.length>0?`
...
`&&(u+=`
`);break;default:u+=`
`}const g=s+i.length+e.source.length;return{value:u,type:o,comment:i.comment,range:[s,g,g]}}function Gs({offset:n,props:e},t,s){if(e[0].type!=="block-scalar-header")return s(e[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:i}=e[0],o=i[0];let a=0,r="",l=-1;for(let h=1;h<i.length;++h){const m=i[h];if(!r&&(m==="-"||m==="+"))r=m;else{const g=Number(m);!a&&g?a=g:l===-1&&(l=n+h)}}l!==-1&&s(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,d="",u=i.length;for(let h=1;h<e.length;++h){const m=e[h];switch(m.type){case"space":c=!0;case"newline":u+=m.source.length;break;case"comment":t&&!c&&s(m,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),u+=m.source.length,d=m.source.substring(1);break;case"error":s(m,"UNEXPECTED_TOKEN",m.message),u+=m.source.length;break;default:{const g=`Unexpected token in block scalar header: ${m.type}`;s(m,"UNEXPECTED_TOKEN",g);const f=m.source;f&&typeof f=="string"&&(u+=f.length)}}}return{mode:o,indent:a,chomp:r,comment:d,length:u}}function Hs(n){const e=n.split(/\n( *)/),t=e[0],s=t.match(/^( *)/),o=[s?.[1]?[s[1],t.slice(s[1].length)]:["",t]];for(let a=1;a<e.length;a+=2)o.push([e[a],e[a+1]]);return o}function zs(n,e,t){const{offset:s,type:i,source:o,end:a}=n;let r,l;const c=(h,m,g)=>t(s+h,m,g);switch(i){case"scalar":r=T.PLAIN,l=Vs(o,c);break;case"single-quoted-scalar":r=T.QUOTE_SINGLE,l=Js(o,c);break;case"double-quoted-scalar":r=T.QUOTE_DOUBLE,l=Ys(o,c);break;default:return t(n,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[s,s+o.length,s+o.length]}}const d=s+o.length,u=ke(a,d,e,t);return{value:l,type:r,comment:u.comment,range:[s,d,u.offset]}}function Vs(n,e){let t="";switch(n[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${n[0]}`;break}case"@":case"`":{t=`reserved character ${n[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),cn(n)}function Js(n,e){return(n[n.length-1]!=="'"||n.length===1)&&e(n.length,"MISSING_CHAR","Missing closing 'quote"),cn(n.slice(1,-1)).replace(/''/g,"'")}function cn(n){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
`,"sy")}catch{e=/(.*?)[ \t]*\r?\n/sy,t=/[ \t]*(.*?)[ \t]*\r?\n/sy}let s=e.exec(n);if(!s)return n;let i=s[1],o=" ",a=e.lastIndex;for(t.lastIndex=a;s=t.exec(n);)s[1]===""?o===`
`?i+=o:o=`
`:(i+=o+s[1],o=" "),a=t.lastIndex;const r=/[ \t]*(.*)/sy;return r.lastIndex=a,s=r.exec(n),i+o+(s?.[1]??"")}function Ys(n,e){let t="";for(let s=1;s<n.length-1;++s){const i=n[s];if(!(i==="\r"&&n[s+1]===`
`))if(i===`
...
`,r:"\r",t:"	",v:"\v",N:"",_:" ",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function Zs(n,e,t,s){const i=n.substr(e,t),a=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;try{return String.fromCodePoint(a)}catch{const r=n.substr(e-2,t+2);return s(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${r}`),r}}function un(n,e,t,s){const{value:i,type:o,comment:a,range:r}=e.type==="block-scalar"?Ks(n,e,s):zs(e,n.options.strict,s),l=t?n.directives.tagName(t.source,u=>s(t,"TAG_RESOLVE_FAILED",u)):null;let c;n.options.stringKeys&&n.atKey?c=n.schema[x]:l?c=ei(n.schema,i,l,t,s):e.type==="scalar"?c=ti(n,i,e,s):c=n.schema[x];let d;try{const u=c.resolve(i,h=>s(t??e,"TAG_RESOLVE_FAILED",h),n.options);d=I(u)?u:new T(u)}catch(u){const h=u instanceof Error?u.message:String(u);s(t??e,"TAG_RESOLVE_FAILED",h),d=new T(i)}return d.range=r,d.source=i,o&&(d.type=o),l&&(d.tag=l),c.format&&(d.format=c.format),a&&(d.comment=a),d}function ei(n,e,t,s,i){if(t==="!")return n[x];const o=[];for(const r of n.tags)if(!r.collection&&r.tag===t)if(r.default&&r.test)o.push(r);else return r;for(const r of o)if(r.test?.test(e))return r;const a=n.knownTags[t];return a&&!a.collection?(n.tags.push(Object.assign({},a,{default:!1,test:void 0})),a):(i(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),n[x])}function ti({atKey:n,directives:e,schema:t},s,i,o){const a=t.tags.find(r=>(r.default===!0||n&&r.default==="key")&&r.test?.test(s))||t[x];if(t.compat){const r=t.compat.find(l=>l.default&&l.test?.test(s))??t[x];if(a.tag!==r.tag){const l=e.tagString(a.tag),c=e.tagString(r.tag),d=`Value may be parsed as either ${l} or ${c}`;o(i,"TAG_RESOLVE_FAILED",d,!0)}}return a}function ni(n,e,t){if(e){t??(t=e.length);for(let s=t-1;s>=0;--s){let i=e[s];switch(i.type){case"space":case"comment":case"newline":n-=i.source.length;continue}for(i=e[++s];i?.type==="space";)n+=i.source.length,i=e[++s];break}}return n}const si={composeNode:hn,composeEmptyNode:yt};function hn(n,e,t,s){const i=n.atKey,{spaceBefore:o,comment:a,anchor:r,tag:l}=t;let c,d=!0;switch(e.type){case"alias":c=ii(n,e,s),(r||l)&&s(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=un(n,e,l,s),r&&(c.anchor=r.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{c=Us(si,n,e,t,s),r&&(c.anchor=r.source.substring(1))}catch(u){const h=u instanceof Error?u.message:String(u);s(e,"RESOURCE_EXHAUSTION",h)}break;default:{const u=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;s(e,"UNEXPECTED_TOKEN",u),d=!1}}return c??(c=yt(n,e.offset,void 0,null,t,s)),r&&c.anchor===""&&s(r,"BAD_ALIAS","Anchor cannot be an empty string"),i&&n.options.stringKeys&&(!I(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&s(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),o&&(c.spaceBefore=!0),a&&(e.type==="scalar"&&e.source===""?c.comment=a:c.commentBefore=a),n.options.keepSourceTokens&&d&&(c.srcToken=e),c}function yt(n,e,t,s,{spaceBefore:i,comment:o,anchor:a,tag:r,end:l},c){const d={type:"scalar",offset:ni(e,t,s),indent:-1,source:""},u=un(n,d,r,c);return a&&(u.anchor=a.source.substring(1),u.anchor===""&&c(a,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(u.spaceBefore=!0),o&&(u.comment=o,u.range[2]=l),u}function ii({options:n},{offset:e,source:t,end:s},i){const o=new ot(t.substring(1));o.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),o.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);const a=e+t.length,r=ke(s,a,n.strict,i);return o.range=[e,a,r.offset],r.comment&&(o.comment=r.comment),o}function oi(n,e,{offset:t,start:s,value:i,end:o},a){const r=Object.assign({_directives:e},n),l=new qe(void 0,r),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},d=ie(s,{indicator:"doc-start",next:i??o?.[0],offset:t,onError:a,parentIndent:0,startOnNewline:!0});d.found&&(l.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!d.hasNewline&&a(d.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=i?hn(c,i,d,a):yt(c,d.end,s,null,d,a);const u=l.contents.range[2],h=ke(o,u,!1,a);return h.comment&&(l.comment=h.comment),l.range=[t,u,h.offset],l}function ue(n){if(typeof n=="number")return[n,n+1];if(Array.isArray(n))return n.length===2?n:[n[0],n[1]];const{offset:e,source:t}=n;return[e,e+(typeof t=="string"?t.length:1)]}function It(n){let e="",t=!1,s=!1;for(let i=0;i<n.length;++i){const o=n[i];switch(o[0]){case"#":e+=(e===""?"":s?`

`:`
`)+(o.substring(1)||" "),t=!0,s=!1;break;case"%":n[i+1]?.[0]!=="#"&&(i+=1),t=!1;break;default:t||(s=!0),t=!1}}return{comment:e,afterEmptyLine:s}}class ai{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,s,i,o)=>{const a=ue(t);o?this.warnings.push(new xs(a,s,i)):this.errors.push(new fe(a,s,i))},this.directives=new P({version:e.version||"1.2"}),this.options=e}decorate(e,t){const{comment:s,afterEmptyLine:i}=It(this.prelude);if(s){const o=e.contents;if(t)e.comment=e.comment?`${e.comment}
