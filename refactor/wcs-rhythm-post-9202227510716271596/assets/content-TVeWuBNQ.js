import{A as Ye}from"./index-R1dMayiN.js";const gn=`---
type: post
draft: true
status: draft
...
![The B• Unit Logo](/assets/posts/boomtick-and-b-thumb.svg "The B• logo represents the 'B-Unit'—a triple rhythm notation—signifying a full weight change on the final syncopated beat.")

The logo is a piece of rhythmic shorthand derived from Skippy Blair’s [Universal Unit System (UUS)](https://www.worldsdc.com/special-recognition/skippy-blair/).
...
In the shorthand of UUS, the letter 'B' denotes a "B-Unit"—the triple rhythm architecture (e.g., 1-2-B-3 or 5-&-6). The addition of the dot (B•) specifies that the third action in that rhythmic unit is a full step.

It symbolizes the three pillars of technical WCS:

1. Rhythm: The mathematical division of the beat.
2. Timing: The precise alignment of movement to the backbeat.
3. Connection: The physical result of committed weight transfer.
...
![BoomTick Branded Merchandise](/assets/posts/boomtick_merch.jpg "A collection of BoomTick merchandise including a 'NorCal Best Cal' t-shirt with a Golden Gate Bridge design, a 'Slot Era' mug, and branded shipping materials.")
...
`,Fn=Object.freeze(Object.defineProperty({__proto__:null,default:Wn},Symbol.toStringTag,{value:"Module"})),Un=`---
type: post
...
![Boomtick Merch](/assets/posts/boomtick_merch.jpg)
