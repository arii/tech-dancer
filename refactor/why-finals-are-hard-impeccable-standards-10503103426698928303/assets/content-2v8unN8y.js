import{A as Ye}from"./index-QwvBUSwY.js";const mn=`---
type: post
draft: true
status: draft
...
`);s=e,i=e+1,o=n[i]}return s}const Be=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),Me=n=>/^(%|---|\.\.\.)/m.test(n);function ms(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let o=0,a=0;o<i;++o)if(n[o]===`
...
${t}`)+"'";return e.implicitKey?s:De(s,t,xt,Be(e,!1))}function ee(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=pe;else{const i=n.includes('"'),o=n.includes("'");i&&!o?s=Ze:o&&!i?s=pe:s=t?Ze:pe}return s(n,e)}let et;try{et=new RegExp(`(^|(?<!
))
+(?!
