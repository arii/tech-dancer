import{A as Ye}from"./index-DWl7CT9l.js";const mn=`---
type: post
draft: true
status: draft
...
${t}`)+"'";return e.implicitKey?s:De(s,t,xt,je(e,!1))}function ee(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=pe;else{const i=n.includes('"'),o=n.includes("'");i&&!o?s=Ze:o&&!i?s=pe:s=t?Ze:pe}return s(n,e)}let et;try{et=new RegExp(`(^|(?<!
))
+(?!
