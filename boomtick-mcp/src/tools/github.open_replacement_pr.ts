...
export async function openReplacementPrHandler(args: z.infer<typeof OpenReplacementPrInputSchema>) {
  if (!args.pushMode) {
    throw new Error("pushMode must be true to push and open a replacement PR. Ensure you pass 'pushMode': true in your tool call. Ensure you pass 'pushMode': true in your tool call.");
  }
  // Push the branch
