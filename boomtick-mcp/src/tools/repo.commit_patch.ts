...
export async function commitPatchHandler(args: z.infer<typeof CommitPatchInputSchema>) {
  if (!args.writeMode) {
    throw new Error("writeMode must be true to commit changes. Ensure you pass 'writeMode': true in your tool call. Ensure you pass 'writeMode': true in your tool call.");
  }
