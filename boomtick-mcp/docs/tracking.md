...
- [ ] Register one read-only GitHub tool.
...
- [ ] Implement `github.search_open_prs`.
...
- [ ] Implement `repo.get_package_scripts`.
...
- [ ] Write Conflict Scout Agent prompt.
- [ ] Write Repo Context Agent prompt.
- [ ] Write Repair Agent prompt.
- [ ] Write Verifier Agent prompt.
- [ ] Write PR Writer Agent prompt.
