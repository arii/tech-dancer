import{A as Ye}from"./index-CIR7Z6PR.js";const gn=`---
type: post
draft: true
status: draft
...
A slim fanny pack or running belt is perfect for keeping your phone, keys, and cash secure without adding bulk or restricting your movement. This essential item is listed in our sidebar for quick access.
...
`,xn=Object.freeze(Object.defineProperty({__proto__:null,default:qn},Symbol.toStringTag,{value:"Module"})),Un=`---
type: post
...
Commit to the alien look with a full-body spandex suit and a latex mask. We've listed the Green Alien Bodysuit and Alien Latex Mask in our sidebar to help you complete the look.
...
`);s=e,i=e+1,o=n[i]}return s}const De=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),Me=n=>/^(%|---|\.\.\.)/m.test(n);function ps(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let o=0,a=0;o<i;++o)if(n[o]===`
