import{bQ as m}from"./vendor-DWKxRxW3.js";import{A as h}from"./index-CG_Oo-rU.js";const f=`---
type: post
draft: true
status: draft
...
\`\`\`
`,ie=Object.freeze(Object.defineProperty({__proto__:null,default:ae},Symbol.toStringTag,{value:"Module"}));function se(e){const o=e.match(/^---\n([\s\S]+?)\n---\n([\s\S]*)$/);if(!o)return{data:{},content:e};const i=o[1],t=o[2];try{const a=m(i);return{data:a&&typeof a=="object"?a:{},content:t}}catch(a){return console.error("Error parsing frontmatter:",a),{data:{},content:t}}}const d={posts:Object.assign({"/content/posts/2026-04-18-competition-metrics.md":y,"/content/posts/2026-04-18-financial-literacy-dancers.md":w,"/content/posts/2026-04-18-github-actions.md":k,"/content/posts/2026-04-18-halloween-costumes.md":S,"/content/posts/2026-04-18-make-shoe-dance.md":A,"/content/posts/2026-04-18-why-finals-are-hard.md":I,"/content/posts/2026-04-19-practical-tools-essentials.md":P,"/content/posts/2026-05-06-boomtick-and-b-the-rhythmic-architecture-of-west-coast-swing.md":j,"/content/posts/2026-06-01-event-travel-packing.md":W,"/content/posts/2026-06-01-general-health-home-care.md":R,"/content/posts/2026-06-01-outdoor-dancing.md":O,"/content/posts/2026-06-01-power-charging.md":F,"/content/posts/2026-06-01-practice-review-tech.md":H,"/content/posts/2026-06-01-practice-social-dance-apparel.md":N,"/content/posts/2026-06-01-shoe-care-modification.md":U,"/content/posts/2026-06-01-theme-wear-costumes-accessories.md":Y,"/content/posts/2026-06-01-wcs-essentials.md":K}),blogs:Object.assign({"/content/blog/2026-06-14-the-story-behind-the-merch-page.md":$}),studies:Object.assign({"/content/studies/ai-devops-pipeline.md":Z,"/content/studies/confidently-incorrect-v4.md":ne,"/content/studies/deployment-impact-analyzer.md":oe,"/content/studies/wcs-scraper-initial-sync.md":ie})},re=e=>e.split("/").pop()?.replace(".md","")||"";function le(e){if(typeof e!="string")return;const o=e.toLowerCase();return["published","draft","planned"].includes(o)?o:void 0}function ce(e){if(typeof e=="number")return e;if(typeof e=="string"){const o=parseInt(e.replace(/[^\d]/g,""),10);return isNaN(o)?void 0:o}}function ge(e){if(!(e===""||e===void 0||e===null))return typeof e!="string"?e:e.startsWith("/")&&!e.startsWith(h)?`${h}${e}`:e}function g(e,o){const i=t=>Array.isArray(t)?t:[];return Object.entries(e).map(([t,a])=>{const r=typeof a=="string"?a:a.default,{data:n,content:c}=se(r),u=n.type||o,p=s=>{if(s!=="")return typeof s=="string"&&s.startsWith("/")?`${h}${s}`:s};return n.image=p(n.image),n.imageBack=p(n.imageBack),{...n,type:u,title:String(n.title||"Untitled"),category:String(n.category||"General"),excerpt:String(n.excerpt||""),date:String(n.date||""),author:String(n.author||""),tags:i(n.tags),affiliateIds:i(n.affiliateIds),seoTitle:n.seoTitle?String(n.seoTitle):void 0,seoDescription:n.seoDescription?String(n.seoDescription):void 0,imageAlt:n.imageAlt?String(n.imageAlt):void 0,imageFit:n.imageFit==="cover"||n.imageFit==="contain"?n.imageFit:void 0,status:le(n.status),readTime:ce(n.readTime),content:c||"",slug:re(t)}}).filter(t=>t.draft?t.type==="study"&&(t.status==="planned"||t.status==="draft"):!0).sort((t,a)=>{const r=t.date?new Date(t.date).getTime():0,n=a.date?new Date(a.date).getTime():0,c=Number.isNaN(r)?0:r;return(Number.isNaN(n)?0:n)-c})}const l={posts:g({...d.posts,...d.blogs},"post"),studies:g(d.studies,"study")},de={posts:new Map(l.posts.map(e=>[e.slug,e])),studies:new Map(l.studies.map(e=>[e.slug,e]))},me=()=>l.posts,fe=()=>l.studies,ye=e=>de.posts.get(e),be=(e,o)=>{if(e&&e.trim().length>0)return Math.max(1,Math.round(e.split(/\s+/).length/200));const i=o?.split(/\s+/).length??0;return Math.max(1,Math.round(i/20))};export{ye as a,fe as b,me as g,ge as n,be as r};
