import{bW as m}from"./vendor-DD3MeM2b.js";import{A as u}from"./index-CJ4iC0wl.js";const f=`---
type: post
draft: true
status: draft
...
`,O=Object.freeze(Object.defineProperty({__proto__:null,default:R},Symbol.toStringTag,{value:"Module"})),z=`---
type: post
...
`,F=Object.freeze(Object.defineProperty({__proto__:null,default:z},Symbol.toStringTag,{value:"Module"})),G=`---
type: post
...
`,H=Object.freeze(Object.defineProperty({__proto__:null,default:G},Symbol.toStringTag,{value:"Module"})),L=`---
type: post
...
`,oe=Object.freeze(Object.defineProperty({__proto__:null,default:te},Symbol.toStringTag,{value:"Module"})),ae=`---
type: study
...
`,ie=Object.freeze(Object.defineProperty({__proto__:null,default:ae},Symbol.toStringTag,{value:"Module"})),se=`---
...
`,pe=Object.freeze(Object.defineProperty({__proto__:null,default:ue},Symbol.toStringTag,{value:"Module"}));function ge(e){const o=e.match(/^---\n([\s\S]+?)\n---\n([\s\S]*)$/);if(!o)return{data:{},content:e};const i=o[1],t=o[2];try{const a=m(i);return{data:a&&typeof a=="object"?a:{},content:t}}catch(a){return console.error("Error parsing frontmatter:",a),{data:{},content:t}}}const c={posts:Object.assign({"/content/posts/2026-04-18-competition-metrics.md":y,"/content/posts/2026-04-18-financial-literacy-dancers.md":w,"/content/posts/2026-04-18-github-actions.md":k,"/content/posts/2026-04-18-halloween-costumes.md":S,"/content/posts/2026-04-18-make-shoe-dance.md":A,"/content/posts/2026-04-18-why-finals-are-hard.md":I,"/content/posts/2026-04-19-practical-tools-essentials.md":P,"/content/posts/2026-05-06-boomtick-and-b-the-rhythmic-architecture-of-west-coast-swing.md":D,"/content/posts/2026-06-01-event-travel-packing.md":W,"/content/posts/2026-06-01-general-health-home-care.md":E,"/content/posts/2026-06-01-outdoor-dancing.md":O,"/content/posts/2026-06-01-power-charging.md":F,"/content/posts/2026-06-01-practice-review-tech.md":H,"/content/posts/2026-06-01-practice-social-dance-apparel.md":N,"/content/posts/2026-06-01-shoe-care-modification.md":U,"/content/posts/2026-06-01-theme-wear-costumes-accessories.md":Y,"/content/posts/2026-06-01-wcs-essentials.md":K}),blogs:Object.assign({"/content/blog/2026-06-14-the-story-behind-the-merch-page.md":Q}),studies:Object.assign({"/content/studies/2026-07-10-latest-version-check-skill.md":Z,"/content/studies/ai-devops-pipeline.md":ne,"/content/studies/confidently-incorrect-v4.md":oe,"/content/studies/deployment-impact-analyzer.md":ie,"/content/studies/wcs-scraper-initial-sync.md":re}),resources:Object.assign({"/content/resources/slot-era-mug.md":ce,"/content/resources/slot-era-tank-top.md":he,"/content/resources/slot-era-tote-bag.md":pe})},me=e=>e.split("/").pop()?.replace(".md","")||"";function fe(e){if(typeof e!="string")return;const o=e.toLowerCase();return["published","draft","planned"].includes(o)?o:void 0}function ye(e){if(typeof e=="number")return e;if(typeof e=="string"){const o=parseInt(e.replace(/[^\d]/g,""),10);return isNaN(o)?void 0:o}}function Te(e){if(!(e===""||e===void 0||e===null))return typeof e!="string"?e:e.startsWith("/")&&!e.startsWith(u)?`${u}${e}`:e}function h(e,o){const i=t=>Array.isArray(t)?t:[];return Object.entries(e).map(([t,a])=>{const l=typeof a=="string"?a:a.default,{data:n,content:d}=ge(l),p=n.type||o,g=s=>{if(s!=="")return typeof s=="string"&&s.startsWith("/")?`${u}${s}`:s};return n.image=g(n.image),n.imageBack=g(n.imageBack),{...n,type:p,title:String(n.title||"Untitled"),category:String(n.category||"General"),excerpt:String(n.excerpt||""),date:String(n.date||""),author:String(n.author||""),tags:i(n.tags),affiliateIds:i(n.affiliateIds),seoTitle:n.seoTitle?String(n.seoTitle):void 0,seoDescription:n.seoDescription?String(n.seoDescription):void 0,imageAlt:n.imageAlt?String(n.imageAlt):void 0,imageFit:n.imageFit==="cover"||n.imageFit==="contain"?n.imageFit:void 0,status:fe(n.status),readTime:ye(n.readTime),content:d||"",slug:me(t)}}).filter(t=>t.draft?t.type==="study"&&(t.status==="planned"||t.status==="draft"):!0).sort((t,a)=>{const l=t.date?new Date(t.date).getTime():0,n=a.date?new Date(a.date).getTime():0,d=Number.isNaN(l)?0:l;return(Number.isNaN(n)?0:n)-d})}const r={posts:h({...c.posts,...c.blogs},"post"),studies:h(c.studies,"study"),resources:h(c.resources,"resource")},be={posts:new Map(r.posts.map(e=>[e.slug,e])),studies:new Map(r.studies.map(e=>[e.slug,e])),resources:new Map(r.resources.map(e=>[e.slug,e]))},Se=()=>r.posts,_e=()=>r.studies,Ae=e=>be.posts.get(e),Ce=(e,o)=>{if(e&&e.trim().length>0)return Math.max(1,Math.round(e.split(/\s+/).length/200));const i=o?.split(/\s+/).length??0;return Math.max(1,Math.round(i/20))};export{Ae as a,_e as b,Se as g,Te as n,Ce as r};
