import{A as Qe}from"./index-CTUPCrZU.js";const yn=`---
type: post
draft: true
...
`,Nn=Object.freeze(Object.defineProperty({__proto__:null,default:Dn},Symbol.toStringTag,{value:"Module"})),Pn=`---
type: post
draft: true
...
`,En=Object.freeze(Object.defineProperty({__proto__:null,default:Pn},Symbol.toStringTag,{value:"Module"})),jn=`---
type: resource
...
`,Ns=Object.freeze(Object.defineProperty({__proto__:null,default:Ds},Symbol.toStringTag,{value:"Module"})),Ps=`---
type: resource
...
`,Es=Object.freeze(Object.defineProperty({__proto__:null,default:Ps},Symbol.toStringTag,{value:"Module"})),js=`---
type: resource
...
`,l+=2;o+=a,t[l+2]===" "&&(o+="\\"),l+=1,r=l+1}break;default:l+=1}return o=r?o+t.slice(r):t,s?o:Me(o,a,Ne,Fe(e,!1))}function et(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
...
`)?te(a,e):Pe(n,e,t,s);if(!r&&!f&&i!==_.PLAIN&&a.includes(`
`))return Pe(n,e,t,s);if(Re(a)){if(l==="")return e.forceBlockIndent=!0,Pe(n,e,t,s);if(r&&l===c)return te(a,e)}const h=a.replace(/\n+/g,`$&
${l}`);if(o){const u=d=>d.default&&d.tag!=="tag:yaml.org,2002:str"&&d.test?.test(h),{compat:g,tags:y}=e.doc.schema;if(y.some(u)||g?.some(u))return te(a,e)}return r?h:Me(h,l,xt,Fe(e,!1))}function rt(n,e,t,s){const{implicitKey:i,inFlow:a}=e,o=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)});let{type:r}=n;r!==_.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value)&&(r=_.QUOTE_DOUBLE);const l=f=>{switch(f){case _.BLOCK_FOLDED:case _.BLOCK_LITERAL:return i||a?te(o.value,e):Pe(o,e,t,s);case _.QUOTE_DOUBLE:return ge(o.value,e);case _.QUOTE_SINGLE:return et(o.value,e);case _.PLAIN:return Ni(o,e,t,s);default:return null}};let c=l(r);if(c===null){const{defaultKeyType:f,defaultStringType:h}=e.options,u=i&&f||h;if(c=l(u),c===null)throw new Error(`Unsupported default string type ${u}`)}return c}function Wt(n,e){const t=Object.assign({blockQuote:!0,commentString:Oi,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e);let s;switch(t.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:s,options:t}}function Pi(n,e){if(e.tag){const i=n.filter(a=>a.tag===e.tag);if(i.length>0)return i.find(a=>a.format===e.format)??i[0]}let t,s;if(I(e)){s=e.value;let i=n.filter(a=>a.identify?.(s));if(i.length>1){const a=i.filter(o=>o.test);a.length>0&&(i=a)}t=i.find(a=>a.format===e.format)??i.find(a=>!a.format)}else s=e,t=n.find(i=>i.nodeClass&&s instanceof i.nodeClass);if(!t){const i=s?.constructor?.name??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${i} value`)}return t}function Ei(n,e,{anchors:t,doc:s}){if(!s.directives)return"";const i=[],a=(I(n)||C(n))&&n.anchor;a&&Bt(a)&&(t.add(a),i.push(`&${a}`));const o=n.tag??(e.default?null:e.tag);return o&&i.push(s.directives.tagString(o)),i.join(" ")}function ie(n,e,t,s){if(D(n))return n.toString(e,t,s);if(re(n)){if(e.doc.directives)return n.toString(e);if(e.resolvedAliases?.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i;const a=O(n)?n:e.doc.createNode(n,{onTagObj:l=>i=l});i??(i=Pi(e.doc.schema.tags,a));const o=Ei(a,i,e);o.length>0&&(e.indentAtStart=(e.indentAtStart??0)+o.length+1);const r=typeof i.stringify=="function"?i.stringify(a,e,t,s):I(a)?rt(a,e,t,s):a.toString(e,t,s);return o?I(a)||r[0]==="{"||r[0]==="["?`${o} ${r}`:`${o}
...
`),N=w!==-1,U=t.inFlow??e.flow??e.items.length===0;if(N||!U){let Y=!1;if(N&&(A==="&"||A==="!")){let P=S.indexOf(" ");A==="&"&&P!==-1&&P<w&&S[P+1]==="!"&&(P=S.indexOf(" ",P+1)),(P===-1||w<P)&&(Y=!0)}Y||(T=`
${t.indent}`)}}else(S===""||S[0]===`
...
`+A:w.comment=A,T.comment=T.comment.substring(A.length+1)}}if(!o&&!k&&!T.found){const A=S?n(t,S,T,i):e(t,T.end,k,null,T,i);c.items.push(A),h=A.range[2],Je(S)&&i(A.range,"BLOCK_IN_FLOW",Ge)}else{t.atKey=!0;const A=T.end,w=v?n(t,v,T,i):e(t,A,m,null,T,i);Je(v)&&i(w.range,"BLOCK_IN_FLOW",Ge),t.atKey=!1;const N=oe(k??[],{flow:r,indicator:"map-value-ind",next:S,offset:w.range[2],onError:i,parentIndent:s.indent,startOnNewline:!1});if(N.found){if(!o&&!T.found&&t.options.strict){if(k)for(const P of k){if(P===N.found)break;if(P.type==="newline"){i(P,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}T.start<N.found.offset-1024&&i(N.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else S&&("source"in S&&S.source?.[0]===":"?i(S,"MISSING_CHAR",`Missing space after : in ${r}`):i(N.start,"MISSING_CHAR",`Missing , or : between ${r} items`));const U=S?n(t,S,N,i):N.found?e(t,N.end,k,null,N,i):null;U?Je(S)&&i(U.range,"BLOCK_IN_FLOW",Ge):N.comment&&(w.comment?w.comment+=`
`+N.comment:w.comment=N.comment);const Y=new j(w,U);if(t.options.keepSourceTokens&&(Y.srcToken=b),o){const P=c;cn(t,P.items,w)&&i(A,"DUPLICATE_KEY","Map keys must be unique"),P.items.push(Y)}else{const P=new B(t.schema);P.flow=!0,P.items.push(Y);const vt=(U??w).range;P.range=[w.range[0],vt[1],vt[2]],c.items.push(P)}h=U?U.range[2]:N.end}}const u=o?"}":"]",[g,...y]=s.end;let d=h;if(g?.source===u)d=g.offset+g.source.length;else{const p=r[0].toUpperCase()+r.substring(1),b=f?`${p} must end with a ${u}`:`${p} in block collection must be sufficiently indented and end with a ${u}`;i(h,f?"MISSING_CHAR":"BAD_INDENT",b),g&&g.source.length!==1&&y.unshift(g)}if(y.length>0){const p=ke(y,d,t.options.strict,i);p.comment&&(c.comment?c.comment+=`
