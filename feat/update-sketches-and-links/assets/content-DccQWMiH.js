import{A as Ye}from"./index-B0U8nEJw.js";const gn=`---
type: post
draft: true
status: draft
...
type: post
title: "Practical Tools Essentials"
date: "2026-04-19"
author: "Ariel Anders, PhD"
category: "Gear"
excerpt: "High‑priority tools every West Coast Swing dancer should have, from earplugs to travel gear."
...
Whether you're heading to a local social or traveling across the country for a convention, these items are essential tools for any West Coast Swing dancer.
...
![Handheld Fan](/images/gear/sketches/zolee-large-rave-folding-hand-fan-with-bamboo-ribs-for-men-women-chine.webp)
...
`,qn=Object.freeze(Object.defineProperty({__proto__:null,default:xn},Symbol.toStringTag,{value:"Module"})),Kn=`---
type: post
...
image: "/images/gear/sketches/portable-speaker.webp"
affiliateIds:
  - "portable-speaker"
  - "tripod"
tags:
...
`,Un=Object.freeze(Object.defineProperty({__proto__:null,default:Kn},Symbol.toStringTag,{value:"Module"})),Wn=`---
type: post
...
image: "/images/gear/sketches/suede-stick-on-sheets.webp"
affiliateIds:
  - "suede-sheets"
  - "shoe-dryer"
tags:
...
`);s=e,i=e+1,o=n[i]}return s}const De=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),Me=n=>/^(%|---|\.\.\.)/m.test(n);function hs(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let o=0,a=0;o<i;++o)if(n[o]===`
...
+(?!
|$)`,"g")}catch{Ze=/\n+(?!\n|$)/g}function Ne({comment:n,type:e,value:t},s,i,o){const{blockQuote:a,commentString:r,lineWidth:l}=s.options;if(!a||/\n[\t ]+$/.test(t))return ee(t,s);const c=s.indent||(s.forceBlockIndent||Me(t)?"  ":""),d=a==="literal"?!0:a==="folded"||e===T.BLOCK_FOLDED?!1:e===T.BLOCK_LITERAL?!0:!hs(t,l,c.length);if(!t)return d?`|
`:`>
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let _=!1;const A=De(s,!0);a!=="folded"&&e!==T.BLOCK_FOLDED&&(A.onOverflow=()=>{_=!0});const y=Be(`${w}${S}${m}`,c,Qe,A);if(!_)return`>${v}
...
`+E.comment:y.comment=E.comment);const Y=new j(y,K);if(t.options.keepSourceTokens&&(Y.srcToken=b),a){const L=c;ln(t,L.items,y)&&i(A,"DUPLICATE_KEY","Map keys must be unique"),L.items.push(Y)}else{const L=new B(t.schema);L.flow=!0,L.items.push(Y);const yt=(K??y).range;L.range=[y.range[0],yt[1],yt[2]],c.items.push(L)}u=K?K.range[2]:E.end}}const f=a?"}":"]",[m,...g]=s.end;let h=u;if(m?.source===f)h=m.offset+m.source.length;else{const p=r[0].toUpperCase()+r.substring(1),b=d?`${p} must end with a ${f}`:`${p} in block collection must be sufficiently indented and end with a ${f}`;i(u,d?"MISSING_CHAR":"BAD_INDENT",b),m&&m.source.length!==1&&g.unshift(m)}if(g.length>0){const p=ke(g,h,t.options.strict,i);p.comment&&(c.comment?c.comment+=`
`+p.comment:c.comment=p.comment),c.range=[s.offset,h,p.offset]}else c.range=[s.offset,h,h];return c}function Ve(n,e,t,s,i,o){const a=t.type==="block-map"?Ms(n,e,t,s,o):t.type==="block-seq"?$s(n,e,t,s,o):Rs(n,e,t,s,o),r=a.constructor;return i==="!"||i===r.tagName?(a.tag=r.tagName,a):(i&&(a.tag=i),a)}function Fs(n,e,t,s,i){const o=s.tag,a=o?e.directives.tagName(o.source,f=>i(o,"TAG_RESOLVE_FAILED",f)):null;if(t.type==="block-seq"){const{anchor:f,newlineAfterProp:m}=s,g=f&&o?f.offset>o.offset?f:o:f??o;g&&(!m||m.offset<g.offset)&&i(g,"MISSING_CHAR","Missing newline after block sequence props")}const r=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!o||!a||a==="!"||a===B.tagName&&r==="map"||a===z.tagName&&r==="seq")return Ve(n,e,t,i,a);let l=e.schema.tags.find(f=>f.tag===a&&f.collection===r);if(!l){const f=e.schema.knownTags[a];if(f?.collection===r)e.schema.tags.push(Object.assign({},f,{default:!1})),l=f;else return f?i(o,"BAD_COLLECTION_TYPE",`${f.tag} used for ${r} collection, but expects ${f.collection??"scalar"}`,!0):i(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${a}`,!0),Ve(n,e,t,i,a)}const c=Ve(n,e,t,i,a,l),d=l.resolve?.(c,f=>i(o,"TAG_RESOLVE_FAILED",f),e.options)??c,u=N(d)?d:new T(d);return u.range=c.range,u.tag=a,l?.format&&(u.format=l.format),u}function xs(n,e,t){const s=e.offset,i=qs(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const o=i.mode===">"?T.BLOCK_FOLDED:T.BLOCK_LITERAL,a=e.source?Ks(e.source):[];let r=a.length;for(let h=a.length-1;h>=0;--h){const p=a[h][1];if(p===""||p==="\r")r=h;else break}if(r===0){const h=i.chomp==="+"&&a.length>0?`
...
`&&(u+=`
`);break;default:u+=`
`}const g=s+i.length+e.source.length;return{value:u,type:o,comment:i.comment,range:[s,g,g]}}function qs({offset:n,props:e},t,s){if(e[0].type!=="block-scalar-header")return s(e[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:i}=e[0],o=i[0];let a=0,r="",l=-1;for(let f=1;f<i.length;++f){const m=i[f];if(!r&&(m==="-"||m==="+"))r=m;else{const g=Number(m);!a&&g?a=g:l===-1&&(l=n+f)}}l!==-1&&s(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,d="",u=i.length;for(let f=1;f<e.length;++f){const m=e[f];switch(m.type){case"space":c=!0;case"newline":u+=m.source.length;break;case"comment":t&&!c&&s(m,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),u+=m.source.length,d=m.source.substring(1);break;case"error":s(m,"UNEXPECTED_TOKEN",m.message),u+=m.source.length;break;default:{const g=`Unexpected token in block scalar header: ${m.type}`;s(m,"UNEXPECTED_TOKEN",g);const h=m.source;h&&typeof h=="string"&&(u+=h.length)}}}return{mode:o,indent:a,chomp:r,comment:d,length:u}}function Ks(n){const e=n.split(/\n( *)/),t=e[0],s=t.match(/^( *)/),o=[s?.[1]?[s[1],t.slice(s[1].length)]:["",t]];for(let a=1;a<e.length;a+=2)o.push([e[a],e[a+1]]);return o}function Us(n,e,t){const{offset:s,type:i,source:o,end:a}=n;let r,l;const c=(f,m,g)=>t(s+f,m,g);switch(i){case"scalar":r=T.PLAIN,l=Ws(o,c);break;case"single-quoted-scalar":r=T.QUOTE_SINGLE,l=Hs(o,c);break;case"double-quoted-scalar":r=T.QUOTE_DOUBLE,l=Gs(o,c);break;default:return t(n,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[s,s+o.length,s+o.length]}}const d=s+o.length,u=ke(a,d,e,t);return{value:l,type:r,comment:u.comment,range:[s,d,u.offset]}}function Ws(n,e){let t="";switch(n[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${n[0]}`;break}case"@":case"`":{t=`reserved character ${n[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),cn(n)}function Hs(n,e){return(n[n.length-1]!=="'"||n.length===1)&&e(n.length,"MISSING_CHAR","Missing closing 'quote"),cn(n.slice(1,-1)).replace(/''/g,"'")}function cn(n){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
...
`))if(i===`
`){const{fold:o,offset:a}=Vs(n,s);t+=o,s=a}else if(i==="\\"){let o=n[++s];const a=zs[o];if(a)t+=a;else if(o===`
`)for(o=n[s+1];o===" "||o==="	";)o=n[++s+1];else if(o==="\r"&&n[s+1]===`
`)for(o=n[++s+1];o===" "||o==="	";)o=n[++s+1];else if(o==="x"||o==="u"||o==="U"){const r=o==="x"?2:o==="u"?4:8;t+=Ys(n,s+1,r,e),s+=r}else{const r=n.substr(s-1,2);e(s-1,"BAD_DQ_ESCAPE",`Invalid escape sequence ${r}`),t+=r}}else if(i===" "||i==="	"){const o=s;let a=n[s+1];for(;a===" "||a==="	";)a=n[++s+1];a!==`
`&&!(a==="\r"&&n[s+2]===`
...
`,r:"\r",t:"	",v:"\v",N:"",_:" ",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function Ys(n,e,t,s){const i=n.substr(e,t),a=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;try{return String.fromCodePoint(a)}catch{const r=n.substr(e-2,t+2);return s(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${r}`),r}}function un(n,e,t,s){const{value:i,type:o,comment:a,range:r}=e.type==="block-scalar"?xs(n,e,s):Us(e,n.options.strict,s),l=t?n.directives.tagName(t.source,u=>s(t,"TAG_RESOLVE_FAILED",u)):null;let c;n.options.stringKeys&&n.atKey?c=n.schema[F]:l?c=Js(n.schema,i,l,t,s):e.type==="scalar"?c=Qs(n,i,e,s):c=n.schema[F];let d;try{const u=c.resolve(i,f=>s(t??e,"TAG_RESOLVE_FAILED",f),n.options);d=I(u)?u:new T(u)}catch(u){const f=u instanceof Error?u.message:String(u);s(t??e,"TAG_RESOLVE_FAILED",f),d=new T(i)}return d.range=r,d.source=i,o&&(d.type=o),l&&(d.tag=l),c.format&&(d.format=c.format),a&&(d.comment=a),d}function Js(n,e,t,s,i){if(t==="!")return n[F];const o=[];for(const r of n.tags)if(!r.collection&&r.tag===t)if(r.default&&r.test)o.push(r);else return r;for(const r of o)if(r.test?.test(e))return r;const a=n.knownTags[t];return a&&!a.collection?(n.tags.push(Object.assign({},a,{default:!1,test:void 0})),a):(i(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),n[F])}function Qs({atKey:n,directives:e,schema:t},s,i,o){const a=t.tags.find(r=>(r.default===!0||n&&r.default==="key")&&r.test?.test(s))||t[F];if(t.compat){const r=t.compat.find(l=>l.default&&l.test?.test(s))??t[F];if(a.tag!==r.tag){const l=e.tagString(a.tag),c=e.tagString(r.tag),d=`Value may be parsed as either ${l} or ${c}`;o(i,"TAG_RESOLVE_FAILED",d,!0)}}return a}function Xs(n,e,t){if(e){t??(t=e.length);for(let s=t-1;s>=0;--s){let i=e[s];switch(i.type){case"space":case"comment":case"newline":n-=i.source.length;continue}for(i=e[++s];i?.type==="space";)n+=i.source.length,i=e[++s];break}}return n}const Zs={composeNode:fn,composeEmptyNode:gt};function fn(n,e,t,s){const i=n.atKey,{spaceBefore:o,comment:a,anchor:r,tag:l}=t;let c,d=!0;switch(e.type){case"alias":c=ei(n,e,s),(r||l)&&s(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=un(n,e,l,s),r&&(c.anchor=r.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{c=Fs(Zs,n,e,t,s),r&&(c.anchor=r.source.substring(1))}catch(u){const f=u instanceof Error?u.message:String(u);s(e,"RESOURCE_EXHAUSTION",f)}break;default:{const u=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;s(e,"UNEXPECTED_TOKEN",u),d=!1}}return c??(c=gt(n,e.offset,void 0,null,t,s)),r&&c.anchor===""&&s(r,"BAD_ALIAS","Anchor cannot be an empty string"),i&&n.options.stringKeys&&(!I(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&s(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),o&&(c.spaceBefore=!0),a&&(e.type==="scalar"&&e.source===""?c.comment=a:c.commentBefore=a),n.options.keepSourceTokens&&d&&(c.srcToken=e),c}function gt(n,e,t,s,{spaceBefore:i,comment:o,anchor:a,tag:r,end:l},c){const d={type:"scalar",offset:Xs(e,t,s),indent:-1,source:""},u=un(n,d,r,c);return a&&(u.anchor=a.source.substring(1),u.anchor===""&&c(a,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(u.spaceBefore=!0),o&&(u.comment=o,u.range[2]=l),u}function ei({options:n},{offset:e,source:t,end:s},i){const o=new it(t.substring(1));o.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),o.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);const a=e+t.length,r=ke(s,a,n.strict,i);return o.range=[e,a,r.offset],r.comment&&(o.comment=r.comment),o}function ti(n,e,{offset:t,start:s,value:i,end:o},a){const r=Object.assign({_directives:e},n),l=new Ke(void 0,r),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},d=ie(s,{indicator:"doc-start",next:i??o?.[0],offset:t,onError:a,parentIndent:0,startOnNewline:!0});d.found&&(l.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!d.hasNewline&&a(d.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=i?fn(c,i,d,a):gt(c,d.end,s,null,d,a);const u=l.contents.range[2],f=ke(o,u,!1,a);return f.comment&&(l.comment=f.comment),l.range=[t,u,f.offset],l}function ue(n){if(typeof n=="number")return[n,n+1];if(Array.isArray(n))return n.length===2?n:[n[0],n[1]];const{offset:e,source:t}=n;return[e,e+(typeof t=="string"?t.length:1)]}function At(n){let e="",t=!1,s=!1;for(let i=0;i<n.length;++i){const o=n[i];switch(o[0]){case"#":e+=(e===""?"":s?`

`:`
`)+(o.substring(1)||" "),t=!0,s=!1;break;case"%":n[i+1]?.[0]!=="#"&&(i+=1),t=!1;break;default:t||(s=!0),t=!1}}return{comment:e,afterEmptyLine:s}}class ni{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,s,i,o)=>{const a=ue(t);o?this.warnings.push(new Ds(a,s,i)):this.errors.push(new he(a,s,i))},this.directives=new P({version:e.version||"1.2"}),this.options=e}decorate(e,t){const{comment:s,afterEmptyLine:i}=At(this.prelude);if(s){const o=e.contents;if(t)e.comment=e.comment?`${e.comment}
...
`:case"\r":case"	":return!0;default:return!1}}const It=new Set("0123456789ABCDEFabcdef"),ii=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),_e=new Set(",[]{}"),oi=new Set(` ,[]{}
...
`)+1;for(;t!==0;)this.onNewLine(this.offset+t),t=this.source.indexOf(`
`,t)+1}return{type:e,offset:this.offset,indent:this.indent,source:this.source}}startBlockValue(e){switch(this.type){case"alias":case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":return this.flowScalar(this.type);case"block-scalar-header":return{type:"block-scalar",offset:this.offset,indent:this.indent,props:[this.sourceToken],source:""};case"flow-map-start":case"flow-seq-start":return{type:"flow-collection",offset:this.offset,indent:this.indent,start:this.sourceToken,items:[],end:[]};case"seq-item-ind":return{type:"block-seq",offset:this.offset,indent:this.indent,items:[{start:[this.sourceToken]}]};case"explicit-key-ind":{this.onKeyLine=!0;const t=Ae(e),s=Q(t);return s.push(this.sourceToken),{type:"block-map",offset:this.offset,indent:this.indent,items:[{start:s,explicitKey:!0}]}}case"map-value-ind":{this.onKeyLine=!0;const t=Ae(e),s=Q(t);return{type:"block-map",offset:this.offset,indent:this.indent,items:[{start:s,key:null,sep:[this.sourceToken]}]}}}return null}atIndentedComment(e,t){return this.type!=="comment"||this.indent<=t?!1:e.every(s=>s.type==="newline"||s.type==="space")}*documentEnd(e){this.type!=="doc-mode"&&(e.end?e.end.push(this.sourceToken):e.end=[this.sourceToken],this.type==="newline"&&(yield*this.pop()))}*lineEnd(e){switch(this.type){case"comma":case"doc-start":case"doc-end":case"flow-seq-end":case"flow-map-end":case"map-value-ind":yield*this.pop(),yield*this.step();break;case"newline":this.onKeyLine=!1;case"space":case"comment":default:e.end?e.end.push(this.sourceToken):e.end=[this.sourceToken],this.type==="newline"&&(yield*this.pop())}}}function ci(n){const e=n.prettyErrors!==!1;return{lineCounter:n.lineCounter||e&&new ri||null,prettyErrors:e}}function ui(n,e={}){const{lineCounter:t,prettyErrors:s}=ci(e),i=new li(t?.addNewLine),o=new ni(e);let a=null;for(const r of o.compose(i.parse(n),!0,n.length))if(!a)a=r;else if(a.options.logLevel!=="silent"){a.errors.push(new he(r.range.slice(0,2),"MULTIPLE_DOCS","Source contains multiple documents; please use YAML.parseAllDocuments()"));break}return s&&t&&(a.errors.forEach(Tt(n,t)),a.warnings.forEach(Tt(n,t))),a}function fi(n,e,t){let s;const i=ui(n,t);if(!i)return null;if(i.warnings.forEach(o=>xt(i.options.logLevel,o)),i.errors.length>0){if(i.options.logLevel!=="silent")throw i.errors[0];i.errors=[]}return i.toJS(Object.assign({reviver:s},t))}function hi(n){const e=n.match(/^---\n([\s\S]+?)\n---\n([\s\S]*)$/);if(!e)return{data:Object.create(null),content:n};const t=e[1],s=e[2];try{const i=fi(t),o=Object.create(null);return i&&typeof i=="object"&&Object.assign(o,i),{data:o,content:s}}catch(i){return console.error("Error parsing frontmatter:",i),{data:Object.create(null),content:s}}}const Ct={posts:Object.assign({"/content/posts/2026-04-18-competition-metrics.md":yn,"/content/posts/2026-04-18-financial-literacy-dancers.md":wn,"/content/posts/2026-04-18-github-actions.md":vn,"/content/posts/2026-04-18-halloween-costumes.md":Tn,"/content/posts/2026-04-18-make-shoe-dance.md":An,"/content/posts/2026-04-18-why-finals-are-hard.md":On,"/content/posts/2026-04-19-gear-essentials.md":Cn,"/content/posts/2026-04-19-practical-tools-essentials.md":Ln,"/content/posts/2026-05-06-boomtick-and-b-the-rhythmic-architecture-of-west-coast-swing.md":jn,"/content/posts/2026-06-01-event-travel-packing.md":Dn,"/content/posts/2026-06-01-general-health-home-care.md":$n,"/content/posts/2026-06-01-outdoor-dancing.md":Fn,"/content/posts/2026-06-01-power-charging.md":qn,"/content/posts/2026-06-01-practice-review-tech.md":Un,"/content/posts/2026-06-01-practice-social-dance-apparel.md":Hn,"/content/posts/2026-06-01-shoe-care-modification.md":Vn,"/content/posts/2026-06-01-theme-wear-costumes-accessories.md":Yn,"/content/posts/2026-06-01-wcs-essentials.md":Qn}),studies:Object.assign({"/content/studies/ai-devops-pipeline.md":Zn,"/content/studies/wcs-scraper-initial-sync.md":ts})},di=n=>n.split("/").pop()?.replace(".md","")||"";function pi(n){if(typeof n!="string")return;const e=n.toLowerCase();return["published","draft","planned"].includes(e)?e:void 0}function mi(n){if(typeof n=="number")return n;if(typeof n=="string"){const e=parseInt(n.replace(/[^\d]/g,""),10);return isNaN(e)?void 0:e}}function bi(n){if(!(n===""||n===void 0||n===null))return typeof n!="string"?n:n.startsWith("/")&&!n.startsWith(Ye)?`${Ye}${n}`:n}function Et(n,e){const t=s=>Array.isArray(s)?s:[];return Object.entries(n).map(([s,i])=>{const o=typeof i=="string"?i:i.default,{data:a,content:r}=hi(o),l=a.type||e,c=u=>{if(u!=="")return typeof u=="string"&&u.startsWith("/")?`${Ye}${u}`:u};return a.image=c(a.image),a.imageBack=c(a.imageBack),{...a,type:l,title:String(a.title||"Untitled"),category:String(a.category||"General"),excerpt:String(a.excerpt||""),date:String(a.date||""),author:String(a.author||""),tags:t(a.tags),affiliateIds:t(a.affiliateIds),seoTitle:a.seoTitle?String(a.seoTitle):void 0,seoDescription:a.seoDescription?String(a.seoDescription):void 0,imageAlt:a.imageAlt?String(a.imageAlt):void 0,status:pi(a.status),readTime:mi(a.readTime),content:r||"",slug:di(s)}}).filter(s=>s.draft?s.type==="study"&&(s.status==="planned"||s.status==="draft"):!0).sort((s,i)=>{const o=s.date?new Date(s.date).getTime():0,a=i.date?new Date(i.date).getTime():0,r=Number.isNaN(o)?0:o;return(Number.isNaN(a)?0:a)-r})}const Pe={posts:Et(Ct.posts,"post"),studies:Et(Ct.studies,"study")},gi={posts:new Map(Pe.posts.map(n=>[n.slug,n])),studies:new Map(Pe.studies.map(n=>[n.slug,n]))},wi=()=>Pe.posts,ki=()=>Pe.studies,vi=n=>gi.posts.get(n),Si=(n,e)=>{if(n&&n.trim().length>0)return Math.max(1,Math.round(n.split(/\s+/).length/200));const t=e?.split(/\s+/).length??0;return Math.max(1,Math.round(t/20))};export{vi as a,ki as b,wi as g,bi as n,Si as r};
