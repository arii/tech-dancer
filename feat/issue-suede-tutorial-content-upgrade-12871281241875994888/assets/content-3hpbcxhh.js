import{A as Qe}from"./index-BZCODDGV.js";const yn=`---
type: post
draft: true
...
Dedicated dance shoes can be expensive and often lack the comfort of your favorite everyday sneakers. My preferred approach is to "upgrade" high-comfort sneakers or flats using adhesive suede. This $15 DIY hack allows you to turn almost any pair of shoes into professional-grade dance footwear.

### Budget Breakdown

Achieving perfect traction doesn't have to break the bank. Here is the cost breakdown for this modification:

| Item | Cost | Purpose |
|------|------|---------|
| [Adhesive Suede Sheets](https://www.amazon.com/dp/B07FZYY6J6?tag=onasafari04-20) | ~$13 | Provides the consistent glide needed for dance floors. |
| Isopropyl Alcohol | ~$2 | Essential for cleaning the sole to ensure a permanent bond. |
| **Total** | **~$15** | |

### Step-by-Step Tutorial

Follow these steps to ensure your suede modification lasts through even the longest social sets.

1.  **Clean the sole**: Thoroughly clean the rubber sole of your shoe with isopropyl alcohol. This removes oils, dirt, and manufacturing residues that would otherwise compromise the adhesive.
2.  **Trace and Cut**: Place your shoe on the paper backing of the suede sheet. Trace the outline of the area you want to cover, then cut the suede to shape using heavy-duty scissors.
3.  **Apply suede**: Peel off the adhesive backing and carefully align the suede with the sole. Press firmly across the entire surface, starting from the center and working outwards to eliminate air bubbles.
4.  **Let it cure**: For the strongest bond, allow the adhesive to cure for at least 24 hours before dancing on them.

### Placement Strategy Comparison

The way you position the suede significantly impacts your traction and "road feel" on the dance floor.

#### 1. Ball Only
![Ball Only Coverage](/images/gear/diy/suede-ball.svg)
*   **Pros:** Maximum spinning capability; allows for "braking" power by engaging the rubber heel.
*   **Cons:** Can feel inconsistent when weight shifting; risk of the suede edge peeling if not applied perfectly.

#### 2. Split Coverage
![Split Coverage](/images/gear/diy/suede-split.svg)
*   **Pros:** Balanced traction; provides grip for both pivots and controlled stops.
*   **Cons:** More complex to cut and apply; twice as many edges that could potentially catch or peel.

#### 3. Full Coverage
![Full Coverage](/images/gear/diy/suede-full.svg)
*   **Pros:** My preferred method. Provides a uniform, consistent friction profile across the entire foot. Most predictable response on unpredictable hotel carpets or sticky social floors.
*   **Cons:** Uses more material; slightly reduces the natural flexibility of very thin-soled shoes.

For more detailed gear recommendations, check out our [DIY Suede Shoe Resource Guide](/gear/2026-04-12-suede-shoe-diy).

_Affiliate disclosure: Links in this guide may earn a commission at no cost to you._
`,In=Object.freeze(Object.defineProperty({__proto__:null,default:An},Symbol.toStringTag,{value:"Module"})),Cn=`---
type: post
...
`,Rn=Object.freeze(Object.defineProperty({__proto__:null,default:Fn},Symbol.toStringTag,{value:"Module"})),xn=`---
type: resource
...
`,Wn=Object.freeze(Object.defineProperty({__proto__:null,default:xn},Symbol.toStringTag,{value:"Module"})),$n=`---
type: resource
...
`,Un=Object.freeze(Object.defineProperty({__proto__:null,default:$n},Symbol.toStringTag,{value:"Module"})),zn=`---
type: resource
...
`,qn=Object.freeze(Object.defineProperty({__proto__:null,default:zn},Symbol.toStringTag,{value:"Module"})),Hn=`---
type: resource
...
`,Is=Object.freeze(Object.defineProperty({__proto__:null,default:As},Symbol.toStringTag,{value:"Module"})),Cs=`---
type: resource
...
`,Os=Object.freeze(Object.defineProperty({__proto__:null,default:Cs},Symbol.toStringTag,{value:"Module"})),Ds=`---
type: resource
...
`,Rs=Object.freeze(Object.defineProperty({__proto__:null,default:Fs},Symbol.toStringTag,{value:"Module"})),xs=`---
type: resource
...
`,Ws=Object.freeze(Object.defineProperty({__proto__:null,default:xs},Symbol.toStringTag,{value:"Module"})),$s=`---
type: resource
...
`,Us=Object.freeze(Object.defineProperty({__proto__:null,default:$s},Symbol.toStringTag,{value:"Module"})),zs=`---
type: resource
...
`,qs=Object.freeze(Object.defineProperty({__proto__:null,default:zs},Symbol.toStringTag,{value:"Module"})),Hs=`---
type: resource
...
Instead of paying for expensive professional shoes, I use a DIY approach to convert my favorite comfortable sneakers into dance shoes. For a complete step-by-step walkthrough and a comparison of placement strategies, see our full [DIY Suede Tutorial](/blog/2026-04-18-make-shoe-dance).
...
- Bullet point 1
- Bullet point 2
`,hi=Object.freeze(Object.defineProperty({__proto__:null,default:ci},Symbol.toStringTag,{value:"Module"})),ui=`---
type: event
title: SOswing
date: '2026-05-14'
...
`,di=Object.freeze(Object.defineProperty({__proto__:null,default:ui},Symbol.toStringTag,{value:"Module"})),fi=`---
type: event
...
`);s=e,i=e+1,a=n[i]}return s}const Fe=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),Re=n=>/^(%|---|\.\.\.)/m.test(n);function Di(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let a=0,o=0;a<i;++a)if(n[a]===`
...
${t}`)+"'";return e.implicitKey?s:Me(s,t,xt,Fe(e,!1))}function te(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=ge;else{const i=n.includes('"'),a=n.includes("'");i&&!a?s=et:a&&!i?s=ge:s=t?et:ge}return s(n,e)}let tt;try{tt=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{tt=/\n+(?!\n|$)/g}function Ne({comment:n,type:e,value:t},s,i,a){const{blockQuote:o,commentString:r,lineWidth:l}=s.options;if(!o||/\n[\t ]+$/.test(t))return te(t,s);const c=s.indent||(s.forceBlockIndent||Re(t)?"  ":""),f=o==="literal"?!0:o==="folded"||e===_.BLOCK_FOLDED?!1:e===_.BLOCK_LITERAL?!0:!Di(t,l,c.length);if(!t)return f?`|
`:`>
...
${c}${m}${t}${g}`}function Pi(n,e,t,s){const{type:i,value:a}=n,{actualString:o,implicitKey:r,indent:l,indentStep:c,inFlow:f}=e;if(r&&a.includes(`
`)||f&&/[[\]{},]/.test(a))return te(a,e);if(/^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(a))return r||f||!a.includes(`
`)?te(a,e):Ne(n,e,t,s);if(!r&&!f&&i!==_.PLAIN&&a.includes(`
`))return Ne(n,e,t,s);if(Re(a)){if(l==="")return e.forceBlockIndent=!0,Ne(n,e,t,s);if(r&&l===c)return te(a,e)}const h=a.replace(/\n+/g,`$&
${l}`);if(o){const u=d=>d.default&&d.tag!=="tag:yaml.org,2002:str"&&d.test?.test(h),{compat:g,tags:y}=e.doc.schema;if(y.some(u)||g?.some(u))return te(a,e)}return r?h:Me(h,l,xt,Fe(e,!1))}function rt(n,e,t,s){const{implicitKey:i,inFlow:a}=e,o=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)});let{type:r}=n;r!==_.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value)&&(r=_.QUOTE_DOUBLE);const l=f=>{switch(f){case _.BLOCK_FOLDED:case _.BLOCK_LITERAL:return i||a?te(o.value,e):Ne(o,e,t,s);case _.QUOTE_DOUBLE:return ge(o.value,e);case _.QUOTE_SINGLE:return et(o.value,e);case _.PLAIN:return Pi(o,e,t,s);default:return null}};let c=l(r);if(c===null){const{defaultKeyType:f,defaultStringType:h}=e.options,u=i&&f||h;if(c=l(u),c===null)throw new Error(`Unsupported default string type ${u}`)}return c}function Wt(n,e){const t=Object.assign({blockQuote:!0,commentString:Oi,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e);let s;switch(t.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:s,options:t}}function Ni(n,e){if(e.tag){const i=n.filter(a=>a.tag===e.tag);if(i.length>0)return i.find(a=>a.format===e.format)??i[0]}let t,s;if(I(e)){s=e.value;let i=n.filter(a=>a.identify?.(s));if(i.length>1){const a=i.filter(o=>o.test);a.length>0&&(i=a)}t=i.find(a=>a.format===e.format)??i.find(a=>!a.format)}else s=e,t=n.find(i=>i.nodeClass&&s instanceof i.nodeClass);if(!t){const i=s?.constructor?.name??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${i} value`)}return t}function Ei(n,e,{anchors:t,doc:s}){if(!s.directives)return"";const i=[],a=(I(n)||C(n))&&n.anchor;a&&Bt(a)&&(t.add(a),i.push(`&${a}`));const o=n.tag??(e.default?null:e.tag);return o&&i.push(s.directives.tagString(o)),i.join(" ")}function ie(n,e,t,s){if(D(n))return n.toString(e,t,s);if(re(n)){if(e.doc.directives)return n.toString(e);if(e.resolvedAliases?.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i;const a=O(n)?n:e.doc.createNode(n,{onTagObj:l=>i=l});i??(i=Ni(e.doc.schema.tags,a));const o=Ei(a,i,e);o.length>0&&(e.indentAtStart=(e.indentAtStart??0)+o.length+1);const r=typeof i.stringify=="function"?i.stringify(a,e,t,s):I(a)?rt(a,e,t,s):a.toString(e,t,s);return o?I(a)||r[0]==="{"||r[0]==="["?`${o} ${r}`:`${o}
${e.indent}${r}`:r}function ji({key:n,value:e},t,s,i){const{allNullValues:a,doc:o,indent:r,indentStep:l,options:{commentString:c,indentSeq:f,simpleKeys:h}}=t;let u=O(n)&&n.comment||null;if(h){if(u)throw new Error("With simple keys, key nodes cannot have comments");if(C(n)||!O(n)&&typeof n=="object"){const A="With simple keys, collection cannot be used as a key value";throw new Error(A)}}let g=!h&&(!n||u&&e==null&&!t.inFlow||C(n)||(I(n)?n.type===_.BLOCK_FOLDED||n.type===_.BLOCK_LITERAL:typeof n=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!g&&(h||!a),indent:r+l});let y=!1,d=!1,p=ie(n,t,()=>y=!0,()=>d=!0);if(!g&&!t.inFlow&&p.length>1024){if(h)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");g=!0}if(t.inFlow){if(a||e==null)return y&&s&&s(),p===""?"?":g?`? ${p}`:p}else if(a&&!h||e==null&&g)return p=`? ${p}`,u&&!y?p+=G(p,t.indent,c(u)):d&&i&&i(),p;y&&(u=null),g?(u&&(p+=G(p,t.indent,c(u))),p=`? ${p}
${r}:`):(p=`${p}:`,u&&(p+=G(p,t.indent,c(u))));let b,m,v;O(e)?(b=!!e.spaceBefore,m=e.commentBefore,v=e.comment):(b=!1,m=null,v=null,e&&typeof e=="object"&&(e=o.createNode(e))),t.implicitKey=!1,!g&&!u&&I(e)&&(t.indentAtStart=p.length+1),d=!1,!f&&l.length>=2&&!t.inFlow&&!g&&we(e)&&!e.flow&&!e.tag&&!e.anchor&&(t.indent=t.indent.substring(2));let k=!1;const S=ie(e,t,()=>k=!0,()=>d=!0);let T=" ";if(u||b||m){if(T=b?`
`:"",m){const A=c(m);T+=`
${W(A,t.indent)}`}S===""&&!t.inFlow?T===`
`&&v&&(T=`

`):T+=`
${t.indent}`}else if(!g&&C(e)){const A=S[0],w=S.indexOf(`
...
${a}${i}${d}`:`
`;return`${y}
${i}${g}`}else return`${u}${o}${h.join(" ")}${o}${g}`}function je({indent:n,options:{commentString:e}},t,s,i){if(s&&i&&(s=s.replace(/^\n+/,"")),s){const a=W(e(s),n);t.push(a.trimStart())}}function J(n,e){const t=I(e)?e.value:e;for(const s of n)if(D(s)&&(s.key===e||s.key===t||I(s.key)&&s.key.value===t))return s}class B extends Rt{static get tagName(){return"tag:yaml.org,2002:map"}constructor(e){super(H,e),this.items=[]}static from(e,t,s){const{keepUndefined:i,replacer:a}=s,o=new this(e),r=(l,c)=>{if(typeof a=="function")c=a.call(t,l,c);else if(Array.isArray(a)&&!a.includes(l))return;(c!==void 0||i)&&o.items.push(lt(l,c,s))};if(t instanceof Map)for(const[l,c]of t)r(l,c);else if(t&&typeof t=="object")for(const l of Object.keys(t))r(l,t[l]);return typeof e.sortMapEntries=="function"&&o.items.sort(e.sortMapEntries),o}add(e,t){let s;D(e)?s=e:!e||typeof e!="object"||!("key"in e)?s=new j(e,e?.value):s=new j(e.key,e.value);const i=J(this.items,s.key),a=this.schema?.sortMapEntries;if(i){if(!t)throw new Error(`Key ${s.key} already set`);I(i.value)&&Ft(s.value)?i.value.value=s.value:i.value=s.value}else if(a){const o=this.items.findIndex(r=>a(s,r)<0);o===-1?this.items.push(s):this.items.splice(o,0,s)}else this.items.push(s)}delete(e){const t=J(this.items,e);return t?this.items.splice(this.items.indexOf(t),1).length>0:!1}get(e,t){const i=J(this.items,e)?.value;return(!t&&I(i)?i.value:i)??void 0}has(e){return!!J(this.items,e)}set(e,t){this.add(new j(e,t),!0)}toJSON(e,t,s){const i=s?new s:t?.mapAsMap?new Map:{};t?.onCreate&&t.onCreate(i);for(const a of this.items)qt(t,i,a);return i}toString(e,t,s){if(!e)return JSON.stringify(this);for(const i of this.items)if(!D(i))throw new Error(`Map items must all be pairs; found ${JSON.stringify(i)} instead`);return!e.allNullValues&&this.hasAllNullValues(!1)&&(e=Object.assign({},e,{allNullValues:!0})),Ht(this,e,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:e.indent||"",onChompKeep:s,onComment:t})}}const ce={collection:"map",default:!0,nodeClass:B,tag:"tag:yaml.org,2002:map",resolve(n,e){return be(n)||e("Expected a mapping for this tag"),n},createNode:(n,e,t)=>B.from(n,e,t)};class V extends Rt{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(e){super(ae,e),this.items=[]}add(e){this.items.push(e)}delete(e){const t=_e(e);return typeof t!="number"?!1:this.items.splice(t,1).length>0}get(e,t){const s=_e(e);if(typeof s!="number")return;const i=this.items[s];return!t&&I(i)?i.value:i}has(e){const t=_e(e);return typeof t=="number"&&t<this.items.length}set(e,t){const s=_e(e);if(typeof s!="number")throw new Error(`Expected a valid index, not ${e}.`);const i=this.items[s];I(i)&&Ft(t)?i.value=t:this.items[s]=t}toJSON(e,t){const s=[];t?.onCreate&&t.onCreate(s);let i=0;for(const a of this.items)s.push(L(a,String(i++),t));return s}toString(e,t,s){return e?Ht(this,e,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(e.indent||"")+"  ",onChompKeep:s,onComment:t}):JSON.stringify(this)}static from(e,t,s){const{replacer:i}=s,a=new this(e);if(t&&Symbol.iterator in Object(t)){let o=0;for(let r of t){if(typeof i=="function"){const l=t instanceof Set?r:String(o++);r=i.call(t,l,r)}a.items.push(me(r,void 0,s))}}return a}}function _e(n){let e=I(n)?n.value:n;return e&&typeof e=="string"&&(e=Number(e)),typeof e=="number"&&Number.isInteger(e)&&e>=0?e:null}const he={collection:"seq",default:!0,nodeClass:V,tag:"tag:yaml.org,2002:seq",resolve(n,e){return we(n)||e("Expected a sequence for this tag"),n},createNode:(n,e,t)=>V.from(n,e,t)},xe={identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify(n,e,t,s){return e=Object.assign({actualString:!0},e),rt(n,e,t,s)}},We={identify:n=>n==null,createNode:()=>new _(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new _(null),stringify:({source:n},e)=>typeof n=="string"&&We.test.test(n)?n:e.options.nullStr},ct={identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:n=>new _(n[0]==="t"||n[0]==="T"),stringify({source:n,value:e},t){if(n&&ct.test.test(n)){const s=n[0]==="t"||n[0]==="T";if(e===s)return n}return e?t.options.trueStr:t.options.falseStr}};function R({format:n,minFractionDigits:e,tag:t,value:s}){if(typeof s=="bigint")return String(s);const i=typeof s=="number"?s:Number(s);if(!isFinite(i))return isNaN(i)?".nan":i<0?"-.inf":".inf";let a=Object.is(s,-0)?"-0":JSON.stringify(s);if(!n&&e&&(!t||t==="tag:yaml.org,2002:float")&&/^-?\d/.test(a)&&!a.includes("e")){let o=a.indexOf(".");o<0&&(o=a.length,a+=".");let r=e-(a.length-o-1);for(;r-- >0;)a+="0"}return a}const Kt={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:R},Gt={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n),stringify(n){const e=Number(n.value);return isFinite(e)?e.toExponential():R(n)}},Jt={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(n){const e=new _(parseFloat(n)),t=n.indexOf(".");return t!==-1&&n[n.length-1]==="0"&&(e.minFractionDigits=n.length-t-1),e},stringify:R},$e=n=>typeof n=="bigint"||Number.isInteger(n),ht=(n,e,t,{intAsBigInt:s})=>s?BigInt(n):parseInt(n.substring(e),t);function Vt(n,e,t){const{value:s}=n;return $e(s)&&s>=0?t+s.toString(e):R(n)}const Yt={identify:n=>$e(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(n,e,t)=>ht(n,2,8,t),stringify:n=>Vt(n,8,"0o")},Qt={identify:$e,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(n,e,t)=>ht(n,0,10,t),stringify:R},Xt={identify:n=>$e(n)&&n>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(n,e,t)=>ht(n,2,16,t),stringify:n=>Vt(n,16,"0x")},Ri=[ce,he,xe,We,ct,Yt,Qt,Xt,Kt,Gt,Jt];function St(n){return typeof n=="bigint"||Number.isInteger(n)}const Te=({value:n})=>JSON.stringify(n),xi=[{identify:n=>typeof n=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:n=>n,stringify:Te},{identify:n=>n==null,createNode:()=>new _(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:Te},{identify:n=>typeof n=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true$|^false$/,resolve:n=>n==="true",stringify:Te},{identify:St,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(n,e,{intAsBigInt:t})=>t?BigInt(n):parseInt(n,10),stringify:({value:n})=>St(n)?n.toString():JSON.stringify(n)},{identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:n=>parseFloat(n),stringify:Te}],Wi={default:!0,tag:"",test:/^/,resolve(n,e){return e(`Unresolved plain scalar ${JSON.stringify(n)}`),n}},$i=[ce,he].concat(xi,Wi),ut={identify:n=>n instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(n,e){if(typeof atob=="function"){const t=atob(n.replace(/[\n\r]/g,"")),s=new Uint8Array(t.length);for(let i=0;i<t.length;++i)s[i]=t.charCodeAt(i);return s}else return e("This environment does not support reading binary tags; either Buffer or atob is required"),n},stringify({comment:n,type:e,value:t},s,i,a){if(!t)return"";const o=t;let r;if(typeof btoa=="function"){let l="";for(let c=0;c<o.length;++c)l+=String.fromCharCode(o[c]);r=btoa(l)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(e??(e=_.BLOCK_LITERAL),e!==_.QUOTE_DOUBLE){const l=Math.max(s.options.lineWidth-s.indent.length,s.options.minContentWidth),c=Math.ceil(r.length/l),f=new Array(c);for(let h=0,u=0;h<c;++h,u+=l)f[h]=r.substr(u,l);r=f.join(e===_.BLOCK_LITERAL?`
`:" ")}return rt({comment:n,type:e,value:r},s,i,a)}};function Zt(n,e){if(we(n))for(let t=0;t<n.items.length;++t){let s=n.items[t];if(!D(s)){if(be(s)){s.items.length>1&&e("Each pair must have its own sequence indicator");const i=s.items[0]||new j(new _(null));if(s.commentBefore&&(i.key.commentBefore=i.key.commentBefore?`${s.commentBefore}
${i.key.commentBefore}`:s.commentBefore),s.comment){const a=i.value??i.key;a.comment=a.comment?`${s.comment}
${a.comment}`:s.comment}s=i}n.items[t]=D(s)?s:new j(s)}}else e("Expected a sequence for this tag");return n}function en(n,e,t){const{replacer:s}=t,i=new V(n);i.tag="tag:yaml.org,2002:pairs";let a=0;if(e&&Symbol.iterator in Object(e))for(let o of e){typeof s=="function"&&(o=s.call(e,String(a++),o));let r,l;if(Array.isArray(o))if(o.length===2)r=o[0],l=o[1];else throw new TypeError(`Expected [key, value] tuple: ${o}`);else if(o&&o instanceof Object){const c=Object.keys(o);if(c.length===1)r=c[0],l=o[r];else throw new TypeError(`Expected tuple with one key, not ${c.length} keys`)}else r=o;i.items.push(lt(r,l,t))}return i}const dt={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:Zt,createNode:en};class ne extends V{constructor(){super(),this.add=B.prototype.add.bind(this),this.delete=B.prototype.delete.bind(this),this.get=B.prototype.get.bind(this),this.has=B.prototype.has.bind(this),this.set=B.prototype.set.bind(this),this.tag=ne.tag}toJSON(e,t){if(!t)return super.toJSON(e);const s=new Map;t?.onCreate&&t.onCreate(s);for(const i of this.items){let a,o;if(D(i)?(a=L(i.key,"",t),o=L(i.value,a,t)):a=L(i,"",t),s.has(a))throw new Error("Ordered maps must not include duplicate keys");s.set(a,o)}return s}static from(e,t,s){const i=en(e,t,s),a=new this;return a.items=i.items,a}}ne.tag="tag:yaml.org,2002:omap";const ft={collection:"seq",identify:n=>n instanceof Map,nodeClass:ne,default:!1,tag:"tag:yaml.org,2002:omap",resolve(n,e){const t=Zt(n,e),s=[];for(const{key:i}of t.items)I(i)&&(s.includes(i.value)?e(`Ordered maps must not include duplicate keys: ${i.value}`):s.push(i.value));return Object.assign(new ne,t)},createNode:(n,e,t)=>ne.from(n,e,t)};function tn({value:n,source:e},t){return e&&(n?nn:sn).test.test(e)?e:n?t.options.trueStr:t.options.falseStr}const nn={identify:n=>n===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new _(!0),stringify:tn},sn={identify:n=>n===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new _(!1),stringify:tn},Ui={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:n=>n.slice(-3).toLowerCase()==="nan"?NaN:n[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:R},zi={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:n=>parseFloat(n.replace(/_/g,"")),stringify(n){const e=Number(n.value);return isFinite(e)?e.toExponential():R(n)}},qi={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(n){const e=new _(parseFloat(n.replace(/_/g,""))),t=n.indexOf(".");if(t!==-1){const s=n.substring(t+1).replace(/_/g,"");s[s.length-1]==="0"&&(e.minFractionDigits=s.length)}return e},stringify:R},ve=n=>typeof n=="bigint"||Number.isInteger(n);function Ue(n,e,t,{intAsBigInt:s}){const i=n[0];if((i==="-"||i==="+")&&(e+=1),n=n.substring(e).replace(/_/g,""),s){switch(t){case 2:n=`0b${n}`;break;case 8:n=`0o${n}`;break;case 16:n=`0x${n}`;break}const o=BigInt(n);return i==="-"?BigInt(-1)*o:o}const a=parseInt(n,t);return i==="-"?-1*a:a}function pt(n,e,t){const{value:s}=n;if(ve(s)){const i=s.toString(e);return s<0?"-"+t+i.substr(1):t+i}return R(n)}const Hi={identify:ve,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(n,e,t)=>Ue(n,2,2,t),stringify:n=>pt(n,2,"0b")},Ki={identify:ve,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(n,e,t)=>Ue(n,1,8,t),stringify:n=>pt(n,8,"0")},Gi={identify:ve,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(n,e,t)=>Ue(n,0,10,t),stringify:R},Ji={identify:ve,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(n,e,t)=>Ue(n,2,16,t),stringify:n=>pt(n,16,"0x")};class se extends B{constructor(e){super(e),this.tag=se.tag}add(e){let t;D(e)?t=e:e&&typeof e=="object"&&"key"in e&&"value"in e&&e.value===null?t=new j(e.key,null):t=new j(e,null),J(this.items,t.key)||this.items.push(t)}get(e,t){const s=J(this.items,e);return!t&&D(s)?I(s.key)?s.key.value:s.key:s}set(e,t){if(typeof t!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof t}`);const s=J(this.items,e);s&&!t?this.items.splice(this.items.indexOf(s),1):!s&&t&&this.items.push(new j(e))}toJSON(e,t){return super.toJSON(e,t,Set)}toString(e,t,s){if(!e)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},e,{allNullValues:!0}),t,s);throw new Error("Set items must all have null values")}static from(e,t,s){const{replacer:i}=s,a=new this(e);if(t&&Symbol.iterator in Object(t))for(let o of t)typeof i=="function"&&(o=i.call(t,o,o)),a.items.push(lt(o,null,s));return a}}se.tag="tag:yaml.org,2002:set";const gt={collection:"map",identify:n=>n instanceof Set,nodeClass:se,default:!1,tag:"tag:yaml.org,2002:set",createNode:(n,e,t)=>se.from(n,e,t),resolve(n,e){if(be(n)){if(n.hasAllNullValues(!0))return Object.assign(new se,n);e("Set items must all have null values")}else e("Expected a mapping for this tag");return n}};function mt(n,e){const t=n[0],s=t==="-"||t==="+"?n.substring(1):n,i=o=>e?BigInt(o):Number(o),a=s.replace(/_/g,"").split(":").reduce((o,r)=>o*i(60)+i(r),i(0));return t==="-"?i(-1)*a:a}function on(n){let{value:e}=n,t=o=>o;if(typeof e=="bigint")t=o=>BigInt(o);else if(isNaN(e)||!isFinite(e))return R(n);let s="";e<0&&(s="-",e*=t(-1));const i=t(60),a=[e%i];return e<60?a.unshift(0):(e=(e-a[0])/i,a.unshift(e%i),e>=60&&(e=(e-a[0])/i,a.unshift(e))),s+a.map(o=>String(o).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}const an={identify:n=>typeof n=="bigint"||Number.isInteger(n),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(n,e,{intAsBigInt:t})=>mt(n,t),stringify:on},rn={identify:n=>typeof n=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:n=>mt(n,!1),stringify:on},ze={identify:n=>n instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(n){const e=n.match(ze.test);if(!e)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");const[,t,s,i,a,o,r]=e.map(Number),l=e[7]?Number((e[7]+"00").substr(1,3)):0;let c=Date.UTC(t,s-1,i,a||0,o||0,r||0,l);const f=e[8];if(f&&f!=="Z"){let h=mt(f,!1);Math.abs(h)<30&&(h*=60),c-=6e4*h}return new Date(c)},stringify:({value:n})=>n?.toISOString().replace(/(T00:00:00)?\.000Z$/,"")??""},_t=[ce,he,xe,We,nn,sn,Hi,Ki,Gi,Ji,Ui,zi,qi,ut,$,ft,dt,gt,an,rn,ze],Tt=new Map([["core",Ri],["failsafe",[ce,he,xe]],["json",$i],["yaml11",_t],["yaml-1.1",_t]]),At={binary:ut,bool:ct,float:Jt,floatExp:Gt,floatNaN:Kt,floatTime:rn,int:Qt,intHex:Xt,intOct:Yt,intTime:an,map:ce,merge:$,null:We,omap:ft,pairs:dt,seq:he,set:gt,timestamp:ze},Vi={"tag:yaml.org,2002:binary":ut,"tag:yaml.org,2002:merge":$,"tag:yaml.org,2002:omap":ft,"tag:yaml.org,2002:pairs":dt,"tag:yaml.org,2002:set":gt,"tag:yaml.org,2002:timestamp":ze};function Ke(n,e,t){const s=Tt.get(e);if(s&&!n)return t&&!s.includes($)?s.concat($):s.slice();let i=s;if(!i)if(Array.isArray(n))i=[];else{const a=Array.from(Tt.keys()).filter(o=>o!=="yaml11").map(o=>JSON.stringify(o)).join(", ");throw new Error(`Unknown schema "${e}"; use one of ${a} or define customTags array`)}if(Array.isArray(n))for(const a of n)i=i.concat(a);else typeof n=="function"&&(i=n(i.slice()));return t&&(i=i.concat($)),i.reduce((a,o)=>{const r=typeof o=="string"?At[o]:o;if(!r){const l=JSON.stringify(o),c=Object.keys(At).map(f=>JSON.stringify(f)).join(", ");throw new Error(`Unknown custom tag ${l}; use one of ${c}`)}return a.includes(r)||a.push(r),a},[])}const Yi=(n,e)=>n.key<e.key?-1:n.key>e.key?1:0;class yt{constructor({compat:e,customTags:t,merge:s,resolveKnownTags:i,schema:a,sortMapEntries:o,toStringDefaults:r}){this.compat=Array.isArray(e)?Ke(e,"compat"):e?Ke(null,e):null,this.name=typeof a=="string"&&a||"core",this.knownTags=i?Vi:{},this.tags=Ke(t,this.name,s),this.toStringOptions=r??null,Object.defineProperty(this,H,{value:ce}),Object.defineProperty(this,x,{value:xe}),Object.defineProperty(this,ae,{value:he}),this.sortMapEntries=typeof o=="function"?o:o===!0?Yi:null}clone(){const e=Object.create(yt.prototype,Object.getOwnPropertyDescriptors(this));return e.tags=this.tags.slice(),e}}function Qi(n,e){const t=[];let s=e.directives===!0;if(e.directives!==!1&&n.directives){const l=n.directives.toString(n);l?(t.push(l),s=!0):n.directives.docStart&&(s=!0)}s&&t.push("---");const i=Wt(n,e),{commentString:a}=i.options;if(n.commentBefore){t.length!==1&&t.unshift("");const l=a(n.commentBefore);t.unshift(W(l,""))}let o=!1,r=null;if(n.contents){if(O(n.contents)){if(n.contents.spaceBefore&&s&&t.push(""),n.contents.commentBefore){const f=a(n.contents.commentBefore);t.push(W(f,""))}i.forceBlockIndent=!!n.comment,r=n.contents.comment}const l=r?void 0:()=>o=!0;let c=ie(n.contents,i,()=>r=null,l);r&&(c+=G(c,"",a(r))),(c[0]==="|"||c[0]===">")&&t[t.length-1]==="---"?t[t.length-1]=`--- ${c}`:t.push(c)}else t.push(ie(n.contents,i));if(n.directives?.docEnd)if(n.comment){const l=a(n.comment);l.includes(`
...
`+P.comment:w.comment=P.comment);const Y=new j(w,U);if(t.options.keepSourceTokens&&(Y.srcToken=b),o){const N=c;cn(t,N.items,w)&&i(A,"DUPLICATE_KEY","Map keys must be unique"),N.items.push(Y)}else{const N=new B(t.schema);N.flow=!0,N.items.push(Y);const vt=(U??w).range;N.range=[w.range[0],vt[1],vt[2]],c.items.push(N)}h=U?U.range[2]:P.end}}const u=o?"}":"]",[g,...y]=s.end;let d=h;if(g?.source===u)d=g.offset+g.source.length;else{const p=r[0].toUpperCase()+r.substring(1),b=f?`${p} must end with a ${u}`:`${p} in block collection must be sufficiently indented and end with a ${u}`;i(h,f?"MISSING_CHAR":"BAD_INDENT",b),g&&g.source.length!==1&&y.unshift(g)}if(y.length>0){const p=ke(y,d,t.options.strict,i);p.comment&&(c.comment?c.comment+=`
`+p.comment:c.comment=p.comment),c.range=[s.offset,d,p.offset]}else c.range=[s.offset,d,d];return c}function Ve(n,e,t,s,i,a){const o=t.type==="block-map"?Zi(n,e,t,s,a):t.type==="block-seq"?eo(n,e,t,s,a):to(n,e,t,s,a),r=o.constructor;return i==="!"||i===r.tagName?(o.tag=r.tagName,o):(i&&(o.tag=i),o)}function no(n,e,t,s,i){const a=s.tag,o=a?e.directives.tagName(a.source,u=>i(a,"TAG_RESOLVE_FAILED",u)):null;if(t.type==="block-seq"){const{anchor:u,newlineAfterProp:g}=s,y=u&&a?u.offset>a.offset?u:a:u??a;y&&(!g||g.offset<y.offset)&&i(y,"MISSING_CHAR","Missing newline after block sequence props")}const r=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!a||!o||o==="!"||o===B.tagName&&r==="map"||o===V.tagName&&r==="seq")return Ve(n,e,t,i,o);let l=e.schema.tags.find(u=>u.tag===o&&u.collection===r);if(!l){const u=e.schema.knownTags[o];if(u?.collection===r)e.schema.tags.push(Object.assign({},u,{default:!1})),l=u;else return u?i(a,"BAD_COLLECTION_TYPE",`${u.tag} used for ${r} collection, but expects ${u.collection??"scalar"}`,!0):i(a,"TAG_RESOLVE_FAILED",`Unresolved tag: ${o}`,!0),Ve(n,e,t,i,o)}const c=Ve(n,e,t,i,o,l),f=l.resolve?.(c,u=>i(a,"TAG_RESOLVE_FAILED",u),e.options)??c,h=O(f)?f:new _(f);return h.range=c.range,h.tag=o,l?.format&&(h.format=l.format),h}function so(n,e,t){const s=e.offset,i=io(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const a=i.mode===">"?_.BLOCK_FOLDED:_.BLOCK_LITERAL,o=e.source?oo(e.source):[];let r=o.length;for(let d=o.length-1;d>=0;--d){const p=o[d][1];if(p===""||p==="\r")r=d;else break}if(r===0){const d=i.chomp==="+"&&o.length>0?`
...
`;for(let d=f;d<r;++d){let[p,b]=o[d];c+=p.length+b.length+1;const m=b[b.length-1]==="\r";if(m&&(b=b.slice(0,-1)),b&&p.length<l){const k=`Block scalar lines must not be less indented than their ${i.indent?"explicit indentation indicator":"first line"}`;t(c-b.length-(m?2:1),"BAD_INDENT",k),p=""}a===_.BLOCK_LITERAL?(h+=u+p.slice(l)+b,u=`
`):p.length>l||b[0]==="	"?(u===" "?u=`
`:!g&&u===`
`&&(u=`
...
`&&(h+=`
`);break;default:h+=`
`}const y=s+i.length+e.source.length;return{value:h,type:a,comment:i.comment,range:[s,y,y]}}function io({offset:n,props:e},t,s){if(e[0].type!=="block-scalar-header")return s(e[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:i}=e[0],a=i[0];let o=0,r="",l=-1;for(let u=1;u<i.length;++u){const g=i[u];if(!r&&(g==="-"||g==="+"))r=g;else{const y=Number(g);!o&&y?o=y:l===-1&&(l=n+u)}}l!==-1&&s(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,f="",h=i.length;for(let u=1;u<e.length;++u){const g=e[u];switch(g.type){case"space":c=!0;case"newline":h+=g.source.length;break;case"comment":t&&!c&&s(g,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),h+=g.source.length,f=g.source.substring(1);break;case"error":s(g,"UNEXPECTED_TOKEN",g.message),h+=g.source.length;break;default:{const y=`Unexpected token in block scalar header: ${g.type}`;s(g,"UNEXPECTED_TOKEN",y);const d=g.source;d&&typeof d=="string"&&(h+=d.length)}}}return{mode:a,indent:o,chomp:r,comment:f,length:h}}function oo(n){const e=n.split(/\n( *)/),t=e[0],s=t.match(/^( *)/),a=[s?.[1]?[s[1],t.slice(s[1].length)]:["",t]];for(let o=1;o<e.length;o+=2)a.push([e[o],e[o+1]]);return a}function ao(n,e,t){const{offset:s,type:i,source:a,end:o}=n;let r,l;const c=(u,g,y)=>t(s+u,g,y);switch(i){case"scalar":r=_.PLAIN,l=ro(a,c);break;case"single-quoted-scalar":r=_.QUOTE_SINGLE,l=lo(a,c);break;case"double-quoted-scalar":r=_.QUOTE_DOUBLE,l=co(a,c);break;default:return t(n,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[s,s+a.length,s+a.length]}}const f=s+a.length,h=ke(o,f,e,t);return{value:l,type:r,comment:h.comment,range:[s,f,h.offset]}}function ro(n,e){let t="";switch(n[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${n[0]}`;break}case"@":case"`":{t=`reserved character ${n[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),hn(n)}function lo(n,e){return(n[n.length-1]!=="'"||n.length===1)&&e(n.length,"MISSING_CHAR","Missing closing 'quote"),hn(n.slice(1,-1)).replace(/''/g,"'")}function hn(n){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
`,"sy")}catch{e=/(.*?)[ \t]*\r?\n/sy,t=/[ \t]*(.*?)[ \t]*\r?\n/sy}let s=e.exec(n);if(!s)return n;let i=s[1],a=" ",o=e.lastIndex;for(t.lastIndex=o;s=t.exec(n);)s[1]===""?a===`
`?i+=a:a=`
`:(i+=a+s[1],a=" "),o=t.lastIndex;const r=/[ \t]*(.*)/sy;return r.lastIndex=o,s=r.exec(n),i+a+(s?.[1]??"")}function co(n,e){let t="";for(let s=1;s<n.length-1;++s){const i=n[s];if(!(i==="\r"&&n[s+1]===`
`))if(i===`
`){const{fold:a,offset:o}=ho(n,s);t+=a,s=o}else if(i==="\\"){let a=n[++s];const o=uo[a];if(o)t+=o;else if(a===`
`)for(a=n[s+1];a===" "||a==="	";)a=n[++s+1];else if(a==="\r"&&n[s+1]===`
`)for(a=n[++s+1];a===" "||a==="	";)a=n[++s+1];else if(a==="x"||a==="u"||a==="U"){const r=a==="x"?2:a==="u"?4:8;t+=fo(n,s+1,r,e),s+=r}else{const r=n.substr(s-1,2);e(s-1,"BAD_DQ_ESCAPE",`Invalid escape sequence ${r}`),t+=r}}else if(i===" "||i==="	"){const a=s;let o=n[s+1];for(;o===" "||o==="	";)o=n[++s+1];o!==`
`&&!(o==="\r"&&n[s+2]===`
`)&&(t+=s>a?n.slice(a,s+1):i)}else t+=i}return(n[n.length-1]!=='"'||n.length===1)&&e(n.length,"MISSING_CHAR",'Missing closing "quote'),t}function ho(n,e){let t="",s=n[e+1];for(;(s===" "||s==="	"||s===`
`||s==="\r")&&!(s==="\r"&&n[e+2]!==`
`);)s===`
`&&(t+=`
`),e+=1,s=n[e+1];return t||(t=" "),{fold:t,offset:e}}const uo={0:"\0",a:"\x07",b:"\b",e:"\x1B",f:"\f",n:`
`,r:"\r",t:"	",v:"\v",N:"",_:" ",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function fo(n,e,t,s){const i=n.substr(e,t),o=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;try{return String.fromCodePoint(o)}catch{const r=n.substr(e-2,t+2);return s(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${r}`),r}}function un(n,e,t,s){const{value:i,type:a,comment:o,range:r}=e.type==="block-scalar"?so(n,e,s):ao(e,n.options.strict,s),l=t?n.directives.tagName(t.source,h=>s(t,"TAG_RESOLVE_FAILED",h)):null;let c;n.options.stringKeys&&n.atKey?c=n.schema[x]:l?c=po(n.schema,i,l,t,s):e.type==="scalar"?c=go(n,i,e,s):c=n.schema[x];let f;try{const h=c.resolve(i,u=>s(t??e,"TAG_RESOLVE_FAILED",u),n.options);f=I(h)?h:new _(h)}catch(h){const u=h instanceof Error?h.message:String(h);s(t??e,"TAG_RESOLVE_FAILED",u),f=new _(i)}return f.range=r,f.source=i,a&&(f.type=a),l&&(f.tag=l),c.format&&(f.format=c.format),o&&(f.comment=o),f}function po(n,e,t,s,i){if(t==="!")return n[x];const a=[];for(const r of n.tags)if(!r.collection&&r.tag===t)if(r.default&&r.test)a.push(r);else return r;for(const r of a)if(r.test?.test(e))return r;const o=n.knownTags[t];return o&&!o.collection?(n.tags.push(Object.assign({},o,{default:!1,test:void 0})),o):(i(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),n[x])}function go({atKey:n,directives:e,schema:t},s,i,a){const o=t.tags.find(r=>(r.default===!0||n&&r.default==="key")&&r.test?.test(s))||t[x];if(t.compat){const r=t.compat.find(l=>l.default&&l.test?.test(s))??t[x];if(o.tag!==r.tag){const l=e.tagString(o.tag),c=e.tagString(r.tag),f=`Value may be parsed as either ${l} or ${c}`;a(i,"TAG_RESOLVE_FAILED",f,!0)}}return o}function mo(n,e,t){if(e){t??(t=e.length);for(let s=t-1;s>=0;--s){let i=e[s];switch(i.type){case"space":case"comment":case"newline":n-=i.source.length;continue}for(i=e[++s];i?.type==="space";)n+=i.source.length,i=e[++s];break}}return n}const yo={composeNode:dn,composeEmptyNode:bt};function dn(n,e,t,s){const i=n.atKey,{spaceBefore:a,comment:o,anchor:r,tag:l}=t;let c,f=!0;switch(e.type){case"alias":c=bo(n,e,s),(r||l)&&s(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=un(n,e,l,s),r&&(c.anchor=r.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{c=no(yo,n,e,t,s),r&&(c.anchor=r.source.substring(1))}catch(h){const u=h instanceof Error?h.message:String(h);s(e,"RESOURCE_EXHAUSTION",u)}break;default:{const h=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;s(e,"UNEXPECTED_TOKEN",h),f=!1}}return c??(c=bt(n,e.offset,void 0,null,t,s)),r&&c.anchor===""&&s(r,"BAD_ALIAS","Anchor cannot be an empty string"),i&&n.options.stringKeys&&(!I(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&s(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),a&&(c.spaceBefore=!0),o&&(e.type==="scalar"&&e.source===""?c.comment=o:c.commentBefore=o),n.options.keepSourceTokens&&f&&(c.srcToken=e),c}function bt(n,e,t,s,{spaceBefore:i,comment:a,anchor:o,tag:r,end:l},c){const f={type:"scalar",offset:mo(e,t,s),indent:-1,source:""},h=un(n,f,r,c);return o&&(h.anchor=o.source.substring(1),h.anchor===""&&c(o,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(h.spaceBefore=!0),a&&(h.comment=a,h.range[2]=l),h}function bo({options:n},{offset:e,source:t,end:s},i){const a=new at(t.substring(1));a.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),a.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);const o=e+t.length,r=ke(s,o,n.strict,i);return a.range=[e,o,r.offset],r.comment&&(a.comment=r.comment),a}function wo(n,e,{offset:t,start:s,value:i,end:a},o){const r=Object.assign({_directives:e},n),l=new qe(void 0,r),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},f=oe(s,{indicator:"doc-start",next:i??a?.[0],offset:t,onError:o,parentIndent:0,startOnNewline:!0});f.found&&(l.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!f.hasNewline&&o(f.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=i?dn(c,i,f,o):bt(c,f.end,s,null,f,o);const h=l.contents.range[2],u=ke(a,h,!1,o);return u.comment&&(l.comment=u.comment),l.range=[t,h,u.offset],l}function ue(n){if(typeof n=="number")return[n,n+1];if(Array.isArray(n))return n.length===2?n:[n[0],n[1]];const{offset:e,source:t}=n;return[e,e+(typeof t=="string"?t.length:1)]}function Ot(n){let e="",t=!1,s=!1;for(let i=0;i<n.length;++i){const a=n[i];switch(a[0]){case"#":e+=(e===""?"":s?`

`:`
`)+(a.substring(1)||" "),t=!0,s=!1;break;case"%":n[i+1]?.[0]!=="#"&&(i+=1),t=!1;break;default:t||(s=!0),t=!1}}return{comment:e,afterEmptyLine:s}}class vo{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,s,i,a)=>{const o=ue(t);a?this.warnings.push(new Xi(o,s,i)):this.errors.push(new fe(o,s,i))},this.directives=new E({version:e.version||"1.2"}),this.options=e}decorate(e,t){const{comment:s,afterEmptyLine:i}=Ot(this.prelude);if(s){const a=e.contents;if(t)e.comment=e.comment?`${e.comment}
...
`:case"\r":case"	":return!0;default:return!1}}const Dt=new Set("0123456789ABCDEFabcdef"),So=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Ae=new Set(",[]{}"),_o=new Set(` ,[]{}
\r	`),Ye=n=>!n||_o.has(n);class To{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
