 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function U_(r){tr(new En("platform-logger",e=>new Jg(e),"PRIVATE")),tr(new En("heartbeat",e=>new O_(e),"PRIVATE")),jt(ha,tl,r),jt(ha,tl,"esm2020"),jt("fire-js","")}U_("");var B_="firebase",j_="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hn="remoteDocuments",Os="owner",Ln="owner",ps="mutationQueues",uT="userId",Ye="mutations",kl="batchId",gn="userMutationsIndex",Dl=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ii(r,e){return[r,Oe(e)]}function of(r,e,t){return[r,Oe(e),t]}const lT={},rr="documentMutations",Fi="remoteDocumentsV14",hT=["prefixPath","collectionGroup","readTime","documentId"],Ti="documentKeyIndex",dT=["prefixPath","collectionGroup","documentId"],af="collectionGroupIndex",fT=["collectionGroup","readTime","prefixPath","documentId"],ms="remoteDocumentGlobal",Ta="remoteDocumentGlobalKey",sr="targets",cf="queryTargetsIndex",pT=["canonicalId","targetId"],ir="targetDocuments",mT=["targetId","path"],ic="documentTargetsIndex",gT=["path","targetId"],Ui="targetGlobalKey",yn="targetGlobal",gs="collectionParents",_T=["collectionId","parent"],or="clientMetadata",yT="clientId",so="bundles",IT="bundleId",io="namedQueries",TT="name",oc="indexConfiguration",ET="indexId",Ea="collectionGroupIndex",wT="collectionGroup",ns="indexState",vT=["indexId","uid"],uf="sequenceNumberIndex",AT=["uid","sequenceNumber"],rs="indexEntries",bT=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],lf="documentKeyIndex",RT=["indexId","uid","orderedDocumentKey"],oo="documentOverlays",ST=["userId","collectionPath","documentId"],wa="collectionPathOverlayIndex",PT=["userId","collectionPath","largestBatchId"],hf="collectionGroupOverlayIndex",CT=["userId","collectionGroup","largestBatchId"],ac="globals",VT="name",df=[ps,Ye,rr,hn,sr,Os,yn,ir,or,ms,gs,so,io],xT=[...df,oo],ff=[ps,Ye,rr,Fi,sr,Os,yn,ir,or,ms,gs,so,io,oo],pf=ff,cc=[...pf,oc,ns,rs],kT=cc,mf=[...cc,ac],DT=mf;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kE{bt(e){return ve(e,ac)}getSessionToken(e){return this.bt(e).get("sessionToken").next((t=>{const n=t?.value;return n?Ie.fromUint8Array(n):Ie.EMPTY_BYTE_STRING}))}setSessionToken(e,t){return this.bt(e).put({name:"sessionToken",value:t.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
