 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bc{constructor(){this.kr=new se(be.qr),this.Kr=new se(be.Ur)}isEmpty(){return this.kr.isEmpty()}addReference(e,t){const n=new be(e,t);this.kr=this.kr.add(n),this.Kr=this.Kr.add(n)}$r(e,t){e.forEach((n=>this.addReference(n,t)))}removeReference(e,t){this.Wr(new be(e,t))}Qr(e,t){e.forEach((n=>this.removeReference(n,t)))}Gr(e){const t=new M(new ee([])),n=new be(t,e),s=new be(t,e+1),i=[];return this.Kr.forEachInRange([n,s],(o=>{this.Wr(o),i.push(o.key)})),i}zr(){this.kr.forEach((e=>this.Wr(e)))}Wr(e){this.kr=this.kr.delete(e),this.Kr=this.Kr.delete(e)}jr(e){const t=new M(new ee([])),n=new be(t,e),s=new be(t,e+1);let i=H();return this.Kr.forEachInRange([n,s],(o=>{i=i.add(o.key)})),i}containsKey(e){const t=new be(e,0),n=this.kr.firstAfterOrEqual(t);return n!==null&&e.isEqual(n.key)}}class be{constructor(e,t){this.key=e,this.Jr=t}static qr(e,t){return M.comparator(e.key,t.key)||$(e.Jr,t.Jr)}static Ur(e,t){return $(e.Jr,t.Jr)||M.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}),y+=`
`)}),y},Y=async()=>{if(!J)return;k(!0);const y=encodeURIComponent(Z()),T=encodeURIComponent(`UX Audit Findings: ${J.url}`);let w="https://github.com/new";try{const g=new URL(J.url);if(g.hostname.endsWith(".github.io")){const te=g.hostname.split(".")[0],he=g.pathname.split("/")[1];te&&he&&(w=`https://github.com/${te}/${he}/issues/new`)}}catch{}window.open(`${w}?title=${T}&body=${y}`,"_blank")},E=async()=>{const y=Z();try{await navigator.clipboard.writeText(y),v(!0)}catch(T){console.error("Failed to copy markdown:",T)}},_=y=>{u(y),localStorage.setItem("ux-auditor-api-key",y)},I=y=>{f(y),localStorage.setItem("ux-auditor-snapshot-service",y)};return{user:e,reports:C,isAnalyzing:N.isPending,activeReport:J,setActiveReport:y=>s(y?.id||null),url:i,setUrl:o,customApiKey:c,setCustomApiKey:_,snapshotService:h,setSnapshotService:I,isCopiedMarkdown:m,isExportingToGithub:S,runUXAudit:U,exportToGithub:Y,copyMarkdown:E,firebaseConfig:kt}}const zv={Mobile:V.jsx(Ae,{icon:sg,size:"md"}),Tablet:V.jsx(Ae,{icon:og,size:"md"}),Desktop:V.jsx(Ae,{icon:tg,size:"md"})};function $v({suggestion:r}){const[e,t]=me.useState(!1),[n,s]=me.useState(!1);me.useEffect(()=>{if(!e)return;const o=setTimeout(()=>{document.startViewTransition?document.startViewTransition(()=>t(!1)):t(!1)},2e3);return()=>clearTimeout(o)},[e]);const i=async()=>{s(!0);try{await navigator.clipboard.writeText(r),await new Promise(o=>setTimeout(o,400)),document.startViewTransition?document.startViewTransition(()=>{t(!0)}):t(!0)}catch(o){console.error("Failed to copy:",o)}finally{s(!1)}};return V.jsxs(pe,{as:"button",onClick:i,disabled:n,marginTop:2,display:"flex",align:"center",gap:1,paddingX:3,paddingY:1,radius:"md",surface:"default",border:!0,className:"hover:border-accent transition-colors hover:text-accent font-bold text-xs",children:[n?V.jsx(Ae,{icon:Jr,className:"w-3 h-3 animate-spin"}):e?V.jsx(Ae,{icon:ha,className:"w-3 h-3",color:"accent"}):V.jsx(Ae,{icon:Yh,className:"w-3 h-3"}),V.jsx("span",{children:n?"Copying...":e?"Copied!":"Copy Prompt"})]})}function tA(){const{reports:r,isAnalyzing:e,activeReport:t,setActiveReport:n,url:s,setUrl:i,customApiKey:o,setCustomApiKey:c,snapshotService:u,setSnapshotService:h,isCopiedMarkdown:f,isExportingToGithub:m,runUXAudit:v,exportToGithub:S,copyMarkdown:k}=qv();return V.jsxs(ae,{gap:8,width:"full",children:[V.jsx(Gm,{title:"Visual UX Auditor",description:"Run automated visual UX audits on any URL using multimodal AI. Identify usability issues and get improvement suggestions for Mobile, Tablet, and Desktop."}),V.jsxs(ae,{direction:{base:"col",md:"row"},align:{base:"start",md:"center"},justify:"between",gap:6,border:"b",paddingBottom:6,children:[V.jsx(pe,{children:V.jsx($m,{label:"Visual UX Auditor",title:"Multimodal AI Analysis",description:"Automated visual regression and UX improvement suggestions across viewports."})}),V.jsxs(ae,{gap:4,children:[V.jsxs(ae,{direction:"row",align:"center",gap:3,padding:2,className:an(),children:[V.jsx(pe,{as:"input",type:"text",value:s,title:s,onChange:C=>i(C.target.value),className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main truncate text-sm",width:{base:"full",sm:64,md:80},paddingX:4,paddingY:2,radius:"lg",placeholder:"https://...","aria-label":"URL to audit"}),V.jsxs(pe,{as:"button",onClick:()=>v(s),disabled:e,display:"flex",align:"center",gap:2,className:"bg-accent hover:opacity-90 text-bg font-bold transition-all disabled:opacity-50",paddingX:6,paddingY:2,radius:"md",children:[e?V.jsx(Ae,{icon:Jr,size:"sm",className:"animate-spin"}):V.jsx(Ae,{icon:Ju,size:"sm"}),e?"Auditing...":"Start Audit"]})]}),V.jsxs(ae,{direction:"row",align:"center",gap:3,padding:2,className:an(),children:[V.jsx(Re,{variant:"mono",size:"xs",color:"dim",paddingLeft:2,uppercase:!0,weight:"font-bold",children:"API KEY"}),V.jsx(pe,{as:"input",type:"password",value:o,onChange:C=>c(C.target.value),className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main truncate text-sm",flex:1,paddingX:4,paddingY:2,radius:"lg",placeholder:"OpenAI or Gemini API Key (optional override)","aria-label":"API Key"})]}),V.jsxs(ae,{direction:"row",align:"center",gap:3,padding:2,className:an(),children:[V.jsx(Re,{variant:"mono",size:"xs",color:"dim",paddingLeft:2,uppercase:!0,weight:"font-bold",children:"SNAPSHOT SERVICE"}),V.jsx(pe,{as:"input",type:"text",value:u,onChange:C=>h(C.target.value),className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main truncate text-sm",flex:1,paddingX:4,paddingY:2,radius:"lg",placeholder:"Custom service URL with {url}, {width}, {height} (optional)","aria-label":"Snapshot Service URL"})]})]})]}),V.jsxs(jm,{cols:{base:1,lg:4},gap:8,children:[V.jsxs(ae,{gap:4,span:{lg:1},minWidth:0,children:[V.jsx(Re,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"widest",color:"dim",paddingX:1,children:"Audit History"}),V.jsxs(ae,{className:`${an({overflow:"hidden"})} divide-y divide-line`,minWidth:0,children:[r.length===0&&V.jsx(Qu,{compact:!0,title:"No history",icon:V.jsx(Ae,{icon:Jr,size:"sm",className:"opacity-30"})}),r.map(C=>V.jsxs(ae,{as:"button",direction:"row",onClick:()=>n(C),width:"full",align:"center",gap:3,padding:4,className:qm({active:t?.id===C.id}),children:[V.jsx(pe,{width:9,height:9,radius:"full",surface:C.status==="completed"?"success":"warning",className:`${C.status!=="completed"?"animate-pulse":""} flex items-center justify-center`,shrink:0,children:C.status==="completed"?V.jsx(Ae,{icon:ha,size:"sm"}):V.jsx(Ae,{icon:Jr,size:"sm"})}),V.jsxs(pe,{flex:1,minWidth:"0",children:[V.jsx(Re,{variant:"sans",size:"sm",weight:"font-bold",className:"truncate block",children:C.url.replace("https://","")}),V.jsx(Re,{variant:"mono",size:"xs",weight:"font-medium",color:"dim",uppercase:!0,children:new Date(C.timestamp).toLocaleTimeString()})]}),V.jsx(Ae,{icon:Km,size:"sm",color:"muted"})]},C.id))]})]}),V.jsx(ae,{gap:6,span:{lg:3},minWidth:0,children:t?V.jsxs(V.Fragment,{children:[V.jsxs(ae,{padding:6,className:an(),justify:"between",align:{base:"start",md:"center"},gap:6,direction:{base:"col",md:"row"},children:[V.jsxs(ae,{gap:1,minWidth:"0",flex:1,children:[V.jsx(Re,{variant:"sans",size:"xs",weight:"font-bold",color:"accent",uppercase:!0,tracking:"widest",display:"block",children:"Current Session"}),V.jsx(Re,{variant:"sans",size:"xl",weight:"font-black",className:"truncate block",title:t.url,children:t.url})]}),V.jsxs(ae,{direction:"row",gap:3,shrink:0,children:[V.jsxs(pe,{as:"button",onClick:k,display:"flex",align:"center",gap:2,className:Wu({variant:"default"}),surface:"muted",color:"dim",paddingX:4,paddingY:2,radius:"xl",children:[f?V.jsx(Ae,{icon:ha,size:"sm"}):V.jsx(Ae,{icon:Yh,size:"sm"}),f?"Copied":"Copy MD"]}),V.jsxs(pe,{as:"button",onClick:S,disabled:t.status!=="completed"||m,display:"flex",align:"center",gap:2,className:Wu({variant:"primary"}),paddingX:6,paddingY:2,radius:"xl",children:[m?V.jsx(Ae,{icon:Jr,size:"sm",className:"animate-spin"}):V.jsx(Ae,{icon:Hm,size:"sm"}),V.jsx("span",{className:"whitespace-nowrap",children:m?"Exporting...":"Export to GitHub Issue"})]})]})]}),V.jsx(ae,{gap:8,children:Ga.map(C=>{const N=t[`findings_${C.name.toLowerCase()}`],z=t[`image_${C.name.toLowerCase()}`];return V.jsxs(pe,{className:an({overflow:"hidden"}),children:[V.jsxs(ae,{padding:4,border:"b",direction:"row",align:"center",justify:"between",surface:"muted",children:[V.jsxs(ae,{direction:"row",align:"center",gap:3,children:[V.jsx(pe,{width:9,height:9,surface:"default",radius:"lg",shadow:"sm",color:"accent",display:"flex",align:"center",justify:"center",shrink:0,children:zv[C.name]}),V.jsxs(Re,{variant:"sans",size:"base",weight:"font-bold",children:[C.name," Analysis"]})]}),V.jsxs(Re,{variant:"mono",size:"xs",weight:"font-bold",color:"dim",uppercase:!0,tracking:"widest",children:[C.width,"w × ",C.height,"h"]})]}),V.jsxs(ae,{direction:{base:"col",md:"row"},width:"full",children:[V.jsx(pe,{padding:8,surface:"muted",display:"flex",align:"center",justify:"center",border:{base:"b",md:"r"},minHeight:400,width:{base:"full",md:"41.666%"},children:z?V.jsx("img",{src:z,alt:`${C.name} snapshot`,loading:"lazy","data-testid":"ux-analysis-snapshot",className:"w-full h-auto rounded-xl shadow-2xl border border-surface object-contain bg-surface max-h-96",onError:U=>{U.target.src=`https://placehold.co/${C.width}x${C.height}/e2e8f0/64748b?text=Snapshot+Unavailable`}}):V.jsxs(ae,{align:"center",justify:"center",color:"dim",className:"text-center",children:[V.jsx(pe,{marginBottom:2,children:V.jsx(Ae,{icon:Zm,className:"w-12 h-12 opacity-20"})}),V.jsx(Re,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"wider",children:"Awaiting Frame..."})]})}),V.jsx(ae,{gap:6,padding:8,flex:1,minWidth:"0",overflow:"hidden",children:N?V.jsxs(V.Fragment,{children:[V.jsxs(pe,{surface:"alt",padding:5,className:"border border-line rounded-lg",children:[V.jsx(pe,{marginBottom:3,children:V.jsx(Re,{variant:"sans",size:"xs",weight:"font-black",color:"accent",uppercase:!0,display:"block",tracking:"widest",children:"Analysis Summary"})}),V.jsxs(Re,{variant:"sans",size:"sm",weight:"font-medium",className:"leading-relaxed break-words block",children:['"',N.summary,'"']})]}),V.jsx(ae,{gap:4,children:N.improvements?.map((U,j)=>V.jsxs(pe,{padding:4,className:an({interactive:!0}),children:[V.jsxs(pe,{display:"flex",justify:"between",align:"start",marginBottom:2,children:[V.jsxs(ae,{direction:"row",align:"center",gap:2,children:[V.jsx(pe,{width:2,height:2,radius:"full",className:U.severity>7?"bg-error shadow-sm":"bg-accent-purple shadow-sm"}),V.jsx(Re,{variant:"sans",size:"sm",weight:"font-black",children:U.element})]}),V.jsxs(Re,{variant:"mono",size:"xs",weight:"font-black",paddingX:2,paddingY:.5,radius:"full",surface:"muted",color:"dim",uppercase:!0,title:`Severity level: ${U.severity} out of 10 (1-10 scale)`,children:["SEV ",U.severity]})]}),V.jsx(Re,{variant:"sans",size:"xs",color:"dim",marginBottom:3,children:U.issue}),U.suggestion&&U.suggestion.trim()!==""&&V.jsx(pe,{surface:"muted",padding:3,radius:"lg",border:!0,children:V.jsxs(ae,{direction:{base:"col",sm:"row"},align:"start",gap:2,children:[V.jsx(Re,{variant:"sans",size:"xs",weight:"font-black",color:"accent",marginTop:.5,uppercase:!0,tracking:"widest",className:"shrink-0",children:"FIX"}),V.jsxs(pe,{flex:1,minWidth:"0",children:[V.jsx(Re,{variant:"sans",size:"xs",weight:"font-bold",className:"break-words whitespace-pre-wrap line-clamp-4",children:U.suggestion}),U.element==="Manual Audit Required"&&V.jsx($v,{suggestion:U.suggestion})]})]})})]},j))})]}):V.jsxs(ae,{gap:4,width:"full",children:[V.jsx(ii,{height:20,width:"full"}),V.jsxs(ae,{gap:2,children:[V.jsx(ii,{height:4,width:"full"}),V.jsx(ii,{height:4,width:"full"}),V.jsx(ii,{height:4,width:"3/4"})]})]})})]})]},C.name)})})]}):V.jsx(Qu,{minHeight:500,icon:V.jsx(Ae,{icon:Ju,size:"xl",className:"opacity-10"}),title:"Ready to Audit",description:"Enter a URL above to start the visual analysis across Mobile, Tablet, and Desktop."})})]})]})}export{tA as default};
