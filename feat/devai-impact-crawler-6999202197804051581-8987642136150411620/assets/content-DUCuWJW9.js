import{A as Ye}from"./index-CnLZswiu.js";const gn=`---
type: post
draft: true
status: draft
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let A=!1;const _=De(s,!0);a!=="folded"&&e!==T.BLOCK_FOLDED&&(_.onOverflow=()=>{A=!0});const y=Be(`${w}${S}${m}`,c,Xe,_);if(!A)return`>${v}
