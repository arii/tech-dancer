import{j as C}from"./vendor-markdown-DJqeimj_.js";import{b as Ke}from"./vendor-react-Ch6pmYmO.js";import{c as Kt,S as xe,d as ld,B as Y,G as La,T as le}from"./index-DK5yJ67P.js";import{P as hd}from"./PageHeader-CdknTt2U.js";import{C as Ua}from"./camera--CzkMSWu.js";import{C as dd}from"./chevron-right-beSijMun.js";import{G as fd}from"./github-B3wtg4tF.js";import"./vendor-recharts-qBDZgJW4.js";import"./vendor-motion-pOD7n95U.js";/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yf{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(Ef(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function Ef(n){return n.getComponent()?.type==="VERSION"}const vi="@firebase/app",za="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const es=new Wi("@firebase/auth");function hp(n,...e){es.logLevel<=G.WARN&&es.warn(`Auth (${yn}): ${n}`,...e)}function qr(n,...e){es.logLevel<=G.ERROR&&es.error(`Auth (${yn}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Si(){return typeof self<"u"&&self.location?.href||""}function dp(){return Qa()==="http:"||Qa()==="https:"}function Qa(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ns(n){const e=n.auth,t=await n.getIdToken(),r=await Yn(n,ts(e,{idToken:t}));B(r?.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const o=s.providerUserInfo?.length?Vu(s.providerUserInfo):[],a=Ap(n.providerData,o),u=n.isAnonymous,h=!(n.email&&s.passwordHash)&&!a?.length,d=u?h:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new bi(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function vp(n){const e=Ae(n);await ns(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Ap(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Vu(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ju(){return typeof Be().WorkerGlobalScope<"u"&&typeof Be().importScripts=="function"}async function om(){if(!navigator?.serviceWorker)return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function am(){return navigator?.serviceWorker?.controller||null}function cm(){return Ju()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Om=new lr(3e4,6e4);function oc(){const n=Be().___jsl;if(n?.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Mm(n){return new Promise((e,t)=>{function r(){oc(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{oc(),t(je(n,"network-request-failed"))},timeout:Om.get()})}if(Be().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(Be().gapi?.load)r();else{const s=Lp("iframefcb");return Be()[s]=()=>{gapi.load?r():t(je(n,"network-request-failed"))},Op(`${Mp()}?onload=${s}`).catch(o=>t(o))}}).catch(e=>{throw Gr=null,e})}let Gr=null;function Lm(n){return Gr=Gr||Mm(n),Gr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pi="webStorageSupport";class ng{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Qu,this._completeRedirectFn=Sm,this._overrideRedirectResult=vm}async _openPopup(e,t,r,s){et(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const o=await cc(e,t,r,Si(),s);return Jm(e,o,ro())}async _openRedirect(e,t,r,s){await this._originValidation(e);const o=await cc(e,t,r,Si(),s);return im(o),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:o}=this.eventManagers[t];return s?Promise.resolve(s):(et(o,"If manager is not set, promise should be"),o)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await zm(e),r=new Pm(e);return t.register("authEvent",s=>(B(s?.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(pi,{type:pi},s=>{const o=s?.[0]?.[pi];o!==void 0&&t(!!o),Ze(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Dm(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return ju()||xu()||to()}}const rg=ng;var uc="@firebase/auth",lc="1.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Tt,nl;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(y,m){function _(){}_.prototype=m.prototype,y.F=m.prototype,y.prototype=new _,y.prototype.constructor=y,y.D=function(I,E,v){for(var g=Array(arguments.length-2),be=2;be<arguments.length;be++)g[be-2]=arguments[be];return m.prototype[E].apply(I,g)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(r,t),r.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(y,m,_){_||(_=0);const I=Array(16);if(typeof m=="string")for(var E=0;E<16;++E)I[E]=m.charCodeAt(_++)|m.charCodeAt(_++)<<8|m.charCodeAt(_++)<<16|m.charCodeAt(_++)<<24;else for(E=0;E<16;++E)I[E]=m[_++]|m[_++]<<8|m[_++]<<16|m[_++]<<24;m=y.g[0],_=y.g[1],E=y.g[2];let v=y.g[3],g;g=m+(v^_&(E^v))+I[0]+3614090360&4294967295,m=_+(g<<7&4294967295|g>>>25),g=v+(E^m&(_^E))+I[1]+3905402710&4294967295,v=m+(g<<12&4294967295|g>>>20),g=E+(_^v&(m^_))+I[2]+606105819&4294967295,E=v+(g<<17&4294967295|g>>>15),g=_+(m^E&(v^m))+I[3]+3250441966&4294967295,_=E+(g<<22&4294967295|g>>>10),g=m+(v^_&(E^v))+I[4]+4118548399&4294967295,m=_+(g<<7&4294967295|g>>>25),g=v+(E^m&(_^E))+I[5]+1200080426&4294967295,v=m+(g<<12&4294967295|g>>>20),g=E+(_^v&(m^_))+I[6]+2821735955&4294967295,E=v+(g<<17&4294967295|g>>>15),g=_+(m^E&(v^m))+I[7]+4249261313&4294967295,_=E+(g<<22&4294967295|g>>>10),g=m+(v^_&(E^v))+I[8]+1770035416&4294967295,m=_+(g<<7&4294967295|g>>>25),g=v+(E^m&(_^E))+I[9]+2336552879&4294967295,v=m+(g<<12&4294967295|g>>>20),g=E+(_^v&(m^_))+I[10]+4294925233&4294967295,E=v+(g<<17&4294967295|g>>>15),g=_+(m^E&(v^m))+I[11]+2304563134&4294967295,_=E+(g<<22&4294967295|g>>>10),g=m+(v^_&(E^v))+I[12]+1804603682&4294967295,m=_+(g<<7&4294967295|g>>>25),g=v+(E^m&(_^E))+I[13]+4254626195&4294967295,v=m+(g<<12&4294967295|g>>>20),g=E+(_^v&(m^_))+I[14]+2792965006&4294967295,E=v+(g<<17&4294967295|g>>>15),g=_+(m^E&(v^m))+I[15]+1236535329&4294967295,_=E+(g<<22&4294967295|g>>>10),g=m+(E^v&(_^E))+I[1]+4129170786&4294967295,m=_+(g<<5&4294967295|g>>>27),g=v+(_^E&(m^_))+I[6]+3225465664&4294967295,v=m+(g<<9&4294967295|g>>>23),g=E+(m^_&(v^m))+I[11]+643717713&4294967295,E=v+(g<<14&4294967295|g>>>18),g=_+(v^m&(E^v))+I[0]+3921069994&4294967295,_=E+(g<<20&4294967295|g>>>12),g=m+(E^v&(_^E))+I[5]+3593408605&4294967295,m=_+(g<<5&4294967295|g>>>27),g=v+(_^E&(m^_))+I[10]+38016083&4294967295,v=m+(g<<9&4294967295|g>>>23),g=E+(m^_&(v^m))+I[15]+3634488961&4294967295,E=v+(g<<14&4294967295|g>>>18),g=_+(v^m&(E^v))+I[4]+3889429448&4294967295,_=E+(g<<20&4294967295|g>>>12),g=m+(E^v&(_^E))+I[9]+568446438&4294967295,m=_+(g<<5&4294967295|g>>>27),g=v+(_^E&(m^_))+I[14]+3275163606&4294967295,v=m+(g<<9&4294967295|g>>>23),g=E+(m^_&(v^m))+I[3]+4107603335&4294967295,E=v+(g<<14&4294967295|g>>>18),g=_+(v^m&(E^v))+I[8]+1163531501&4294967295,_=E+(g<<20&4294967295|g>>>12),g=m+(E^v&(_^E))+I[13]+2850285829&4294967295,m=_+(g<<5&4294967295|g>>>27),g=v+(_^E&(m^_))+I[2]+4243563512&4294967295,v=m+(g<<9&4294967295|g>>>23),g=E+(m^_&(v^m))+I[7]+1735328473&4294967295,E=v+(g<<14&4294967295|g>>>18),g=_+(v^m&(E^v))+I[12]+2368359562&4294967295,_=E+(g<<20&4294967295|g>>>12),g=m+(_^E^v)+I[5]+4294588738&4294967295,m=_+(g<<4&4294967295|g>>>28),g=v+(m^_^E)+I[8]+2272392833&4294967295,v=m+(g<<11&4294967295|g>>>21),g=E+(v^m^_)+I[11]+1839030562&4294967295,E=v+(g<<16&4294967295|g>>>16),g=_+(E^v^m)+I[14]+4259657740&4294967295,_=E+(g<<23&4294967295|g>>>9),g=m+(_^E^v)+I[1]+2763975236&4294967295,m=_+(g<<4&4294967295|g>>>28),g=v+(m^_^E)+I[4]+1272893353&4294967295,v=m+(g<<11&4294967295|g>>>21),g=E+(v^m^_)+I[7]+4139469664&4294967295,E=v+(g<<16&4294967295|g>>>16),g=_+(E^v^m)+I[10]+3200236656&4294967295,_=E+(g<<23&4294967295|g>>>9),g=m+(_^E^v)+I[13]+681279174&4294967295,m=_+(g<<4&4294967295|g>>>28),g=v+(m^_^E)+I[0]+3936430074&4294967295,v=m+(g<<11&4294967295|g>>>21),g=E+(v^m^_)+I[3]+3572445317&4294967295,E=v+(g<<16&4294967295|g>>>16),g=_+(E^v^m)+I[6]+76029189&4294967295,_=E+(g<<23&4294967295|g>>>9),g=m+(_^E^v)+I[9]+3654602809&4294967295,m=_+(g<<4&4294967295|g>>>28),g=v+(m^_^E)+I[12]+3873151461&4294967295,v=m+(g<<11&4294967295|g>>>21),g=E+(v^m^_)+I[15]+530742520&4294967295,E=v+(g<<16&4294967295|g>>>16),g=_+(E^v^m)+I[2]+3299628645&4294967295,_=E+(g<<23&4294967295|g>>>9),g=m+(E^(_|~v))+I[0]+4096336452&4294967295,m=_+(g<<6&4294967295|g>>>26),g=v+(_^(m|~E))+I[7]+1126891415&4294967295,v=m+(g<<10&4294967295|g>>>22),g=E+(m^(v|~_))+I[14]+2878612391&4294967295,E=v+(g<<15&4294967295|g>>>17),g=_+(v^(E|~m))+I[5]+4237533241&4294967295,_=E+(g<<21&4294967295|g>>>11),g=m+(E^(_|~v))+I[12]+1700485571&4294967295,m=_+(g<<6&4294967295|g>>>26),g=v+(_^(m|~E))+I[3]+2399980690&4294967295,v=m+(g<<10&4294967295|g>>>22),g=E+(m^(v|~_))+I[10]+4293915773&4294967295,E=v+(g<<15&4294967295|g>>>17),g=_+(v^(E|~m))+I[1]+2240044497&4294967295,_=E+(g<<21&4294967295|g>>>11),g=m+(E^(_|~v))+I[8]+1873313359&4294967295,m=_+(g<<6&4294967295|g>>>26),g=v+(_^(m|~E))+I[15]+4264355552&4294967295,v=m+(g<<10&4294967295|g>>>22),g=E+(m^(v|~_))+I[6]+2734768916&4294967295,E=v+(g<<15&4294967295|g>>>17),g=_+(v^(E|~m))+I[13]+1309151649&4294967295,_=E+(g<<21&4294967295|g>>>11),g=m+(E^(_|~v))+I[4]+4149444226&4294967295,m=_+(g<<6&4294967295|g>>>26),g=v+(_^(m|~E))+I[11]+3174756917&4294967295,v=m+(g<<10&4294967295|g>>>22),g=E+(m^(v|~_))+I[2]+718787259&4294967295,E=v+(g<<15&4294967295|g>>>17),g=_+(v^(E|~m))+I[9]+3951481745&4294967295,y.g[0]=y.g[0]+m&4294967295,y.g[1]=y.g[1]+(E+(g<<21&4294967295|g>>>11))&4294967295,y.g[2]=y.g[2]+E&4294967295,y.g[3]=y.g[3]+v&4294967295}r.prototype.v=function(y,m){m===void 0&&(m=y.length);const _=m-this.blockSize,I=this.C;let E=this.h,v=0;for(;v<m;){if(E==0)for(;v<=_;)s(this,y,v),v+=this.blockSize;if(typeof y=="string"){for(;v<m;)if(I[E++]=y.charCodeAt(v++),E==this.blockSize){s(this,I),E=0;break}}else for(;v<m;)if(I[E++]=y[v++],E==this.blockSize){s(this,I),E=0;break}}this.h=E,this.o+=m},r.prototype.A=function(){var y=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);y[0]=128;for(var m=1;m<y.length-8;++m)y[m]=0;m=this.o*8;for(var _=y.length-8;_<y.length;++_)y[_]=m&255,m/=256;for(this.v(y),y=Array(16),m=0,_=0;_<4;++_)for(let I=0;I<32;I+=8)y[m++]=this.g[_]>>>I&255;return y};function o(y,m){var _=u;return Object.prototype.hasOwnProperty.call(_,y)?_[y]:_[y]=m(y)}function a(y,m){this.h=m;const _=[];let I=!0;for(let E=y.length-1;E>=0;E--){const v=y[E]|0;I&&v==m||(_[E]=v,I=!1)}this.g=_}var u={};function h(y){return-128<=y&&y<128?o(y,function(m){return new a([m|0],m<0?-1:0)}):new a([y|0],y<0?-1:0)}function d(y){if(isNaN(y)||!isFinite(y))return T;if(y<0)return D(d(-y));const m=[];let _=1;for(let I=0;y>=_;I++)m[I]=y/_|0,_*=4294967296;return new a(m,0)}function p(y,m){if(y.length==0)throw Error("number format error: empty string");if(m=m||10,m<2||36<m)throw Error("radix out of range: "+m);if(y.charAt(0)=="-")return D(p(y.substring(1),m));if(y.indexOf("-")>=0)throw Error('number format error: interior "-" character');const _=d(Math.pow(m,8));let I=T;for(let v=0;v<y.length;v+=8){var E=Math.min(8,y.length-v);const g=parseInt(y.substring(v,v+E),m);E<8?(E=d(Math.pow(m,E)),I=I.j(E).add(d(g))):(I=I.j(_),I=I.add(d(g)))}return I}var T=h(0),R=h(1),b=h(16777216);n=a.prototype,n.m=function(){if(U(this))return-D(this).m();let y=0,m=1;for(let _=0;_<this.g.length;_++){const I=this.i(_);y+=(I>=0?I:4294967296+I)*m,m*=4294967296}return y},n.toString=function(y){if(y=y||10,y<2||36<y)throw Error("radix out of range: "+y);if(N(this))return"0";if(U(this))return"-"+D(this).toString(y);const m=d(Math.pow(y,6));var _=this;let I="";for(;;){const E=z(_,m).g;_=x(_,E.j(m));let v=((_.g.length>0?_.g[0]:_.h)>>>0).toString(y);if(_=E,N(_))return v+I;for(;v.length<6;)v="0"+v;I=v+I}},n.i=function(y){return y<0?0:y<this.g.length?this.g[y]:this.h};function N(y){if(y.h!=0)return!1;for(let m=0;m<y.g.length;m++)if(y.g[m]!=0)return!1;return!0}function U(y){return y.h==-1}n.l=function(y){return y=x(this,y),U(y)?-1:N(y)?0:1};function D(y){const m=y.g.length,_=[];for(let I=0;I<m;I++)_[I]=~y.g[I];return new a(_,~y.h).add(R)}n.abs=function(){return U(this)?D(this):this},n.add=function(y){const m=Math.max(this.g.length,y.g.length),_=[];let I=0;for(let E=0;E<=m;E++){let v=I+(this.i(E)&65535)+(y.i(E)&65535),g=(v>>>16)+(this.i(E)>>>16)+(y.i(E)>>>16);I=g>>>16,v&=65535,g&=65535,_[E]=g<<16|v}return new a(_,_[_.length-1]&-2147483648?-1:0)};function x(y,m){return y.add(D(m))}n.j=function(y){if(N(this)||N(y))return T;if(U(this))return U(y)?D(this).j(D(y)):D(D(this).j(y));if(U(y))return D(this.j(D(y)));if(this.l(b)<0&&y.l(b)<0)return d(this.m()*y.m());const m=this.g.length+y.g.length,_=[];for(var I=0;I<2*m;I++)_[I]=0;for(I=0;I<this.g.length;I++)for(let E=0;E<y.g.length;E++){const v=this.i(I)>>>16,g=this.i(I)&65535,be=y.i(E)>>>16,kt=y.i(E)&65535;_[2*I+2*E]+=g*kt,M(_,2*I+2*E),_[2*I+2*E+1]+=v*kt,M(_,2*I+2*E+1),_[2*I+2*E+1]+=g*be,M(_,2*I+2*E+1),_[2*I+2*E+2]+=v*be,M(_,2*I+2*E+2)}for(y=0;y<m;y++)_[y]=_[2*y+1]<<16|_[2*y];for(y=m;y<2*m;y++)_[y]=0;return new a(_,0)};function M(y,m){for(;(y[m]&65535)!=y[m];)y[m+1]+=y[m]>>>16,y[m]&=65535,m++}function L(y,m){this.g=y,this.h=m}function z(y,m){if(N(m))throw Error("division by zero");if(N(y))return new L(T,T);if(U(y))return m=z(D(y),m),new L(D(m.g),D(m.h));if(U(m))return m=z(y,D(m)),new L(D(m.g),m.h);if(y.g.length>30){if(U(y)||U(m))throw Error("slowDivide_ only works with positive integers.");for(var _=R,I=m;I.l(y)<=0;)_=ee(_),I=ee(I);var E=J(_,1),v=J(I,1);for(I=J(I,2),_=J(_,2);!N(I);){var g=v.add(I);g.l(y)<=0&&(E=E.add(_),v=g),I=J(I,1),_=J(_,1)}return m=x(y,E.j(m)),new L(E,m)}for(E=T;y.l(m)>=0;){for(_=Math.max(1,Math.floor(y.m()/m.m())),I=Math.ceil(Math.log(_)/Math.LN2),I=I<=48?1:Math.pow(2,I-48),v=d(_),g=v.j(m);U(g)||g.l(y)>0;)_-=I,v=d(_),g=v.j(m);N(v)&&(v=R),E=E.add(v),y=x(y,g)}return new L(E,y)}n.B=function(y){return z(this,y).h},n.and=function(y){const m=Math.max(this.g.length,y.g.length),_=[];for(let I=0;I<m;I++)_[I]=this.i(I)&y.i(I);return new a(_,this.h&y.h)},n.or=function(y){const m=Math.max(this.g.length,y.g.length),_=[];for(let I=0;I<m;I++)_[I]=this.i(I)|y.i(I);return new a(_,this.h|y.h)},n.xor=function(y){const m=Math.max(this.g.length,y.g.length),_=[];for(let I=0;I<m;I++)_[I]=this.i(I)^y.i(I);return new a(_,this.h^y.h)};function ee(y){const m=y.g.length+1,_=[];for(let I=0;I<m;I++)_[I]=y.i(I)<<1|y.i(I-1)>>>31;return new a(_,y.h)}function J(y,m){const _=m>>5;m%=32;const I=y.g.length-_,E=[];for(let v=0;v<I;v++)E[v]=m>0?y.i(v+_)>>>m|y.i(v+_+1)<<32-m:y.i(v+_);return new a(E,y.h)}r.prototype.digest=r.prototype.A,r.prototype.reset=r.prototype.u,r.prototype.update=r.prototype.v,nl=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.B,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=p,Tt=a}).apply(typeof dc<"u"?dc:typeof self<"u"?self:typeof window<"u"?window:{});var Mr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var rl,Bn,sl,Wr,Ci,il,ol,al;(function(){var n,e=Object.defineProperty;function t(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof Mr=="object"&&Mr];for(var c=0;c<i.length;++c){var l=i[c];if(l&&l.Math==Math)return l}throw Error("Cannot find global object")}var r=t(this);function s(i,c){if(c)e:{var l=r;i=i.split(".");for(var f=0;f<i.length-1;f++){var w=i[f];if(!(w in l))break e;l=l[w]}i=i[i.length-1],f=l[i],c=c(f),c!=f&&c!=null&&e(l,i,{configurable:!0,writable:!0,value:c})}}s("Symbol.dispose",function(i){return i||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(i){return i||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(i){return i||function(c){var l=[],f;for(f in c)Object.prototype.hasOwnProperty.call(c,f)&&l.push([f,c[f]]);return l}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},a=this||self;function u(i){var c=typeof i;return c=="object"&&i!=null||c=="function"}function h(i,c,l){return i.call.apply(i.bind,arguments)}function d(i,c,l){return d=h,d.apply(null,arguments)}function p(i,c){var l=Array.prototype.slice.call(arguments,1);return function(){var f=l.slice();return f.push.apply(f,arguments),i.apply(this,f)}}function T(i,c){function l(){}l.prototype=c.prototype,i.Z=c.prototype,i.prototype=new l,i.prototype.constructor=i,i.Ob=function(f,w,A){for(var k=Array(arguments.length-2),H=2;H<arguments.length;H++)k[H-2]=arguments[H];return c.prototype[w].apply(f,k)}}var R=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?i=>i&&AsyncContext.Snapshot.wrap(i):i=>i;function b(i){const c=i.length;if(c>0){const l=Array(c);for(let f=0;f<c;f++)l[f]=i[f];return l}return[]}function N(i,c){for(let f=1;f<arguments.length;f++){const w=arguments[f];var l=typeof w;if(l=l!="object"?l:w?Array.isArray(w)?"array":l:"null",l=="array"||l=="object"&&typeof w.length=="number"){l=i.length||0;const A=w.length||0;i.length=l+A;for(let k=0;k<A;k++)i[l+k]=w[k]}else i.push(w)}}class U{constructor(c,l){this.i=c,this.j=l,this.h=0,this.g=null}get(){let c;return this.h>0?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function D(i){a.setTimeout(()=>{throw i},0)}function x(){var i=y;let c=null;return i.g&&(c=i.g,i.g=i.g.next,i.g||(i.h=null),c.next=null),c}class M{constructor(){this.h=this.g=null}add(c,l){const f=L.get();f.set(c,l),this.h?this.h.next=f:this.g=f,this.h=f}}var L=new U(()=>new z,i=>i.reset());class z{constructor(){this.next=this.g=this.h=null}set(c,l){this.h=c,this.g=l,this.next=null}reset(){this.next=this.g=this.h=null}}let ee,J=!1,y=new M,m=()=>{const i=Promise.resolve(void 0);ee=()=>{i.then(_)}};function _(){for(var i;i=x();){try{i.h.call(i.g)}catch(l){D(l)}var c=L;c.j(i),c.h<100&&(c.h++,i.next=c.g,c.g=i)}J=!1}function I(){this.u=this.u,this.C=this.C}I.prototype.u=!1,I.prototype.dispose=function(){this.u||(this.u=!0,this.N())},I.prototype[Symbol.dispose]=function(){this.dispose()},I.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function E(i,c){this.type=i,this.g=this.target=c,this.defaultPrevented=!1}E.prototype.h=function(){this.defaultPrevented=!0};var v=(function(){if(!a.addEventListener||!Object.defineProperty)return!1;var i=!1,c=Object.defineProperty({},"passive",{get:function(){i=!0}});try{const l=()=>{};a.addEventListener("test",l,c),a.removeEventListener("test",l,c)}catch{}return i})();function g(i){return/^[\s\xa0]*$/.test(i)}function be(i,c){E.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i&&this.init(i,c)}T(be,E),be.prototype.init=function(i,c){const l=this.type=i.type,f=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;this.target=i.target||i.srcElement,this.g=c,c=i.relatedTarget,c||(l=="mouseover"?c=i.fromElement:l=="mouseout"&&(c=i.toElement)),this.relatedTarget=c,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=i.pointerType,this.state=i.state,this.i=i,i.defaultPrevented&&be.Z.h.call(this)},be.prototype.h=function(){be.Z.h.call(this);const i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var kt="closure_listenable_"+(Math.random()*1e6|0),Nh=0;function Dh(i,c,l,f,w){this.listener=i,this.proxy=null,this.src=c,this.type=l,this.capture=!!f,this.ha=w,this.key=++Nh,this.da=this.fa=!1}function Tr(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function Ir(i,c,l){for(const f in i)c.call(l,i[f],f,i)}function xh(i,c){for(const l in i)c.call(void 0,i[l],l,i)}function Mo(i){const c={};for(const l in i)c[l]=i[l];return c}const Lo="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Uo(i,c){let l,f;for(let w=1;w<arguments.length;w++){f=arguments[w];for(l in f)i[l]=f[l];for(let A=0;A<Lo.length;A++)l=Lo[A],Object.prototype.hasOwnProperty.call(f,l)&&(i[l]=f[l])}}function wr(i){this.src=i,this.g={},this.h=0}wr.prototype.add=function(i,c,l,f,w){const A=i.toString();i=this.g[A],i||(i=this.g[A]=[],this.h++);const k=Us(i,c,f,w);return k>-1?(c=i[k],l||(c.fa=!1)):(c=new Dh(c,this.src,A,!!f,w),c.fa=l,i.push(c)),c};function Ls(i,c){const l=c.type;if(l in i.g){var f=i.g[l],w=Array.prototype.indexOf.call(f,c,void 0),A;(A=w>=0)&&Array.prototype.splice.call(f,w,1),A&&(Tr(c),i.g[l].length==0&&(delete i.g[l],i.h--))}}function Us(i,c,l,f){for(let w=0;w<i.length;++w){const A=i[w];if(!A.da&&A.listener==c&&A.capture==!!l&&A.ha==f)return w}return-1}var Fs="closure_lm_"+(Math.random()*1e6|0),js={};function Fo(i,c,l,f,w){if(Array.isArray(c)){for(let A=0;A<c.length;A++)Fo(i,c[A],l,f,w);return null}return l=$o(l),i&&i[kt]?i.J(c,l,u(f)?!!f.capture:!1,w):Oh(i,c,l,!1,f,w)}function Oh(i,c,l,f,w,A){if(!c)throw Error("Invalid event type");const k=u(w)?!!w.capture:!!w;let H=$s(i);if(H||(i[Fs]=H=new wr(i)),l=H.add(c,l,f,k,A),l.proxy)return l;if(f=Mh(),l.proxy=f,f.src=i,f.listener=l,i.addEventListener)v||(w=k),w===void 0&&(w=!1),i.addEventListener(c.toString(),f,w);else if(i.attachEvent)i.attachEvent(Bo(c.toString()),f);else if(i.addListener&&i.removeListener)i.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return l}function Mh(){function i(l){return c.call(i.src,i.listener,l)}const c=Lh;return i}function jo(i,c,l,f,w){if(Array.isArray(c))for(var A=0;A<c.length;A++)jo(i,c[A],l,f,w);else f=u(f)?!!f.capture:!!f,l=$o(l),i&&i[kt]?(i=i.i,A=String(c).toString(),A in i.g&&(c=i.g[A],l=Us(c,l,f,w),l>-1&&(Tr(c[l]),Array.prototype.splice.call(c,l,1),c.length==0&&(delete i.g[A],i.h--)))):i&&(i=$s(i))&&(c=i.g[c.toString()],i=-1,c&&(i=Us(c,l,f,w)),(l=i>-1?c[i]:null)&&Bs(l))}function Bs(i){if(typeof i!="number"&&i&&!i.da){var c=i.src;if(c&&c[kt])Ls(c.i,i);else{var l=i.type,f=i.proxy;c.removeEventListener?c.removeEventListener(l,f,i.capture):c.detachEvent?c.detachEvent(Bo(l),f):c.addListener&&c.removeListener&&c.removeListener(f),(l=$s(c))?(Ls(l,i),l.h==0&&(l.src=null,c[Fs]=null)):Tr(i)}}}function Bo(i){return i in js?js[i]:js[i]="on"+i}function Lh(i,c){if(i.da)i=!0;else{c=new be(c,this);const l=i.listener,f=i.ha||i.src;i.fa&&Bs(i),i=l.call(f,c)}return i}function $s(i){return i=i[Fs],i instanceof wr?i:null}var qs="__closure_events_fn_"+(Math.random()*1e9>>>0);function $o(i){return typeof i=="function"?i:(i[qs]||(i[qs]=function(c){return i.handleEvent(c)}),i[qs])}function Ee(){I.call(this),this.i=new wr(this),this.M=this,this.G=null}T(Ee,I),Ee.prototype[kt]=!0,Ee.prototype.removeEventListener=function(i,c,l,f){jo(this,i,c,l,f)};function Re(i,c){var l,f=i.G;if(f)for(l=[];f;f=f.G)l.push(f);if(i=i.M,f=c.type||c,typeof c=="string")c=new E(c,i);else if(c instanceof E)c.target=c.target||i;else{var w=c;c=new E(f,i),Uo(c,w)}w=!0;let A,k;if(l)for(k=l.length-1;k>=0;k--)A=c.g=l[k],w=vr(A,f,!0,c)&&w;if(A=c.g=i,w=vr(A,f,!0,c)&&w,w=vr(A,f,!1,c)&&w,l)for(k=0;k<l.length;k++)A=c.g=l[k],w=vr(A,f,!1,c)&&w}Ee.prototype.N=function(){if(Ee.Z.N.call(this),this.i){var i=this.i;for(const c in i.g){const l=i.g[c];for(let f=0;f<l.length;f++)Tr(l[f]);delete i.g[c],i.h--}}this.G=null},Ee.prototype.J=function(i,c,l,f){return this.i.add(String(i),c,!1,l,f)},Ee.prototype.K=function(i,c,l,f){return this.i.add(String(i),c,!0,l,f)};function vr(i,c,l,f){if(c=i.i.g[String(c)],!c)return!0;c=c.concat();let w=!0;for(let A=0;A<c.length;++A){const k=c[A];if(k&&!k.da&&k.capture==l){const H=k.listener,ue=k.ha||k.src;k.fa&&Ls(i.i,k),w=H.call(ue,f)!==!1&&w}}return w&&!f.defaultPrevented}function Uh(i,c){if(typeof i!="function")if(i&&typeof i.handleEvent=="function")i=d(i.handleEvent,i);else throw Error("Invalid listener argument");return Number(c)>2147483647?-1:a.setTimeout(i,c||0)}function qo(i){i.g=Uh(()=>{i.g=null,i.i&&(i.i=!1,qo(i))},i.l);const c=i.h;i.h=null,i.m.apply(null,c)}class Fh extends I{constructor(c,l){super(),this.m=c,this.l=l,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:qo(this)}N(){super.N(),this.g&&(a.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function An(i){I.call(this),this.h=i,this.g={}}T(An,I);var zo=[];function Ho(i){Ir(i.g,function(c,l){this.g.hasOwnProperty(l)&&Bs(c)},i),i.g={}}An.prototype.N=function(){An.Z.N.call(this),Ho(this)},An.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var zs=a.JSON.stringify,jh=a.JSON.parse,Bh=class{stringify(i){return a.JSON.stringify(i,void 0)}parse(i){return a.JSON.parse(i,void 0)}};function Go(){}function Wo(){}var Rn={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Hs(){E.call(this,"d")}T(Hs,E);function Gs(){E.call(this,"c")}T(Gs,E);var Vt={},Ko=null;function Ar(){return Ko=Ko||new Ee}Vt.Ia="serverreachability";function Qo(i){E.call(this,Vt.Ia,i)}T(Qo,E);function Sn(i){const c=Ar();Re(c,new Qo(c))}Vt.STAT_EVENT="statevent";function Jo(i,c){E.call(this,Vt.STAT_EVENT,i),this.stat=c}T(Jo,E);function Se(i){const c=Ar();Re(c,new Jo(c,i))}Vt.Ja="timingevent";function Xo(i,c){E.call(this,Vt.Ja,i),this.size=c}T(Xo,E);function bn(i,c){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return a.setTimeout(function(){i()},c)}function Pn(){this.g=!0}Pn.prototype.ua=function(){this.g=!1};function $h(i,c,l,f,w,A){i.info(function(){if(i.g)if(A){var k="",H=A.split("&");for(let Z=0;Z<H.length;Z++){var ue=H[Z].split("=");if(ue.length>1){const pe=ue[0];ue=ue[1];const Ue=pe.split("_");k=Ue.length>=2&&Ue[1]=="type"?k+(pe+"="+ue+"&"):k+(pe+"=redacted&")}}}else k=null;else k=A;return"XMLHTTP REQ ("+f+") [attempt "+w+"]: "+c+`
`+l+`
`+k})}function qh(i,c,l,f,w,A,k){i.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+w+"]: "+c+`
`+l+`
`+A+" "+k})}function Xt(i,c,l,f){i.info(function(){return"XMLHTTP TEXT ("+c+"): "+Hh(i,l)+(f?" "+f:"")})}function zh(i,c){i.info(function(){return"TIMEOUT: "+c})}Pn.prototype.info=function(){};function Hh(i,c){if(!i.g)return c;if(!c)return null;try{const A=JSON.parse(c);if(A){for(i=0;i<A.length;i++)if(Array.isArray(A[i])){var l=A[i];if(!(l.length<2)){var f=l[1];if(Array.isArray(f)&&!(f.length<1)){var w=f[0];if(w!="noop"&&w!="stop"&&w!="close")for(let k=1;k<f.length;k++)f[k]=""}}}}return zs(A)}catch{return c}}var Rr={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},Yo={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},Zo;function Ws(){}T(Ws,Go),Ws.prototype.g=function(){return new XMLHttpRequest},Zo=new Ws;function Cn(i){return encodeURIComponent(String(i))}function Gh(i){var c=1;i=i.split(":");const l=[];for(;c>0&&i.length;)l.push(i.shift()),c--;return i.length&&l.push(i.join(":")),l}function it(i,c,l,f){this.j=i,this.i=c,this.l=l,this.S=f||1,this.V=new An(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new ea}function ea(){this.i=null,this.g="",this.h=!1}var ta={},Ks={};function Qs(i,c,l){i.M=1,i.A=br(Le(c)),i.u=l,i.R=!0,na(i,null)}function na(i,c){i.F=Date.now(),Sr(i),i.B=Le(i.A);var l=i.B,f=i.S;Array.isArray(f)||(f=[String(f)]),ma(l.i,"t",f),i.C=0,l=i.j.L,i.h=new ea,i.g=Da(i.j,l?c:null,!i.u),i.P>0&&(i.O=new Fh(d(i.Y,i,i.g),i.P)),c=i.V,l=i.g,f=i.ba;var w="readystatechange";Array.isArray(w)||(w&&(zo[0]=w.toString()),w=zo);for(let A=0;A<w.length;A++){const k=Fo(l,w[A],f||c.handleEvent,!1,c.h||c);if(!k)break;c.g[k.key]=k}c=i.J?Mo(i.J):{},i.u?(i.v||(i.v="POST"),c["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.B,i.v,i.u,c)):(i.v="GET",i.g.ea(i.B,i.v,null,c)),Sn(),$h(i.i,i.v,i.B,i.l,i.S,i.u)}it.prototype.ba=function(i){i=i.target;const c=this.O;c&&ct(i)==3?c.j():this.Y(i)},it.prototype.Y=function(i){try{if(i==this.g)e:{const H=ct(this.g),ue=this.g.ya(),Z=this.g.ca();if(!(H<3)&&(H!=3||this.g&&(this.h.h||this.g.la()||wa(this.g)))){this.K||H!=4||ue==7||(ue==8||Z<=0?Sn(3):Sn(2)),Js(this);var c=this.g.ca();this.X=c;var l=Wh(this);if(this.o=c==200,qh(this.i,this.v,this.B,this.l,this.S,H,c),this.o){if(this.U&&!this.L){t:{if(this.g){var f,w=this.g;if((f=w.g?w.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!g(f)){var A=f;break t}}A=null}if(i=A)Xt(this.i,this.l,i,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Xs(this,i);else{this.o=!1,this.m=3,Se(12),Nt(this),kn(this);break e}}if(this.R){i=!0;let pe;for(;!this.K&&this.C<l.length;)if(pe=Kh(this,l),pe==Ks){H==4&&(this.m=4,Se(14),i=!1),Xt(this.i,this.l,null,"[Incomplete Response]");break}else if(pe==ta){this.m=4,Se(15),Xt(this.i,this.l,l,"[Invalid Chunk]"),i=!1;break}else Xt(this.i,this.l,pe,null),Xs(this,pe);if(ra(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),H!=4||l.length!=0||this.h.h||(this.m=1,Se(16),i=!1),this.o=this.o&&i,!i)Xt(this.i,this.l,l,"[Invalid Chunked Response]"),Nt(this),kn(this);else if(l.length>0&&!this.W){this.W=!0;var k=this.j;k.g==this&&k.aa&&!k.P&&(k.j.info("Great, no buffering proxy detected. Bytes received: "+l.length),ii(k),k.P=!0,Se(11))}}else Xt(this.i,this.l,l,null),Xs(this,l);H==4&&Nt(this),this.o&&!this.K&&(H==4?Ca(this.j,this):(this.o=!1,Sr(this)))}else cd(this.g),c==400&&l.indexOf("Unknown SID")>0?(this.m=3,Se(12)):(this.m=0,Se(13)),Nt(this),kn(this)}}}catch{}finally{}};function Wh(i){if(!ra(i))return i.g.la();const c=wa(i.g);if(c==="")return"";let l="";const f=c.length,w=ct(i.g)==4;if(!i.h.i){if(typeof TextDecoder>"u")return Nt(i),kn(i),"";i.h.i=new a.TextDecoder}for(let A=0;A<f;A++)i.h.h=!0,l+=i.h.i.decode(c[A],{stream:!(w&&A==f-1)});return c.length=0,i.h.g+=l,i.C=0,i.h.g}function ra(i){return i.g?i.v=="GET"&&i.M!=2&&i.j.Aa:!1}function Kh(i,c){var l=i.C,f=c.indexOf(`
`,l);return f==-1?Ks:(l=Number(c.substring(l,f)),isNaN(l)?ta:(f+=1,f+l>c.length?Ks:(c=c.slice(f,f+l),i.C=f+l,c)))}it.prototype.cancel=function(){this.K=!0,Nt(this)};function Sr(i){i.T=Date.now()+i.H,sa(i,i.H)}function sa(i,c){if(i.D!=null)throw Error("WatchDog timer not null");i.D=bn(d(i.aa,i),c)}function Js(i){i.D&&(a.clearTimeout(i.D),i.D=null)}it.prototype.aa=function(){this.D=null;const i=Date.now();i-this.T>=0?(zh(this.i,this.B),this.M!=2&&(Sn(),Se(17)),Nt(this),this.m=2,kn(this)):sa(this,this.T-i)};function kn(i){i.j.I==0||i.K||Ca(i.j,i)}function Nt(i){Js(i);var c=i.O;c&&typeof c.dispose=="function"&&c.dispose(),i.O=null,Ho(i.V),i.g&&(c=i.g,i.g=null,c.abort(),c.dispose())}function Xs(i,c){try{var l=i.j;if(l.I!=0&&(l.g==i||Ys(l.h,i))){if(!i.L&&Ys(l.h,i)&&l.I==3){try{var f=l.Ba.g.parse(c)}catch{f=null}if(Array.isArray(f)&&f.length==3){var w=f;if(w[0]==0){e:if(!l.v){if(l.g)if(l.g.F+3e3<i.F)Nr(l),kr(l);else break e;si(l),Se(18)}}else l.xa=w[1],0<l.xa-l.K&&w[2]<37500&&l.F&&l.A==0&&!l.C&&(l.C=bn(d(l.Va,l),6e3));aa(l.h)<=1&&l.ta&&(l.ta=void 0)}else xt(l,11)}else if((i.L||l.g==i)&&Nr(l),!g(c))for(w=l.Ba.g.parse(c),c=0;c<w.length;c++){let Z=w[c];const pe=Z[0];if(!(pe<=l.K))if(l.K=pe,Z=Z[1],l.I==2)if(Z[0]=="c"){l.M=Z[1],l.ba=Z[2];const Ue=Z[3];Ue!=null&&(l.ka=Ue,l.j.info("VER="+l.ka));const Ot=Z[4];Ot!=null&&(l.za=Ot,l.j.info("SVER="+l.za));const ut=Z[5];ut!=null&&typeof ut=="number"&&ut>0&&(f=1.5*ut,l.O=f,l.j.info("backChannelRequestTimeoutMs_="+f)),f=l;const lt=i.g;if(lt){const xr=lt.g?lt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(xr){var A=f.h;A.g||xr.indexOf("spdy")==-1&&xr.indexOf("quic")==-1&&xr.indexOf("h2")==-1||(A.j=A.l,A.g=new Set,A.h&&(Zs(A,A.h),A.h=null))}if(f.G){const oi=lt.g?lt.g.getResponseHeader("X-HTTP-Session-Id"):null;oi&&(f.wa=oi,te(f.J,f.G,oi))}}l.I=3,l.l&&l.l.ra(),l.aa&&(l.T=Date.now()-i.F,l.j.info("Handshake RTT: "+l.T+"ms")),f=l;var k=i;if(f.na=Na(f,f.L?f.ba:null,f.W),k.L){ca(f.h,k);var H=k,ue=f.O;ue&&(H.H=ue),H.D&&(Js(H),Sr(H)),f.g=k}else ba(f);l.i.length>0&&Vr(l)}else Z[0]!="stop"&&Z[0]!="close"||xt(l,7);else l.I==3&&(Z[0]=="stop"||Z[0]=="close"?Z[0]=="stop"?xt(l,7):ri(l):Z[0]!="noop"&&l.l&&l.l.qa(Z),l.A=0)}}Sn(4)}catch{}}var Qh=class{constructor(i,c){this.g=i,this.map=c}};function ia(i){this.l=i||10,a.PerformanceNavigationTiming?(i=a.performance.getEntriesByType("navigation"),i=i.length>0&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(a.chrome&&a.chrome.loadTimes&&a.chrome.loadTimes()&&a.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function oa(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function aa(i){return i.h?1:i.g?i.g.size:0}function Ys(i,c){return i.h?i.h==c:i.g?i.g.has(c):!1}function Zs(i,c){i.g?i.g.add(c):i.h=c}function ca(i,c){i.h&&i.h==c?i.h=null:i.g&&i.g.has(c)&&i.g.delete(c)}ia.prototype.cancel=function(){if(this.i=ua(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const i of this.g.values())i.cancel();this.g.clear()}};function ua(i){if(i.h!=null)return i.i.concat(i.h.G);if(i.g!=null&&i.g.size!==0){let c=i.i;for(const l of i.g.values())c=c.concat(l.G);return c}return b(i.i)}var la=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Jh(i,c){if(i){i=i.split("&");for(let l=0;l<i.length;l++){const f=i[l].indexOf("=");let w,A=null;f>=0?(w=i[l].substring(0,f),A=i[l].substring(f+1)):w=i[l],c(w,A?decodeURIComponent(A.replace(/\+/g," ")):"")}}}function ot(i){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let c;i instanceof ot?(this.l=i.l,Vn(this,i.j),this.o=i.o,this.g=i.g,Nn(this,i.u),this.h=i.h,ei(this,ga(i.i)),this.m=i.m):i&&(c=String(i).match(la))?(this.l=!1,Vn(this,c[1]||"",!0),this.o=Dn(c[2]||""),this.g=Dn(c[3]||"",!0),Nn(this,c[4]),this.h=Dn(c[5]||"",!0),ei(this,c[6]||"",!0),this.m=Dn(c[7]||"")):(this.l=!1,this.i=new On(null,this.l))}ot.prototype.toString=function(){const i=[];var c=this.j;c&&i.push(xn(c,ha,!0),":");var l=this.g;return(l||c=="file")&&(i.push("//"),(c=this.o)&&i.push(xn(c,ha,!0),"@"),i.push(Cn(l).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l=this.u,l!=null&&i.push(":",String(l))),(l=this.h)&&(this.g&&l.charAt(0)!="/"&&i.push("/"),i.push(xn(l,l.charAt(0)=="/"?Zh:Yh,!0))),(l=this.i.toString())&&i.push("?",l),(l=this.m)&&i.push("#",xn(l,td)),i.join("")},ot.prototype.resolve=function(i){const c=Le(this);let l=!!i.j;l?Vn(c,i.j):l=!!i.o,l?c.o=i.o:l=!!i.g,l?c.g=i.g:l=i.u!=null;var f=i.h;if(l)Nn(c,i.u);else if(l=!!i.h){if(f.charAt(0)!="/")if(this.g&&!this.h)f="/"+f;else{var w=c.h.lastIndexOf("/");w!=-1&&(f=c.h.slice(0,w+1)+f)}if(w=f,w==".."||w==".")f="";else if(w.indexOf("./")!=-1||w.indexOf("/.")!=-1){f=w.lastIndexOf("/",0)==0,w=w.split("/");const A=[];for(let k=0;k<w.length;){const H=w[k++];H=="."?f&&k==w.length&&A.push(""):H==".."?((A.length>1||A.length==1&&A[0]!="")&&A.pop(),f&&k==w.length&&A.push("")):(A.push(H),f=!0)}f=A.join("/")}else f=w}return l?c.h=f:l=i.i.toString()!=="",l?ei(c,ga(i.i)):l=!!i.m,l&&(c.m=i.m),c};function Le(i){return new ot(i)}function Vn(i,c,l){i.j=l?Dn(c,!0):c,i.j&&(i.j=i.j.replace(/:$/,""))}function Nn(i,c){if(c){if(c=Number(c),isNaN(c)||c<0)throw Error("Bad port number "+c);i.u=c}else i.u=null}function ei(i,c,l){c instanceof On?(i.i=c,nd(i.i,i.l)):(l||(c=xn(c,ed)),i.i=new On(c,i.l))}function te(i,c,l){i.i.set(c,l)}function br(i){return te(i,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),i}function Dn(i,c){return i?c?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function xn(i,c,l){return typeof i=="string"?(i=encodeURI(i).replace(c,Xh),l&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function Xh(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var ha=/[#\/\?@]/g,Yh=/[#\?:]/g,Zh=/[#\?]/g,ed=/[#\?@]/g,td=/#/g;function On(i,c){this.h=this.g=null,this.i=i||null,this.j=!!c}function Dt(i){i.g||(i.g=new Map,i.h=0,i.i&&Jh(i.i,function(c,l){i.add(decodeURIComponent(c.replace(/\+/g," ")),l)}))}n=On.prototype,n.add=function(i,c){Dt(this),this.i=null,i=Yt(this,i);let l=this.g.get(i);return l||this.g.set(i,l=[]),l.push(c),this.h+=1,this};function da(i,c){Dt(i),c=Yt(i,c),i.g.has(c)&&(i.i=null,i.h-=i.g.get(c).length,i.g.delete(c))}function fa(i,c){return Dt(i),c=Yt(i,c),i.g.has(c)}n.forEach=function(i,c){Dt(this),this.g.forEach(function(l,f){l.forEach(function(w){i.call(c,w,f,this)},this)},this)};function pa(i,c){Dt(i);let l=[];if(typeof c=="string")fa(i,c)&&(l=l.concat(i.g.get(Yt(i,c))));else for(i=Array.from(i.g.values()),c=0;c<i.length;c++)l=l.concat(i[c]);return l}n.set=function(i,c){return Dt(this),this.i=null,i=Yt(this,i),fa(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[c]),this.h+=1,this},n.get=function(i,c){return i?(i=pa(this,i),i.length>0?String(i[0]):c):c};function ma(i,c,l){da(i,c),l.length>0&&(i.i=null,i.g.set(Yt(i,c),b(l)),i.h+=l.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const i=[],c=Array.from(this.g.keys());for(let f=0;f<c.length;f++){var l=c[f];const w=Cn(l);l=pa(this,l);for(let A=0;A<l.length;A++){let k=w;l[A]!==""&&(k+="="+Cn(l[A])),i.push(k)}}return this.i=i.join("&")};function ga(i){const c=new On;return c.i=i.i,i.g&&(c.g=new Map(i.g),c.h=i.h),c}function Yt(i,c){return c=String(c),i.j&&(c=c.toLowerCase()),c}function nd(i,c){c&&!i.j&&(Dt(i),i.i=null,i.g.forEach(function(l,f){const w=f.toLowerCase();f!=w&&(da(this,f),ma(this,w,l))},i)),i.j=c}function rd(i,c){const l=new Pn;if(a.Image){const f=new Image;f.onload=p(at,l,"TestLoadImage: loaded",!0,c,f),f.onerror=p(at,l,"TestLoadImage: error",!1,c,f),f.onabort=p(at,l,"TestLoadImage: abort",!1,c,f),f.ontimeout=p(at,l,"TestLoadImage: timeout",!1,c,f),a.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=i}else c(!1)}function sd(i,c){const l=new Pn,f=new AbortController,w=setTimeout(()=>{f.abort(),at(l,"TestPingServer: timeout",!1,c)},1e4);fetch(i,{signal:f.signal}).then(A=>{clearTimeout(w),A.ok?at(l,"TestPingServer: ok",!0,c):at(l,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(w),at(l,"TestPingServer: error",!1,c)})}function at(i,c,l,f,w){try{w&&(w.onload=null,w.onerror=null,w.onabort=null,w.ontimeout=null),f(l)}catch{}}function id(){this.g=new Bh}function ti(i){this.i=i.Sb||null,this.h=i.ab||!1}T(ti,Go),ti.prototype.g=function(){return new Pr(this.i,this.h)};function Pr(i,c){Ee.call(this),this.H=i,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}T(Pr,Ee),n=Pr.prototype,n.open=function(i,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=i,this.D=c,this.readyState=1,Ln(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const c={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};i&&(c.body=i),(this.H||a).fetch(new Request(this.D,c)).then(this.Pa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,Mn(this)),this.readyState=0},n.Pa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,Ln(this)),this.g&&(this.readyState=3,Ln(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof a.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;_a(this)}else i.text().then(this.Oa.bind(this),this.ga.bind(this))};function _a(i){i.j.read().then(i.Ma.bind(i)).catch(i.ga.bind(i))}n.Ma=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var c=i.value?i.value:new Uint8Array(0);(c=this.B.decode(c,{stream:!i.done}))&&(this.response=this.responseText+=c)}i.done?Mn(this):Ln(this),this.readyState==3&&_a(this)}},n.Oa=function(i){this.g&&(this.response=this.responseText=i,Mn(this))},n.Na=function(i){this.g&&(this.response=i,Mn(this))},n.ga=function(){this.g&&Mn(this)};function Mn(i){i.readyState=4,i.l=null,i.j=null,i.B=null,Ln(i)}n.setRequestHeader=function(i,c){this.A.append(i,c)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const i=[],c=this.h.entries();for(var l=c.next();!l.done;)l=l.value,i.push(l[0]+": "+l[1]),l=c.next();return i.join(`\r
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ht=new Wi("@firebase/firestore");function en(){return Ht.logLevel}function V(n,...e){if(Ht.logLevel<=G.DEBUG){const t=e.map(io);Ht.debug(`Firestore (${Tn}): ${n}`,...t)}}function nt(n,...e){if(Ht.logLevel<=G.ERROR){const t=e.map(io);Ht.error(`Firestore (${Tn}): ${n}`,...t)}}function Gt(n,...e){if(Ht.logLevel<=G.WARN){const t=e.map(io);Ht.warn(`Firestore (${Tn}): ${n}`,...t)}}function io(n){if(typeof n=="string")return n;try{return(function(t){return JSON.stringify(t)})(n)}catch{return n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ce(n,e){const t={typeString:n};return e&&(t.value=e),t}function mr(n,e){if(!hl(n))throw new O(P.INVALID_ARGUMENT,"JSON must be an object");let t;for(const r in e)if(e[r]){const s=e[r].typeString,o="value"in e[r]?{value:e[r].value}:void 0;if(!(r in n)){t=`JSON missing required field: '${r}'`;break}const a=n[r];if(s&&typeof a!==s){t=`JSON field '${r}' must be a ${s}.`;break}if(o!==void 0&&a!==o.value){t=`Expected '${r}' field to equal '${o.value}'`;break}}if(t)throw new O(P.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function In(n){if(n.code!==P.FAILED_PRECONDITION||n.message!==bg)throw n;V("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ml="server_timestamp",gl="__type__",_l="__previous_value__",yl="__local_write_time__";function uo(n){return(n?.mapValue?.fields||{})[gl]?.stringValue===ml}function vs(n){const e=n.mapValue.fields[_l];return uo(e)?vs(e):e}function er(n){const e=vt(n.mapValue.fields[yl].timestampValue);return new re(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xg{constructor(e,t,r,s,o,a,u,h,d,p,T){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=o,this.forceLongPolling=a,this.autoDetectLongPolling=u,this.longPollingOptions=h,this.useFetchStreams=d,this.isUsingEmulator=p,this.apiKey=T}}const as="(default)";class tr{constructor(e,t){this.projectId=e,this.database=t||as}static empty(){return new tr("","")}get isDefaultDatabase(){return this.database===as}isEqual(e){return e instanceof tr&&e.projectId===this.projectId&&e.database===this.database}}function Og(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new O(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new tr(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const t_=new se(F.comparator);function rt(){return t_}const kl=new se(F.comparator);function $n(...n){let e=kl;for(const t of n)e=e.insert(t.key,t);return e}function Vl(n){let e=kl;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function Ut(){return Kn()}function Nl(){return Kn()}function Kn(){return new Qt((n=>n.toString()),((n,e)=>n.isEqual(e)))}const n_=new se(F.comparator),r_=new fe(F.comparator);function K(...n){let e=r_;for(const t of n)e=e.add(t);return e}const s_=new fe(W);function i_(){return s_}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Q_{constructor(e,t,r,s){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=s}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next((s=>(r=s,this.remoteDocumentCache.getEntry(e,t)))).next((s=>(r!==null&&Qn(r.mutation,s,Ve.empty(),re.now()),s)))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next((r=>this.getLocalViewOfDocuments(e,r,K()).next((()=>r))))}getLocalViewOfDocuments(e,t,r=K()){const s=Ut();return this.populateOverlays(e,s,t).next((()=>this.computeViews(e,t,s,r).next((o=>{let a=$n();return o.forEach(((u,h)=>{a=a.insert(u,h.overlayedDocument)})),a}))))}getOverlayedDocuments(e,t){const r=Ut();return this.populateOverlays(e,r,t).next((()=>this.computeViews(e,t,r,K())))}populateOverlays(e,t,r){const s=[];return r.forEach((o=>{t.has(o)||s.push(o)})),this.documentOverlayCache.getOverlays(e,s).next((o=>{o.forEach(((a,u)=>{t.set(a,u)}))}))}computeViews(e,t,r,s){let o=rt();const a=Kn(),u=(function(){return Kn()})();return t.forEach(((h,d)=>{const p=r.get(d.key);s.has(d.key)&&(p===void 0||p.mutation instanceof Ct)?o=o.insert(d.key,d):p!==void 0?(a.set(d.key,p.mutation.getFieldMask()),Qn(p.mutation,d,p.mutation.getFieldMask(),re.now())):a.set(d.key,Ve.empty())})),this.recalculateAndSaveOverlays(e,o).next((h=>(h.forEach(((d,p)=>a.set(d,p))),t.forEach(((d,p)=>u.set(d,new K_(p,a.get(d)??null)))),u)))}recalculateAndSaveOverlays(e,t){const r=Kn();let s=new se(((a,u)=>a-u)),o=K();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((a=>{for(const u of a)u.keys().forEach((h=>{const d=t.get(h);if(d===null)return;let p=r.get(h)||Ve.empty();p=u.applyToLocalView(d,p),r.set(h,p);const T=(s.get(u.batchId)||K()).add(h);s=s.insert(u.batchId,T)}))})).next((()=>{const a=[],u=s.getReverseIterator();for(;u.hasNext();){const h=u.getNext(),d=h.key,p=h.value,T=Nl();p.forEach((R=>{if(!o.has(R)){const b=Ul(t.get(R),r.get(R));b!==null&&T.set(R,b),o=o.add(R)}})),a.push(this.documentOverlayCache.saveOverlays(e,d,T))}return S.waitFor(a)})).next((()=>r))}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next((r=>this.recalculateAndSaveOverlays(e,r)))}getDocumentsMatchingQuery(e,t,r,s){return Jg(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Xg(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,s):this.getDocumentsMatchingCollectionQuery(e,t,r,s)}getNextDocuments(e,t,r,s){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,s).next((o=>{const a=s-o.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,s-o.size):S.resolve(Ut());let u=Zn,h=o;return a.next((d=>S.forEach(d,((p,T)=>(u<T.largestBatchId&&(u=T.largestBatchId),o.get(p)?S.resolve():this.remoteDocumentCache.getEntry(e,p).next((R=>{h=h.insert(p,R)}))))).next((()=>this.populateOverlays(e,d,o))).next((()=>this.computeViews(e,h,d,K()))).next((p=>({batchId:u,changes:Vl(p)})))))}))}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new F(t)).next((r=>{let s=$n();return r.isFoundDocument()&&(s=s.insert(r.key,r)),s}))}getDocumentsMatchingCollectionGroupQuery(e,t,r,s){const o=t.collectionGroup;let a=$n();return this.indexManager.getCollectionParents(e,o).next((u=>S.forEach(u,(h=>{const d=(function(T,R){return new As(R,null,T.explicitOrderBy.slice(),T.filters.slice(),T.limit,T.limitType,T.startAt,T.endAt)})(t,h.child(o));return this.getDocumentsMatchingCollectionQuery(e,d,r,s).next((p=>{p.forEach(((T,R)=>{a=a.insert(T,R)}))}))})).next((()=>a))))}getDocumentsMatchingCollectionQuery(e,t,r,s){let o;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next((a=>(o=a,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,o,s)))).next((a=>{o.forEach(((h,d)=>{const p=d.getKey();a.get(p)===null&&(a=a.insert(p,we.newInvalidDocument(p)))}));let u=$n();return a.forEach(((h,d)=>{const p=o.get(h);p!==void 0&&Qn(p.mutation,d,Ve.empty(),re.now()),Ss(t,d)&&(u=u.insert(h,d))})),u}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iy{constructor(){this.Rs=!1,this.As=!1,this.Vs=100,this.ds=(function(){return $d()?8:Cg(ve())>0?6:4})()}initialize(e,t){this.fs=e,this.indexManager=t,this.Rs=!0}getDocumentsMatchingQuery(e,t,r,s){const o={result:null};return this.gs(e,t).next((a=>{o.result=a})).next((()=>{if(!o.result)return this.ps(e,t,s,r).next((a=>{o.result=a}))})).next((()=>{if(o.result)return;const a=new sy;return this.ys(e,t,a).next((u=>{if(o.result=u,this.As)return this.ws(e,t,a,u.size)}))})).next((()=>o.result))}ws(e,t,r,s){return r.documentReadCount<this.Vs?(en()<=G.DEBUG&&V("QueryEngine","SDK will not create cache indexes for query:",tn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),S.resolve()):(en()<=G.DEBUG&&V("QueryEngine","Query:",tn(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.ds*s?(en()<=G.DEBUG&&V("QueryEngine","The SDK decides to create cache indexes for query:",tn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,$e(t))):S.resolve())}gs(e,t){if(Cc(t))return S.resolve(null);let r=$e(t);return this.indexManager.getIndexType(e,r).next((s=>s===0?null:(t.limit!==null&&s===1&&(t=Oi(t,null,"F"),r=$e(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next((o=>{const a=K(...o);return this.fs.getDocuments(e,a).next((u=>this.indexManager.getMinOffset(e,r).next((h=>{const d=this.Ss(t,u);return this.bs(t,d,a,h.readTime)?this.gs(e,Oi(t,null,"F")):this.Ds(e,d,t,h)}))))})))))}ps(e,t,r,s){return Cc(t)||s.isEqual($.min())?S.resolve(null):this.fs.getDocuments(e,r).next((o=>{const a=this.Ss(t,o);return this.bs(t,a,r,s)?S.resolve(null):(en()<=G.DEBUG&&V("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),tn(t)),this.Ds(e,a,t,Ag(s,Zn)).next((u=>u)))}))}Ss(e,t){let r=new fe(Cl(e));return t.forEach(((s,o)=>{Ss(e,o)&&(r=r.add(o))})),r}bs(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const o=e.limitType==="F"?t.last():t.first();return!!o&&(o.hasPendingWrites||o.version.compareTo(s)>0)}ys(e,t,r){return en()<=G.DEBUG&&V("QueryEngine","Using full collection scan to execute query:",tn(t)),this.fs.getDocumentsMatchingQuery(e,t,wt.min(),r)}Ds(e,t,r,s){return this.fs.getDocumentsMatchingQuery(e,r,s).next((o=>(t.forEach((a=>{o=o.insert(a.key,a)})),o)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _i="RestConnection",_y={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class yy{get qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Ko=t+"://"+e.host,this.Uo=`projects/${r}/databases/${s}`,this.$o=this.databaseId.database===as?`project_id=${r}`:`project_id=${r}&database_id=${s}`}Wo(e,t,r,s,o){const a=Bi(),u=this.Qo(e,t.toUriEncodedString());V(_i,`Sending RPC '${e}' ${a}:`,u,r);const h={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(h,s,o);const{host:d}=new URL(u),p=ur(d);return this.zo(e,u,h,r,p).then((T=>(V(_i,`Received RPC '${e}' ${a}: `,T),T)),(T=>{throw Gt(_i,`RPC '${e}' ${a} failed with error: `,T,"url: ",u,"request:",r),T}))}jo(e,t,r,s,o,a){return this.Wo(e,t,r,s,o)}Go(e,t,r){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+Tn})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((s,o)=>e[o]=s)),r&&r.headers.forEach(((s,o)=>e[o]=s))}Qo(e,t){const r=_y[e];let s=`${this.Ko}/v1/${t}:${r}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Te="WebChannelConnection",jn=(n,e,t)=>{n.listen(e,(r=>{try{t(r)}catch(s){setTimeout((()=>{throw s}),0)}}))};class un extends yy{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!un.c_){const e=ol();jn(e,il.STAT_EVENT,(t=>{t.stat===Ci.PROXY?V(Te,"STAT_EVENT: detected buffering proxy"):t.stat===Ci.NOPROXY&&V(Te,"STAT_EVENT: detected no buffering proxy")})),un.c_=!0}}zo(e,t,r,s,o){const a=Bi();return new Promise(((u,h)=>{const d=new rl;d.setWithCredentials(!0),d.listenOnce(sl.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Wr.NO_ERROR:const T=d.getResponseJson();V(Te,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(T)),u(T);break;case Wr.TIMEOUT:V(Te,`RPC '${e}' ${a} timed out`),h(new O(P.DEADLINE_EXCEEDED,"Request time out"));break;case Wr.HTTP_ERROR:const R=d.getStatus();if(V(Te,`RPC '${e}' ${a} failed with status:`,R,"response text:",d.getResponseText()),R>0){let b=d.getResponseJson();Array.isArray(b)&&(b=b[0]);const N=b?.error;if(N&&N.status&&N.message){const U=(function(x){const M=x.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(M)>=0?M:P.UNKNOWN})(N.status);h(new O(U,N.message))}else h(new O(P.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new O(P.UNAVAILABLE,"Connection failed."));break;default:j(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{V(Te,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(s);V(Te,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",p,r,15)}))}T_(e,t,r){const s=Bi(),o=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},h=this.longPollingOptions.timeoutSeconds;h!==void 0&&(u.longPollingTimeout=Math.round(1e3*h)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Go(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const d=o.join("");V(Te,`Creating RPC '${e}' stream ${s}: ${d}`,u);const p=a.createWebChannel(d,u);this.E_(p);let T=!1,R=!1;const b=new Ey({Jo:N=>{R?V(Te,`Not sending because RPC '${e}' stream ${s} is closed:`,N):(T||(V(Te,`Opening RPC '${e}' stream ${s} transport.`),p.open(),T=!0),V(Te,`RPC '${e}' stream ${s} sending:`,N),p.send(N))},Ho:()=>p.close()});return jn(p,Bn.EventType.OPEN,(()=>{R||(V(Te,`RPC '${e}' stream ${s} transport opened.`),b.i_())})),jn(p,Bn.EventType.CLOSE,(()=>{R||(R=!0,V(Te,`RPC '${e}' stream ${s} transport closed`),b.o_(),this.I_(p))})),jn(p,Bn.EventType.ERROR,(N=>{R||(R=!0,Gt(Te,`RPC '${e}' stream ${s} transport errored. Name:`,N.name,"Message:",N.message),b.o_(new O(P.UNAVAILABLE,"The operation could not be completed")))})),jn(p,Bn.EventType.MESSAGE,(N=>{if(!R){const U=N.data[0];X(!!U,16349);const D=U,x=D?.error||D[0]?.error;if(x){V(Te,`RPC '${e}' stream ${s} received error:`,x);const M=x.status;let L=(function(J){const y=ae[J];if(y!==void 0)return Bl(y)})(M),z=x.message;M==="NOT_FOUND"&&z.includes("database")&&z.includes("does not exist")&&z.includes(this.databaseId.database)&&Gt(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),L===void 0&&(L=P.INTERNAL,z="Unknown error status: "+M+" with message "+x.message),R=!0,b.o_(new O(L,z)),p.close()}else V(Te,`RPC '${e}' stream ${s} received:`,U),b.__(U)}})),un.u_(),setTimeout((()=>{b.s_()}),0),b}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,r){super.Go(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return al()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */hn._jsonSchemaVersion="firestore/querySnapshot/1.0",hn._jsonSchema={type:ce("string",hn._jsonSchemaVersion),bundleSource:ce("string","QuerySnapshot"),bundleName:ce("string"),bundle:ce("string")};function hu(n,e,t,...r){n=jt(n,de);const s=jt(n.firestore,ir),o=Ah(s);let a;return a=typeof(e=Ae(e))=="string"||e instanceof No?RE(o,"updateDoc",n._key,e,t,r):AE(o,"updateDoc",n._key,e),Vh(s,[a.toMutation(n._key,qe.exists(!0))])}function NE(n,e){const t=jt(n.firestore,ir),r=Hi(n),s=kE(n.converter,e),o=Ah(n.firestore);return Vh(t,[vE(o,"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,qe.exists(!1))]).then((()=>r))}function DE(n,...e){n=Ae(n);let t={includeMetadataChanges:!1,source:"default"},r=0;typeof e[r]!="object"||lu(e[r])||(t=e[r++]);const s={includeMetadataChanges:t.includeMetadataChanges,source:t.source};if(lu(e[r])){const d=e[r];e[r]=d.next?.bind(d),e[r+1]=d.error?.bind(d),e[r+2]=d.complete?.bind(d)}let o,a,u;if(n instanceof de)a=jt(n.firestore,ir),u=po(n._key.path),o={next:d=>{e[r]&&e[r](xE(a,n,d))},error:e[r+1],complete:e[r+2]};else{const d=jt(n,xs);a=jt(d.firestore,ir),u=d._query;const p=new Ch(a);o={next:T=>{e[r]&&e[r](new hn(a,p,d,T))},error:e[r+1],complete:e[r+2]},CE(n._query)}const h=Ih(a);return pE(h,u,s,o)}function Vh(n,e){const t=Ih(n);return mE(t,e)}function xE(n,e,t){const r=t.docs.get(e._key),s=new Ch(n);return new Bt(n,s,e._key,r,new zn(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){dg(yn),dn(new qt("firestore",((r,{instanceIdentifier:s,options:o})=>{const a=r.getProvider("app").getImmediate(),u=new ir(new mg(r.getProvider("auth-internal")),new yg(a,r.getProvider("app-check-internal")),Og(a,s),a);return o={useFetchStreams:t,...o},u._setSettings(o),u}),"PUBLIC").setMultipleInstances(!0)),Et(cu,uu,e),Et(cu,uu,"esm2020")})();const OE="",$r=typeof __app_id<"u"?__app_id:"ux-auditor-v2",Mt=typeof __firebase_config<"u"?JSON.parse(__firebase_config):null,Gi=[{name:"Mobile",width:375,height:667},{name:"Tablet",width:768,height:1024},{name:"Desktop",width:1440,height:900}];function ME(){const[n,e]=Ke.useState(null),[t,r]=Ke.useState([]),[s,o]=Ke.useState(!1),[a,u]=Ke.useState(null),[h,d]=Ke.useState("https://arii.github.io/tech-dancer/"),[p,T]=Ke.useState(!1);Ke.useEffect(()=>{if(!Mt)return;const x=Xf().length===0?wu(Mt):Ji(),M=lg(x);(async()=>{try{typeof __initial_auth_token<"u"&&__initial_auth_token?await Jp(M,__initial_auth_token):await Hp(M)}catch(ee){console.error("Firebase auth error:",ee)}})();const z=Zp(M,e);return()=>z()},[]),Ke.useEffect(()=>{if(!n||!Mt)return;const x=Br(),M=su(x,"artifacts",$r,"users",n.uid,"ux_reports"),L=DE(M,z=>{const ee=z.docs.map(J=>({id:J.id,...J.data()}));r(ee.sort((J,y)=>y.timestamp-J.timestamp))},z=>console.error("Firestore error:",z));return()=>L()},[n]);const R=async()=>{if(h){o(!0);try{let x=Date.now().toString();const M={id:x,url:h,timestamp:Date.now(),status:"processing"};if(r(L=>[M,...L].sort((z,ee)=>ee.timestamp-z.timestamp)),u(M),n&&Mt){const L=Br();x=(await NE(su(L,"artifacts",$r,"users",n.uid,"ux_reports"),M)).id,M.id=x}for(const L of Gi){let z=`https://placehold.co/${L.width}x${L.height}/6366f1/ffffff?text=${L.name}+Analysis+Pending`,ee="";try{const y=Math.floor(L.width*.5),m=Math.floor(L.height*.5),_=`https://s0.wp.com/mshots/v1/${encodeURIComponent(h)}?w=${y}&h=${m}`,I=await fetch(_);if(I.ok){const E=await I.blob();ee=await new Promise(v=>{const g=new FileReader;g.onloadend=()=>v(g.result),g.readAsDataURL(E)}),z=ee}}catch(y){console.error("Failed to fetch realistic snapshot, using placeholder",y)}const J=await b(L,h,ee);if(M[`findings_${L.name.toLowerCase()}`]=J,M[`image_${L.name.toLowerCase()}`]=z,r(y=>y.map(m=>m.id===x?{...M}:m)),n&&Mt){const y=Br();await hu(Hi(y,"artifacts",$r,"users",n.uid,"ux_reports",x),{[`findings_${L.name.toLowerCase()}`]:J,[`image_${L.name.toLowerCase()}`]:z})}}if(M.status="completed",r(L=>L.map(z=>z.id===x?{...M}:z)),u({...M}),n&&Mt){const L=Br();await hu(Hi(L,"artifacts",$r,"users",n.uid,"ux_reports",x),{status:"completed"})}}catch(x){console.error("Audit failed",x)}finally{o(!1)}}},b=async(x,M,L)=>{const z=`You are a Senior UX Auditor. Analyze the UI for ${x.name}. Focus on specific elements, accessibility, and visual bugs. Output JSON.`,ee=`Analyze ${M} on ${x.name}.`;try{const y=await(await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash-preview-09-2025:generateContent?key=${OE}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{text:ee}]}],systemInstruction:{parts:[{text:z}]},generationConfig:{responseMimeType:"application/json",responseSchema:{type:"OBJECT",properties:{summary:{type:"STRING"},improvements:{type:"ARRAY",items:{type:"OBJECT",properties:{element:{type:"STRING"},issue:{type:"STRING"},suggestion:{type:"STRING"},severity:{type:"NUMBER"}}}}}}}})})).json();return JSON.parse(y.candidates[0].content.parts[0].text)}catch{const y=L?`Here is the base64 encoded snapshot:
${L}`:"[Please attach the image from scripts/ux-capture.js here]";return{summary:"API Key missing or fetch failed. Manual analysis required. Copy the prompt below.",improvements:[{element:"Manual Audit Required",issue:"No automated analysis generated.",suggestion:`Prompt: You are a Senior UX Auditor. Analyze the UI for ${x.name}. Focus on specific elements, accessibility, and visual bugs. Identify 'Cardocalypse', 'Centering Sickness', and violations of flat design principles. Provide recommendations.

${y}`,severity:5}]}}},N=()=>{if(!a)return"";let x=`# Visual UX Audit for ${a.url}

`;return Gi.forEach(M=>{const L=a[`findings_${M.name.toLowerCase()}`];L&&(x+=`## ${M.name} Analysis
${L.summary}

`,x+=`| Element | Issue | Suggestion | Severity |
|---|---|---|---|
`,L.improvements?.forEach(z=>{x+=`| ${z.element} | ${z.issue} | ${z.suggestion} | ${z.severity}/10 |
`}),x+=`
`)}),x};return{user:n,reports:t,isAnalyzing:s,activeReport:a,setActiveReport:u,url:h,setUrl:d,isExporting:p,runUXAudit:R,exportToGithub:()=>{if(!a)return;const x=encodeURIComponent(N()),M=encodeURIComponent(`UX Audit Findings: ${a.url}`);let L="https://github.com/new";try{const z=new URL(a.url);if(z.hostname.endsWith(".github.io")){const ee=z.hostname.split(".")[0],J=z.pathname.split("/")[1];ee&&J&&(L=`https://github.com/${ee}/${J}/issues/new`)}}catch{}window.open(`${L}?title=${M}&body=${x}`,"_blank")},copyMarkdown:()=>{const x=N(),M=document.createElement("textarea");M.value=x,document.body.appendChild(M),M.select(),document.execCommand("copy"),document.body.removeChild(M),T(!0),setTimeout(()=>T(!1),2e3)},firebaseConfig:Mt}}const LE={Mobile:C.jsx(wd,{className:"w-5 h-5"}),Tablet:C.jsx(Ad,{className:"w-5 h-5"}),Desktop:C.jsx(Ed,{className:"w-5 h-5"})};function UE({suggestion:n}){const[e,t]=Ke.useState(!1),r=async()=>{await navigator.clipboard.writeText(n),document.startViewTransition?document.startViewTransition(()=>{t(!0)}):t(!0),setTimeout(()=>{document.startViewTransition?document.startViewTransition(()=>t(!1)):t(!1)},2e3)};return C.jsx(Y,{as:"button",onClick:r,marginTop:2,display:"flex",align:"center",gap:1,paddingX:3,paddingY:1,radius:"md",surface:e?"success":"default",border:!0,cursor:"pointer",className:`transition-colors font-bold text-xs ${e?"":"hover:border-accent hover:text-accent"}`,children:C.jsxs(Y,{color:e?"accent":"main",display:"flex",align:"center",gap:1,children:[e?C.jsx(Ti,{className:"w-3 h-3"}):C.jsx(du,{className:"w-3 h-3"}),C.jsx(le,{children:e?"Copied!":"Copy Prompt"})]})})}function QE(){const{reports:n,isAnalyzing:e,activeReport:t,setActiveReport:r,url:s,setUrl:o,isExporting:a,runUXAudit:u,exportToGithub:h,copyMarkdown:d}=ME();return C.jsxs(xe,{gap:8,className:`${ld.tool} w-full mx-auto`,children:[C.jsxs(xe,{direction:{base:"col",md:"row"},align:{base:"start",md:"center"},justify:"between",gap:6,border:"b",paddingBottom:6,children:[C.jsx(Y,{children:C.jsx(hd,{label:"Visual UX Auditor",title:"Multimodal AI Analysis",description:"Automated visual regression and UX improvement suggestions across viewports."})}),C.jsxs(xe,{direction:"row",align:"center",gap:3,surface:"default",padding:2,radius:"xl",shadow:"sm",border:!0,children:[C.jsx(Y,{as:"input",type:"text",value:s,onChange:p=>o(p.target.value),width:64,paddingX:4,paddingY:2,radius:"md",className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main text-sm",placeholder:"https://..."}),C.jsxs(Y,{as:"button",onClick:u,disabled:e,display:"flex",align:"center",gap:2,paddingX:6,paddingY:2,radius:"md",cursor:"pointer",className:"bg-accent hover:opacity-90 text-white font-bold transition-all disabled:opacity-50",children:[e?C.jsx(ai,{className:"animate-spin w-4 h-4"}):C.jsx(Ua,{className:"w-4 h-4"}),e?"Auditing...":"Start Audit"]})]})]}),C.jsxs(La,{cols:{base:1,lg:4},gap:8,children:[C.jsxs(xe,{gap:4,span:{lg:1},children:[C.jsx(le,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"widest",color:"dim",paddingX:1,children:"Audit History"}),C.jsxs(xe,{surface:"default",radius:"2xl",shadow:"sm",border:!0,overflow:"hidden",className:"divide-y divide-line",children:[n.length===0&&C.jsx(Y,{padding:10,className:"italic",color:"dim",align:"center",size:"sm",children:"No audits recorded."}),n.map(p=>C.jsxs(Y,{as:"button",onClick:()=>r(p),width:"full",display:"flex",align:"center",gap:3,padding:4,className:`text-left hover:bg-surface transition-all ${t?.id===p.id?"bg-bg border-l-4 border-accent":"border-l-4 border-transparent"}`,children:[C.jsx(Y,{padding:2,radius:"full",surface:p.status==="completed"?"success":"warning",opacity:p.status==="completed"?100:20,className:p.status==="completed"?"":"animate-pulse",children:p.status==="completed"?C.jsx(Ti,{className:"w-4 h-4"}):C.jsx(ai,{className:"w-4 h-4"})}),C.jsxs(Y,{flex:1,minWidth:"0",children:[C.jsx(le,{variant:"sans",size:"sm",weight:"font-bold",className:"truncate",children:p.url.replace("https://","")}),C.jsx(le,{variant:"mono",size:"xs",weight:"font-medium",color:"dim",uppercase:!0,children:new Date(p.timestamp).toLocaleTimeString()})]}),C.jsx(dd,{className:"w-4 h-4 text-text-dim opacity-50"})]},p.id))]})]}),C.jsx(xe,{gap:6,span:{lg:3},children:t?C.jsxs(C.Fragment,{children:[C.jsxs(Y,{surface:"default",padding:6,radius:"2xl",shadow:"sm",border:!0,display:"flex",justify:"between",align:"center",gap:4,direction:{base:"col",md:"row"},marginBottom:2,children:[C.jsxs(Y,{children:[C.jsx(le,{variant:"sans",size:"xs",weight:"font-bold",color:"accent",uppercase:!0,tracking:"tighter",marginBottom:1,children:"Current Session"}),C.jsx(le,{variant:"sans",size:"xl",weight:"font-black",children:t.url})]}),C.jsxs(Y,{display:"flex",gap:2,children:[C.jsxs(Y,{as:"button",onClick:d,display:"flex",align:"center",gap:2,paddingX:4,paddingY:2,radius:"xl",surface:"muted",color:"dim",cursor:"pointer",className:"font-bold hover:text-text-main transition-all text-sm",children:[a?C.jsx(Ti,{className:"w-4 h-4"}):C.jsx(du,{className:"w-4 h-4"}),a?"Copied":"Copy MD"]}),C.jsxs(Y,{as:"button",onClick:h,disabled:t.status!=="completed",display:"flex",align:"center",gap:2,paddingX:6,paddingY:2,radius:"xl",cursor:"pointer",surface:"inverted",className:"font-bold hover:opacity-90 shadow-md transition-all disabled:opacity-50 text-sm",children:[C.jsx(fd,{className:"w-4 h-4"}),"Export to GitHub Issue"]})]})]}),C.jsx(xe,{gap:8,children:Gi.map(p=>{const T=t[`findings_${p.name.toLowerCase()}`],R=t[`image_${p.name.toLowerCase()}`];return C.jsxs(Y,{surface:"default",radius:"2xl",shadow:"sm",border:!0,overflow:"hidden",children:[C.jsxs(Y,{padding:4,border:"b",display:"flex",align:"center",justify:"between",surface:"muted",children:[C.jsxs(Y,{display:"flex",align:"center",gap:3,children:[C.jsx(Y,{padding:2,surface:"default",radius:"lg",shadow:"sm",color:"accent",children:LE[p.name]}),C.jsxs(le,{variant:"sans",size:"base",weight:"font-bold",children:[p.name," Analysis"]})]}),C.jsxs(le,{variant:"mono",size:"xs",weight:"font-bold",color:"dim",uppercase:!0,tracking:"widest",children:[p.width,"w × ",p.height,"h"]})]}),C.jsxs(La,{cols:{base:1,md:12},children:[C.jsx(Y,{padding:8,surface:"muted",display:"flex",align:"center",justify:"center",border:"r",minHeight:400,span:{base:1,md:5},children:R?C.jsx("img",{src:R,alt:`${p.name} snapshot`,className:"w-full h-auto rounded-xl shadow-2xl border border-surface object-contain bg-surface",style:{maxHeight:"450px"},onError:b=>{b.target.src=`https://placehold.co/${p.width}x${p.height}/e2e8f0/64748b?text=Snapshot+Unavailable`}}):C.jsxs(xe,{gap:2,textAlign:"center",color:"dim",marginX:"auto",padding:1,children:[C.jsx(Y,{marginX:"auto",children:C.jsx(_d,{className:"w-12 h-12 opacity-20"})}),C.jsx(le,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"wider",children:"Awaiting Frame..."})]})}),C.jsx(xe,{gap:6,padding:8,span:{base:1,md:7},children:T?C.jsxs(C.Fragment,{children:[C.jsxs(Y,{surface:"muted",border:!0,padding:5,radius:"2xl",children:[C.jsx(le,{variant:"sans",size:"xs",weight:"font-black",color:"accent",uppercase:!0,marginBottom:2,tracking:"widest",children:"Analysis Summary"}),C.jsxs(le,{variant:"sans",size:"sm",weight:"font-medium",className:"leading-relaxed",children:['"',T.summary,'"']})]}),C.jsx(xe,{gap:4,children:T.improvements?.map((b,N)=>C.jsxs(Y,{padding:4,radius:"xl",border:!0,surface:"default",shadow:"sm",className:"hover:border-accent/30 transition-all",children:[C.jsxs(Y,{display:"flex",justify:"between",align:"start",marginBottom:2,children:[C.jsxs(Y,{as:"span",display:"flex",align:"center",gap:2,children:[C.jsx(Y,{width:2,height:2,radius:"full",className:b.severity>7?"bg-red-600 shadow-sm":"bg-amber-500"}),C.jsx(le,{variant:"sans",size:"sm",weight:"font-black",children:b.element})]}),C.jsxs(le,{variant:"mono",size:"xs",weight:"font-black",paddingX:2,paddingY:.5,radius:"full",surface:"muted",color:"dim",uppercase:!0,children:["LVL ",b.severity]})]}),C.jsx(le,{variant:"sans",size:"xs",color:"dim",marginBottom:3,children:b.issue}),C.jsxs(Y,{surface:"muted",padding:3,radius:"lg",border:!0,display:"flex",align:"start",gap:2,children:[C.jsx(le,{variant:"sans",size:"xs",weight:"font-bold",color:"brand",marginTop:.5,children:"FIX"}),C.jsxs(Y,{flex:1,minWidth:"0",children:[C.jsx(le,{variant:"sans",size:"xs",weight:"font-bold",className:"break-words whitespace-pre-wrap line-clamp-4",children:b.suggestion}),b.element==="Manual Audit Required"&&C.jsx(UE,{suggestion:b.suggestion})]})]})]},N))})]}):C.jsxs(Y,{display:"flex",align:"center",justify:"center",paddingY:20,direction:"col",color:"dim",children:[C.jsx(ai,{className:"animate-spin w-6 h-6"}),C.jsx(le,{variant:"sans",size:"xs",weight:"font-bold",tracking:"widest",uppercase:!0,children:"Agent Processing..."})]})})]})]},p.name)})})]}):C.jsxs(xe,{height:"full",align:"center",justify:"center",surface:"default",radius:"3xl",padding:20,minHeight:500,className:"border-2 border-dashed text-center",children:[C.jsx(Y,{surface:"muted",padding:6,radius:"full",marginBottom:6,className:"text-text-dim/50",children:C.jsx(Ua,{className:"w-16 h-16"})}),C.jsx(le,{variant:"sans",size:"xl",weight:"font-black",marginBottom:2,children:"Ready to Audit"}),C.jsx(le,{variant:"sans",size:"sm",weight:"font-medium",color:"dim",maxWidth:"sm",marginX:"auto",children:"Enter a URL above to start the visual analysis across Mobile, Tablet, and Desktop."})]})})]})]})}export{QE as default};
