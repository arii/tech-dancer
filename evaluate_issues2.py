...
def evaluate(issue):
    ...
    if "dompurify" in title:
        ...
        if version and '3.4.12' in version:
            ...
            return "Keep open", f"dompurify not found or not 3.4.12 in package.json (Found: {version})"
    ...
    if "shell-quote" in title:
        ...
        if version and ('1.8.4' in version or '1.8.5' in version):
            ...
            return "Keep open", f"shell-quote not found or not >=1.8.4 in package.json (Found: {version})"
    ...
    if "react-router" in title:
        ...
        if version and ('7.15.1' in version or '7.15.2' in version):
            ...
            return "Keep open", f"react-router-dom version is {version}, needs >=7.15.1"
