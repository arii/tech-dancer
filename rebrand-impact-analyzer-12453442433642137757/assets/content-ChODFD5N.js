import{A as Ye}from"./index-C3FKkjz6.js";const gn=`---
type: post
draft: true
status: draft
...
`);s=e,i=e+1,o=n[i]}return s}const Be=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),Me=n=>/^(%|---|\.\.\.)/m.test(n);function gs(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let o=0,a=0;o<i;++o)if(n[o]===`
