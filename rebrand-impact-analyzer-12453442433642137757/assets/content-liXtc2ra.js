import{A as Ye}from"./index-D71QVJf6.js";const gn=`---
type: post
draft: true
status: draft
...
`,l+=2;a+=o,t[l+2]===" "&&(a+="\\"),l+=1,r=l+1}break;default:l+=1}return a=r?a+t.slice(r):t,s?a:De(a,o,Ce,Be(e,!1))}function Ze(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let A=!1;const _=Be(s,!0);a!=="folded"&&e!==T.BLOCK_FOLDED&&(_.onOverflow=()=>{A=!0});const y=De(`${w}${S}${m}`,c,Xe,_);if(!A)return`>${v}
