 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dg=()=>td().__FIREBASE_DEFAULTS__,fg=()=>{if(typeof process>"u"||typeof Ju>"u")return;const r=Ju.__FIREBASE_DEFAULTS__;if(r)return JSON.parse(r)},mg=()=>{if(typeof document>"u")return;let r;try{r=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const e=r&&ed(r[1]);return e&&JSON.parse(e)},Yi=()=>{try{return cg()||dg()||fg()||mg()}catch(r){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${r}`);return}},nd=r=>Yi()?.emulatorHosts?.[r],pg=r=>{const e=nd(r);if(!e)return;const t=e.lastIndexOf(":");if(t<=0||t+1===e.length)throw new Error(`Invalid host ${e} with no separate hostname and port!`);const n=parseInt(e.substring(t+1),10);return e[0]==="["?[e.substring(1,t-1),n]:[e.substring(0,t),n]},rd=()=>Yi()?.config,sd=r=>Yi()?.[`_${r}`];/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ht=new Ga("@firebase/app"),Xg="@firebase/app-compat",Zg="@firebase/analytics-compat",e_="@firebase/analytics",t_="@firebase/app-check-compat",n_="@firebase/app-check",r_="@firebase/auth",s_="@firebase/auth-compat",i_="@firebase/database",o_="@firebase/data-connect",a_="@firebase/database-compat",c_="@firebase/functions",u_="@firebase/functions-compat",l_="@firebase/installations",h_="@firebase/installations-compat",d_="@firebase/messaging",f_="@firebase/messaging-compat",m_="@firebase/performance",p_="@firebase/performance-compat",g_="@firebase/remote-config",__="@firebase/remote-config-compat",y_="@firebase/storage",I_="@firebase/storage-compat",T_="@firebase/firestore",E_="@firebase/ai",w_="@firebase/firestore-compat",v_="firebase",A_="12.12.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const is=new Map,R_=new Map,ma=new Map;function nl(r,e){try{r.container.addComponent(e)}catch(t){ht.debug(`Component ${e.name} failed to register with FirebaseApp ${r.name}`,t)}}function Xn(r){const e=r.name;if(ma.has(e))return ht.debug(`There were multiple attempts to register component ${e}.`),!1;ma.set(e,r);for(const t of is.values())nl(t,r);for(const t of R_.values())nl(t,r);return!0}function Xi(r,e){const t=r.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),r.container.getProvider(e)}function $e(r){return r==null?!1:r.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mr=A_;function hd(r,e={}){let t=r;typeof e!="object"&&(e={name:e});const n={name:fa,automaticDataCollectionEnabled:!0,...e},s=n.name;if(typeof s!="string"||!s)throw Ft.create("bad-app-name",{appName:String(s)});if(t||(t=rd()),!t)throw Ft.create("no-options");const i=is.get(s);if(i){if(Gt(t,i.options)&&Gt(n,i.config))return i;throw Ft.create("duplicate-app",{appName:s})}const o=new Ng(s);for(const u of ma.values())o.addComponent(u);const c=new P_(t,n,o);return is.set(s,c),c}function Ha(r=fa){const e=is.get(r);if(!e&&r===fa&&rd())return hd();if(!e)throw Ft.create("no-app",{appName:r});return e}function C_(){return Array.from(is.values())}function Ut(r,e,t){let n=b_[r]??r;t&&(n+=`-${t}`);const s=n.match(/\s|\//),i=e.match(/\s|\//);if(s||i){const o=[`Unable to register library "${n}" with version "${e}":`];s&&o.push(`library name "${n}" contains illegal characters (whitespace or "/")`),s&&i&&o.push("and"),i&&o.push(`version name "${e}" contains illegal characters (whitespace or "/")`),ht.warn(o.join(" "));return}Xn(new _n(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const x_=1024,N_=30;class O_{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new L_(t),this._heartbeatsCachePromise=this._storage.read().then(n=>(this._heartbeatsCache=n,n))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),n=sl();if(this._heartbeatsCache?.heartbeats==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null)||this._heartbeatsCache.lastSentHeartbeatDate===n||this._heartbeatsCache.heartbeats.some(s=>s.date===n))return;if(this._heartbeatsCache.heartbeats.push({date:n,agent:t}),this._heartbeatsCache.heartbeats.length>N_){const s=F_(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(s,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){ht.warn(e)}}async getHeartbeatsHeader(){try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,this._heartbeatsCache?.heartbeats==null||this._heartbeatsCache.heartbeats.length===0)return"";const e=sl(),{heartbeatsToSend:t,unsentEntries:n}=M_(this._heartbeatsCache.heartbeats),s=Ci(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),s}catch(e){return ht.warn(e),""}}}function sl(){return new Date().toISOString().substring(0,10)}function M_(r,e=x_){const t=[];let n=r.slice();for(const s of r){const i=t.find(o=>o.agent===s.agent);if(i){if(i.dates.push(s.date),il(t)>e){i.dates.pop();break}}else if(t.push({agent:s.agent,dates:[s.date]}),il(t)>e){t.pop();break}n=n.slice(1)}return{heartbeatsToSend:t,unsentEntries:n}}class L_{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return cd()?vg().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){const t=await D_(this.app);return t?.heartbeats?t:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const n=await this.read();return rl(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}else return}async add(e){if(await this._canUseIndexedDBPromise){const n=await this.read();return rl(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}else return}}function il(r){return Ci(JSON.stringify({version:2,heartbeats:r})).length}function F_(r){if(r.length===0)return-1;let e=0,t=r[0].date;for(let n=1;n<r.length;n++)r[n].date<t&&(t=r[n].date,e=n);return e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function U_(r){Xn(new _n("platform-logger",e=>new Jg(e),"PRIVATE")),Xn(new _n("heartbeat",e=>new O_(e),"PRIVATE")),Ut(da,tl,r),Ut(da,tl,"esm2020"),Ut("fire-js","")}U_("");var B_="firebase",j_="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vi=new Ga("@firebase/auth");function z_(r,...e){Vi.logLevel<=Y.WARN&&Vi.warn(`Auth (${mr}): ${r}`,...e)}function fi(r,...e){Vi.logLevel<=Y.ERROR&&Vi.error(`Auth (${mr}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dt(r,...e){throw Wa(r,...e)}function nt(r,...e){return Wa(r,...e)}function gd(r,e,t){const n={...q_(),[e]:t};return new As("auth","Firebase",n).create(e,{appName:r.name})}function lt(r){return gd(r,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Wa(r,...e){if(typeof r!="string"){const t=e[0],n=[...e.slice(1)];return n[0]&&(n[0].appName=r.name),r._errorFactory.create(t,...n)}return pd.create(r,...e)}function $(r,e,...t){if(!r)throw Wa(e,...t)}function at(r){const e="INTERNAL ASSERTION FAILED: "+r;throw fi(e),new Error(e)}function ft(r,e){r||at(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const W_=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],Q_=new Rs(3e4,6e4);function Ss(r,e){return r.tenantId&&!e.tenantId?{...e,tenantId:r.tenantId}:e}async function pr(r,e,t,n,s={}){return yd(r,s,async()=>{let i={},o={};n&&(e==="GET"?o=n:i={body:JSON.stringify(n)});const c=bs({key:r.config.apiKey,...o}).slice(1),u=await r._getAdditionalHeaders();u["Content-Type"]="application/json",r.languageCode&&(u["X-Firebase-Locale"]=r.languageCode);const h={method:e,headers:u,...i};return Ig()||(h.referrerPolicy="no-referrer"),r.emulatorConfig&&fr(r.emulatorConfig.host)&&(h.credentials="include"),_d.fetch()(await Id(r,r.config.apiHost,t,c),h)})}async function yd(r,e,t){r._canInitEmulator=!1;const n={...H_,...e};try{const s=new J_(r),i=await Promise.race([t(),s.promise]);s.clearNetworkTimeout();const o=await i.json();if("needConfirmation"in o)throw ni(r,"account-exists-with-different-credential",o);if(i.ok&&!("errorMessage"in o))return o;{const c=i.ok?o.errorMessage:o.error.message,[u,h]=c.split(" : ");if(u==="FEDERATED_USER_ID_ALREADY_LINKED")throw ni(r,"credential-already-in-use",o);if(u==="EMAIL_EXISTS")throw ni(r,"email-already-in-use",o);if(u==="USER_DISABLED")throw ni(r,"user-disabled",o);const f=n[u]||u.toLowerCase().replace(/[_\s]+/g,"-");if(h)throw gd(r,f,h);dt(r,f)}}catch(s){if(s instanceof _t)throw s;dt(r,"network-request-failed",{message:String(s)})}}async function Ja(r,e,t,n,s={}){const i=await pr(r,e,t,n,s);return"mfaPendingCredential"in i&&dt(r,"multi-factor-auth-required",{_serverResponse:i}),i}async function Id(r,e,t,n){const s=`${e}${t}?${n}`,i=r,o=i.config.emulator?Qa(r.config,s):`${r.config.apiScheme}://${s}`;return W_.includes(t)&&(await i._persistenceManagerAvailable,i._getPersistenceType()==="COOKIE")?i._getPersistence()._getFinalTarget(o).toString():o}class J_{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((t,n)=>{this.timer=setTimeout(()=>n(nt(this.auth,"network-request-failed")),Q_.get())})}}function ni(r,e,t){const n={appName:r.name};t.email&&(n.email=t.email),t.phoneNumber&&(n.phoneNumber=t.phoneNumber);const s=nt(r,e,n);return s.customData._tokenResponse=t,s}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Y_(r,e){return pr(r,"POST","/v1/accounts:delete",e)}async function ki(r,e){return pr(r,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jr(r){if(r)try{const e=new Date(Number(r));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function X_(r,e=!1){const t=Se(r),n=await t.getIdToken(e),s=Ya(n);$(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,o=i?.sign_in_provider;return{claims:s,token:n,authTime:Jr(Xo(s.auth_time)),issuedAtTime:Jr(Xo(s.iat)),expirationTime:Jr(Xo(s.exp)),signInProvider:o||null,signInSecondFactor:i?.sign_in_second_factor||null}}function Xo(r){return Number(r)*1e3}function Ya(r){const[e,t,n]=r.split(".");if(e===void 0||t===void 0||n===void 0)return fi("JWT malformed, contained fewer than 3 sections"),null;try{const s=ed(t);return s?JSON.parse(s):(fi("Failed to decode base64 JWT payload"),null)}catch(s){return fi("Caught error parsing JWT payload as JSON",s?.toString()),null}}function al(r){const e=Ya(r);return $(e,"internal-error"),$(typeof e.exp<"u","internal-error"),$(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Za={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function dy(r){Za=r}function fy(r){return Za.loadJS(r)}function my(){return Za.gapiScript}function py(r){return`__${r}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gy(r,e){const t=Xi(r,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(Gt(i,e??{}))return s;dt(s,"already-initialized")}return t.initialize({options:e})}function _y(r,e){const t=e?.persistence||[],n=(Array.isArray(t)?t:[t]).map(ct);e?.errorMap&&r._updateErrorMap(e.errorMap),r._initializeWithPersistence(n,e?.popupRedirectResolver)}function yy(r,e,t){const n=Ps(r);$(/^https?:\/\//.test(e),n,"invalid-emulator-scheme");const s=!1,i=kd(e),{host:o,port:c}=Iy(e),u=c===null?"":`:${c}`,h={url:`${i}//${o}${u}/`},f=Object.freeze({host:o,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!n._canInitEmulator){$(n.config.emulator&&n.emulatorConfig,n,"emulator-config-failed"),$(Gt(h,n.config.emulator)&&Gt(f,n.emulatorConfig),n,"emulator-config-failed");return}n.config.emulator=h,n.emulatorConfig=f,n.settings.appVerificationDisabledForTesting=!0,fr(o)?$a(`${i}//${o}${u}`):Ty()}function kd(r){const e=r.indexOf(":");return e<0?"":r.substr(0,e+1)}function Iy(r){const e=kd(r),t=/(\/\/)?([^?#/]+)/.exec(r.substr(e.length));if(!t)return{host:"",port:null};const n=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(n);if(s){const i=s[1];return{host:i,port:dl(n.substr(i.length+1))}}else{const[i,o]=n.split(":");return{host:i,port:dl(o)}}}function dl(r){if(!r)return null;const e=Number(r);return isNaN(e)?null:e}function Ty(){function r(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",r):r())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wn(r,e){return Ja(r,"POST","/v1/accounts:signInWithIdp",Ss(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Dt extends Cs{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return yn._fromParams({providerId:Dt.PROVIDER_ID,signInMethod:Dt.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Dt.credentialFromTaggedObject(e)}static credentialFromError(e){return Dt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:n}=e;if(!t&&!n)return null;try{return Dt.credential(t,n)}catch{return null}}}Dt.GOOGLE_SIGN_IN_METHOD="google.com";Dt.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class xt extends Cs{constructor(){super("github.com")}static credential(e){return yn._fromParams({providerId:xt.PROVIDER_ID,signInMethod:xt.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return xt.credentialFromTaggedObject(e)}static credentialFromError(e){return xt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return xt.credential(e.oauthAccessToken)}catch{return null}}}xt.GITHUB_SIGN_IN_METHOD="github.com";xt.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function wy(r,e){return Ja(r,"POST","/v1/accounts:signUp",Ss(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function by(r,e,t=!1){const{auth:n}=r;if($e(n.app))return Promise.reject(lt(n));const s="reauthenticate";try{const i=await as(r,Nd(n,s,e,r),t);$(i.idToken,n,"internal-error");const o=Ya(i.idToken);$(o,n,"internal-error");const{sub:c}=o;return $(r.uid===c,n,"user-mismatch"),mt._forOperation(r,s,i)}catch(i){throw i?.code==="auth/user-not-found"&&dt(n,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sy(r,e){return Ja(r,"POST","/v1/accounts:signInWithCustomToken",Ss(r,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Od{constructor(e,t){this.storageRetriever=e,this.type=t}_isAvailable(){try{return this.storage?(this.storage.setItem(Ni,"1"),this.storage.removeItem(Ni),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,t){return this.storage.setItem(e,JSON.stringify(t)),Promise.resolve()}_get(e){const t=this.storage.getItem(e);return Promise.resolve(t?JSON.parse(t):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tc extends Dd{constructor(e){super("custom","custom"),this.params=e}_getIdTokenResponse(e){return Wn(e,this._buildIdpRequest())}_linkToIdToken(e,t){return Wn(e,this._buildIdpRequest(t))}_getReauthenticationResolver(e){return Wn(e,this._buildIdpRequest())}_buildIdpRequest(e){const t={requestUri:this.params.requestUri,sessionId:this.params.sessionId,postBody:this.params.postBody,tenantId:this.params.tenantId,pendingToken:this.params.pendingToken,returnSecureToken:!0,returnIdpCredential:!0};return e&&(t.idToken=e),t}}function Wy(r){return Ry(r.auth,new tc(r),r.bypassAuthState)}function Qy(r){const{auth:e,user:t}=r;return $(t,e,"internal-error"),by(t,new tc(r),r.bypassAuthState)}async function Jy(r){const{auth:e,user:t}=r;return $(t,e,"internal-error"),Ay(t,new tc(r),r.bypassAuthState)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xy="pendingRedirect",pi=new Map;class Zy extends zd{constructor(e,t,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,n),this.eventId=null}async execute(){let e=pi.get(this.auth._key());if(!e){try{const n=await eI(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(n)}catch(t){e=()=>Promise.reject(t)}pi.set(this.auth._key(),e)}return this.bypassAuthState||pi.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function eI(r,e){const t=rI(e),n=nI(r);if(!await n._isAvailable())return!1;const s=await n._get(t)==="true";return await n._remove(t),s}function tI(r,e){pi.set(r._key(),e)}function nI(r){return ct(r._redirectPersistence)}function rI(r){return mi(Xy,r.config.apiKey,r.name)}async function sI(r,e,t=!1){if($e(r.app))return Promise.reject(lt(r));const n=Ps(r),s=Hy(n,e),o=await new Zy(n,s,t).execute();return o&&!t&&(delete o.user._redirectEventId,await n._persistUserIfCurrent(o.user),await n._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const VI="__/auth/handler",kI="emulator/auth/handler",DI=encodeURIComponent("fac");async function Il(r,e,t,n,s,i){$(r.config.authDomain,r,"auth-domain-config-required"),$(r.config.apiKey,r,"invalid-api-key");const o={apiKey:r.config.apiKey,appName:r.name,authType:t,redirectUrl:n,v:mr,eventId:s};if(e instanceof xd){e.setDefaultLanguage(r.languageCode),o.providerId=e.providerId||"",Sg(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[f,p]of Object.entries({}))o[f]=p}if(e instanceof Cs){const f=e.getScopes().filter(p=>p!=="");f.length>0&&(o.scopes=f.join(","))}r.tenantId&&(o.tid=r.tenantId);const c=o;for(const f of Object.keys(c))c[f]===void 0&&delete c[f];const u=await r._getAppCheckToken(),h=u?`#${DI}=${encodeURIComponent(u)}`:"";return`${xI(r)}?${bs(c).slice(1)}${h}`}function xI({config:r}){return r.emulator?Qa(r,kI):`https://${r.authDomain}/${VI}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zo="webStorageSupport";class NI{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Fd,this._completeRedirectFn=sI,this._overrideRedirectResult=tI}async _openPopup(e,t,n,s){ft(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const i=await Il(e,t,n,pa(),s);return PI(e,i,ec())}async _openRedirect(e,t,n,s){await this._originValidation(e);const i=await Il(e,t,n,pa(),s);return Ly(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(ft(i,"If manager is not set, promise should be"),i)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch(()=>{delete this.eventManagers[t]}),n}async initAndGetManager(e){const t=await wI(e),n=new oI(e);return t.register("authEvent",s=>($(s?.authEvent,e,"invalid-auth-event"),{status:n.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Zo,{type:Zo},s=>{const i=s?.[0]?.[Zo];i!==void 0&&t(!!i),dt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=hI(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Cd()||vd()||Xa()}}const OI=NI;var Tl="@firebase/auth",El="1.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var Bt,Gd;(function(){var r;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(_,g){function y(){}y.prototype=g.prototype,_.F=g.prototype,_.prototype=new y,_.prototype.constructor=_,_.D=function(E,T,A){for(var I=Array(arguments.length-2),Ae=2;Ae<arguments.length;Ae++)I[Ae-2]=arguments[Ae];return g.prototype[T].apply(E,I)}}function t(){this.blockSize=-1}function n(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.C=Array(this.blockSize),this.o=this.h=0,this.u()}e(n,t),n.prototype.u=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(_,g,y){y||(y=0);const E=Array(16);if(typeof g=="string")for(var T=0;T<16;++T)E[T]=g.charCodeAt(y++)|g.charCodeAt(y++)<<8|g.charCodeAt(y++)<<16|g.charCodeAt(y++)<<24;else for(T=0;T<16;++T)E[T]=g[y++]|g[y++]<<8|g[y++]<<16|g[y++]<<24;g=_.g[0],y=_.g[1],T=_.g[2];let A=_.g[3],I;I=g+(A^y&(T^A))+E[0]+3614090360&4294967295,g=y+(I<<7&4294967295|I>>>25),I=A+(T^g&(y^T))+E[1]+3905402710&4294967295,A=g+(I<<12&4294967295|I>>>20),I=T+(y^A&(g^y))+E[2]+606105819&4294967295,T=A+(I<<17&4294967295|I>>>15),I=y+(g^T&(A^g))+E[3]+3250441966&4294967295,y=T+(I<<22&4294967295|I>>>10),I=g+(A^y&(T^A))+E[4]+4118548399&4294967295,g=y+(I<<7&4294967295|I>>>25),I=A+(T^g&(y^T))+E[5]+1200080426&4294967295,A=g+(I<<12&4294967295|I>>>20),I=T+(y^A&(g^y))+E[6]+2821735955&4294967295,T=A+(I<<17&4294967295|I>>>15),I=y+(g^T&(A^g))+E[7]+4249261313&4294967295,y=T+(I<<22&4294967295|I>>>10),I=g+(A^y&(T^A))+E[8]+1770035416&4294967295,g=y+(I<<7&4294967295|I>>>25),I=A+(T^g&(y^T))+E[9]+2336552879&4294967295,A=g+(I<<12&4294967295|I>>>20),I=T+(y^A&(g^y))+E[10]+4294925233&4294967295,T=A+(I<<17&4294967295|I>>>15),I=y+(g^T&(A^g))+E[11]+2304563134&4294967295,y=T+(I<<22&4294967295|I>>>10),I=g+(A^y&(T^A))+E[12]+1804603682&4294967295,g=y+(I<<7&4294967295|I>>>25),I=A+(T^g&(y^T))+E[13]+4254626195&4294967295,A=g+(I<<12&4294967295|I>>>20),I=T+(y^A&(g^y))+E[14]+2792965006&4294967295,T=A+(I<<17&4294967295|I>>>15),I=y+(g^T&(A^g))+E[15]+1236535329&4294967295,y=T+(I<<22&4294967295|I>>>10),I=g+(T^A&(y^T))+E[1]+4129170786&4294967295,g=y+(I<<5&4294967295|I>>>27),I=A+(y^T&(g^y))+E[6]+3225465664&4294967295,A=g+(I<<9&4294967295|I>>>23),I=T+(g^y&(A^g))+E[11]+643717713&4294967295,T=A+(I<<14&4294967295|I>>>18),I=y+(A^g&(T^A))+E[0]+3921069994&4294967295,y=T+(I<<20&4294967295|I>>>12),I=g+(T^A&(y^T))+E[5]+3593408605&4294967295,g=y+(I<<5&4294967295|I>>>27),I=A+(y^T&(g^y))+E[10]+38016083&4294967295,A=g+(I<<9&4294967295|I>>>23),I=T+(g^y&(A^g))+E[15]+3634488961&4294967295,T=A+(I<<14&4294967295|I>>>18),I=y+(A^g&(T^A))+E[4]+3889429448&4294967295,y=T+(I<<20&4294967295|I>>>12),I=g+(T^A&(y^T))+E[9]+568446438&4294967295,g=y+(I<<5&4294967295|I>>>27),I=A+(y^T&(g^y))+E[14]+3275163606&4294967295,A=g+(I<<9&4294967295|I>>>23),I=T+(g^y&(A^g))+E[3]+4107603335&4294967295,T=A+(I<<14&4294967295|I>>>18),I=y+(A^g&(T^A))+E[8]+1163531501&4294967295,y=T+(I<<20&4294967295|I>>>12),I=g+(T^A&(y^T))+E[13]+2850285829&4294967295,g=y+(I<<5&4294967295|I>>>27),I=A+(y^T&(g^y))+E[2]+4243563512&4294967295,A=g+(I<<9&4294967295|I>>>23),I=T+(g^y&(A^g))+E[7]+1735328473&4294967295,T=A+(I<<14&4294967295|I>>>18),I=y+(A^g&(T^A))+E[12]+2368359562&4294967295,y=T+(I<<20&4294967295|I>>>12),I=g+(y^T^A)+E[5]+4294588738&4294967295,g=y+(I<<4&4294967295|I>>>28),I=A+(g^y^T)+E[8]+2272392833&4294967295,A=g+(I<<11&4294967295|I>>>21),I=T+(A^g^y)+E[11]+1839030562&4294967295,T=A+(I<<16&4294967295|I>>>16),I=y+(T^A^g)+E[14]+4259657740&4294967295,y=T+(I<<23&4294967295|I>>>9),I=g+(y^T^A)+E[1]+2763975236&4294967295,g=y+(I<<4&4294967295|I>>>28),I=A+(g^y^T)+E[4]+1272893353&4294967295,A=g+(I<<11&4294967295|I>>>21),I=T+(A^g^y)+E[7]+4139469664&4294967295,T=A+(I<<16&4294967295|I>>>16),I=y+(T^A^g)+E[10]+3200236656&4294967295,y=T+(I<<23&4294967295|I>>>9),I=g+(y^T^A)+E[13]+681279174&4294967295,g=y+(I<<4&4294967295|I>>>28),I=A+(g^y^T)+E[0]+3936430074&4294967295,A=g+(I<<11&4294967295|I>>>21),I=T+(A^g^y)+E[3]+3572445317&4294967295,T=A+(I<<16&4294967295|I>>>16),I=y+(T^A^g)+E[6]+76029189&4294967295,y=T+(I<<23&4294967295|I>>>9),I=g+(y^T^A)+E[9]+3654602809&4294967295,g=y+(I<<4&4294967295|I>>>28),I=A+(g^y^T)+E[12]+3873151461&4294967295,A=g+(I<<11&4294967295|I>>>21),I=T+(A^g^y)+E[15]+530742520&4294967295,T=A+(I<<16&4294967295|I>>>16),I=y+(T^A^g)+E[2]+3299628645&4294967295,y=T+(I<<23&4294967295|I>>>9),I=g+(T^(y|~A))+E[0]+4096336452&4294967295,g=y+(I<<6&4294967295|I>>>26),I=A+(y^(g|~T))+E[7]+1126891415&4294967295,A=g+(I<<10&4294967295|I>>>22),I=T+(g^(A|~y))+E[14]+2878612391&4294967295,T=A+(I<<15&4294967295|I>>>17),I=y+(A^(T|~g))+E[5]+4237533241&4294967295,y=T+(I<<21&4294967295|I>>>11),I=g+(T^(y|~A))+E[12]+1700485571&4294967295,g=y+(I<<6&4294967295|I>>>26),I=A+(y^(g|~T))+E[3]+2399980690&4294967295,A=g+(I<<10&4294967295|I>>>22),I=T+(g^(A|~y))+E[10]+4293915773&4294967295,T=A+(I<<15&4294967295|I>>>17),I=y+(A^(T|~g))+E[1]+2240044497&4294967295,y=T+(I<<21&4294967295|I>>>11),I=g+(T^(y|~A))+E[8]+1873313359&4294967295,g=y+(I<<6&4294967295|I>>>26),I=A+(y^(g|~T))+E[15]+4264355552&4294967295,A=g+(I<<10&4294967295|I>>>22),I=T+(g^(A|~y))+E[6]+2734768916&4294967295,T=A+(I<<15&4294967295|I>>>17),I=y+(A^(T|~g))+E[13]+1309151649&4294967295,y=T+(I<<21&4294967295|I>>>11),I=g+(T^(y|~A))+E[4]+4149444226&4294967295,g=y+(I<<6&4294967295|I>>>26),I=A+(y^(g|~T))+E[11]+3174756917&4294967295,A=g+(I<<10&4294967295|I>>>22),I=T+(g^(A|~y))+E[2]+718787259&4294967295,T=A+(I<<15&4294967295|I>>>17),I=y+(A^(T|~g))+E[9]+3951481745&4294967295,_.g[0]=_.g[0]+g&4294967295,_.g[1]=_.g[1]+(T+(I<<21&4294967295|I>>>11))&4294967295,_.g[2]=_.g[2]+T&4294967295,_.g[3]=_.g[3]+A&4294967295}n.prototype.v=function(_,g){g===void 0&&(g=_.length);const y=g-this.blockSize,E=this.C;let T=this.h,A=0;for(;A<g;){if(T==0)for(;A<=y;)s(this,_,A),A+=this.blockSize;if(typeof _=="string"){for(;A<g;)if(E[T++]=_.charCodeAt(A++),T==this.blockSize){s(this,E),T=0;break}}else for(;A<g;)if(E[T++]=_[A++],T==this.blockSize){s(this,E),T=0;break}}this.h=T,this.o+=g},n.prototype.A=function(){var _=Array((this.h<56?this.blockSize:this.blockSize*2)-this.h);_[0]=128;for(var g=1;g<_.length-8;++g)_[g]=0;g=this.o*8;for(var y=_.length-8;y<_.length;++y)_[y]=g&255,g/=256;for(this.v(_),_=Array(16),g=0,y=0;y<4;++y)for(let E=0;E<32;E+=8)_[g++]=this.g[y]>>>E&255;return _};function i(_,g){var y=c;return Object.prototype.hasOwnProperty.call(y,_)?y[_]:y[_]=g(_)}function o(_,g){this.h=g;const y=[];let E=!0;for(let T=_.length-1;T>=0;T--){const A=_[T]|0;E&&A==g||(y[T]=A,E=!1)}this.g=y}var c={};function u(_){return-128<=_&&_<128?i(_,function(g){return new o([g|0],g<0?-1:0)}):new o([_|0],_<0?-1:0)}function h(_){if(isNaN(_)||!isFinite(_))return p;if(_<0)return x(h(-_));const g=[];let y=1;for(let E=0;_>=y;E++)g[E]=_/y|0,y*=4294967296;return new o(g,0)}function f(_,g){if(_.length==0)throw Error("number format error: empty string");if(g=g||10,g<2||36<g)throw Error("radix out of range: "+g);if(_.charAt(0)=="-")return x(f(_.substring(1),g));if(_.indexOf("-")>=0)throw Error('number format error: interior "-" character');const y=h(Math.pow(g,8));let E=p;for(let A=0;A<_.length;A+=8){var T=Math.min(8,_.length-A);const I=parseInt(_.substring(A,A+T),g);T<8?(T=h(Math.pow(g,T)),E=E.j(T).add(h(I))):(E=E.j(y),E=E.add(h(I)))}return E}var p=u(0),w=u(1),S=u(16777216);r=o.prototype,r.m=function(){if(O(this))return-x(this).m();let _=0,g=1;for(let y=0;y<this.g.length;y++){const E=this.i(y);_+=(E>=0?E:4294967296+E)*g,g*=4294967296}return _},r.toString=function(_){if(_=_||10,_<2||36<_)throw Error("radix out of range: "+_);if(C(this))return"0";if(O(this))return"-"+x(this).toString(_);const g=h(Math.pow(_,6));var y=this;let E="";for(;;){const T=F(y,g).g;y=W(y,T.j(g));let A=((y.g.length>0?y.g[0]:y.h)>>>0).toString(_);if(y=T,C(y))return A+E;for(;A.length<6;)A="0"+A;E=A+E}},r.i=function(_){return _<0?0:_<this.g.length?this.g[_]:this.h};function C(_){if(_.h!=0)return!1;for(let g=0;g<_.g.length;g++)if(_.g[g]!=0)return!1;return!0}function O(_){return _.h==-1}r.l=function(_){return _=W(this,_),O(_)?-1:C(_)?0:1};function x(_){const g=_.g.length,y=[];for(let E=0;E<g;E++)y[E]=~_.g[E];return new o(y,~_.h).add(w)}r.abs=function(){return O(this)?x(this):this},r.add=function(_){const g=Math.max(this.g.length,_.g.length),y=[];let E=0;for(let T=0;T<=g;T++){let A=E+(this.i(T)&65535)+(_.i(T)&65535),I=(A>>>16)+(this.i(T)>>>16)+(_.i(T)>>>16);E=I>>>16,A&=65535,I&=65535,y[T]=I<<16|A}return new o(y,y[y.length-1]&-2147483648?-1:0)};function W(_,g){return _.add(x(g))}r.j=function(_){if(C(this)||C(_))return p;if(O(this))return O(_)?x(this).j(x(_)):x(x(this).j(_));if(O(_))return x(this.j(x(_)));if(this.l(S)<0&&_.l(S)<0)return h(this.m()*_.m());const g=this.g.length+_.g.length,y=[];for(var E=0;E<2*g;E++)y[E]=0;for(E=0;E<this.g.length;E++)for(let T=0;T<_.g.length;T++){const A=this.i(E)>>>16,I=this.i(E)&65535,Ae=_.i(T)>>>16,ot=_.i(T)&65535;y[2*E+2*T]+=I*ot,H(y,2*E+2*T),y[2*E+2*T+1]+=A*ot,H(y,2*E+2*T+1),y[2*E+2*T+1]+=I*Ae,H(y,2*E+2*T+1),y[2*E+2*T+2]+=A*Ae,H(y,2*E+2*T+2)}for(_=0;_<g;_++)y[_]=y[2*_+1]<<16|y[2*_];for(_=g;_<2*g;_++)y[_]=0;return new o(y,0)};function H(_,g){for(;(_[g]&65535)!=_[g];)_[g+1]+=_[g]>>>16,_[g]&=65535,g++}function z(_,g){this.g=_,this.h=g}function F(_,g){if(C(g))throw Error("division by zero");if(C(_))return new z(p,p);if(O(_))return g=F(x(_),g),new z(x(g.g),x(g.h));if(O(g))return g=F(_,x(g)),new z(x(g.g),g.h);if(_.g.length>30){if(O(_)||O(g))throw Error("slowDivide_ only works with positive integers.");for(var y=w,E=g;E.l(_)<=0;)y=q(y),E=q(E);var T=B(y,1),A=B(E,1);for(E=B(E,2),y=B(y,2);!C(E);){var I=A.add(E);I.l(_)<=0&&(T=T.add(y),A=I),E=B(E,1),y=B(y,1)}return g=W(_,T.j(g)),new z(T,g)}for(T=p;_.l(g)>=0;){for(y=Math.max(1,Math.floor(_.m()/g.m())),E=Math.ceil(Math.log(y)/Math.LN2),E=E<=48?1:Math.pow(2,E-48),A=h(y),I=A.j(g);O(I)||I.l(_)>0;)y-=E,A=h(y),I=A.j(g);C(A)&&(A=w),T=T.add(A),_=W(_,I)}return new z(T,_)}r.B=function(_){return F(this,_).h},r.and=function(_){const g=Math.max(this.g.length,_.g.length),y=[];for(let E=0;E<g;E++)y[E]=this.i(E)&_.i(E);return new o(y,this.h&_.h)},r.or=function(_){const g=Math.max(this.g.length,_.g.length),y=[];for(let E=0;E<g;E++)y[E]=this.i(E)|_.i(E);return new o(y,this.h|_.h)},r.xor=function(_){const g=Math.max(this.g.length,_.g.length),y=[];for(let E=0;E<g;E++)y[E]=this.i(E)^_.i(E);return new o(y,this.h^_.h)};function q(_){const g=_.g.length+1,y=[];for(let E=0;E<g;E++)y[E]=_.i(E)<<1|_.i(E-1)>>>31;return new o(y,_.h)}function B(_,g){const y=g>>5;g%=32;const E=_.g.length-y,T=[];for(let A=0;A<E;A++)T[A]=g>0?_.i(A+y)>>>g|_.i(A+y+1)<<32-g:_.i(A+y);return new o(T,_.h)}n.prototype.digest=n.prototype.A,n.prototype.reset=n.prototype.u,n.prototype.update=n.prototype.v,Gd=n,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.B,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=h,o.fromString=f,Bt=o}).apply(typeof vl<"u"?vl:typeof self<"u"?self:typeof window<"u"?window:{});var ri=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var Kd,Gr,Hd,_i,ya,Wd,Qd,Jd;(function(){var r,e=Object.defineProperty;function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof ri=="object"&&ri];for(var l=0;l<a.length;++l){var d=a[l];if(d&&d.Math==Math)return d}throw Error("Cannot find global object")}var n=t(this);function s(a,l){if(l)e:{var d=n;a=a.split(".");for(var m=0;m<a.length-1;m++){var b=a[m];if(!(b in d))break e;d=d[b]}a=a[a.length-1],m=d[a],l=l(m),l!=m&&l!=null&&e(d,a,{configurable:!0,writable:!0,value:l})}}s("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),s("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),s("Object.entries",function(a){return a||function(l){var d=[],m;for(m in l)Object.prototype.hasOwnProperty.call(l,m)&&d.push([m,l[m]]);return d}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var i=i||{},o=this||self;function c(a){var l=typeof a;return l=="object"&&a!=null||l=="function"}function u(a,l,d){return a.call.apply(a.bind,arguments)}function h(a,l,d){return h=u,h.apply(null,arguments)}function f(a,l){var d=Array.prototype.slice.call(arguments,1);return function(){var m=d.slice();return m.push.apply(m,arguments),a.apply(this,m)}}function p(a,l){function d(){}d.prototype=l.prototype,a.Z=l.prototype,a.prototype=new d,a.prototype.constructor=a,a.Ob=function(m,b,R){for(var N=Array(arguments.length-2),Q=2;Q<arguments.length;Q++)N[Q-2]=arguments[Q];return l.prototype[b].apply(m,N)}}var w=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function S(a){const l=a.length;if(l>0){const d=Array(l);for(let m=0;m<l;m++)d[m]=a[m];return d}return[]}function C(a,l){for(let m=1;m<arguments.length;m++){const b=arguments[m];var d=typeof b;if(d=d!="object"?d:b?Array.isArray(b)?"array":d:"null",d=="array"||d=="object"&&typeof b.length=="number"){d=a.length||0;const R=b.length||0;a.length=d+R;for(let N=0;N<R;N++)a[d+N]=b[N]}else a.push(b)}}class O{constructor(l,d){this.i=l,this.j=d,this.h=0,this.g=null}get(){let l;return this.h>0?(this.h--,l=this.g,this.g=l.next,l.next=null):l=this.i(),l}}function x(a){o.setTimeout(()=>{throw a},0)}function W(){var a=_;let l=null;return a.g&&(l=a.g,a.g=a.g.next,a.g||(a.h=null),l.next=null),l}class H{constructor(){this.h=this.g=null}add(l,d){const m=z.get();m.set(l,d),this.h?this.h.next=m:this.g=m,this.h=m}}var z=new O(()=>new F,a=>a.reset());class F{constructor(){this.next=this.g=this.h=null}set(l,d){this.h=l,this.g=d,this.next=null}reset(){this.next=this.g=this.h=null}}let q,B=!1,_=new H,g=()=>{const a=Promise.resolve(void 0);q=()=>{a.then(y)}};function y(){for(var a;a=W();){try{a.h.call(a.g)}catch(d){x(d)}var l=z;l.j(a),l.h<100&&(l.h++,a.next=l.g,l.g=a)}B=!1}function E(){this.u=this.u,this.C=this.C}E.prototype.u=!1,E.prototype.dispose=function(){this.u||(this.u=!0,this.N())},E.prototype[Symbol.dispose]=function(){this.dispose()},E.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function T(a,l){this.type=a,this.g=this.target=l,this.defaultPrevented=!1}T.prototype.h=function(){this.defaultPrevented=!0};var A=(function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,l=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const d=()=>{};o.addEventListener("test",d,l),o.removeEventListener("test",d,l)}catch{}return a})();function I(a){return/^[\s\xa0]*$/.test(a)}function Ae(a,l){T.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,l)}p(Ae,T),Ae.prototype.init=function(a,l){const d=this.type=a.type,m=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=l,l=a.relatedTarget,l||(d=="mouseover"?l=a.fromElement:d=="mouseout"&&(l=a.toElement)),this.relatedTarget=l,m?(this.clientX=m.clientX!==void 0?m.clientX:m.pageX,this.clientY=m.clientY!==void 0?m.clientY:m.pageY,this.screenX=m.screenX||0,this.screenY=m.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&Ae.Z.h.call(this)},Ae.prototype.h=function(){Ae.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var ot="closure_listenable_"+(Math.random()*1e6|0),wo=0;function Tr(a,l,d,m,b){this.listener=a,this.proxy=null,this.src=l,this.type=d,this.capture=!!m,this.ha=b,this.key=++wo,this.da=this.fa=!1}function Bs(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function js(a,l,d){for(const m in a)l.call(d,a[m],m,a)}function ap(a,l){for(const d in a)l.call(void 0,a[d],d,a)}function Kc(a){const l={};for(const d in a)l[d]=a[d];return l}const Hc="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Wc(a,l){let d,m;for(let b=1;b<arguments.length;b++){m=arguments[b];for(d in m)a[d]=m[d];for(let R=0;R<Hc.length;R++)d=Hc[R],Object.prototype.hasOwnProperty.call(m,d)&&(a[d]=m[d])}}function qs(a){this.src=a,this.g={},this.h=0}qs.prototype.add=function(a,l,d,m,b){const R=a.toString();a=this.g[R],a||(a=this.g[R]=[],this.h++);const N=Ao(a,l,m,b);return N>-1?(l=a[N],d||(l.fa=!1)):(l=new Tr(l,this.src,R,!!m,b),l.fa=d,a.push(l)),l};function vo(a,l){const d=l.type;if(d in a.g){var m=a.g[d],b=Array.prototype.indexOf.call(m,l,void 0),R;(R=b>=0)&&Array.prototype.splice.call(m,b,1),R&&(Bs(l),a.g[d].length==0&&(delete a.g[d],a.h--))}}function Ao(a,l,d,m){for(let b=0;b<a.length;++b){const R=a[b];if(!R.da&&R.listener==l&&R.capture==!!d&&R.ha==m)return b}return-1}var bo="closure_lm_"+(Math.random()*1e6|0),Ro={};function Qc(a,l,d,m,b){if(Array.isArray(l)){for(let R=0;R<l.length;R++)Qc(a,l[R],d,m,b);return null}return d=Xc(d),a&&a[ot]?a.J(l,d,c(m)?!!m.capture:!1,b):cp(a,l,d,!1,m,b)}function cp(a,l,d,m,b,R){if(!l)throw Error("Invalid event type");const N=c(b)?!!b.capture:!!b;let Q=Po(a);if(Q||(a[bo]=Q=new qs(a)),d=Q.add(l,d,m,N,R),d.proxy)return d;if(m=up(),d.proxy=m,m.src=a,m.listener=d,a.addEventListener)A||(b=N),b===void 0&&(b=!1),a.addEventListener(l.toString(),m,b);else if(a.attachEvent)a.attachEvent(Yc(l.toString()),m);else if(a.addListener&&a.removeListener)a.addListener(m);else throw Error("addEventListener and attachEvent are unavailable.");return d}function up(){function a(d){return l.call(a.src,a.listener,d)}const l=lp;return a}function Jc(a,l,d,m,b){if(Array.isArray(l))for(var R=0;R<l.length;R++)Jc(a,l[R],d,m,b);else m=c(m)?!!m.capture:!!m,d=Xc(d),a&&a[ot]?(a=a.i,R=String(l).toString(),R in a.g&&(l=a.g[R],d=Ao(l,d,m,b),d>-1&&(Bs(l[d]),Array.prototype.splice.call(l,d,1),l.length==0&&(delete a.g[R],a.h--)))):a&&(a=Po(a))&&(l=a.g[l.toString()],a=-1,l&&(a=Ao(l,d,m,b)),(d=a>-1?l[a]:null)&&So(d))}function So(a){if(typeof a!="number"&&a&&!a.da){var l=a.src;if(l&&l[ot])vo(l.i,a);else{var d=a.type,m=a.proxy;l.removeEventListener?l.removeEventListener(d,m,a.capture):l.detachEvent?l.detachEvent(Yc(d),m):l.addListener&&l.removeListener&&l.removeListener(m),(d=Po(l))?(vo(d,a),d.h==0&&(d.src=null,l[bo]=null)):Bs(a)}}}function Yc(a){return a in Ro?Ro[a]:Ro[a]="on"+a}function lp(a,l){if(a.da)a=!0;else{l=new Ae(l,this);const d=a.listener,m=a.ha||a.src;a.fa&&So(a),a=d.call(m,l)}return a}function Po(a){return a=a[bo],a instanceof qs?a:null}var Co="__closure_events_fn_"+(Math.random()*1e9>>>0);function Xc(a){return typeof a=="function"?a:(a[Co]||(a[Co]=function(l){return a.handleEvent(l)}),a[Co])}function Pe(){E.call(this),this.i=new qs(this),this.M=this,this.G=null}p(Pe,E),Pe.prototype[ot]=!0,Pe.prototype.removeEventListener=function(a,l,d,m){Jc(this,a,l,d,m)};function xe(a,l){var d,m=a.G;if(m)for(d=[];m;m=m.G)d.push(m);if(a=a.M,m=l.type||l,typeof l=="string")l=new T(l,a);else if(l instanceof T)l.target=l.target||a;else{var b=l;l=new T(m,a),Wc(l,b)}b=!0;let R,N;if(d)for(N=d.length-1;N>=0;N--)R=l.g=d[N],b=zs(R,m,!0,l)&&b;if(R=l.g=a,b=zs(R,m,!0,l)&&b,b=zs(R,m,!1,l)&&b,d)for(N=0;N<d.length;N++)R=l.g=d[N],b=zs(R,m,!1,l)&&b}Pe.prototype.N=function(){if(Pe.Z.N.call(this),this.i){var a=this.i;for(const l in a.g){const d=a.g[l];for(let m=0;m<d.length;m++)Bs(d[m]);delete a.g[l],a.h--}}this.G=null},Pe.prototype.J=function(a,l,d,m){return this.i.add(String(a),l,!1,d,m)},Pe.prototype.K=function(a,l,d,m){return this.i.add(String(a),l,!0,d,m)};function zs(a,l,d,m){if(l=a.i.g[String(l)],!l)return!0;l=l.concat();let b=!0;for(let R=0;R<l.length;++R){const N=l[R];if(N&&!N.da&&N.capture==d){const Q=N.listener,ge=N.ha||N.src;N.fa&&vo(a.i,N),b=Q.call(ge,m)!==!1&&b}}return b&&!m.defaultPrevented}function hp(a,l){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=h(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(l)>2147483647?-1:o.setTimeout(a,l||0)}function Zc(a){a.g=hp(()=>{a.g=null,a.i&&(a.i=!1,Zc(a))},a.l);const l=a.h;a.h=null,a.m.apply(null,l)}class dp extends E{constructor(l,d){super(),this.m=l,this.l=d,this.h=null,this.i=!1,this.g=null}j(l){this.h=arguments,this.g?this.i=!0:Zc(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function Er(a){E.call(this),this.h=a,this.g={}}p(Er,E);var eu=[];function tu(a){js(a.g,function(l,d){this.g.hasOwnProperty(d)&&So(l)},a),a.g={}}Er.prototype.N=function(){Er.Z.N.call(this),tu(this)},Er.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Vo=o.JSON.stringify,fp=o.JSON.parse,mp=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function nu(){}function ru(){}var wr={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function ko(){T.call(this,"d")}p(ko,T);function Do(){T.call(this,"c")}p(Do,T);var Xt={},su=null;function $s(){return su=su||new Pe}Xt.Ia="serverreachability";function iu(a){T.call(this,Xt.Ia,a)}p(iu,T);function vr(a){const l=$s();xe(l,new iu(l))}Xt.STAT_EVENT="statevent";function ou(a,l){T.call(this,Xt.STAT_EVENT,a),this.stat=l}p(ou,T);function Ne(a){const l=$s();xe(l,new ou(l,a))}Xt.Ja="timingevent";function au(a,l){T.call(this,Xt.Ja,a),this.size=l}p(au,T);function Ar(a,l){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},l)}function br(){this.g=!0}br.prototype.ua=function(){this.g=!1};function pp(a,l,d,m,b,R){a.info(function(){if(a.g)if(R){var N="",Q=R.split("&");for(let se=0;se<Q.length;se++){var ge=Q[se].split("=");if(ge.length>1){const Ee=ge[0];ge=ge[1];const Xe=Ee.split("_");N=Xe.length>=2&&Xe[1]=="type"?N+(Ee+"="+ge+"&"):N+(Ee+"=redacted&")}}}else N=null;else N=R;return"XMLHTTP REQ ("+m+") [attempt "+b+"]: "+l+`
`+d+`
`+N})}function gp(a,l,d,m,b,R,N){a.info(function(){return"XMLHTTP RESP ("+m+") [ attempt "+b+"]: "+l+`
`+d+`
`+R+" "+N})}function kn(a,l,d,m){a.info(function(){return"XMLHTTP TEXT ("+l+"): "+yp(a,d)+(m?" "+m:"")})}function _p(a,l){a.info(function(){return"TIMEOUT: "+l})}br.prototype.info=function(){};function yp(a,l){if(!a.g)return l;if(!l)return null;try{const R=JSON.parse(l);if(R){for(a=0;a<R.length;a++)if(Array.isArray(R[a])){var d=R[a];if(!(d.length<2)){var m=d[1];if(Array.isArray(m)&&!(m.length<1)){var b=m[0];if(b!="noop"&&b!="stop"&&b!="close")for(let N=1;N<m.length;N++)m[N]=""}}}}return Vo(R)}catch{return l}}var Gs={NO_ERROR:0,cb:1,qb:2,pb:3,kb:4,ob:5,rb:6,Ga:7,TIMEOUT:8,ub:9},cu={ib:"complete",Fb:"success",ERROR:"error",Ga:"abort",xb:"ready",yb:"readystatechange",TIMEOUT:"timeout",sb:"incrementaldata",wb:"progress",lb:"downloadprogress",Nb:"uploadprogress"},uu;function xo(){}p(xo,nu),xo.prototype.g=function(){return new XMLHttpRequest},uu=new xo;function Rr(a){return encodeURIComponent(String(a))}function Ip(a){var l=1;a=a.split(":");const d=[];for(;l>0&&a.length;)d.push(a.shift()),l--;return a.length&&d.push(a.join(":")),d}function Tt(a,l,d,m){this.j=a,this.i=l,this.l=d,this.S=m||1,this.V=new Er(this),this.H=45e3,this.J=null,this.o=!1,this.u=this.B=this.A=this.M=this.F=this.T=this.D=null,this.G=[],this.g=null,this.C=0,this.m=this.v=null,this.X=-1,this.K=!1,this.P=0,this.O=null,this.W=this.L=this.U=this.R=!1,this.h=new lu}function lu(){this.i=null,this.g="",this.h=!1}var hu={},No={};function Oo(a,l,d){a.M=1,a.A=Hs(Ye(l)),a.u=d,a.R=!0,du(a,null)}function du(a,l){a.F=Date.now(),Ks(a),a.B=Ye(a.A);var d=a.B,m=a.S;Array.isArray(m)||(m=[String(m)]),bu(d.i,"t",m),a.C=0,d=a.j.L,a.h=new lu,a.g=zu(a.j,d?l:null,!a.u),a.P>0&&(a.O=new dp(h(a.Y,a,a.g),a.P)),l=a.V,d=a.g,m=a.ba;var b="readystatechange";Array.isArray(b)||(b&&(eu[0]=b.toString()),b=eu);for(let R=0;R<b.length;R++){const N=Qc(d,b[R],m||l.handleEvent,!1,l.h||l);if(!N)break;l.g[N.key]=N}l=a.J?Kc(a.J):{},a.u?(a.v||(a.v="POST"),l["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.B,a.v,a.u,l)):(a.v="GET",a.g.ea(a.B,a.v,null,l)),vr(),pp(a.i,a.v,a.B,a.l,a.S,a.u)}Tt.prototype.ba=function(a){a=a.target;const l=this.O;l&&vt(a)==3?l.j():this.Y(a)},Tt.prototype.Y=function(a){try{if(a==this.g)e:{const Q=vt(this.g),ge=this.g.ya(),se=this.g.ca();if(!(Q<3)&&(Q!=3||this.g&&(this.h.h||this.g.la()||Du(this.g)))){this.K||Q!=4||ge==7||(ge==8||se<=0?vr(3):vr(2)),Mo(this);var l=this.g.ca();this.X=l;var d=Tp(this);if(this.o=l==200,gp(this.i,this.v,this.B,this.l,this.S,Q,l),this.o){if(this.U&&!this.L){t:{if(this.g){var m,b=this.g;if((m=b.g?b.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!I(m)){var R=m;break t}}R=null}if(a=R)kn(this.i,this.l,a,"Initial handshake response via X-HTTP-Initial-Response"),this.L=!0,Lo(this,a);else{this.o=!1,this.m=3,Ne(12),Zt(this),Sr(this);break e}}if(this.R){a=!0;let Ee;for(;!this.K&&this.C<d.length;)if(Ee=Ep(this,d),Ee==No){Q==4&&(this.m=4,Ne(14),a=!1),kn(this.i,this.l,null,"[Incomplete Response]");break}else if(Ee==hu){this.m=4,Ne(15),kn(this.i,this.l,d,"[Invalid Chunk]"),a=!1;break}else kn(this.i,this.l,Ee,null),Lo(this,Ee);if(fu(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Q!=4||d.length!=0||this.h.h||(this.m=1,Ne(16),a=!1),this.o=this.o&&a,!a)kn(this.i,this.l,d,"[Invalid Chunked Response]"),Zt(this),Sr(this);else if(d.length>0&&!this.W){this.W=!0;var N=this.j;N.g==this&&N.aa&&!N.P&&(N.j.info("Great, no buffering proxy detected. Bytes received: "+d.length),Go(N),N.P=!0,Ne(11))}}else kn(this.i,this.l,d,null),Lo(this,d);Q==4&&Zt(this),this.o&&!this.K&&(Q==4?Uu(this.j,this):(this.o=!1,Ks(this)))}else Op(this.g),l==400&&d.indexOf("Unknown SID")>0?(this.m=3,Ne(12)):(this.m=0,Ne(13)),Zt(this),Sr(this)}}}catch{}finally{}};function Tp(a){if(!fu(a))return a.g.la();const l=Du(a.g);if(l==="")return"";let d="";const m=l.length,b=vt(a.g)==4;if(!a.h.i){if(typeof TextDecoder>"u")return Zt(a),Sr(a),"";a.h.i=new o.TextDecoder}for(let R=0;R<m;R++)a.h.h=!0,d+=a.h.i.decode(l[R],{stream:!(b&&R==m-1)});return l.length=0,a.h.g+=d,a.C=0,a.h.g}function fu(a){return a.g?a.v=="GET"&&a.M!=2&&a.j.Aa:!1}function Ep(a,l){var d=a.C,m=l.indexOf(`
`,d);return m==-1?No:(d=Number(l.substring(d,m)),isNaN(d)?hu:(m+=1,m+d>l.length?No:(l=l.slice(m,m+d),a.C=m+d,l)))}Tt.prototype.cancel=function(){this.K=!0,Zt(this)};function Ks(a){a.T=Date.now()+a.H,mu(a,a.H)}function mu(a,l){if(a.D!=null)throw Error("WatchDog timer not null");a.D=Ar(h(a.aa,a),l)}function Mo(a){a.D&&(o.clearTimeout(a.D),a.D=null)}Tt.prototype.aa=function(){this.D=null;const a=Date.now();a-this.T>=0?(_p(this.i,this.B),this.M!=2&&(vr(),Ne(17)),Zt(this),this.m=2,Sr(this)):mu(this,this.T-a)};function Sr(a){a.j.I==0||a.K||Uu(a.j,a)}function Zt(a){Mo(a);var l=a.O;l&&typeof l.dispose=="function"&&l.dispose(),a.O=null,tu(a.V),a.g&&(l=a.g,a.g=null,l.abort(),l.dispose())}function Lo(a,l){try{var d=a.j;if(d.I!=0&&(d.g==a||Fo(d.h,a))){if(!a.L&&Fo(d.h,a)&&d.I==3){try{var m=d.Ba.g.parse(l)}catch{m=null}if(Array.isArray(m)&&m.length==3){var b=m;if(b[0]==0){e:if(!d.v){if(d.g)if(d.g.F+3e3<a.F)Xs(d),Js(d);else break e;$o(d),Ne(18)}}else d.xa=b[1],0<d.xa-d.K&&b[2]<37500&&d.F&&d.A==0&&!d.C&&(d.C=Ar(h(d.Va,d),6e3));_u(d.h)<=1&&d.ta&&(d.ta=void 0)}else tn(d,11)}else if((a.L||d.g==a)&&Xs(d),!I(l))for(b=d.Ba.g.parse(l),l=0;l<b.length;l++){let se=b[l];const Ee=se[0];if(!(Ee<=d.K))if(d.K=Ee,se=se[1],d.I==2)if(se[0]=="c"){d.M=se[1],d.ba=se[2];const Xe=se[3];Xe!=null&&(d.ka=Xe,d.j.info("VER="+d.ka));const nn=se[4];nn!=null&&(d.za=nn,d.j.info("SVER="+d.za));const At=se[5];At!=null&&typeof At=="number"&&At>0&&(m=1.5*At,d.O=m,d.j.info("backChannelRequestTimeoutMs_="+m)),m=d;const bt=a.g;if(bt){const ei=bt.g?bt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(ei){var R=m.h;R.g||ei.indexOf("spdy")==-1&&ei.indexOf("quic")==-1&&ei.indexOf("h2")==-1||(R.j=R.l,R.g=new Set,R.h&&(Uo(R,R.h),R.h=null))}if(m.G){const Ko=bt.g?bt.g.getResponseHeader("X-HTTP-Session-Id"):null;Ko&&(m.wa=Ko,ie(m.J,m.G,Ko))}}d.I=3,d.l&&d.l.ra(),d.aa&&(d.T=Date.now()-a.F,d.j.info("Handshake RTT: "+d.T+"ms")),m=d;var N=a;if(m.na=qu(m,m.L?m.ba:null,m.W),N.L){yu(m.h,N);var Q=N,ge=m.O;ge&&(Q.H=ge),Q.D&&(Mo(Q),Ks(Q)),m.g=N}else Lu(m);d.i.length>0&&Ys(d)}else se[0]!="stop"&&se[0]!="close"||tn(d,7);else d.I==3&&(se[0]=="stop"||se[0]=="close"?se[0]=="stop"?tn(d,7):zo(d):se[0]!="noop"&&d.l&&d.l.qa(se),d.A=0)}}vr(4)}catch{}}var wp=class{constructor(a,l){this.g=a,this.map=l}};function pu(a){this.l=a||10,o.PerformanceNavigationTiming?(a=o.performance.getEntriesByType("navigation"),a=a.length>0&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(o.chrome&&o.chrome.loadTimes&&o.chrome.loadTimes()&&o.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,this.j>1&&(this.g=new Set),this.h=null,this.i=[]}function gu(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function _u(a){return a.h?1:a.g?a.g.size:0}function Fo(a,l){return a.h?a.h==l:a.g?a.g.has(l):!1}function Uo(a,l){a.g?a.g.add(l):a.h=l}function yu(a,l){a.h&&a.h==l?a.h=null:a.g&&a.g.has(l)&&a.g.delete(l)}pu.prototype.cancel=function(){if(this.i=Iu(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function Iu(a){if(a.h!=null)return a.i.concat(a.h.G);if(a.g!=null&&a.g.size!==0){let l=a.i;for(const d of a.g.values())l=l.concat(d.G);return l}return S(a.i)}var Tu=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function vp(a,l){if(a){a=a.split("&");for(let d=0;d<a.length;d++){const m=a[d].indexOf("=");let b,R=null;m>=0?(b=a[d].substring(0,m),R=a[d].substring(m+1)):b=a[d],l(b,R?decodeURIComponent(R.replace(/\+/g," ")):"")}}}function Et(a){this.g=this.o=this.j="",this.u=null,this.m=this.h="",this.l=!1;let l;a instanceof Et?(this.l=a.l,Pr(this,a.j),this.o=a.o,this.g=a.g,Cr(this,a.u),this.h=a.h,Bo(this,Ru(a.i)),this.m=a.m):a&&(l=String(a).match(Tu))?(this.l=!1,Pr(this,l[1]||"",!0),this.o=Vr(l[2]||""),this.g=Vr(l[3]||"",!0),Cr(this,l[4]),this.h=Vr(l[5]||"",!0),Bo(this,l[6]||"",!0),this.m=Vr(l[7]||"")):(this.l=!1,this.i=new Dr(null,this.l))}Et.prototype.toString=function(){const a=[];var l=this.j;l&&a.push(kr(l,Eu,!0),":");var d=this.g;return(d||l=="file")&&(a.push("//"),(l=this.o)&&a.push(kr(l,Eu,!0),"@"),a.push(Rr(d).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),d=this.u,d!=null&&a.push(":",String(d))),(d=this.h)&&(this.g&&d.charAt(0)!="/"&&a.push("/"),a.push(kr(d,d.charAt(0)=="/"?Rp:bp,!0))),(d=this.i.toString())&&a.push("?",d),(d=this.m)&&a.push("#",kr(d,Pp)),a.join("")},Et.prototype.resolve=function(a){const l=Ye(this);let d=!!a.j;d?Pr(l,a.j):d=!!a.o,d?l.o=a.o:d=!!a.g,d?l.g=a.g:d=a.u!=null;var m=a.h;if(d)Cr(l,a.u);else if(d=!!a.h){if(m.charAt(0)!="/")if(this.g&&!this.h)m="/"+m;else{var b=l.h.lastIndexOf("/");b!=-1&&(m=l.h.slice(0,b+1)+m)}if(b=m,b==".."||b==".")m="";else if(b.indexOf("./")!=-1||b.indexOf("/.")!=-1){m=b.lastIndexOf("/",0)==0,b=b.split("/");const R=[];for(let N=0;N<b.length;){const Q=b[N++];Q=="."?m&&N==b.length&&R.push(""):Q==".."?((R.length>1||R.length==1&&R[0]!="")&&R.pop(),m&&N==b.length&&R.push("")):(R.push(Q),m=!0)}m=R.join("/")}else m=b}return d?l.h=m:d=a.i.toString()!=="",d?Bo(l,Ru(a.i)):d=!!a.m,d&&(l.m=a.m),l};function Ye(a){return new Et(a)}function Pr(a,l,d){a.j=d?Vr(l,!0):l,a.j&&(a.j=a.j.replace(/:$/,""))}function Cr(a,l){if(l){if(l=Number(l),isNaN(l)||l<0)throw Error("Bad port number "+l);a.u=l}else a.u=null}function Bo(a,l,d){l instanceof Dr?(a.i=l,Cp(a.i,a.l)):(d||(l=kr(l,Sp)),a.i=new Dr(l,a.l))}function ie(a,l,d){a.i.set(l,d)}function Hs(a){return ie(a,"zx",Math.floor(Math.random()*2147483648).toString(36)+Math.abs(Math.floor(Math.random()*2147483648)^Date.now()).toString(36)),a}function Vr(a,l){return a?l?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function kr(a,l,d){return typeof a=="string"?(a=encodeURI(a).replace(l,Ap),d&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function Ap(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Eu=/[#\/\?@]/g,bp=/[#\?:]/g,Rp=/[#\?]/g,Sp=/[#\?@]/g,Pp=/#/g;function Dr(a,l){this.h=this.g=null,this.i=a||null,this.j=!!l}function en(a){a.g||(a.g=new Map,a.h=0,a.i&&vp(a.i,function(l,d){a.add(decodeURIComponent(l.replace(/\+/g," ")),d)}))}r=Dr.prototype,r.add=function(a,l){en(this),this.i=null,a=Dn(this,a);let d=this.g.get(a);return d||this.g.set(a,d=[]),d.push(l),this.h+=1,this};function wu(a,l){en(a),l=Dn(a,l),a.g.has(l)&&(a.i=null,a.h-=a.g.get(l).length,a.g.delete(l))}function vu(a,l){return en(a),l=Dn(a,l),a.g.has(l)}r.forEach=function(a,l){en(this),this.g.forEach(function(d,m){d.forEach(function(b){a.call(l,b,m,this)},this)},this)};function Au(a,l){en(a);let d=[];if(typeof l=="string")vu(a,l)&&(d=d.concat(a.g.get(Dn(a,l))));else for(a=Array.from(a.g.values()),l=0;l<a.length;l++)d=d.concat(a[l]);return d}r.set=function(a,l){return en(this),this.i=null,a=Dn(this,a),vu(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[l]),this.h+=1,this},r.get=function(a,l){return a?(a=Au(this,a),a.length>0?String(a[0]):l):l};function bu(a,l,d){wu(a,l),d.length>0&&(a.i=null,a.g.set(Dn(a,l),S(d)),a.h+=d.length)}r.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],l=Array.from(this.g.keys());for(let m=0;m<l.length;m++){var d=l[m];const b=Rr(d);d=Au(this,d);for(let R=0;R<d.length;R++){let N=b;d[R]!==""&&(N+="="+Rr(d[R])),a.push(N)}}return this.i=a.join("&")};function Ru(a){const l=new Dr;return l.i=a.i,a.g&&(l.g=new Map(a.g),l.h=a.h),l}function Dn(a,l){return l=String(l),a.j&&(l=l.toLowerCase()),l}function Cp(a,l){l&&!a.j&&(en(a),a.i=null,a.g.forEach(function(d,m){const b=m.toLowerCase();m!=b&&(wu(this,m),bu(this,b,d))},a)),a.j=l}function Vp(a,l){const d=new br;if(o.Image){const m=new Image;m.onload=f(wt,d,"TestLoadImage: loaded",!0,l,m),m.onerror=f(wt,d,"TestLoadImage: error",!1,l,m),m.onabort=f(wt,d,"TestLoadImage: abort",!1,l,m),m.ontimeout=f(wt,d,"TestLoadImage: timeout",!1,l,m),o.setTimeout(function(){m.ontimeout&&m.ontimeout()},1e4),m.src=a}else l(!1)}function kp(a,l){const d=new br,m=new AbortController,b=setTimeout(()=>{m.abort(),wt(d,"TestPingServer: timeout",!1,l)},1e4);fetch(a,{signal:m.signal}).then(R=>{clearTimeout(b),R.ok?wt(d,"TestPingServer: ok",!0,l):wt(d,"TestPingServer: server error",!1,l)}).catch(()=>{clearTimeout(b),wt(d,"TestPingServer: error",!1,l)})}function wt(a,l,d,m,b){try{b&&(b.onload=null,b.onerror=null,b.onabort=null,b.ontimeout=null),m(d)}catch{}}function Dp(){this.g=new mp}function jo(a){this.i=a.Sb||null,this.h=a.ab||!1}p(jo,nu),jo.prototype.g=function(){return new Ws(this.i,this.h)};function Ws(a,l){Pe.call(this),this.H=a,this.o=l,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.A=new Headers,this.h=null,this.F="GET",this.D="",this.g=!1,this.B=this.j=this.l=null,this.v=new AbortController}p(Ws,Pe),r=Ws.prototype,r.open=function(a,l){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.F=a,this.D=l,this.readyState=1,Nr(this)},r.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");if(this.v.signal.aborted)throw this.abort(),Error("Request was aborted.");this.g=!0;const l={headers:this.A,method:this.F,credentials:this.m,cache:void 0,signal:this.v.signal};a&&(l.body=a),(this.H||o).fetch(new Request(this.D,l)).then(this.Pa.bind(this),this.ga.bind(this))},r.abort=function(){this.response=this.responseText="",this.A=new Headers,this.status=0,this.v.abort(),this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),this.readyState>=1&&this.g&&this.readyState!=4&&(this.g=!1,xr(this)),this.readyState=0},r.Pa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Nr(this)),this.g&&(this.readyState=3,Nr(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Na.bind(this),this.ga.bind(this));else if(typeof o.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.B=new TextDecoder;Su(this)}else a.text().then(this.Oa.bind(this),this.ga.bind(this))};function Su(a){a.j.read().then(a.Ma.bind(a)).catch(a.ga.bind(a))}r.Ma=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var l=a.value?a.value:new Uint8Array(0);(l=this.B.decode(l,{stream:!a.done}))&&(this.response=this.responseText+=l)}a.done?xr(this):Nr(this),this.readyState==3&&Su(this)}},r.Oa=function(a){this.g&&(this.response=this.responseText=a,xr(this))},r.Na=function(a){this.g&&(this.response=a,xr(this))},r.ga=function(){this.g&&xr(this)};function xr(a){a.readyState=4,a.l=null,a.j=null,a.B=null,Nr(a)}r.setRequestHeader=function(a,l){this.A.append(a,l)},r.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},r.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],l=this.h.entries();for(var d=l.next();!d.done;)d=d.value,a.push(d[0]+": "+d[1]),d=l.next();return a.join(`\r
`)};function Nr(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(Ws.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function Pu(a){let l="";return js(a,function(d,m){l+=m,l+=":",l+=d,l+=`\r
`}),l}function qo(a,l,d){e:{for(m in d){var m=!1;break e}m=!0}m||(d=Pu(d),typeof a=="string"?d!=null&&Rr(d):ie(a,l,d))}function ue(a){Pe.call(this),this.headers=new Map,this.L=a||null,this.h=!1,this.g=null,this.D="",this.o=0,this.l="",this.j=this.B=this.v=this.A=!1,this.m=null,this.F="",this.H=!1}p(ue,Pe);var xp=/^https?$/i,Np=["POST","PUT"];r=ue.prototype,r.Fa=function(a){this.H=a},r.ea=function(a,l,d,m){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);l=l?l.toUpperCase():"GET",this.D=a,this.l="",this.o=0,this.A=!1,this.h=!0,this.g=this.L?this.L.g():uu.g(),this.g.onreadystatechange=w(h(this.Ca,this));try{this.B=!0,this.g.open(l,String(a),!0),this.B=!1}catch(R){Cu(this,R);return}if(a=d||"",d=new Map(this.headers),m)if(Object.getPrototypeOf(m)===Object.prototype)for(var b in m)d.set(b,m[b]);else if(typeof m.keys=="function"&&typeof m.get=="function")for(const R of m.keys())d.set(R,m.get(R));else throw Error("Unknown input type for opt_headers: "+String(m));m=Array.from(d.keys()).find(R=>R.toLowerCase()=="content-type"),b=o.FormData&&a instanceof o.FormData,!(Array.prototype.indexOf.call(Np,l,void 0)>=0)||m||b||d.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,N]of d)this.g.setRequestHeader(R,N);this.F&&(this.g.responseType=this.F),"withCredentials"in this.g&&this.g.withCredentials!==this.H&&(this.g.withCredentials=this.H);try{this.m&&(clearTimeout(this.m),this.m=null),this.v=!0,this.g.send(a),this.v=!1}catch(R){Cu(this,R)}};function Cu(a,l){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=l,a.o=5,Vu(a),Qs(a)}function Vu(a){a.A||(a.A=!0,xe(a,"complete"),xe(a,"error"))}r.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.o=a||7,xe(this,"complete"),xe(this,"abort"),Qs(this))},r.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),Qs(this,!0)),ue.Z.N.call(this)},r.Ca=function(){this.u||(this.B||this.v||this.j?ku(this):this.Xa())},r.Xa=function(){ku(this)};function ku(a){if(a.h&&typeof i<"u"){if(a.v&&vt(a)==4)setTimeout(a.Ca.bind(a),0);else if(xe(a,"readystatechange"),vt(a)==4){a.h=!1;try{const R=a.ca();e:switch(R){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var l=!0;break e;default:l=!1}var d;if(!(d=l)){var m;if(m=R===0){let N=String(a.D).match(Tu)[1]||null;!N&&o.self&&o.self.location&&(N=o.self.location.protocol.slice(0,-1)),m=!xp.test(N?N.toLowerCase():"")}d=m}if(d)xe(a,"complete"),xe(a,"success");else{a.o=6;try{var b=vt(a)>2?a.g.statusText:""}catch{b=""}a.l=b+" ["+a.ca()+"]",Vu(a)}}finally{Qs(a)}}}}function Qs(a,l){if(a.g){a.m&&(clearTimeout(a.m),a.m=null);const d=a.g;a.g=null,l||xe(a,"ready");try{d.onreadystatechange=null}catch{}}}r.isActive=function(){return!!this.g};function vt(a){return a.g?a.g.readyState:0}r.ca=function(){try{return vt(this)>2?this.g.status:-1}catch{return-1}},r.la=function(){try{return this.g?this.g.responseText:""}catch{return""}},r.La=function(a){if(this.g){var l=this.g.responseText;return a&&l.indexOf(a)==0&&(l=l.substring(a.length)),fp(l)}};function Du(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.F){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function Op(a){const l={};a=(a.g&&vt(a)>=2&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let m=0;m<a.length;m++){if(I(a[m]))continue;var d=Ip(a[m]);const b=d[0];if(d=d[1],typeof d!="string")continue;d=d.trim();const R=l[b]||[];l[b]=R,R.push(d)}ap(l,function(m){return m.join(", ")})}r.ya=function(){return this.o},r.Ha=function(){return typeof this.l=="string"?this.l:String(this.l)};function Or(a,l,d){return d&&d.internalChannelParams&&d.internalChannelParams[a]||l}function xu(a){this.za=0,this.i=[],this.j=new br,this.ba=this.na=this.J=this.W=this.g=this.wa=this.G=this.H=this.u=this.U=this.o=null,this.Ya=this.V=0,this.Sa=Or("failFast",!1,a),this.F=this.C=this.v=this.m=this.l=null,this.X=!0,this.xa=this.K=-1,this.Y=this.A=this.D=0,this.Qa=Or("baseRetryDelayMs",5e3,a),this.Za=Or("retryDelaySeedMs",1e4,a),this.Ta=Or("forwardChannelMaxRetries",2,a),this.va=Or("forwardChannelRequestTimeoutMs",2e4,a),this.ma=a&&a.xmlHttpFactory||void 0,this.Ua=a&&a.Rb||void 0,this.Aa=a&&a.useFetchStreams||!1,this.O=void 0,this.L=a&&a.supportsCrossDomainXhr||!1,this.M="",this.h=new pu(a&&a.concurrentRequestLimit),this.Ba=new Dp,this.S=a&&a.fastHandshake||!1,this.R=a&&a.encodeInitMessageHeaders||!1,this.S&&this.R&&(this.R=!1),this.Ra=a&&a.Pb||!1,a&&a.ua&&this.j.ua(),a&&a.forceLongPolling&&(this.X=!1),this.aa=!this.S&&this.X&&a&&a.detectBufferingProxy||!1,this.ia=void 0,a&&a.longPollingTimeout&&a.longPollingTimeout>0&&(this.ia=a.longPollingTimeout),this.ta=void 0,this.T=0,this.P=!1,this.ja=this.B=null}r=xu.prototype,r.ka=8,r.I=1,r.connect=function(a,l,d,m){Ne(0),this.W=a,this.H=l||{},d&&m!==void 0&&(this.H.OSID=d,this.H.OAID=m),this.F=this.X,this.J=qu(this,null,this.W),Ys(this)};function zo(a){if(Nu(a),a.I==3){var l=a.V++,d=Ye(a.J);if(ie(d,"SID",a.M),ie(d,"RID",l),ie(d,"TYPE","terminate"),Mr(a,d),l=new Tt(a,a.j,l),l.M=2,l.A=Hs(Ye(d)),d=!1,o.navigator&&o.navigator.sendBeacon)try{d=o.navigator.sendBeacon(l.A.toString(),"")}catch{}!d&&o.Image&&(new Image().src=l.A,d=!0),d||(l.g=zu(l.j,null),l.g.ea(l.A)),l.F=Date.now(),Ks(l)}ju(a)}function Js(a){a.g&&(Go(a),a.g.cancel(),a.g=null)}function Nu(a){Js(a),a.v&&(o.clearTimeout(a.v),a.v=null),Xs(a),a.h.cancel(),a.m&&(typeof a.m=="number"&&o.clearTimeout(a.m),a.m=null)}function Ys(a){if(!gu(a.h)&&!a.m){a.m=!0;var l=a.Ea;q||g(),B||(q(),B=!0),_.add(l,a),a.D=0}}function Mp(a,l){return _u(a.h)>=a.h.j-(a.m?1:0)?!1:a.m?(a.i=l.G.concat(a.i),!0):a.I==1||a.I==2||a.D>=(a.Sa?0:a.Ta)?!1:(a.m=Ar(h(a.Ea,a,l),Bu(a,a.D)),a.D++,!0)}r.Ea=function(a){if(this.m)if(this.m=null,this.I==1){if(!a){this.V=Math.floor(Math.random()*1e5),a=this.V++;const b=new Tt(this,this.j,a);let R=this.o;if(this.U&&(R?(R=Kc(R),Wc(R,this.U)):R=this.U),this.u!==null||this.R||(b.J=R,R=null),this.S)e:{for(var l=0,d=0;d<this.i.length;d++){t:{var m=this.i[d];if("__data__"in m.map&&(m=m.map.__data__,typeof m=="string")){m=m.length;break t}m=void 0}if(m===void 0)break;if(l+=m,l>4096){l=d;break e}if(l===4096||d===this.i.length-1){l=d+1;break e}}l=1e3}else l=1e3;l=Mu(this,b,l),d=Ye(this.J),ie(d,"RID",a),ie(d,"CVER",22),this.G&&ie(d,"X-HTTP-Session-Id",this.G),Mr(this,d),R&&(this.R?l="headers="+Rr(Pu(R))+"&"+l:this.u&&qo(d,this.u,R)),Uo(this.h,b),this.Ra&&ie(d,"TYPE","init"),this.S?(ie(d,"$req",l),ie(d,"SID","null"),b.U=!0,Oo(b,d,null)):Oo(b,d,l),this.I=2}}else this.I==3&&(a?Ou(this,a):this.i.length==0||gu(this.h)||Ou(this))};function Ou(a,l){var d;l?d=l.l:d=a.V++;const m=Ye(a.J);ie(m,"SID",a.M),ie(m,"RID",d),ie(m,"AID",a.K),Mr(a,m),a.u&&a.o&&qo(m,a.u,a.o),d=new Tt(a,a.j,d,a.D+1),a.u===null&&(d.J=a.o),l&&(a.i=l.G.concat(a.i)),l=Mu(a,d,1e3),d.H=Math.round(a.va*.5)+Math.round(a.va*.5*Math.random()),Uo(a.h,d),Oo(d,m,l)}function Mr(a,l){a.H&&js(a.H,function(d,m){ie(l,m,d)}),a.l&&js({},function(d,m){ie(l,m,d)})}function Mu(a,l,d){d=Math.min(a.i.length,d);const m=a.l?h(a.l.Ka,a.l,a):null;e:{var b=a.i;let Q=-1;for(;;){const ge=["count="+d];Q==-1?d>0?(Q=b[0].g,ge.push("ofs="+Q)):Q=0:ge.push("ofs="+Q);let se=!0;for(let Ee=0;Ee<d;Ee++){var R=b[Ee].g;const Xe=b[Ee].map;if(R-=Q,R<0)Q=Math.max(0,b[Ee].g-100),se=!1;else try{R="req"+R+"_"||"";try{var N=Xe instanceof Map?Xe:Object.entries(Xe);for(const[nn,At]of N){let bt=At;c(At)&&(bt=Vo(At)),ge.push(R+nn+"="+encodeURIComponent(bt))}}catch(nn){throw ge.push(R+"type="+encodeURIComponent("_badmap")),nn}}catch{m&&m(Xe)}}if(se){N=ge.join("&");break e}}N=void 0}return a=a.i.splice(0,d),l.G=a,N}function Lu(a){if(!a.g&&!a.v){a.Y=1;var l=a.Da;q||g(),B||(q(),B=!0),_.add(l,a),a.A=0}}function $o(a){return a.g||a.v||a.A>=3?!1:(a.Y++,a.v=Ar(h(a.Da,a),Bu(a,a.A)),a.A++,!0)}r.Da=function(){if(this.v=null,Fu(this),this.aa&&!(this.P||this.g==null||this.T<=0)){var a=4*this.T;this.j.info("BP detection timer enabled: "+a),this.B=Ar(h(this.Wa,this),a)}},r.Wa=function(){this.B&&(this.B=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.P=!0,Ne(10),Js(this),Fu(this))};function Go(a){a.B!=null&&(o.clearTimeout(a.B),a.B=null)}function Fu(a){a.g=new Tt(a,a.j,"rpc",a.Y),a.u===null&&(a.g.J=a.o),a.g.P=0;var l=Ye(a.na);ie(l,"RID","rpc"),ie(l,"SID",a.M),ie(l,"AID",a.K),ie(l,"CI",a.F?"0":"1"),!a.F&&a.ia&&ie(l,"TO",a.ia),ie(l,"TYPE","xmlhttp"),Mr(a,l),a.u&&a.o&&qo(l,a.u,a.o),a.O&&(a.g.H=a.O);var d=a.g;a=a.ba,d.M=1,d.A=Hs(Ye(l)),d.u=null,d.R=!0,du(d,a)}r.Va=function(){this.C!=null&&(this.C=null,Js(this),$o(this),Ne(19))};function Xs(a){a.C!=null&&(o.clearTimeout(a.C),a.C=null)}function Uu(a,l){var d=null;if(a.g==l){Xs(a),Go(a),a.g=null;var m=2}else if(Fo(a.h,l))d=l.G,yu(a.h,l),m=1;else return;if(a.I!=0){if(l.o)if(m==1){d=l.u?l.u.length:0,l=Date.now()-l.F;var b=a.D;m=$s(),xe(m,new au(m,d)),Ys(a)}else Lu(a);else if(b=l.m,b==3||b==0&&l.X>0||!(m==1&&Mp(a,l)||m==2&&$o(a)))switch(d&&d.length>0&&(l=a.h,l.i=l.i.concat(d)),b){case 1:tn(a,5);break;case 4:tn(a,10);break;case 3:tn(a,6);break;default:tn(a,2)}}}function Bu(a,l){let d=a.Qa+Math.floor(Math.random()*a.Za);return a.isActive()||(d*=2),d*l}function tn(a,l){if(a.j.info("Error code "+l),l==2){var d=h(a.bb,a),m=a.Ua;const b=!m;m=new Et(m||"//www.google.com/images/cleardot.gif"),o.location&&o.location.protocol=="http"||Pr(m,"https"),Hs(m),b?Vp(m.toString(),d):kp(m.toString(),d)}else Ne(2);a.I=0,a.l&&a.l.pa(l),ju(a),Nu(a)}r.bb=function(a){a?(this.j.info("Successfully pinged google.com"),Ne(2)):(this.j.info("Failed to ping google.com"),Ne(1))};function ju(a){if(a.I=0,a.ja=[],a.l){const l=Iu(a.h);(l.length!=0||a.i.length!=0)&&(C(a.ja,l),C(a.ja,a.i),a.h.i.length=0,S(a.i),a.i.length=0),a.l.oa()}}function qu(a,l,d){var m=d instanceof Et?Ye(d):new Et(d);if(m.g!="")l&&(m.g=l+"."+m.g),Cr(m,m.u);else{var b=o.location;m=b.protocol,l=l?l+"."+b.hostname:b.hostname,b=+b.port;const R=new Et(null);m&&Pr(R,m),l&&(R.g=l),b&&Cr(R,b),d&&(R.h=d),m=R}return d=a.G,l=a.wa,d&&l&&ie(m,d,l),ie(m,"VER",a.ka),Mr(a,m),m}function zu(a,l,d){if(l&&!a.L)throw Error("Can't create secondary domain capable XhrIo object.");return l=a.Aa&&!a.ma?new ue(new jo({ab:d})):new ue(a.ma),l.Fa(a.L),l}r.isActive=function(){return!!this.l&&this.l.isActive(this)};function $u(){}r=$u.prototype,r.ra=function(){},r.qa=function(){},r.pa=function(){},r.oa=function(){},r.isActive=function(){return!0},r.Ka=function(){};function Zs(){}Zs.prototype.g=function(a,l){return new Be(a,l)};function Be(a,l){Pe.call(this),this.g=new xu(l),this.l=a,this.h=l&&l.messageUrlParams||null,a=l&&l.messageHeaders||null,l&&l.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=l&&l.initMessageHeaders||null,l&&l.messageContentType&&(a?a["X-WebChannel-Content-Type"]=l.messageContentType:a={"X-WebChannel-Content-Type":l.messageContentType}),l&&l.sa&&(a?a["X-WebChannel-Client-Profile"]=l.sa:a={"X-WebChannel-Client-Profile":l.sa}),this.g.U=a,(a=l&&l.Qb)&&!I(a)&&(this.g.u=a),this.A=l&&l.supportsCrossDomainXhr||!1,this.v=l&&l.sendRawJson||!1,(l=l&&l.httpSessionIdParam)&&!I(l)&&(this.g.G=l,a=this.h,a!==null&&l in a&&(a=this.h,l in a&&delete a[l])),this.j=new xn(this)}p(Be,Pe),Be.prototype.m=function(){this.g.l=this.j,this.A&&(this.g.L=!0),this.g.connect(this.l,this.h||void 0)},Be.prototype.close=function(){zo(this.g)},Be.prototype.o=function(a){var l=this.g;if(typeof a=="string"){var d={};d.__data__=a,a=d}else this.v&&(d={},d.__data__=Vo(a),a=d);l.i.push(new wp(l.Ya++,a)),l.I==3&&Ys(l)},Be.prototype.N=function(){this.g.l=null,delete this.j,zo(this.g),delete this.g,Be.Z.N.call(this)};function Gu(a){ko.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var l=a.__sm__;if(l){e:{for(const d in l){a=d;break e}a=void 0}(this.i=a)&&(a=this.i,l=l!==null&&a in l?l[a]:void 0),this.data=l}else this.data=a}p(Gu,ko);function Ku(){Do.call(this),this.status=1}p(Ku,Do);function xn(a){this.g=a}p(xn,$u),xn.prototype.ra=function(){xe(this.g,"a")},xn.prototype.qa=function(a){xe(this.g,new Gu(a))},xn.prototype.pa=function(a){xe(this.g,new Ku)},xn.prototype.oa=function(){xe(this.g,"b")},Zs.prototype.createWebChannel=Zs.prototype.g,Be.prototype.send=Be.prototype.o,Be.prototype.open=Be.prototype.m,Be.prototype.close=Be.prototype.close,Jd=function(){return new Zs},Qd=function(){return $s()},Wd=Xt,ya={jb:0,mb:1,nb:2,Hb:3,Mb:4,Jb:5,Kb:6,Ib:7,Gb:8,Lb:9,PROXY:10,NOPROXY:11,Eb:12,Ab:13,Bb:14,zb:15,Cb:16,Db:17,fb:18,eb:19,gb:20},Gs.NO_ERROR=0,Gs.TIMEOUT=8,Gs.HTTP_ERROR=6,_i=Gs,cu.COMPLETE="complete",Hd=cu,ru.EventType=wr,wr.OPEN="a",wr.CLOSE="b",wr.ERROR="c",wr.MESSAGE="d",Pe.prototype.listen=Pe.prototype.J,Gr=ru,ue.prototype.listenOnce=ue.prototype.K,ue.prototype.getLastError=ue.prototype.Ha,ue.prototype.getLastErrorCode=ue.prototype.ya,ue.prototype.getStatus=ue.prototype.ca,ue.prototype.getResponseJson=ue.prototype.La,ue.prototype.getResponseText=ue.prototype.la,ue.prototype.send=ue.prototype.ea,ue.prototype.setWithCredentials=ue.prototype.Fa,Kd=ue}).apply(typeof ri<"u"?ri:typeof self<"u"?self:typeof window<"u"?window:{});/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const In=new Ga("@firebase/firestore");function Bn(){return In.logLevel}function V(r,...e){if(In.logLevel<=Y.DEBUG){const t=e.map(nc);In.debug(`Firestore (${gr}): ${r}`,...t)}}function Me(r,...e){if(In.logLevel<=Y.ERROR){const t=e.map(nc);In.error(`Firestore (${gr}): ${r}`,...t)}}function Tn(r,...e){if(In.logLevel<=Y.WARN){const t=e.map(nc);In.warn(`Firestore (${gr}): ${r}`,...t)}}function nc(r){if(typeof r=="string")return r;try{return(function(t){return JSON.stringify(t)})(r)}catch{return r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function me(r,e){const t={typeString:r};return e&&(t.value=e),t}function ks(r,e){if(!tf(r))throw new D(P.INVALID_ARGUMENT,"JSON must be an object");let t;for(const n in e)if(e[n]){const s=e[n].typeString,i="value"in e[n]?{value:e[n].value}:void 0;if(!(n in r)){t=`JSON missing required field: '${n}'`;break}const o=r[n];if(s&&typeof o!==s){t=`JSON field '${n}' must be a ${s}.`;break}if(i!==void 0&&o!==i.value){t=`Expected '${n}' field to equal '${i.value}'`;break}}if(t)throw new D(P.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cs=-1;class Mi{constructor(e,t,n,s){this.indexId=e,this.collectionGroup=t,this.fields=n,this.indexState=s}}function Ta(r){return r.fields.find((e=>e.kind===2))}function on(r){return r.fields.filter((e=>e.kind!==2))}Mi.UNKNOWN_ID=-1;class yi{constructor(e,t){this.fieldPath=e,this.kind=t}}class us{constructor(e,t){this.sequenceNumber=e,this.offset=t}static empty(){return new us(0,ze.min())}}function nT(r,e){const t=r.toTimestamp().seconds,n=r.toTimestamp().nanoseconds+1,s=j.fromTimestamp(n===1e9?new te(t+1,0):new te(t,n));return new ze(s,M.empty(),e)}function nf(r){return new ze(r.readTime,r.key,cs)}class ze{constructor(e,t,n){this.readTime=e,this.documentKey=t,this.largestBatchId=n}static min(){return new ze(j.min(),M.empty(),cs)}static max(){return new ze(j.max(),M.empty(),cs)}}function sc(r,e){let t=r.readTime.compareTo(e.readTime);return t!==0?t:(t=M.comparator(r.documentKey,e.documentKey),t!==0?t:G(r.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fn=-1;function ro(r){return r==null}function ls(r){return r===0&&1/r==-1/0}function aT(r){return typeof r=="number"&&Number.isInteger(r)&&!ls(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const an="remoteDocuments",Ds="owner",Nn="owner",hs="mutationQueues",uT="userId",We="mutations",Dl="batchId",dn="userMutationsIndex",xl=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ii(r,e){return[r,De(e)]}function af(r,e,t){return[r,De(e),t]}const lT={},er="documentMutations",Fi="remoteDocumentsV14",hT=["prefixPath","collectionGroup","readTime","documentId"],Ti="documentKeyIndex",dT=["prefixPath","collectionGroup","documentId"],cf="collectionGroupIndex",fT=["collectionGroup","readTime","prefixPath","documentId"],ds="remoteDocumentGlobal",Ea="remoteDocumentGlobalKey",tr="targets",uf="queryTargetsIndex",mT=["canonicalId","targetId"],nr="targetDocuments",pT=["targetId","path"],oc="documentTargetsIndex",gT=["path","targetId"],Ui="targetGlobalKey",mn="targetGlobal",fs="collectionParents",_T=["collectionId","parent"],rr="clientMetadata",yT="clientId",so="bundles",IT="bundleId",io="namedQueries",TT="name",ac="indexConfiguration",ET="indexId",wa="collectionGroupIndex",wT="collectionGroup",Zr="indexState",vT=["indexId","uid"],lf="sequenceNumberIndex",AT=["uid","sequenceNumber"],es="indexEntries",bT=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],hf="documentKeyIndex",RT=["indexId","uid","orderedDocumentKey"],oo="documentOverlays",ST=["userId","collectionPath","documentId"],va="collectionPathOverlayIndex",PT=["userId","collectionPath","largestBatchId"],df="collectionGroupOverlayIndex",CT=["userId","collectionGroup","largestBatchId"],cc="globals",VT="name",ff=[hs,We,er,an,tr,Ds,mn,nr,rr,ds,fs,so,io],kT=[...ff,oo],mf=[hs,We,er,Fi,tr,Ds,mn,nr,rr,ds,fs,so,io,oo],pf=mf,uc=[...pf,ac,Zr,es],DT=uc,gf=[...uc,cc],xT=gf;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Aa extends sf{constructor(e,t){super(),this.le=e,this.currentSequenceNumber=t}}function Te(r,e){const t=K(r);return zt.O(t.le,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const If="server_timestamp",Tf="__type__",Ef="__previous_value__",wf="__local_write_time__";function lc(r){return(r?.mapValue?.fields||{})[Tf]?.stringValue===If}function ao(r){const e=r.mapValue.fields[Ef];return lc(e)?ao(e):e}function ms(r){const e=pt(r.mapValue.fields[wf].timestampValue);return new te(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke{constructor(e){this.value=e}static empty(){return new ke({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!vi(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=ts(t)}setAll(e){let t=ce.emptyPath(),n={},s=[];e.forEach(((o,c)=>{if(!t.isImmediateParentOf(c)){const u=this.getFieldsMap(t);this.applyChanges(u,n,s),n={},s=[],t=c.popLast()}o?n[c.lastSegment()]=ts(o):s.push(c.lastSegment())}));const i=this.getFieldsMap(t);this.applyChanges(i,n,s)}delete(e){const t=this.field(e.popLast());vi(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return it(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let s=t.mapValue.fields[e.get(n)];vi(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,n){Yt(t,((s,i)=>e[s]=i));for(const s of n)delete e[s]}clone(){return new ke(ts(this.value))}}function Rf(r){const e=[];return Yt(r.fields,((t,n)=>{const s=new ce([t]);if(vi(n)){const i=Rf(n.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)})),new Fe(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KT{constructor(e,t=null,n=[],s=[],i=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=n,this.filters=s,this.limit=i,this.startAt=o,this.endAt=c,this.Te=null}}function Ca(r,e=null,t=[],n=[],s=null,i=null,o=null){return new KT(r,e,t,n,s,i,o)}function wn(r){const e=K(r);if(e.Te===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map((n=>Pa(n))).join(","),t+="|ob:",t+=e.orderBy.map((n=>(function(i){return i.field.canonicalString()+i.dir})(n))).join(","),ro(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map((n=>ir(n))).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map((n=>ir(n))).join(",")),e.Te=t}return e.Te}function xs(r,e){if(r.limit!==e.limit||r.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<r.orderBy.length;t++)if(!UT(r.orderBy[t],e.orderBy[t]))return!1;if(r.filters.length!==e.filters.length)return!1;for(let t=0;t<r.filters.length;t++)if(!Cf(r.filters[t],e.filters[t]))return!1;return r.collectionGroup===e.collectionGroup&&!!r.path.isEqual(e.path)&&!!zl(r.startAt,e.startAt)&&zl(r.endAt,e.endAt)}function Bi(r){return M.isDocumentKey(r.path)&&r.collectionGroup===null&&r.filters.length===0}function ji(r,e){return r.filters.filter((t=>t instanceof X&&t.field.isEqual(e)))}function $l(r,e,t){let n=Ei,s=!0;for(const i of ji(r,e)){let o=Ei,c=!0;switch(i.op){case"<":case"<=":o=LT(i.value);break;case"==":case"in":case">=":o=i.value;break;case">":o=i.value,c=!1;break;case"!=":case"not-in":o=Ei}Bl({value:n,inclusive:s},{value:o,inclusive:c})<0&&(n=o,s=c)}if(t!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(e)){const o=t.position[i];Bl({value:n,inclusive:s},{value:o,inclusive:t.inclusive})<0&&(n=o,s=t.inclusive);break}}return{value:n,inclusive:s}}function Gl(r,e,t){let n=Mt,s=!0;for(const i of ji(r,e)){let o=Mt,c=!0;switch(i.op){case">=":case">":o=FT(i.value),c=!1;break;case"==":case"in":case"<=":o=i.value;break;case"<":o=i.value,c=!1;break;case"!=":case"not-in":o=Mt}jl({value:n,inclusive:s},{value:o,inclusive:c})>0&&(n=o,s=c)}if(t!==null){for(let i=0;i<r.orderBy.length;++i)if(r.orderBy[i].field.isEqual(e)){const o=t.position[i];jl({value:n,inclusive:s},{value:o,inclusive:t.inclusive})>0&&(n=o,s=t.inclusive);break}}return{value:n,inclusive:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mc(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ls(e)?"-0":e}}function Bf(r){return{integerValue:""+r}}function sE(r,e){return aT(e)?Bf(e):mc(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ho{constructor(){this._=void 0}}function iE(r,e,t){return r instanceof Ts?(function(s,i){const o={fields:{[Tf]:{stringValue:If},[wf]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&lc(i)&&(i=ao(i)),i&&(o.fields[Ef]=i),{mapValue:o}})(t,e):r instanceof cr?qf(r,e):r instanceof ur?zf(r,e):(function(s,i){const o=jf(s,i),c=Hl(o)+Hl(s.Ae);return Ra(o)&&Ra(s.Ae)?Bf(c):mc(s.serializer,c)})(r,e)}function oE(r,e,t){return r instanceof cr?qf(r,e):r instanceof ur?zf(r,e):t}function jf(r,e){return r instanceof Es?(function(n){return Ra(n)||(function(i){return!!i&&"doubleValue"in i})(n)})(e)?e:{integerValue:0}:null}class Ts extends ho{}class cr extends ho{constructor(e){super(),this.elements=e}}function qf(r,e){const t=$f(e);for(const n of r.elements)t.some((s=>it(s,n)))||t.push(n);return{arrayValue:{values:t}}}class ur extends ho{constructor(e){super(),this.elements=e}}function zf(r,e){let t=$f(e);for(const n of r.elements)t=t.filter((s=>!it(s,n)));return{arrayValue:{values:t}}}class Es extends ho{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function Hl(r){return oe(r.integerValue||r.doubleValue)}function $f(r){return ys(r)&&r.arrayValue.values?r.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mo{constructor(e,t,n,s,i){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=n,this.documentUpdates=s,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(e,t,n){const s=new Map;return s.set(e,Os.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new mo(j.min(),s,new ae(G),qe(),J())}}class Os{constructor(e,t,n,s,i){this.resumeToken=e,this.current=t,this.addedDocuments=n,this.modifiedDocuments=s,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(e,t,n){return new Os(n,t,J(),J(),J())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class um{constructor(e){this.yt=e}}function VE(r,e){let t;if(e.document)t=wE(r.yt,e.document,!!e.hasCommittedMutations);else if(e.noDocument){const n=M.fromSegments(e.noDocument.path),s=An(e.noDocument.readTime);t=le.newNoDocument(n,s),e.hasCommittedMutations&&t.setHasCommittedMutations()}else{if(!e.unknownDocument)return L(56709);{const n=M.fromSegments(e.unknownDocument.path),s=An(e.unknownDocument.version);t=le.newUnknownDocument(n,s)}}return e.readTime&&t.setReadTime((function(s){const i=new te(s[0],s[1]);return j.fromTimestamp(i)})(e.readTime)),t}function nh(r,e){const t=e.key,n={prefixPath:t.getCollectionPath().popLast().toArray(),collectionGroup:t.collectionGroup,documentId:t.path.lastSegment(),readTime:$i(e.readTime),hasCommittedMutations:e.hasCommittedMutations};if(e.isFoundDocument())n.document=(function(i,o){return{name:qi(i,o.key),fields:o.data.value.mapValue.fields,updateTime:lr(i,o.version.toTimestamp()),createTime:lr(i,o.createTime.toTimestamp())}})(r.yt,e);else if(e.isNoDocument())n.noDocument={path:t.path.toArray(),readTime:vn(e.version)};else{if(!e.isUnknownDocument())return L(57904,{document:e});n.unknownDocument={path:t.path.toArray(),version:vn(e.version)}}return n}function $i(r){const e=r.toTimestamp();return[e.seconds,e.nanoseconds]}function vn(r){const e=r.toTimestamp();return{seconds:e.seconds,nanoseconds:e.nanoseconds}}function An(r){const e=new te(r.seconds,r.nanoseconds);return j.fromTimestamp(e)}function un(r,e){const t=(e.baseMutations||[]).map((i=>Oa(r.yt,i)));for(let i=0;i<e.mutations.length-1;++i){const o=e.mutations[i];if(i+1<e.mutations.length&&e.mutations[i+1].transform!==void 0){const c=e.mutations[i+1];o.updateTransforms=c.transform.fieldTransforms,e.mutations.splice(i+1,1),++i}}const n=e.mutations.map((i=>Oa(r.yt,i))),s=te.fromMillis(e.localWriteTimeMs);return new gc(e.batchId,s,t,n)}function Wr(r){const e=An(r.readTime),t=r.lastLimboFreeSnapshotVersion!==void 0?An(r.lastLimboFreeSnapshotVersion):j.min();let n;return n=(function(i){return i.documents!==void 0})(r.query)?(function(i){const o=i.documents.length;return U(o===1,1966,{count:o}),He(uo(em(i.documents[0])))})(r.query):(function(i){return He(sm(i))})(r.query),new ut(n,r.targetId,"TargetPurposeListen",r.lastListenSequenceNumber,e,t,pe.fromBase64String(r.resumeToken))}function lm(r,e){const t=vn(e.snapshotVersion),n=vn(e.lastLimboFreeSnapshotVersion);let s;s=Bi(e.target)?nm(r.yt,e.target):rm(r.yt,e.target).ft;const i=e.resumeToken.toBase64();return{targetId:e.targetId,canonicalId:wn(e.target),readTime:t,resumeToken:i,lastListenSequenceNumber:e.sequenceNumber,lastLimboFreeSnapshotVersion:n,query:s}}function hm(r){const e=sm({parent:r.parent,structuredQuery:r.structuredQuery});return r.limitType==="LAST"?ka(e,e.limit,"L"):e}function ta(r,e){return new yc(e.largestBatchId,Oa(r.yt,e.overlayMutation))}function rh(r,e){const t=e.path.lastSegment();return[r,De(e.path.popLast()),t]}function sh(r,e,t,n){return{indexId:r,uid:e,sequenceNumber:t,readTime:vn(n.readTime),documentKey:De(n.documentKey.path),largestBatchId:n.largestBatchId}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class po{constructor(e,t){this.serializer=e,this.userId=t}static wt(e,t){const n=t.uid||"";return new po(e,n)}getOverlay(e,t){return Fr(e).get(rh(this.userId,t)).next((n=>n?ta(this.serializer,n):null))}getOverlays(e,t){const n=tt();return v.forEach(t,(s=>this.getOverlay(e,s).next((i=>{i!==null&&n.set(s,i)})))).next((()=>n))}saveOverlays(e,t,n){const s=[];return n.forEach(((i,o)=>{const c=new yc(t,o);s.push(this.St(e,c))})),v.waitFor(s)}removeOverlaysForBatchId(e,t,n){const s=new Set;t.forEach((o=>s.add(De(o.getCollectionPath()))));const i=[];return s.forEach((o=>{const c=IDBKeyRange.bound([this.userId,o,n],[this.userId,o,n+1],!1,!0);i.push(Fr(e).X(va,c))})),v.waitFor(i)}getOverlaysForCollection(e,t,n){const s=tt(),i=De(t),o=IDBKeyRange.bound([this.userId,i,n],[this.userId,i,Number.POSITIVE_INFINITY],!0);return Fr(e).J(va,o).next((c=>{for(const u of c){const h=ta(this.serializer,u);s.set(h.getKey(),h)}return s}))}getOverlaysForCollectionGroup(e,t,n,s){const i=tt();let o;const c=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,Number.POSITIVE_INFINITY],!0);return Fr(e).ee({index:df,range:c},((u,h,f)=>{const p=ta(this.serializer,h);i.size()<s||p.largestBatchId===o?(i.set(p.getKey(),p),o=p.largestBatchId):f.done()})).next((()=>i))}St(e,t){return Fr(e).put((function(s,i,o){const[c,u,h]=rh(i,o.mutation.key);return{userId:i,collectionPath:u,documentId:h,collectionGroup:o.mutation.key.getCollectionGroup(),largestBatchId:o.largestBatchId,overlayMutation:zi(s.yt,o.mutation)}})(this.serializer,this.userId,t))}}function Fr(r){return Te(r,oo)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DE{bt(e){return Te(e,cc)}getSessionToken(e){return this.bt(e).get("sessionToken").next((t=>{const n=t?.value;return n?pe.fromUint8Array(n):pe.EMPTY_BYTE_STRING}))}setSessionToken(e,t){return this.bt(e).put({name:"sessionToken",value:t.toUint8Array()})}}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dm(r){if(U(r instanceof X||r instanceof ne,20012),r instanceof X){if(r instanceof xf){const t=r.value.arrayValue?.values?.map((n=>X.create(r.field,"==",n)))||[];return ne.create(t,"or")}return r}const e=r.filters.map((t=>dm(t)));return ne.create(e,r.op)}function LE(r){if(r.getFilters().length===0)return[];const e=Fa(dm(r));return U(fm(e),7391),Ma(e)||La(e)?[e]:e.getFilters()}function Ma(r){return r instanceof X}function La(r){return r instanceof ne&&fc(r)}function fm(r){return Ma(r)||La(r)||(function(t){if(t instanceof ne&&Sa(t)){for(const n of t.getFilters())if(!Ma(n)&&!La(n))return!1;return!0}return!1})(r)}function Fa(r){if(U(r instanceof X||r instanceof ne,34018),r instanceof X)return r;if(r.filters.length===1)return Fa(r.filters[0]);const e=r.filters.map((n=>Fa(n)));let t=ne.create(e,r.op);return t=Gi(t),fm(t)?t:(U(t instanceof ne,64498),U(ar(t),40251),U(t.filters.length>1,57927),t.filters.reduce(((n,s)=>Ec(n,s))))}function Ec(r,e){let t;return U(r instanceof X||r instanceof ne,38388),U(e instanceof X||e instanceof ne,25473),t=r instanceof X?e instanceof X?(function(s,i){return ne.create([s,i],"and")})(r,e):hh(r,e):e instanceof X?hh(e,r):(function(s,i){if(U(s.filters.length>0&&i.filters.length>0,48005),ar(s)&&ar(i))return Vf(s,i.getFilters());const o=Sa(s)?s:i,c=Sa(s)?i:s,u=o.filters.map((h=>Ec(h,c)));return ne.create(u,"or")})(r,e),Gi(t)}function hh(r,e){if(ar(e))return Vf(e,r.getFilters());{const t=e.filters.map((n=>Ec(r,n)));return ne.create(t,"or")}}function Gi(r){if(U(r instanceof X||r instanceof ne,11850),r instanceof X)return r;const e=r.getFilters();if(e.length===1)return Gi(e[0]);if(Pf(r))return r;const t=e.map((s=>Gi(s))),n=[];return t.forEach((s=>{s instanceof X?n.push(s):s instanceof ne&&(s.op===r.op?n.push(...s.filters):n.push(s))})),n.length===1?n[0]:ne.create(n,r.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FE{constructor(){this.bn=new wc}addToCollectionParentIndex(e,t){return this.bn.add(t),v.resolve()}getCollectionParents(e,t){return v.resolve(this.bn.getEntries(t))}addFieldIndex(e,t){return v.resolve()}deleteFieldIndex(e,t){return v.resolve()}deleteAllFieldIndexes(e){return v.resolve()}createTargetIndexes(e,t){return v.resolve()}getDocumentsMatchingTarget(e,t){return v.resolve(null)}getIndexType(e,t){return v.resolve(0)}getFieldIndexes(e,t){return v.resolve([])}getNextCollectionGroupToUpdate(e){return v.resolve(null)}getMinOffset(e,t){return v.resolve(ze.min())}getMinOffsetFromCollectionGroup(e,t){return v.resolve(ze.min())}updateCollectionGroup(e,t,n){return v.resolve()}updateIndexEntries(e,t){return v.resolve()}}class wc{constructor(){this.index={}}add(e){const t=e.lastSegment(),n=e.popLast(),s=this.index[t]||new re(ee.comparator),i=!s.has(n);return this.index[t]=s.add(n),i}has(e){const t=e.lastSegment(),n=e.popLast(),s=this.index[t];return s&&s.has(n)}getEntries(e){return(this.index[e]||new re(ee.comparator)).toArray()}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class BE{constructor(e,t){this.referenceDelegate=e,this.serializer=t}allocateTargetId(e){return this.ur(e).next((t=>{const n=new bn(t.highestTargetId);return t.highestTargetId=n.next(),this.cr(e,t).next((()=>t.highestTargetId))}))}getLastRemoteSnapshotVersion(e){return this.ur(e).next((t=>j.fromTimestamp(new te(t.lastRemoteSnapshotVersion.seconds,t.lastRemoteSnapshotVersion.nanoseconds))))}getHighestSequenceNumber(e){return this.ur(e).next((t=>t.highestListenSequenceNumber))}setTargetsMetadata(e,t,n){return this.ur(e).next((s=>(s.highestListenSequenceNumber=t,n&&(s.lastRemoteSnapshotVersion=n.toTimestamp()),t>s.highestListenSequenceNumber&&(s.highestListenSequenceNumber=t),this.cr(e,s))))}addTargetData(e,t){return this.lr(e,t).next((()=>this.ur(e).next((n=>(n.targetCount+=1,this.hr(t,n),this.cr(e,n))))))}updateTargetData(e,t){return this.lr(e,t)}removeTargetData(e,t){return this.removeMatchingKeysForTargetId(e,t.targetId).next((()=>Un(e).delete(t.targetId))).next((()=>this.ur(e))).next((n=>(U(n.targetCount>0,8065),n.targetCount-=1,this.cr(e,n))))}removeTargets(e,t,n){let s=0;const i=[];return Un(e).ee(((o,c)=>{const u=Wr(c);u.sequenceNumber<=t&&n.get(u.targetId)===null&&(s++,i.push(this.removeTargetData(e,u)))})).next((()=>v.waitFor(i))).next((()=>s))}forEachTarget(e,t){return Un(e).ee(((n,s)=>{const i=Wr(s);t(i)}))}ur(e){return gh(e).get(Ui).next((t=>(U(t!==null,2888),t)))}cr(e,t){return gh(e).put(Ui,t)}lr(e,t){return Un(e).put(lm(this.serializer,t))}hr(e,t){let n=!1;return e.targetId>t.highestTargetId&&(t.highestTargetId=e.targetId,n=!0),e.sequenceNumber>t.highestListenSequenceNumber&&(t.highestListenSequenceNumber=e.sequenceNumber,n=!0),n}getTargetCount(e){return this.ur(e).next((t=>t.targetCount))}getTargetData(e,t){const n=wn(t),s=IDBKeyRange.bound([n,Number.NEGATIVE_INFINITY],[n,Number.POSITIVE_INFINITY]);let i=null;return Un(e).ee({range:s,index:uf},((o,c,u)=>{const h=Wr(c);xs(t,h.target)&&(i=h,u.done())})).next((()=>i))}addMatchingKeys(e,t,n){const s=[],i=Ot(e);return t.forEach((o=>{const c=De(o.path);s.push(i.put({targetId:n,path:c})),s.push(this.referenceDelegate.addReference(e,n,o))})),v.waitFor(s)}removeMatchingKeys(e,t,n){const s=Ot(e);return v.forEach(t,(i=>{const o=De(i.path);return v.waitFor([s.delete([n,o]),this.referenceDelegate.removeReference(e,n,i)])}))}removeMatchingKeysForTargetId(e,t){const n=Ot(e),s=IDBKeyRange.bound([t],[t+1],!1,!0);return n.delete(s)}getMatchingKeysForTargetId(e,t){const n=IDBKeyRange.bound([t],[t+1],!1,!0),s=Ot(e);let i=J();return s.ee({range:n,Y:!0},((o,c,u)=>{const h=et(o[1]),f=new M(h);i=i.add(f)})).next((()=>i))}containsKey(e,t){const n=De(t.path),s=IDBKeyRange.bound([n],[Zd(n)],!1,!0);let i=0;return Ot(e).ee({index:oc,Y:!0,range:s},(([o,c],u,h)=>{o!==0&&(i++,h.done())})).next((()=>i>0))}At(e,t){return Un(e).get(t).next((n=>n?Wr(n):null))}}function Un(r){return Te(r,tr)}function gh(r){return Te(r,mn)}function Ot(r){return Te(r,nr)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tw{constructor(e){this.serializer=e}k(e,t,n,s){const i=new no("createOrUpgrade",t);n<1&&s>=1&&((function(u){u.createObjectStore(Ds)})(e),(function(u){u.createObjectStore(hs,{keyPath:uT}),u.createObjectStore(We,{keyPath:Dl,autoIncrement:!0}).createIndex(dn,xl,{unique:!0}),u.createObjectStore(er)})(e),wh(e),(function(u){u.createObjectStore(an)})(e));let o=v.resolve();return n<3&&s>=3&&(n!==0&&((function(u){u.deleteObjectStore(nr),u.deleteObjectStore(tr),u.deleteObjectStore(mn)})(e),wh(e)),o=o.next((()=>(function(u){const h=u.store(mn),f={highestTargetId:0,highestListenSequenceNumber:0,lastRemoteSnapshotVersion:j.min().toTimestamp(),targetCount:0};return h.put(Ui,f)})(i)))),n<4&&s>=4&&(n!==0&&(o=o.next((()=>(function(u,h){return h.store(We).J().next((p=>{u.deleteObjectStore(We),u.createObjectStore(We,{keyPath:Dl,autoIncrement:!0}).createIndex(dn,xl,{unique:!0});const w=h.store(We),S=p.map((C=>w.put(C)));return v.waitFor(S)}))})(e,i)))),o=o.next((()=>{(function(u){u.createObjectStore(rr,{keyPath:yT})})(e)}))),n<5&&s>=5&&(o=o.next((()=>this.gi(i)))),n<6&&s>=6&&(o=o.next((()=>((function(u){u.createObjectStore(ds)})(e),this.pi(i))))),n<7&&s>=7&&(o=o.next((()=>this.yi(i)))),n<8&&s>=8&&(o=o.next((()=>this.wi(e,i)))),n<9&&s>=9&&(o=o.next((()=>{(function(u){u.objectStoreNames.contains("remoteDocumentChanges")&&u.deleteObjectStore("remoteDocumentChanges")})(e)}))),n<10&&s>=10&&(o=o.next((()=>this.Si(i)))),n<11&&s>=11&&(o=o.next((()=>{(function(u){u.createObjectStore(so,{keyPath:IT})})(e),(function(u){u.createObjectStore(io,{keyPath:TT})})(e)}))),n<12&&s>=12&&(o=o.next((()=>{(function(u){const h=u.createObjectStore(oo,{keyPath:ST});h.createIndex(va,PT,{unique:!1}),h.createIndex(df,CT,{unique:!1})})(e)}))),n<13&&s>=13&&(o=o.next((()=>(function(u){const h=u.createObjectStore(Fi,{keyPath:hT});h.createIndex(Ti,dT),h.createIndex(cf,fT)})(e))).next((()=>this.bi(e,i))).next((()=>e.deleteObjectStore(an)))),n<14&&s>=14&&(o=o.next((()=>this.Di(e,i)))),n<15&&s>=15&&(o=o.next((()=>(function(u){u.createObjectStore(ac,{keyPath:ET,autoIncrement:!0}).createIndex(wa,wT,{unique:!1}),u.createObjectStore(Zr,{keyPath:vT}).createIndex(lf,AT,{unique:!1}),u.createObjectStore(es,{keyPath:bT}).createIndex(hf,RT,{unique:!1})})(e)))),n<16&&s>=16&&(o=o.next((()=>{t.objectStore(Zr).clear()})).next((()=>{t.objectStore(es).clear()}))),n<17&&s>=17&&(o=o.next((()=>{(function(u){u.createObjectStore(cc,{keyPath:VT})})(e)}))),n<18&&s>=18&&ad()&&(o=o.next((()=>{t.objectStore(Zr).clear()})).next((()=>{t.objectStore(es).clear()}))),o}pi(e){let t=0;return e.store(an).ee(((n,s)=>{t+=Ki(s)})).next((()=>{const n={byteSize:t};return e.store(ds).put(Ea,n)}))}gi(e){const t=e.store(hs),n=e.store(We);return t.J().next((s=>v.forEach(s,(i=>{const o=IDBKeyRange.bound([i.userId,fn],[i.userId,i.lastAcknowledgedBatchId]);return n.J(dn,o).next((c=>v.forEach(c,(u=>{U(u.userId===i.userId,18650,"Cannot process batch from unexpected user",{batchId:u.batchId});const h=un(this.serializer,u);return pm(e,i.userId,h).next((()=>{}))}))))}))))}yi(e){const t=e.store(nr),n=e.store(an);return e.store(mn).get(Ui).next((s=>{const i=[];return n.ee(((o,c)=>{const u=new ee(o),h=(function(p){return[0,De(p)]})(u);i.push(t.get(h).next((f=>f?v.resolve():(p=>t.put({targetId:0,path:De(p),sequenceNumber:s.highestListenSequenceNumber}))(u))))})).next((()=>v.waitFor(i)))}))}wi(e,t){e.createObjectStore(fs,{keyPath:_T});const n=t.store(fs),s=new wc,i=o=>{if(s.add(o)){const c=o.lastSegment(),u=o.popLast();return n.put({collectionId:c,parent:De(u)})}};return t.store(an).ee({Y:!0},((o,c)=>{const u=new ee(o);return i(u.popLast())})).next((()=>t.store(er).ee({Y:!0},(([o,c,u],h)=>{const f=et(c);return i(f.popLast())}))))}Si(e){const t=e.store(tr);return t.ee(((n,s)=>{const i=Wr(s),o=lm(this.serializer,i);return t.put(o)}))}bi(e,t){const n=t.store(an),s=[];return n.ee(((i,o)=>{const c=t.store(Fi),u=(function(p){return p.document?new M(ee.fromString(p.document.name).popFirst(5)):p.noDocument?M.fromSegments(p.noDocument.path):p.unknownDocument?M.fromSegments(p.unknownDocument.path):L(36783)})(o).path.toArray(),h={prefixPath:u.slice(0,u.length-2),collectionGroup:u[u.length-2],documentId:u[u.length-1],readTime:o.readTime||[0,0],unknownDocument:o.unknownDocument,noDocument:o.noDocument,document:o.document,hasCommittedMutations:!!o.hasCommittedMutations};s.push(c.put(h))})).next((()=>v.waitFor(s)))}Di(e,t){const n=t.store(We),s=wm(this.serializer),i=new Ac(_o.Vi,this.serializer.yt);return n.J().next((o=>{const c=new Map;return o.forEach((u=>{let h=c.get(u.userId)??J();un(this.serializer,u).keys().forEach((f=>h=h.add(f))),c.set(u.userId,h)})),v.forEach(c,((u,h)=>{const f=new be(h),p=po.wt(this.serializer,f),w=i.getIndexManager(f),S=go.wt(f,this.serializer,w,i.referenceDelegate);return new vm(s,S,p,w).recalculateAndSaveOverlaysForDocumentKeys(new Aa(t,Ke.ce),u).next()}))}))}}function wh(r){r.createObjectStore(nr,{keyPath:pT}).createIndex(oc,gT,{unique:!0}),r.createObjectStore(tr,{keyPath:"targetId"}).createIndex(uf,mT,{unique:!0}),r.createObjectStore(mn)}const Ct="IndexedDbPersistence",na=18e5,ra=5e3,sa="Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.",nw="main";class bc{constructor(e,t,n,s,i,o,c,u,h,f,p=18){if(this.allowTabSynchronization=e,this.persistenceKey=t,this.clientId=n,this.Ci=i,this.window=o,this.document=c,this.Fi=h,this.Mi=f,this.xi=p,this.ai=null,this.ui=!1,this.isPrimary=!1,this.networkEnabled=!0,this.Oi=null,this.inForeground=!1,this.Ni=null,this.Bi=null,this.Li=Number.NEGATIVE_INFINITY,this.ki=w=>Promise.resolve(),!bc.v())throw new D(P.UNIMPLEMENTED,"This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");this.referenceDelegate=new zE(this,s),this.qi=t+nw,this.serializer=new um(u),this.Ki=new zt(this.qi,this.xi,new tw(this.serializer)),this.ci=new DE,this.li=new BE(this.referenceDelegate,this.serializer),this.remoteDocumentCache=wm(this.serializer),this.Pi=new kE,this.window&&this.window.localStorage?this.Ui=this.window.localStorage:(this.Ui=null,f===!1&&Me(Ct,"LocalStorage is unavailable. As a result, persistence may not work reliably. In particular enablePersistence() could fail immediately after refreshing the page."))}start(){return this.$i().then((()=>{if(!this.isPrimary&&!this.allowTabSynchronization)throw new D(P.FAILED_PRECONDITION,sa);return this.Wi(),this.Qi(),this.Gi(),this.runTransaction("getHighestListenSequenceNumber","readonly",(e=>this.li.getHighestSequenceNumber(e)))})).then((e=>{this.ai=new Ke(e,this.Fi)})).then((()=>{this.ui=!0})).catch((e=>(this.Ki&&this.Ki.close(),Promise.reject(e))))}zi(e){return this.ki=async t=>{if(this.started)return e(t)},e(this.isPrimary)}setDatabaseDeletedListener(e){this.Ki.K((async t=>{t.newVersion===null&&await e()}))}setNetworkEnabled(e){this.networkEnabled!==e&&(this.networkEnabled=e,this.Ci.enqueueAndForget((async()=>{this.started&&await this.$i()})))}$i(){return this.runTransaction("updateClientMetadataAndTryBecomePrimary","readwrite",(e=>ci(e).put({clientId:this.clientId,updateTimeMs:Date.now(),networkEnabled:this.networkEnabled,inForeground:this.inForeground}).next((()=>{if(this.isPrimary)return this.ji(e).next((t=>{t||(this.isPrimary=!1,this.Ci.enqueueRetryable((()=>this.ki(!1))))}))})).next((()=>this.Ji(e))).next((t=>this.isPrimary&&!t?this.Hi(e).next((()=>!1)):!!t&&this.Zi(e).next((()=>!0)))))).catch((e=>{if(Jt(e))return V(Ct,"Failed to extend owner lease: ",e),this.isPrimary;if(!this.allowTabSynchronization)throw e;return V(Ct,"Releasing owner lease after error during lease refresh",e),!1})).then((e=>{this.isPrimary!==e&&this.Ci.enqueueRetryable((()=>this.ki(e))),this.isPrimary=e}))}ji(e){return qr(e).get(Nn).next((t=>v.resolve(this.Xi(t))))}Yi(e){return ci(e).delete(this.clientId)}async es(){if(this.isPrimary&&!this.ts(this.Li,na)){this.Li=Date.now();const e=await this.runTransaction("maybeGarbageCollectMultiClientState","readwrite-primary",(t=>{const n=Te(t,rr);return n.J().next((s=>{const i=this.ns(s,na),o=s.filter((c=>i.indexOf(c)===-1));return v.forEach(o,(c=>n.delete(c.clientId))).next((()=>o))}))})).catch((()=>[]));if(this.Ui)for(const t of e)this.Ui.removeItem(this.rs(t.clientId))}}Gi(){this.Bi=this.Ci.enqueueAfterDelay("client_metadata_refresh",4e3,(()=>this.$i().then((()=>this.es())).then((()=>this.Gi()))))}Xi(e){return!!e&&e.ownerId===this.clientId}Ji(e){return this.Mi?v.resolve(!0):qr(e).get(Nn).next((t=>{if(t!==null&&this.ts(t.leaseTimestampMs,ra)&&!this.ss(t.ownerId)){if(this.Xi(t)&&this.networkEnabled)return!0;if(!this.Xi(t)){if(!t.allowTabSynchronization)throw new D(P.FAILED_PRECONDITION,sa);return!1}}return!(!this.networkEnabled||!this.inForeground)||ci(e).J().next((n=>this.ns(n,ra).find((s=>{if(this.clientId!==s.clientId){const i=!this.networkEnabled&&s.networkEnabled,o=!this.inForeground&&s.inForeground,c=this.networkEnabled===s.networkEnabled;if(i||o&&c)return!0}return!1}))===void 0))})).next((t=>(this.isPrimary!==t&&V(Ct,`Client ${t?"is":"is not"} eligible for a primary lease.`),t)))}async shutdown(){this.ui=!1,this._s(),this.Bi&&(this.Bi.cancel(),this.Bi=null),this.us(),this.cs(),await this.Ki.runTransaction("shutdown","readwrite",[Ds,rr],(e=>{const t=new Aa(e,Ke.ce);return this.Hi(t).next((()=>this.Yi(t)))})),this.Ki.close(),this.ls()}ns(e,t){return e.filter((n=>this.ts(n.updateTimeMs,t)&&!this.ss(n.clientId)))}hs(){return this.runTransaction("getActiveClients","readonly",(e=>ci(e).J().next((t=>this.ns(t,na).map((n=>n.clientId))))))}get started(){return this.ui}getGlobalsCache(){return this.ci}getMutationQueue(e,t){return go.wt(e,this.serializer,t,this.referenceDelegate)}getTargetCache(){return this.li}getRemoteDocumentCache(){return this.remoteDocumentCache}getIndexManager(e){return new UE(e,this.serializer.yt.databaseId)}getDocumentOverlayCache(e){return po.wt(this.serializer,e)}getBundleCache(){return this.Pi}runTransaction(e,t,n){V(Ct,"Starting transaction:",e);const s=t==="readonly"?"readonly":"readwrite",i=(function(u){return u===18?xT:u===17?gf:u===16?DT:u===15?uc:u===14?pf:u===13?mf:u===12?kT:u===11?ff:void L(60245)})(this.xi);let o;return this.Ki.runTransaction(e,s,i,(c=>(o=new Aa(c,this.ai?this.ai.next():Ke.ce),t==="readwrite-primary"?this.ji(o).next((u=>!!u||this.Ji(o))).next((u=>{if(!u)throw Me(`Failed to obtain primary lease for action '${e}'.`),this.isPrimary=!1,this.Ci.enqueueRetryable((()=>this.ki(!1))),new D(P.FAILED_PRECONDITION,rf);return n(o)})).next((u=>this.Zi(o).next((()=>u)))):this.Ps(o).next((()=>n(o)))))).then((c=>(o.raiseOnCommittedEvent(),c)))}Ps(e){return qr(e).get(Nn).next((t=>{if(t!==null&&this.ts(t.leaseTimestampMs,ra)&&!this.ss(t.ownerId)&&!this.Xi(t)&&!(this.Mi||this.allowTabSynchronization&&t.allowTabSynchronization))throw new D(P.FAILED_PRECONDITION,sa)}))}Zi(e){const t={ownerId:this.clientId,allowTabSynchronization:this.allowTabSynchronization,leaseTimestampMs:Date.now()};return qr(e).put(Nn,t)}static v(){return zt.v()}Hi(e){const t=qr(e);return t.get(Nn).next((n=>this.Xi(n)?(V(Ct,"Releasing primary lease."),t.delete(Nn)):v.resolve()))}ts(e,t){const n=Date.now();return!(e<n-t)&&(!(e>n)||(Me(`Detected an update time that is in the future: ${e} > ${n}`),!1))}Wi(){this.document!==null&&typeof this.document.addEventListener=="function"&&(this.Ni=()=>{this.Ci.enqueueAndForget((()=>(this.inForeground=this.document.visibilityState==="visible",this.$i())))},this.document.addEventListener("visibilitychange",this.Ni),this.inForeground=this.document.visibilityState==="visible")}us(){this.Ni&&(this.document.removeEventListener("visibilitychange",this.Ni),this.Ni=null)}Qi(){typeof this.window?.addEventListener=="function"&&(this.Oi=()=>{this._s();const e=/(?:Version|Mobile)\/1[456]/;od()&&(navigator.appVersion.match(e)||navigator.userAgent.match(e))&&this.Ci.enterRestrictedMode(!0),this.Ci.enqueueAndForget((()=>this.shutdown()))},this.window.addEventListener("pagehide",this.Oi))}cs(){this.Oi&&(this.window.removeEventListener("pagehide",this.Oi),this.Oi=null)}ss(e){try{const t=this.Ui?.getItem(this.rs(e))!==null;return V(Ct,`Client '${e}' ${t?"is":"is not"} zombied in LocalStorage`),t}catch(t){return Me(Ct,"Failed to get zombied client id.",t),!1}}_s(){if(this.Ui)try{this.Ui.setItem(this.rs(this.clientId),String(Date.now()))}catch(e){Me("Failed to set zombie client id.",e)}}ls(){if(this.Ui)try{this.Ui.removeItem(this.rs(this.clientId))}catch{}}rs(e){return`firestore_zombie_${this.persistenceKey}_${e}`}}function qr(r){return Te(r,Ds)}function ci(r){return Te(r,rr)}function rw(r,e){let t=r.projectId;return r.isDefaultDatabase||(t+="."+r.database),"firestore/"+e+"/"+t+"/"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rc{constructor(e,t,n,s){this.targetId=e,this.fromCache=t,this.Ts=n,this.Es=s}static Is(e,t){let n=J(),s=J();for(const i of t.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new Rc(e,t.fromCache,n,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ia="RestConnection",mw={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class pw{get qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Ko=t+"://"+e.host,this.Uo=`projects/${n}/databases/${s}`,this.$o=this.databaseId.database===ps?`project_id=${n}`:`project_id=${n}&database_id=${s}`}Wo(e,t,n,s,i){const o=Ba(),c=this.Qo(e,t.toUriEncodedString());V(ia,`Sending RPC '${e}' ${o}:`,c,n);const u={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(u,s,i);const{host:h}=new URL(c),f=fr(h);return this.zo(e,c,u,n,f).then((p=>(V(ia,`Received RPC '${e}' ${o}: `,p),p)),(p=>{throw Tn(ia,`RPC '${e}' ${o} failed with error: `,p,"url: ",c,"request:",n),p}))}jo(e,t,n,s,i,o){return this.Wo(e,t,n,s,i)}Go(e,t,n){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+gr})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((s,i)=>e[i]=s)),n&&n.headers.forEach(((s,i)=>e[i]=s))}Qo(e,t){const n=mw[e];let s=`${this.Ko}/v1/${t}:${n}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce="WebChannelConnection",zr=(r,e,t)=>{r.listen(e,(n=>{try{t(n)}catch(s){setTimeout((()=>{throw s}),0)}}))};class Qn extends pw{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!Qn.c_){const e=Qd();zr(e,Wd.STAT_EVENT,(t=>{t.stat===ya.PROXY?V(Ce,"STAT_EVENT: detected buffering proxy"):t.stat===ya.NOPROXY&&V(Ce,"STAT_EVENT: detected no buffering proxy")})),Qn.c_=!0}}zo(e,t,n,s,i){const o=Ba();return new Promise(((c,u)=>{const h=new Kd;h.setWithCredentials(!0),h.listenOnce(Hd.COMPLETE,(()=>{try{switch(h.getLastErrorCode()){case _i.NO_ERROR:const p=h.getResponseJson();V(Ce,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),c(p);break;case _i.TIMEOUT:V(Ce,`RPC '${e}' ${o} timed out`),u(new D(P.DEADLINE_EXCEEDED,"Request time out"));break;case _i.HTTP_ERROR:const w=h.getStatus();if(V(Ce,`RPC '${e}' ${o} failed with status:`,w,"response text:",h.getResponseText()),w>0){let S=h.getResponseJson();Array.isArray(S)&&(S=S[0]);const C=S?.error;if(C&&C.status&&C.message){const O=(function(W){const H=W.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(H)>=0?H:P.UNKNOWN})(C.status);u(new D(O,C.message))}else u(new D(P.UNKNOWN,"Server responded with status "+h.getStatus()))}else u(new D(P.UNAVAILABLE,"Connection failed."));break;default:L(9055,{l_:e,streamId:o,h_:h.getLastErrorCode(),P_:h.getLastError()})}}finally{V(Ce,`RPC '${e}' ${o} completed.`)}}));const f=JSON.stringify(s);V(Ce,`RPC '${e}' ${o} sending request:`,s),h.send(t,"POST",f,n,15)}))}T_(e,t,n){const s=Ba(),i=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=this.createWebChannelTransport(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.Go(c.initMessageHeaders,t,n),c.encodeInitMessageHeaders=!0;const h=i.join("");V(Ce,`Creating RPC '${e}' stream ${s}: ${h}`,c);const f=o.createWebChannel(h,c);this.E_(f);let p=!1,w=!1;const S=new gw({Jo:C=>{w?V(Ce,`Not sending because RPC '${e}' stream ${s} is closed:`,C):(p||(V(Ce,`Opening RPC '${e}' stream ${s} transport.`),f.open(),p=!0),V(Ce,`RPC '${e}' stream ${s} sending:`,C),f.send(C))},Ho:()=>f.close()});return zr(f,Gr.EventType.OPEN,(()=>{w||(V(Ce,`RPC '${e}' stream ${s} transport opened.`),S.i_())})),zr(f,Gr.EventType.CLOSE,(()=>{w||(w=!0,V(Ce,`RPC '${e}' stream ${s} transport closed`),S.o_(),this.I_(f))})),zr(f,Gr.EventType.ERROR,(C=>{w||(w=!0,Tn(Ce,`RPC '${e}' stream ${s} transport errored. Name:`,C.name,"Message:",C.message),S.o_(new D(P.UNAVAILABLE,"The operation could not be completed")))})),zr(f,Gr.EventType.MESSAGE,(C=>{if(!w){const O=C.data[0];U(!!O,16349);const x=O,W=x?.error||x[0]?.error;if(W){V(Ce,`RPC '${e}' stream ${s} received error:`,W);const H=W.status;let z=(function(B){const _=fe[B];if(_!==void 0)return Wf(_)})(H),F=W.message;H==="NOT_FOUND"&&F.includes("database")&&F.includes("does not exist")&&F.includes(this.databaseId.database)&&Tn(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),z===void 0&&(z=P.INTERNAL,F="Unknown error status: "+H+" with message "+W.message),w=!0,S.o_(new D(z,F)),f.close()}else V(Ce,`RPC '${e}' stream ${s} received:`,O),S.__(O)}})),Qn.u_(),setTimeout((()=>{S.s_()}),0),S}terminate(){this.a_.forEach((e=>e.close())),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter((t=>t===e))}Go(e,t,n){super.Go(e,t,n),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return Jd()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rn="RemoteStore";class bw{constructor(e,t,n,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ea=new Map,this.Ia=new Set,this.Ra=[],this.Aa=i,this.Aa.Mo((o=>{n.enqueueAndForget((async()=>{Cn(this)&&(V(Rn,"Restarting streams for network reachability change."),await(async function(u){const h=K(u);h.Ia.add(4),await Ms(h),h.Va.set("Unknown"),h.Ia.delete(4),await Io(h)})(this))}))})),this.Va=new Aw(n,s)}}async function Io(r){if(Cn(r))for(const e of r.Ra)await e(!0)}async function Ms(r){for(const e of r.Ra)await e(!1)}function km(r,e){const t=K(r);t.Ea.has(e.targetId)||(t.Ea.set(e.targetId,e),kc(t)?Vc(t):Ir(t).O_()&&Cc(t,e))}function Pc(r,e){const t=K(r),n=Ir(t);t.Ea.delete(e),n.O_()&&Dm(t,e),t.Ea.size===0&&(n.O_()?n.L_():Cn(t)&&t.Va.set("Unknown"))}function Cc(r,e){if(r.da.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(j.min())>0){const t=r.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Ir(r).Z_(e)}function Dm(r,e){r.da.$e(e),Ir(r).X_(e)}function Vc(r){r.da=new gE({getRemoteKeysForTarget:e=>r.remoteSyncer.getRemoteKeysForTarget(e),At:e=>r.Ea.get(e)||null,ht:()=>r.datastore.serializer.databaseId}),Ir(r).start(),r.Va.ua()}function kc(r){return Cn(r)&&!Ir(r).x_()&&r.Ea.size>0}function Cn(r){return K(r).Ia.size===0}function xm(r){r.da=void 0}async function Rw(r){r.Va.set("Online")}async function Sw(r){r.Ea.forEach(((e,t)=>{Cc(r,e)}))}async function Pw(r,e){xm(r),kc(r)?(r.Va.ha(e),Vc(r)):r.Va.set("Unknown")}async function Cw(r,e,t){if(r.Va.set("Online"),e instanceof Jf&&e.state===2&&e.cause)try{await(async function(s,i){const o=i.cause;for(const c of i.targetIds)s.Ea.has(c)&&(await s.remoteSyncer.rejectListen(c,o),s.Ea.delete(c),s.da.removeTarget(c))})(r,e)}catch(n){V(Rn,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Wi(r,n)}else if(e instanceof bi?r.da.Xe(e):e instanceof Qf?r.da.st(e):r.da.tt(e),!t.isEqual(j.min()))try{const n=await Sm(r.localStore);t.compareTo(n)>=0&&await(function(i,o){const c=i.da.Tt(o);return c.targetChanges.forEach(((u,h)=>{if(u.resumeToken.approximateByteSize()>0){const f=i.Ea.get(h);f&&i.Ea.set(h,f.withResumeToken(u.resumeToken,o))}})),c.targetMismatches.forEach(((u,h)=>{const f=i.Ea.get(u);if(!f)return;i.Ea.set(u,f.withResumeToken(pe.EMPTY_BYTE_STRING,f.snapshotVersion)),Dm(i,u);const p=new ut(f.target,u,h,f.sequenceNumber);Cc(i,p)})),i.remoteSyncer.applyRemoteEvent(c)})(r,t)}catch(n){V(Rn,"Failed to raise snapshot:",n),await Wi(r,n)}}async function Wi(r,e,t){if(!Jt(e))throw e;r.Ia.add(1),await Ms(r),r.Va.set("Offline"),t||(t=()=>Sm(r.localStore)),r.asyncQueue.enqueueRetryable((async()=>{V(Rn,"Retrying IndexedDB access"),await t(),r.Ia.delete(1),await Io(r)}))}function Nm(r,e){return e().catch((t=>Wi(r,t,e)))}async function Ls(r){const e=K(r),t=Wt(e);let n=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:fn;for(;Vw(e);)try{const s=await lw(e.localStore,n);if(s===null){e.Ta.length===0&&t.L_();break}n=s.batchId,kw(e,s)}catch(s){await Wi(e,s)}Om(e)&&Mm(e)}function Vw(r){return Cn(r)&&r.Ta.length<10}function kw(r,e){r.Ta.push(e);const t=Wt(r);t.O_()&&t.Y_&&t.ea(e.mutations)}function Om(r){return Cn(r)&&!Wt(r).x_()&&r.Ta.length>0}function Mm(r){Wt(r).start()}async function Dw(r){Wt(r).ra()}async function xw(r){const e=Wt(r);for(const t of r.Ta)e.ea(t.mutations)}async function Nw(r,e,t){const n=r.Ta.shift(),s=_c.from(n,e,t);await Nm(r,(()=>r.remoteSyncer.applySuccessfulWrite(s))),await Ls(r)}async function Ow(r,e){e&&Wt(r).Y_&&await(async function(n,s){if((function(o){return fE(o)&&o!==P.ABORTED})(s.code)){const i=n.Ta.shift();Wt(n).B_(),await Nm(n,(()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s))),await Ls(n)}})(r,e),Om(r)&&Mm(r)}async function Ph(r,e){const t=K(r);t.asyncQueue.verifyOperationInProgress(),V(Rn,"RemoteStore received new credentials");const n=Cn(t);t.Ia.add(3),await Ms(t),n&&t.Va.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await Io(t)}async function Mw(r,e){const t=K(r);e?(t.Ia.delete(2),await Io(t)):e||(t.Ia.add(2),await Ms(t),t.Va.set("Unknown"))}function Ir(r){return r.ma||(r.ma=(function(t,n,s){const i=K(t);return i.sa(),new Iw(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(r.datastore,r.asyncQueue,{Zo:Rw.bind(null,r),Yo:Sw.bind(null,r),t_:Pw.bind(null,r),H_:Cw.bind(null,r)}),r.Ra.push((async e=>{e?(r.ma.B_(),kc(r)?Vc(r):r.Va.set("Unknown")):(await r.ma.stop(),xm(r))}))),r.ma}function Wt(r){return r.fa||(r.fa=(function(t,n,s){const i=K(t);return i.sa(),new Tw(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(r.datastore,r.asyncQueue,{Zo:()=>Promise.resolve(),Yo:Dw.bind(null,r),t_:Ow.bind(null,r),ta:xw.bind(null,r),na:Nw.bind(null,r)}),r.Ra.push((async e=>{e?(r.fa.B_(),await Ls(r)):(await r.fa.stop(),r.Ta.length>0&&(V(Rn,`Stopping write stream with ${r.Ta.length} pending writes`),r.Ta=[]))}))),r.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vn{constructor(e,t,n){this.converter=t,this._query=n,this.type="query",this.firestore=e}withConverter(e){return new Vn(this.firestore,e,this._query)}}class de{constructor(e,t,n){this.converter=t,this._key=n,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new $t(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new de(this.firestore,e,this._key)}toJSON(){return{type:de._jsonSchemaVersion,referencePath:this._key.toString()}}static fromJSON(e,t,n){if(ks(t,de._jsonSchema))return new de(e,n||null,new M(ee.fromString(t.referencePath)))}}de._jsonSchemaVersion="firestore/documentReference/1.0",de._jsonSchema={type:me("string",de._jsonSchemaVersion),referencePath:me("string")};class $t extends Vn{constructor(e,t,n){super(e,t,uo(n)),this._path=n,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new de(this.firestore,null,new M(e))}withConverter(e){return new $t(this.firestore,e,this._path)}}function _v(r,e,...t){if(r=Se(r),ef("collection","path",e),r instanceof To){const n=ee.fromString(e,...t);return Sl(n),new $t(r,null,n)}{if(!(r instanceof de||r instanceof $t))throw new D(P.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(ee.fromString(e,...t));return Sl(n),new $t(r.firestore,null,n)}}function aa(r,e,...t){if(r=Se(r),arguments.length===1&&(e=rc.newId()),ef("doc","path",e),r instanceof To){const n=ee.fromString(e,...t);return Rl(n),new de(r,null,new M(n))}{if(!(r instanceof de||r instanceof $t))throw new D(P.INVALID_ARGUMENT,"Expected first argument to doc() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const n=r._path.child(ee.fromString(e,...t));return Rl(n),new de(r.firestore,r instanceof $t?r.converter:null,new M(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`+r.stack),e}class vs extends To{constructor(e,t,n,s){super(e,t,n,s),this.type="firestore",this._queue=new Bh,this._persistenceKey=s?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const e=this._firestoreClient.terminate();this._queue=new Bh(e),this._firestoreClient=void 0,await e}}}function yv(r,e,t){t||(t=ps);const n=Xi(r,"firestore");if(n.isInitialized(t)){const s=n.getImmediate({identifier:t}),i=n.getOptions(t);if(Gt(i,e))return s;throw new D(P.FAILED_PRECONDITION,"initializeFirestore() has already been called with different options. To avoid this error, call initializeFirestore() with the same options as when it was originally called, or call getFirestore() to return the already initialized instance.")}if(e.cacheSizeBytes!==void 0&&e.localCache!==void 0)throw new D(P.INVALID_ARGUMENT,"cache and cacheSizeBytes cannot be specified at the same time as cacheSizeBytes willbe deprecated. Instead, specify the cache size in the cache object");if(e.cacheSizeBytes!==void 0&&e.cacheSizeBytes!==-1&&e.cacheSizeBytes<ym)throw new D(P.INVALID_ARGUMENT,"cacheSizeBytes must be at least 1048576");return e.host&&fr(e.host)&&$a(e.host),n.initialize({options:e,instanceIdentifier:t})}function li(r,e){const t=Ha(),n=ps,s=Xi(t,"firestore").getImmediate({identifier:n});if(!s._initialized){const i=pg("firestore");i&&gv(s,...i)}return s}function Qm(r){if(r._terminated)throw new D(P.FAILED_PRECONDITION,"The client has already been terminated.");return r._firestoreClient||Iv(r),r._firestoreClient}function Iv(r){const e=r._freezeSettings(),t=pv(r._databaseId,r._app?.options.appId||"",r._persistenceKey,r._app?.options.apiKey,e);r._componentsProvider||e.localCache?._offlineComponentProvider&&e.localCache?._onlineComponentProvider&&(r._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),r._firestoreClient=new uv(r._authCredentials,r._appCheckCredentials,r._queue,t,r._componentsProvider&&(function(s){const i=s?._online.build();return{_offline:s?._offline.build(i),_online:i}})(r._componentsProvider))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lc{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new D(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ce(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${y}`.trim(),severity:5}]}}},x=p.find(F=>F.id===n)||null,W=()=>{if(!x)return"";let F=`# Visual UX Audit for ${x.url}

`;return za.forEach(q=>{const B=x[`findings_${q.name.toLowerCase()}`];B&&(F+=`## ${q.name} Analysis
${B.summary}
