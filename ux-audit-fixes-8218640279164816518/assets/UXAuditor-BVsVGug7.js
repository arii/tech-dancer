 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const v_=new se(M.comparator);function st(){return v_}const ql=new se(M.comparator);function Wn(...n){let e=ql;for(const t of n)e=e.insert(t.key,t);return e}function zl(n){let e=ql;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function Ut(){return Zn()}function Gl(){return Zn()}function Zn(){return new Qt((n=>n.toString()),((n,e)=>n.isEqual(e)))}const A_=new se(M.comparator),R_=new fe(M.comparator);function K(...n){let e=R_;for(const t of n)e=e.add(t);return e}const b_=new fe(W);function S_(){return b_}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
