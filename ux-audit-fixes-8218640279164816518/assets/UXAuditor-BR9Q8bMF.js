 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function F(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,Tl(n,r,t)}function Tl(n,e,t){let r=`FIRESTORE (${wn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw rt(r),new Error(r)}function X(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||Tl(e,s,r)}function $(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bh extends YE{constructor(e){super(),this.firestore=e}convertBytes(e){return new xe(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new he(this.firestore,null,t)}}const gu="@firebase/firestore",_u="4.14.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}),U+=`
`)}),U},Y=async()=>{if(!O)return;p(!0);const U=encodeURIComponent(x()),z=encodeURIComponent(`UX Audit Findings: ${O.url}`);let G="https://github.com/new";try{const L=new URL(O.url);if(L.hostname.endsWith(".github.io")){const E=L.hostname.split(".")[0],m=L.pathname.split("/")[1];E&&m&&(G=`https://github.com/${E}/${m}/issues/new`)}}catch{}window.open(`${G}?title=${z}&body=${U}`,"_blank")},Z=async()=>{const U=x();try{await navigator.clipboard.writeText(U),h(!0)}catch(z){console.error("Failed to copy markdown:",z)}};return{user:e,reports:y,isAnalyzing:R.isPending,activeReport:O,setActiveReport:U=>s(U?.id||null),url:o,setUrl:a,isCopiedMarkdown:u,isExportingToGithub:d,runUXAudit:P,exportToGithub:Y,copyMarkdown:Z,firebaseConfig:ft}}const cT={Mobile:C.jsx(zd,{className:"w-5 h-5"}),Tablet:C.jsx(Hd,{className:"w-5 h-5"}),Desktop:C.jsx(Bd,{className:"w-5 h-5"})};function uT({suggestion:n}){const[e,t]=ve.useState(!1),[r,s]=ve.useState(!1);Cd.useEffect(()=>{if(!e)return;const a=setTimeout(()=>{document.startViewTransition?document.startViewTransition(()=>t(!1)):t(!1)},2e3);return()=>clearTimeout(a)},[e]);const o=async()=>{s(!0);try{await navigator.clipboard.writeText(n),await new Promise(a=>setTimeout(a,400)),document.startViewTransition?document.startViewTransition(()=>{t(!0)}):t(!0)}catch(a){console.error("Failed to copy:",a)}finally{s(!1)}};return C.jsxs(J,{as:"button",onClick:o,disabled:r,marginTop:2,display:"flex",align:"center",gap:1,paddingX:3,paddingY:1,radius:"md",surface:"default",border:!0,className:"hover:border-accent transition-colors hover:text-accent font-bold text-xs",children:[r?C.jsx(Gn,{className:"w-3 h-3 animate-spin"}):e?C.jsx(wi,{className:"w-3 h-3 text-emerald-500"}):C.jsx(Au,{className:"w-3 h-3"}),C.jsx("span",{children:r?"Copying...":e?"Copied!":"Copy Prompt"})]})}function _T(){const{reports:n,isAnalyzing:e,activeReport:t,setActiveReport:r,url:s,setUrl:o,isCopiedMarkdown:a,isExportingToGithub:u,runUXAudit:h,exportToGithub:d,copyMarkdown:p}=aT();return C.jsxs(Ne,{gap:8,width:"full",children:[C.jsxs(Ne,{direction:{base:"col",md:"row"},align:{base:"start",md:"center"},justify:"between",gap:6,border:"b",paddingBottom:6,children:[C.jsx(J,{children:C.jsx(Vd,{label:"Visual UX Auditor",title:"Multimodal AI Analysis",description:"Automated visual regression and UX improvement suggestions across viewports."})}),C.jsxs(Ne,{direction:"row",align:"center",gap:3,surface:"default",padding:2,radius:"xl",shadow:"sm",border:!0,children:[C.jsx(J,{as:"input",type:"text",value:s,title:s,onChange:y=>o(y.target.value),className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono truncate text-sm",color:"main",width:64,paddingX:4,paddingY:2,radius:"lg",placeholder:"https://...","aria-label":"URL to audit"}),C.jsxs(J,{as:"button",onClick:h,disabled:e,display:"flex",align:"center",gap:2,className:"bg-accent hover:opacity-90 text-white font-bold transition-all disabled:opacity-50",paddingX:6,paddingY:2,radius:"md",children:[e?C.jsx(Gn,{className:"animate-spin w-4 h-4"}):C.jsx(Ga,{className:"w-4 h-4"}),e?"Auditing...":"Start Audit"]})]})]}),C.jsxs(Pd,{cols:{base:1,lg:4},gap:8,children:[C.jsxs(Ne,{gap:4,span:{lg:1},children:[C.jsx(ae,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"widest",color:"dim",paddingX:1,children:"Audit History"}),C.jsxs(Ne,{surface:"default",radius:"2xl",shadow:"sm",border:!0,overflow:"hidden",className:"divide-y divide-line",children:[n.length===0&&C.jsx(J,{padding:10,align:"center",children:C.jsx(ae,{color:"dim",size:"sm",className:"italic",children:"No audits recorded."})}),n.map(y=>C.jsxs(J,{as:"button",onClick:()=>r(y),width:"full",display:"flex",align:"center",gap:3,padding:4,className:`text-left hover:bg-surface transition-all ${t?.id===y.id?"bg-bg border-l-4 border-accent":"border-l-4 border-transparent"}`,children:[C.jsx(J,{padding:2,radius:"full",surface:y.status==="completed"?"success":"warning",className:y.status!=="completed"?"animate-pulse":"",children:y.status==="completed"?C.jsx(wi,{className:"w-4 h-4"}):C.jsx(Gn,{className:"w-4 h-4"})}),C.jsxs(J,{flex:1,minWidth:"0",children:[C.jsx(ae,{variant:"sans",size:"sm",weight:"font-bold",className:"truncate",children:y.url.replace("https://","")}),C.jsx(ae,{variant:"mono",size:"xs",weight:"font-medium",color:"dim",uppercase:!0,children:new Date(y.timestamp).toLocaleTimeString()})]}),C.jsx(J,{color:"dim",children:C.jsx(Nd,{className:"w-4 h-4 opacity-50"})})]},y.id))]})]}),C.jsx(Ne,{gap:6,span:{lg:3},children:t?C.jsxs(C.Fragment,{children:[C.jsxs(J,{surface:"default",padding:6,radius:"2xl",shadow:"sm",border:!0,display:"flex",justify:"between",align:{base:"start",md:"center"},gap:4,direction:{base:"col",md:"row"},children:[C.jsxs(Ne,{gap:1,marginBottom:{base:4,md:0},minWidth:"0",flex:1,children:[C.jsx(ae,{variant:"sans",size:"xs",weight:"font-bold",color:"accent",uppercase:!0,tracking:"widest",display:"block",children:"Current Session"}),C.jsx(ae,{variant:"sans",size:"xl",weight:"font-black",className:"truncate block",title:t.url,children:t.url})]}),C.jsxs(J,{display:"flex",gap:2,children:[C.jsxs(ae,{as:"button",onClick:p,display:"flex",align:"center",gap:2,className:"font-bold hover:opacity-80 transition-all text-sm",surface:"muted",color:"dim",paddingX:4,paddingY:2,radius:"xl",children:[a?C.jsx(wi,{className:"w-4 h-4"}):C.jsx(Au,{className:"w-4 h-4"}),a?"Copied":"Copy MD"]}),C.jsxs(J,{as:"button",onClick:d,disabled:t.status!=="completed"||u,display:"flex",align:"center",gap:2,className:"font-bold bg-accent text-white hover:opacity-90 shadow-md transition-all disabled:opacity-50 text-sm",paddingX:6,paddingY:2,radius:"xl",children:[u?C.jsx(Gn,{className:"w-4 h-4 animate-spin"}):C.jsx(Dd,{className:"w-4 h-4"}),C.jsx("span",{className:"whitespace-nowrap",children:u?"Exporting...":"Export to GitHub Issue"})]})]})]}),C.jsx(Ne,{gap:8,children:Qi.map(y=>{const R=t[`findings_${y.name.toLowerCase()}`],P=t[`image_${y.name.toLowerCase()}`];return C.jsxs(J,{surface:"default",radius:"2xl",shadow:"sm",border:!0,overflow:"hidden",children:[C.jsxs(J,{padding:4,border:"b",display:"flex",align:"center",justify:"between",surface:"muted",children:[C.jsxs(J,{display:"flex",align:"center",gap:3,children:[C.jsx(J,{padding:2,surface:"default",radius:"lg",shadow:"sm",color:"accent",children:cT[y.name]}),C.jsxs(ae,{variant:"sans",size:"base",weight:"font-bold",children:[y.name," Analysis"]})]}),C.jsxs(ae,{variant:"mono",size:"xs",weight:"font-bold",color:"dim",uppercase:!0,tracking:"widest",children:[y.width,"w × ",y.height,"h"]})]}),C.jsxs(Ne,{direction:{base:"col",md:"row"},width:"full",children:[C.jsx(J,{padding:8,surface:"muted",display:"flex",align:"center",justify:"center",border:{base:"b",md:"r"},minHeight:400,width:{base:"full",md:"41.666%"},children:P?C.jsx("img",{src:P,alt:`${y.name} snapshot`,className:"w-full h-auto rounded-xl shadow-2xl border border-surface object-contain bg-surface max-h-96",onError:V=>{V.target.src=`https://placehold.co/${y.width}x${y.height}/e2e8f0/64748b?text=Snapshot+Unavailable`}}):C.jsxs(J,{display:"flex",direction:"col",align:"center",className:"text-center",children:[C.jsx(J,{marginBottom:2,children:C.jsx(J,{color:"dim",children:C.jsx(Fd,{className:"w-12 h-12 opacity-20"})})}),C.jsx(ae,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"wider",color:"dim",children:"Awaiting Frame..."})]})}),C.jsx(Ne,{gap:6,padding:8,flex:1,minWidth:"0",overflow:"hidden",children:R?C.jsxs(C.Fragment,{children:[C.jsxs(J,{surface:"muted",border:!0,padding:5,radius:"2xl",children:[C.jsx(J,{marginBottom:3,children:C.jsx(ae,{variant:"sans",size:"xs",weight:"font-black",color:"accent",uppercase:!0,display:"block",tracking:"widest",children:"Analysis Summary"})}),C.jsxs(ae,{variant:"sans",size:"sm",weight:"font-medium",className:"leading-relaxed break-words block",children:['"',R.summary,'"']})]}),C.jsx(Ne,{gap:4,children:R.improvements?.map((V,O)=>C.jsxs(J,{padding:4,radius:"xl",border:!0,surface:"default",shadow:"sm",className:"hover:border-accent transition-all",children:[C.jsxs(J,{display:"flex",justify:"between",align:"start",marginBottom:2,children:[C.jsxs(Ne,{direction:"row",align:"center",gap:2,children:[C.jsx(J,{width:2,height:2,radius:"full",surface:V.severity>7?"error":"warning",className:V.severity>7?"bg-red-500 shadow-sm":"bg-amber-500"}),C.jsx(ae,{variant:"sans",size:"sm",weight:"font-black",children:V.element})]}),C.jsxs(ae,{variant:"mono",size:"xs",weight:"font-black",paddingX:2,paddingY:.5,radius:"full",surface:"muted",color:"dim",uppercase:!0,title:`Severity level: ${V.severity} out of 10 (1-10 scale)`,children:["SEV ",V.severity]})]}),C.jsx(ae,{variant:"sans",size:"xs",color:"dim",marginBottom:3,children:V.issue}),V.suggestion&&V.suggestion.trim()!==""&&C.jsxs(J,{surface:"muted",padding:3,radius:"lg",border:!0,display:"flex",direction:{base:"col",sm:"row"},align:"start",gap:2,children:[C.jsx(ae,{variant:"sans",size:"xs",weight:"font-black",color:"accent",marginTop:.5,uppercase:!0,tracking:"widest",className:"shrink-0",children:"FIX"}),C.jsxs(J,{flex:1,minWidth:"0",children:[C.jsx(ae,{variant:"sans",size:"xs",weight:"font-bold",className:"break-words whitespace-pre-wrap line-clamp-4",children:V.suggestion}),V.element==="Manual Audit Required"&&C.jsx(uT,{suggestion:V.suggestion})]})]})]},O))})]}):C.jsxs(J,{display:"flex",align:"center",justify:"center",paddingY:20,direction:"col",children:[C.jsx(J,{color:"dim",children:C.jsx(Gn,{className:"animate-spin w-6 h-6"})}),C.jsx(ae,{variant:"sans",size:"xs",weight:"font-bold",tracking:"widest",uppercase:!0,color:"dim",children:"Agent Processing..."})]})})]})]},y.name)})})]}):C.jsxs(Ne,{height:"full",align:"center",justify:"center",surface:"default",radius:"3xl",padding:20,minHeight:500,className:"border-2 border-dashed text-center",children:[C.jsx(J,{surface:"muted",padding:6,radius:"full",marginBottom:6,children:C.jsx(J,{color:"dim",className:"opacity-50",children:C.jsx(Ga,{className:"w-16 h-16"})})}),C.jsx(ae,{variant:"sans",size:"xl",weight:"font-black",marginBottom:2,children:"Ready to Audit"}),C.jsx(ae,{variant:"sans",size:"sm",weight:"font-medium",color:"dim",maxWidth:"sm",marginX:"auto",children:"Enter a URL above to start the visual analysis across Mobile, Tablet, and Desktop."})]})})]})]})}export{_T as default};
