...
export default defineConfig(({mode}) => {
  ...
  return {
    ...
    define: {
      ...
      'import.meta.env.VITE_SERVICES_INTAKE_DEPLOYMENT_ID': JSON.stringify(
        process.env.VITE_SERVICES_INTAKE_DEPLOYMENT_ID || env.VITE_SERVICES_INTAKE_DEPLOYMENT_ID || ''
      ),
    },
    plugins: [
      react(),
