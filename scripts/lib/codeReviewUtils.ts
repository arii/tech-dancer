...
/**
 * Shared utilities for code review clients.
 */
...
export function budgetInputContext(summary: CodeReviewSummary, systemPrompt: string): { diffText: string; externalText: string } {
  // We must ensure the total input (systemPrompt + diffText + externalText) stays within a reasonable limit.
