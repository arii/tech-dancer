...
- Before flagging a "syntax error" or "missing property/method", re-read the diff to confirm the code isn't simply continued on the next line or truncated in your working memory. Hallucinating errors due to your own memory truncation is a severe failure.
