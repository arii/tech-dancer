...
export const DomRouteSummarySchema = z.object({
  ...
  beforeHtmlPath: z.string(), afterHtmlPath: z.string(), diffPath: z.string(),
  metrics: z.object({
    nodesAdded: z.number(), nodesRemoved: z.number(),
    imagesAdded: z.number(), imagesRemoved: z.number(),
    linksAdded: z.number(), linksRemoved: z.number(),
  }),
  severity: z.enum(['LOW', 'MEDIUM', 'HIGH'])
});
