...
const ALLOWED_COLORS = ['bg', 'surface', 'accent', 'accent-navy', 'text-main', 'text-body', 'text-dim', 'yellow-500', 'emerald-600', 'amber-600', 'line', 'white', 'black', 'transparent', 'current', 'yellow-400'];
