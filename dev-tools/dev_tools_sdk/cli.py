...
def build_parser() -> argparse.ArgumentParser:
    ...
    gh_audit = gh_sub.add_parser("audit", help="Run audit-focused review")
    gh_audit.add_argument("pr", type=int)
    ...
    ai_analyze = ai_sub.add_parser("analyze", help="Analyze a file path")
