...
def main():
    ...
    for cmd, func in [("validate-issue", handle_validate_issue), ("conflicts", handle_conflicts), ("resolve-conflicts", handle_conflicts), ("detect-conflicts", handle_detect_conflicts),
                      ...
                      ("fix-ci", handle_fix_ci), ("repair", handle_repair), ("repair-context", handle_repair_context), ("track-review", handle_track_review)]: # fetch-review is alias for audit-pr --fetch
