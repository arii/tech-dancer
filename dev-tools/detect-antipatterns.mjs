...
const ALLOWED_COLORS = [
  'bg', 'surface', 'accent', 'accent-brand', 'accent-navy', 'text-main', 'text-body', 'text-dim', 'line', 'white', 'black', 'transparent', 'current', 'yellow-400',
  'success', 'warning', 'error', 'success-dim', 'warning-dim'
];
