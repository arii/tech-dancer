...
from utils import call_ollama, is_ollama_available, clean_llm_output, OLLAMA_MODEL

class LocalAIClient:
    def __init__(self, ollama_url: str = None, ollama_model: str = None, gemini_api_key: str = None):
        # Note: ollama_url is now managed centrally in utils.py via OLLAMA_URL constant
