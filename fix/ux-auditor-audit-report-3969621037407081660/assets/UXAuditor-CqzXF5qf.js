import{j as C}from"./vendor-markdown-e9PAft-3.js";import{b as Oe}from"./vendor-react-qDFqdIvJ.js";import{c as Kt,S as xe,B as ee,G as ud,T as pe}from"./index-WQMufUpa.js";import{P as ld}from"./PageHeader-CB835u70.js";import{C as Ua}from"./camera-ODMuNu8K.js";import{C as hd}from"./chevron-right-DRtNhc_k.js";import{G as dd}from"./github-CmmFU5zD.js";import"./vendor-recharts-JfjGcoGW.js";import"./vendor-motion-CQhsUiTf.js";/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wp(n,e,t=!1){if(Ne(n.app))return Promise.reject(Xe(n));const r="signIn",s=await Hu(n,r,e),o=await nt._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(o.user),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
${_}`,severity:5}]}}},x=()=>{if(!a)return"";let L=`# Visual UX Audit for ${a.url}

`;return Wi.forEach(z=>{var q;const F=a[`findings_${z.name.toLowerCase()}`];F&&(L+=`## ${z.name} Analysis
${F.summary}
...
`}),L+=`
`)}),L};return{user:n,reports:t,isAnalyzing:s,activeReport:a,setActiveReport:u,url:h,setUrl:d,isCopiedMarkdown:p,isExportingToGithub:A,runUXAudit:V,exportToGithub:async()=>{if(!a)return;b(!0);const L=encodeURIComponent(x()),z=encodeURIComponent(`UX Audit Findings: ${a.url}`);let F="https://github.com/new";try{const q=new URL(a.url);if(q.hostname.endsWith(".github.io")){const E=q.hostname.split(".")[0],m=q.pathname.split("/")[1];E&&m&&(F=`https://github.com/${E}/${m}/issues/new`)}}catch{}window.open(`${F}?title=${z}&body=${L}`,"_blank"),setTimeout(()=>b(!1),1e3)},copyMarkdown:()=>{const L=x(),z=document.createElement("textarea");z.value=L,document.body.appendChild(z),z.select(),document.execCommand("copy"),document.body.removeChild(z),y(!0),setTimeout(()=>y(!1),2e3)},firebaseConfig:Mt}}const ME={Mobile:C.jsx(Id,{className:"w-5 h-5"}),Tablet:C.jsx(vd,{className:"w-5 h-5"}),Desktop:C.jsx(yd,{className:"w-5 h-5"})};function LE({suggestion:n}){const[e,t]=Oe.useState(!1),[r,s]=Oe.useState(!1),o=async()=>{s(!0),await navigator.clipboard.writeText(n),setTimeout(()=>{s(!1),document.startViewTransition?document.startViewTransition(()=>{t(!0)}):t(!0),setTimeout(()=>{document.startViewTransition?document.startViewTransition(()=>t(!1)):t(!1)},2e3)},400)};return C.jsxs(ee,{as:"button",onClick:o,disabled:r,marginTop:2,display:"flex",align:"center",gap:1,paddingX:3,paddingY:1,radius:"md",surface:"default",border:!0,className:"hover:border-accent transition-colors hover:text-accent font-bold text-xs",children:[r?C.jsx($n,{className:"w-3 h-3 animate-spin"}):e?C.jsx(Ii,{className:"w-3 h-3 text-[var(--color-success,#16a34a)]"}):C.jsx(du,{className:"w-3 h-3"}),C.jsx("span",{children:r?"Copying...":e?"Copied!":"Copy Prompt"})]})}function KE(){const{reports:n,isAnalyzing:e,activeReport:t,setActiveReport:r,url:s,setUrl:o,isCopiedMarkdown:a,isExportingToGithub:u,runUXAudit:h,exportToGithub:d,copyMarkdown:p}=OE();return C.jsxs(xe,{gap:8,width:"full",children:[C.jsxs(xe,{direction:{base:"col",md:"row"},align:{base:"start",md:"center"},justify:"between",gap:6,border:"b",paddingBottom:6,children:[C.jsx(ee,{children:C.jsx(ld,{label:"Visual UX Auditor",title:"Multimodal AI Analysis",description:"Automated visual regression and UX improvement suggestions across viewports."})}),C.jsxs(xe,{direction:"row",align:"center",gap:3,surface:"default",padding:2,radius:"xl",shadow:"sm",border:!0,children:[C.jsx(ee,{as:"input",type:"text",value:s,title:s,onChange:y=>o(y.target.value),className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text truncate",style:{width:"16rem",padding:"0.5rem 1rem",borderRadius:"0.5rem",fontSize:"0.875rem"},placeholder:"https://..."}),C.jsxs(ee,{as:"button",onClick:h,disabled:e,display:"flex",align:"center",gap:2,className:"bg-accent hover:opacity-90 text-white font-bold transition-all disabled:opacity-50",style:{padding:"0.5rem 1.5rem",borderRadius:"0.5rem"},children:[e?C.jsx($n,{className:"animate-spin w-4 h-4"}):C.jsx(Ua,{className:"w-4 h-4"}),e?"Auditing...":"Start Audit"]})]})]}),C.jsxs(ud,{cols:{base:1,lg:4},gap:8,children:[C.jsxs(xe,{gap:4,span:{lg:1},children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"widest",color:"dim",paddingX:1,children:"Audit History"}),C.jsxs(xe,{surface:"default",radius:"2xl",shadow:"sm",border:!0,overflow:"hidden",className:"divide-y divide-line",children:[n.length===0&&C.jsx(ee,{padding:10,className:"italic",color:"dim",align:"center",size:"sm",children:"No audits recorded."}),n.map(y=>C.jsxs(ee,{as:"button",onClick:()=>r(y),width:"full",display:"flex",align:"center",gap:3,padding:4,className:`text-left hover:bg-surface transition-all ${(t==null?void 0:t.id)===y.id?"bg-bg border-l-4 border-accent":"border-l-4 border-transparent"}`,children:[C.jsx(ee,{padding:2,radius:"full",className:y.status==="completed"?"bg-[var(--color-success-dim,#dcfce7)] text-[var(--color-success,#16a34a)]":"bg-[var(--color-warning-dim,#fef3c7)] text-[var(--color-warning,#d97706)] animate-pulse",children:y.status==="completed"?C.jsx(Ii,{className:"w-4 h-4"}):C.jsx($n,{className:"w-4 h-4"})}),C.jsxs(ee,{flex:1,minWidth:"0",children:[C.jsx(pe,{variant:"sans",size:"sm",weight:"font-bold",className:"truncate",children:y.url.replace("https://","")}),C.jsx(pe,{variant:"mono",size:"xs",weight:"font-medium",color:"dim",uppercase:!0,children:new Date(y.timestamp).toLocaleTimeString()})]}),C.jsx(hd,{className:"w-4 h-4 text-text-dim opacity-50"})]},y.id))]})]}),C.jsx(xe,{gap:6,span:{lg:3},children:t?C.jsxs(C.Fragment,{children:[C.jsxs(ee,{surface:"default",padding:6,radius:"2xl",shadow:"sm",border:!0,display:"flex",justify:"between",align:{base:"start",md:"center"},gap:4,direction:{base:"col",md:"row"},children:[C.jsxs(ee,{marginBottom:{base:4,md:0},children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",color:"accent",uppercase:!0,tracking:"tighter",display:"block",marginBottom:2,children:"Current Session"}),C.jsx(pe,{variant:"sans",size:"xl",weight:"font-black",className:"break-all",children:t.url})]}),C.jsxs(ee,{display:"flex",gap:2,children:[C.jsxs(ee,{as:"button",onClick:p,display:"flex",align:"center",gap:2,className:"font-bold hover:text-text transition-all",surface:"muted",color:"dim",style:{padding:"0.5rem 1rem",borderRadius:"0.75rem",fontSize:"0.875rem"},children:[a?C.jsx(Ii,{className:"w-4 h-4"}):C.jsx(du,{className:"w-4 h-4"}),a?"Copied":"Copy MD"]}),C.jsxs(ee,{as:"button",onClick:d,disabled:t.status!=="completed"||u,display:"flex",align:"center",gap:2,className:"font-bold bg-text-main text-bg hover:bg-accent hover:text-white shadow-md transition-all disabled:opacity-50",style:{padding:"0.5rem 1.5rem",borderRadius:"0.75rem",fontSize:"0.875rem"},children:[u?C.jsx($n,{className:"w-4 h-4 animate-spin"}):C.jsx(dd,{className:"w-4 h-4"}),C.jsx("span",{className:"whitespace-nowrap",children:u?"Exporting...":"Export to GitHub Issue"})]})]})]}),C.jsx(xe,{gap:8,children:Wi.map(y=>{var V;const A=t[`findings_${y.name.toLowerCase()}`],b=t[`image_${y.name.toLowerCase()}`];return C.jsxs(ee,{surface:"default",radius:"2xl",shadow:"sm",border:!0,overflow:"hidden",children:[C.jsxs(ee,{padding:4,border:"b",display:"flex",align:"center",justify:"between",surface:"muted",children:[C.jsxs(ee,{display:"flex",align:"center",gap:3,children:[C.jsx(ee,{padding:2,surface:"default",radius:"lg",shadow:"sm",color:"accent",children:ME[y.name]}),C.jsxs(pe,{variant:"sans",size:"base",weight:"font-bold",children:[y.name," Analysis"]})]}),C.jsxs(pe,{variant:"mono",size:"xs",weight:"font-bold",color:"dim",uppercase:!0,tracking:"widest",children:[y.width,"w × ",y.height,"h"]})]}),C.jsxs(xe,{direction:{base:"col",md:"row"},width:"full",children:[C.jsx(ee,{padding:8,surface:"muted",display:"flex",align:"center",justify:"center",border:{base:"b",md:"r"},minHeight:400,width:{base:"full",md:"41.666%"},children:b?C.jsx("img",{src:b,alt:`${y.name} snapshot`,className:"w-full h-auto rounded-xl shadow-2xl border border-surface object-contain bg-surface",style:{maxHeight:"450px"},onError:D=>{D.target.src=`https://placehold.co/${y.width}x${y.height}/e2e8f0/64748b?text=Snapshot+Unavailable`}}):C.jsxs(ee,{className:"text-center",color:"dim",children:[C.jsx(gd,{className:"w-12 h-12 mx-auto mb-2 opacity-20"}),C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"wider",children:"Awaiting Frame..."})]})}),C.jsx(xe,{gap:6,padding:8,flex:1,minWidth:"0",children:A?C.jsxs(C.Fragment,{children:[C.jsxs(ee,{surface:"muted",border:!0,padding:5,radius:"2xl",children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-black",color:"accent",uppercase:!0,display:"block",marginBottom:2,tracking:"widest",children:"Analysis Summary"}),C.jsxs(pe,{variant:"sans",size:"sm",weight:"font-medium",className:"leading-relaxed break-words",children:['"',A.summary,'"']})]}),C.jsx(xe,{gap:4,children:(V=A.improvements)==null?void 0:V.map((D,x)=>C.jsxs(ee,{padding:4,radius:"xl",border:!0,surface:"default",shadow:"sm",className:"hover:border-accent/30 transition-all",children:[C.jsxs(ee,{display:"flex",justify:"between",align:"start",marginBottom:2,children:[C.jsxs(pe,{variant:"sans",size:"sm",weight:"font-black",className:"flex items-center gap-2",children:[C.jsx("div",{className:`h-2 w-2 rounded-full ${D.severity>7?"bg-[var(--color-error,#ef4444)] shadow-sm":"bg-[var(--color-warning,#f59e0b)]"}`}),D.element]}),C.jsxs(pe,{variant:"mono",size:"xs",weight:"font-black",paddingX:2,paddingY:.5,radius:"full",surface:"muted",color:"dim",uppercase:!0,title:`Severity level: ${D.severity} out of 10`,children:["SEV ",D.severity]})]}),C.jsx(pe,{variant:"sans",size:"xs",color:"dim",marginBottom:3,children:D.issue}),D.suggestion&&C.jsxs(ee,{surface:"muted",padding:3,radius:"lg",border:!0,display:"flex",direction:{base:"col",sm:"row"},align:"start",gap:2,children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-black",color:"accent",marginTop:.5,uppercase:!0,tracking:"widest",className:"shrink-0",children:"FIX"}),C.jsxs(ee,{flex:1,minWidth:"0",children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",className:"break-words whitespace-pre-wrap line-clamp-4",children:D.suggestion}),D.element==="Manual Audit Required"&&C.jsx(LE,{suggestion:D.suggestion})]})]})]},x))})]}):C.jsxs(ee,{display:"flex",align:"center",justify:"center",paddingY:20,direction:"col",color:"dim",children:[C.jsx($n,{className:"animate-spin w-6 h-6"}),C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",tracking:"widest",uppercase:!0,children:"Agent Processing..."})]})})]})]},y.name)})})]}):C.jsxs(xe,{height:"full",align:"center",justify:"center",surface:"default",radius:"3xl",padding:20,minHeight:500,className:"border-2 border-dashed text-center",children:[C.jsx(ee,{surface:"muted",padding:6,radius:"full",marginBottom:6,className:"text-text-dim/50",children:C.jsx(Ua,{className:"w-16 h-16"})}),C.jsx(pe,{variant:"sans",size:"xl",weight:"font-black",marginBottom:2,children:"Ready to Audit"}),C.jsx(pe,{variant:"sans",size:"sm",weight:"font-medium",color:"dim",maxWidth:"sm",marginX:"auto",children:"Enter a URL above to start the visual analysis across Mobile, Tablet, and Desktop."})]})})]})]})}export{KE as default};
