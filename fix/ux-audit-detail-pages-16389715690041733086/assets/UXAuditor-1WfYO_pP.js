import{j as C}from"./vendor-markdown-e9PAft-3.js";import{b as Ke}from"./vendor-react-qDFqdIvJ.js";import{c as Kt,S as Ue,B as ee,G as La,T as pe}from"./index-BORk44Ii.js";import{P as ld}from"./PageHeader-Dqe3FkTE.js";import{C as Ua}from"./camera-BVgL-ao6.js";import{C as hd}from"./chevron-right-KujGsW3g.js";import{G as dd}from"./github-CTHRfUMs.js";import"./vendor-recharts-JfjGcoGW.js";import"./vendor-motion-CQhsUiTf.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pd=[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]],du=Kt("copy",pd);/**
 * @license lucide-react v0.546.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _f{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(yf(t)){const r=t.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(t=>t).join(" ")}}function yf(n){const e=n.getComponent();return(e==null?void 0:e.type)==="VERSION"}const vi="@firebase/app",za="0.14.11";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const yn=Hf;function wu(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r={name:Ai,automaticDataCollectionEnabled:!0,...e},s=r.name;if(typeof s!="string"||!s)throw yt.create("bad-app-name",{appName:String(s)});if(t||(t=_u()),!t)throw yt.create("no-options");const o=Jn.get(s);if(o){if($t(t,o.options)&&$t(r,o.config))return o;throw yt.create("duplicate-app",{appName:s})}const a=new ef(s);for(const h of Ri.values())a.addComponent(h);const u=new Qf(t,r,a);return Jn.set(s,u),u}function Ji(n=Ai){const e=Jn.get(n);if(!e&&n===Ai&&_u())return wu();if(!e)throw yt.create("no-app",{appName:n});return e}function Jf(){return Array.from(Jn.values())}function Et(n,e,t){let r=Gf[n]??n;t&&(r+=`-${t}`);const s=r.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const a=[`Unable to register library "${r}" with version "${e}":`];s&&a.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Xe.warn(a.join(" "));return}dn(new qt(`${r}-version`,()=>({library:r,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Yf="firebase-heartbeat-database",Xf=1,Yn="firebase-heartbeat-store";let di=null;function vu(){return di||(di=pf(Yf,Xf,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Yn)}catch(t){console.warn(t)}}}}).catch(n=>{throw yt.create("idb-open",{originalErrorMessage:n.message})})),di}async function Zf(n){try{const t=(await vu()).transaction(Yn),r=await t.objectStore(Yn).get(Au(n));return await t.done,r}catch(e){if(e instanceof st)Xe.warn(e.message);else{const t=yt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Xe.warn(t.message)}}}async function Ga(n,e){try{const r=(await vu()).transaction(Yn,"readwrite");await r.objectStore(Yn).put(e,Au(n)),await r.done}catch(t){if(t instanceof st)Xe.warn(t.message);else{const r=yt.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Xe.warn(r.message)}}}function Au(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function op(n){dn(new qt("platform-logger",e=>new _f(e),"PRIVATE")),dn(new qt("heartbeat",e=>new np(e),"PRIVATE")),Et(vi,za,n),Et(vi,za,"esm2020"),Et("fire-js","")}op("");var ap="firebase",cp="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Et(ap,cp,"app");function Ru(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const up=Ru,Su=new ar("auth","Firebase",Ru());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ze(n,...e){throw Yi(n,...e)}function je(n,...e){return Yi(n,...e)}function bu(n,e,t){const r={...up(),[e]:t};return new ar("auth","Firebase",r).create(e,{appName:n.name})}function Ye(n){return bu(n,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Yi(n,...e){if(typeof n!="string"){const t=e[0],r=[...e.slice(1)];return r[0]&&(r[0].appName=n.name),n._errorFactory.create(t,...r)}return Su.create(n,...e)}function B(n,e,...t){if(!n)throw Yi(e,...t)}function Qe(n){const e="INTERNAL ASSERTION FAILED: "+n;throw qr(e),new Error(e)}function et(n,e){n||Qe(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Si(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.href)||""}function hp(){return Qa()==="http:"||Qa()==="https:"}function Qa(){var n;return typeof self<"u"&&((n=self.location)==null?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ns(n){var y;const e=n.auth,t=await n.getIdToken(),r=await Xn(n,ts(e,{idToken:t}));B(r==null?void 0:r.users.length,e,"internal-error");const s=r.users[0];n._notifyReloadListener(s);const o=(y=s.providerUserInfo)!=null&&y.length?Vu(s.providerUserInfo):[],a=vp(n.providerData,o),u=n.isAnonymous,h=!(n.email&&s.passwordHash)&&!(a!=null&&a.length),d=u?h:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new bi(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(n,p)}async function wp(n){const e=Ae(n);await ns(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function vp(n,e){return[...n.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Vu(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ap(n,e){const t=await Cu(n,{},async()=>{const r=cr({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:s,apiKey:o}=n.config,a=await ku(n,s,"/v1/token",`key=${o}`),u=await n._getAdditionalHeaders();u["Content-Type"]="application/x-www-form-urlencoded";const h={method:"POST",headers:u,body:r};return n.emulatorConfig&&ur(n.emulatorConfig.host)&&(h.credentials="include"),Pu.fetch()(a,h)});return{accessToken:t.access_token,expiresIn:t.expires_in,refreshToken:t.refresh_token}}async function Rp(n,e){return En(n,"POST","/v2/accounts:revokeToken",hr(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ya=new Map;function Je(n){et(n instanceof Function,"Expected a class definition");let e=Ya.get(n);return e?(et(e instanceof n,"Instance stored in cache mismatched with class"),e):(e=new n,Ya.set(n,e),e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lp(n,e){const t=Qi(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),o=t.getOptions();if($t(o,e??{}))return s;Ze(s,"already-initialized")}return t.initialize({options:e})}function Up(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Je);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Fp(n,e,t){const r=dr(n);B(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,o=$u(e),{host:a,port:u}=jp(e),h=u===null?"":`:${u}`,d={url:`${o}//${a}${h}/`},p=Object.freeze({host:a,port:u,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){B(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),B($t(d,r.config.emulator)&&$t(p,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=p,r.settings.appVerificationDisabledForTesting=!0,ur(a)?Eu(`${o}//${a}${h}`):Bp()}function $u(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function jp(n){const e=$u(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const o=s[1];return{host:o,port:tc(r.substr(o.length+1))}}else{const[o,a]=r.split(":");return{host:o,port:tc(a)}}}function tc(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Bp(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wp(n,e,t=!1){if(Ne(n.app))return Promise.reject(Ye(n));const r="signIn",s=await Hu(n,r,e),o=await tt._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(o.user),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ju(){return typeof Be().WorkerGlobalScope<"u"&&typeof Be().importScripts=="function"}async function im(){if(!(navigator!=null&&navigator.serviceWorker))return null;try{return(await navigator.serviceWorker.ready).active}catch{return null}}function om(){var n;return((n=navigator==null?void 0:navigator.serviceWorker)==null?void 0:n.controller)||null}function am(){return Ju()?self:null}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class el{constructor(e,t,r,s,o=!1){this.auth=e,this.resolver=r,this.user=s,this.bypassAuthState=o,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:s,tenantId:o,error:a,type:u}=e;if(a){this.reject(a);return}const h={auth:this.auth,requestUri:t,sessionId:r,tenantId:o||void 0,postBody:s||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(u)(h))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return mm;case"linkViaPopup":case"linkViaRedirect":return _m;case"reauthViaPopup":case"reauthViaRedirect":return gm;default:Ze(this.auth,"internal-error")}}resolve(e){et(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){et(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xm=new lr(3e4,6e4);function oc(){const n=Be().___jsl;if(n!=null&&n.H){for(const e of Object.keys(n.H))if(n.H[e].r=n.H[e].r||[],n.H[e].L=n.H[e].L||[],n.H[e].r=[...n.H[e].L],n.CP)for(let t=0;t<n.CP.length;t++)n.CP[t]=null}}function Om(n){return new Promise((e,t)=>{var s,o,a;function r(){oc(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{oc(),t(je(n,"network-request-failed"))},timeout:xm.get()})}if((o=(s=Be().gapi)==null?void 0:s.iframes)!=null&&o.Iframe)e(gapi.iframes.getContext());else if((a=Be().gapi)!=null&&a.load)r();else{const u=Mp("iframefcb");return Be()[u]=()=>{gapi.load?r():t(je(n,"network-request-failed"))},xp(`${Op()}?onload=${u}`).catch(h=>t(h))}}).catch(e=>{throw Gr=null,e})}let Gr=null;function Mm(n){return Gr=Gr||Om(n),Gr}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,cl(n,r,t)}function cl(n,e,t){let r=`FIRESTORE (${Tn}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw nt(r),new Error(r)}function Y(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||cl(e,s,r)}function q(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ul{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class dg{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable((()=>t(Ie.UNAUTHENTICATED)))}shutdown(){}}class fg{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable((()=>t(this.token.user)))}shutdown(){this.changeListener=null}}class pg{constructor(e){this.t=e,this.currentUser=Ie.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){Y(this.o===void 0,42304);let r=this.i;const s=h=>this.i!==r?(r=this.i,t(h)):Promise.resolve();let o=new Ft;this.o=()=>{this.i++,this.currentUser=this.u(),o.resolve(),o=new Ft,e.enqueueRetryable((()=>s(this.currentUser)))};const a=()=>{const h=o;e.enqueueRetryable((async()=>{await h.promise,await s(this.currentUser)}))},u=h=>{N("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=h,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit((h=>u(h))),setTimeout((()=>{if(!this.auth){const h=this.t.getImmediate({optional:!0});h?u(h):(N("FirebaseAuthCredentialsProvider","Auth not yet detected"),o.resolve(),o=new Ft)}}),0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then((r=>this.i!==e?(N("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(Y(typeof r.accessToken=="string",31837,{l:r}),new ul(r.accessToken,this.currentUser)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return Y(e===null||typeof e=="string",2055,{h:e}),new Ie(e)}}class mg{constructor(e,t,r){this.P=e,this.T=t,this.I=r,this.type="FirstParty",this.user=Ie.FIRST_PARTY,this.R=new Map}A(){return this.I?this.I():null}get headers(){this.R.set("X-Goog-AuthUser",this.P);const e=this.A();return e&&this.R.set("Authorization",e),this.T&&this.R.set("X-Goog-Iam-Authorization-Token",this.T),this.R}}class gg{constructor(e,t,r){this.P=e,this.T=t,this.I=r}getToken(){return Promise.resolve(new mg(this.P,this.T,this.I))}start(e,t){e.enqueueRetryable((()=>t(Ie.FIRST_PARTY)))}shutdown(){}invalidateToken(){}}class fc{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class _g{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Ne(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){Y(this.o===void 0,3512);const r=o=>{o.error!=null&&N("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${o.error.message}`);const a=o.token!==this.m;return this.m=o.token,N("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(o.token):Promise.resolve()};this.o=o=>{e.enqueueRetryable((()=>r(o)))};const s=o=>{N("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=o,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit((o=>s(o))),setTimeout((()=>{if(!this.appCheck){const o=this.V.getImmediate({optional:!0});o?s(o):N("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}}),0)}getToken(){if(this.p)return Promise.resolve(new fc(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then((t=>t?(Y(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new fc(t.token)):null)):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const e_=new se(F.comparator);function rt(){return e_}const kl=new se(F.comparator);function $n(...n){let e=kl;for(const t of n)e=e.insert(t.key,t);return e}function Vl(n){let e=kl;return n.forEach(((t,r)=>e=e.insert(t,r.overlayedDocument))),e}function Ut(){return Kn()}function Nl(){return Kn()}function Kn(){return new Qt((n=>n.toString()),((n,e)=>n.isEqual(e)))}const t_=new se(F.comparator),n_=new de(F.comparator);function Q(...n){let e=n_;for(const t of n)e=e.add(t);return e}const r_=new de(K);function s_(){return r_}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mo(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:os(e)?"-0":e}}function Dl(n){return{integerValue:""+n}}function i_(n,e){return Cg(e)?Dl(e):mo(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class G_{constructor(){this.changes=new Qt((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,we.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?S.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ch extends SE{constructor(e){super(),this.firestore=e}convertBytes(e){return new De(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new he(this.firestore,null,t)}}const cu="@firebase/firestore",uu="4.14.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}),O+=`
`)}),O};return{user:n,reports:t,isAnalyzing:s,activeReport:a,setActiveReport:u,url:h,setUrl:d,isExporting:p,runUXAudit:A,exportToGithub:()=>{if(!a)return;const O=encodeURIComponent(V()),M=encodeURIComponent(`UX Audit Findings: ${a.url}`);let U="https://github.com/new";try{const H=new URL(a.url);if(H.hostname.endsWith(".github.io")){const G=H.hostname.split(".")[0],X=H.pathname.split("/")[1];G&&X&&(U=`https://github.com/${G}/${X}/issues/new`)}}catch{}window.open(`${U}?title=${M}&body=${O}`,"_blank")},copyMarkdown:()=>{const O=V(),M=document.createElement("textarea");M.value=O,document.body.appendChild(M),M.select(),document.execCommand("copy"),document.body.removeChild(M),y(!0),setTimeout(()=>y(!1),2e3)},firebaseConfig:Mt}}const ME={Mobile:C.jsx(Id,{className:"w-5 h-5"}),Tablet:C.jsx(vd,{className:"w-5 h-5"}),Desktop:C.jsx(yd,{className:"w-5 h-5"})};function LE({suggestion:n}){const[e,t]=Ke.useState(!1),r=async()=>{await navigator.clipboard.writeText(n),document.startViewTransition?document.startViewTransition(()=>{t(!0)}):t(!0),setTimeout(()=>{document.startViewTransition?document.startViewTransition(()=>t(!1)):t(!1)},2e3)};return C.jsxs(ee,{as:"button",onClick:r,marginTop:2,display:"flex",align:"center",gap:1,paddingX:3,paddingY:1,radius:"md",surface:"default",border:!0,className:"hover:border-accent transition-colors hover:text-accent font-bold text-xs",children:[e?C.jsx(Ti,{className:"w-3 h-3 text-[var(--color-success,#16a34a)]"}):C.jsx(du,{className:"w-3 h-3"}),e?C.jsx("span",{className:"text-[var(--color-success,#16a34a)]",children:"Copied!"}):C.jsx("span",{children:"Copy Prompt"})]})}function KE(){const{reports:n,isAnalyzing:e,activeReport:t,setActiveReport:r,url:s,setUrl:o,isExporting:a,runUXAudit:u,exportToGithub:h,copyMarkdown:d}=OE();return C.jsxs(Ue,{gap:8,width:"full",children:[C.jsxs(Ue,{direction:{base:"col",md:"row"},align:{base:"start",md:"center"},justify:"between",gap:6,border:"b",paddingBottom:6,children:[C.jsx(ee,{children:C.jsx(ld,{label:"Visual UX Auditor",title:"Multimodal AI Analysis",description:"Automated visual regression and UX improvement suggestions across viewports."})}),C.jsxs(Ue,{direction:"row",align:"center",gap:3,surface:"default",padding:2,radius:"xl",shadow:"sm",border:!0,children:[C.jsx(ee,{as:"input",type:"text",value:s,onChange:p=>o(p.target.value),className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text",style:{width:"16rem",padding:"0.5rem 1rem",borderRadius:"0.5rem",fontSize:"0.875rem"},placeholder:"https://..."}),C.jsxs(ee,{as:"button",onClick:u,disabled:e,display:"flex",align:"center",gap:2,className:"bg-accent hover:opacity-90 text-white font-bold transition-all disabled:opacity-50",style:{padding:"0.5rem 1.5rem",borderRadius:"0.5rem"},children:[e?C.jsx(ai,{className:"animate-spin w-4 h-4"}):C.jsx(Ua,{className:"w-4 h-4"}),e?"Auditing...":"Start Audit"]})]})]}),C.jsxs(La,{cols:{base:1,lg:4},gap:8,children:[C.jsxs(Ue,{gap:4,span:{lg:1},children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"widest",color:"dim",paddingX:1,children:"Audit History"}),C.jsxs(Ue,{surface:"default",radius:"2xl",shadow:"sm",border:!0,overflow:"hidden",className:"divide-y divide-line",children:[n.length===0&&C.jsx(ee,{padding:10,className:"italic",color:"dim",align:"center",size:"sm",children:"No audits recorded."}),n.map(p=>C.jsxs(ee,{as:"button",onClick:()=>r(p),width:"full",display:"flex",align:"center",gap:3,padding:4,className:`text-left hover:bg-surface transition-all ${(t==null?void 0:t.id)===p.id?"bg-bg border-l-4 border-accent":"border-l-4 border-transparent"}`,children:[C.jsx(ee,{padding:2,radius:"full",className:p.status==="completed"?"bg-[var(--color-success-dim,#dcfce7)] text-[var(--color-success,#16a34a)]":"bg-[var(--color-warning-dim,#fef3c7)] text-[var(--color-warning,#d97706)] animate-pulse",children:p.status==="completed"?C.jsx(Ti,{className:"w-4 h-4"}):C.jsx(ai,{className:"w-4 h-4"})}),C.jsxs(ee,{flex:1,minWidth:"0",children:[C.jsx(pe,{variant:"sans",size:"sm",weight:"font-bold",className:"truncate",children:p.url.replace("https://","")}),C.jsx(pe,{variant:"mono",size:"xs",weight:"font-medium",color:"dim",uppercase:!0,children:new Date(p.timestamp).toLocaleTimeString()})]}),C.jsx(hd,{className:"w-4 h-4 text-text-dim opacity-50"})]},p.id))]})]}),C.jsx(Ue,{gap:6,span:{lg:3},children:t?C.jsxs(C.Fragment,{children:[C.jsxs(ee,{surface:"default",padding:6,radius:"2xl",shadow:"sm",border:!0,display:"flex",justify:"between",align:"center",gap:4,direction:{base:"col",md:"row"},children:[C.jsxs(ee,{children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",color:"accent",uppercase:!0,tracking:"tighter",marginBottom:1,children:"Current Session"}),C.jsx(pe,{variant:"sans",size:"xl",weight:"font-black",children:t.url})]}),C.jsxs(ee,{display:"flex",gap:2,children:[C.jsxs(ee,{as:"button",onClick:d,display:"flex",align:"center",gap:2,className:"font-bold hover:text-text transition-all",surface:"muted",color:"dim",style:{padding:"0.5rem 1rem",borderRadius:"0.75rem",fontSize:"0.875rem"},children:[a?C.jsx(Ti,{className:"w-4 h-4"}):C.jsx(du,{className:"w-4 h-4"}),a?"Copied":"Copy MD"]}),C.jsxs(ee,{as:"button",onClick:h,disabled:t.status!=="completed",display:"flex",align:"center",gap:2,className:"font-bold bg-text text-surface hover:opacity-90 shadow-md transition-all disabled:opacity-50",style:{padding:"0.5rem 1.5rem",borderRadius:"0.75rem",fontSize:"0.875rem"},children:[C.jsx(dd,{className:"w-4 h-4"}),"Export to GitHub Issue"]})]})]}),C.jsx(Ue,{gap:8,children:Gi.map(p=>{var b;const y=t[`findings_${p.name.toLowerCase()}`],A=t[`image_${p.name.toLowerCase()}`];return C.jsxs(ee,{surface:"default",radius:"2xl",shadow:"sm",border:!0,overflow:"hidden",children:[C.jsxs(ee,{padding:4,border:"b",display:"flex",align:"center",justify:"between",surface:"muted",children:[C.jsxs(ee,{display:"flex",align:"center",gap:3,children:[C.jsx(ee,{padding:2,surface:"default",radius:"lg",shadow:"sm",color:"accent",children:ME[p.name]}),C.jsxs(pe,{variant:"sans",size:"base",weight:"font-bold",children:[p.name," Analysis"]})]}),C.jsxs(pe,{variant:"mono",size:"xs",weight:"font-bold",color:"dim",uppercase:!0,tracking:"widest",children:[p.width,"w × ",p.height,"h"]})]}),C.jsxs(La,{cols:{base:1,md:12},children:[C.jsx(ee,{padding:8,surface:"muted",display:"flex",align:"center",justify:"center",border:"r",minHeight:400,span:{base:1,md:5},children:A?C.jsx("img",{src:A,alt:`${p.name} snapshot`,className:"w-full h-auto rounded-xl shadow-2xl border border-surface object-contain bg-surface",style:{maxHeight:"450px"},onError:V=>{V.target.src=`https://placehold.co/${p.width}x${p.height}/e2e8f0/64748b?text=Snapshot+Unavailable`}}):C.jsxs(ee,{className:"text-center",color:"dim",children:[C.jsx(gd,{className:"w-12 h-12 mx-auto mb-2 opacity-20"}),C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"wider",children:"Awaiting Frame..."})]})}),C.jsx(Ue,{gap:6,padding:8,span:{base:1,md:7},children:y?C.jsxs(C.Fragment,{children:[C.jsxs(ee,{surface:"muted",border:!0,padding:5,radius:"2xl",children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-black",color:"accent",uppercase:!0,marginBottom:2,tracking:"widest",children:"Analysis Summary"}),C.jsxs(pe,{variant:"sans",size:"sm",weight:"font-medium",className:"leading-relaxed",children:['"',y.summary,'"']})]}),C.jsx(Ue,{gap:4,children:(b=y.improvements)==null?void 0:b.map((V,L)=>C.jsxs(ee,{padding:4,radius:"xl",border:!0,surface:"default",shadow:"sm",className:"hover:border-accent/30 transition-all",children:[C.jsxs(ee,{display:"flex",justify:"between",align:"start",marginBottom:2,children:[C.jsxs(pe,{variant:"sans",size:"sm",weight:"font-black",className:"flex items-center gap-2",children:[C.jsx("div",{className:`h-2 w-2 rounded-full ${V.severity>7?"bg-[var(--color-error,#ef4444)] shadow-sm":"bg-[var(--color-warning,#f59e0b)]"}`}),V.element]}),C.jsxs(pe,{variant:"mono",size:"xs",weight:"font-black",paddingX:2,paddingY:.5,radius:"full",surface:"muted",color:"dim",uppercase:!0,children:["LVL ",V.severity]})]}),C.jsx(pe,{variant:"sans",size:"xs",color:"dim",marginBottom:3,children:V.issue}),C.jsxs(ee,{surface:"muted",padding:3,radius:"lg",border:!0,display:"flex",align:"start",gap:2,children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",color:"accent",marginTop:.5,children:"FIX"}),C.jsxs(ee,{flex:1,minWidth:"0",children:[C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",className:"break-words whitespace-pre-wrap line-clamp-4",children:V.suggestion}),V.element==="Manual Audit Required"&&C.jsx(LE,{suggestion:V.suggestion})]})]})]},L))})]}):C.jsxs(ee,{display:"flex",align:"center",justify:"center",paddingY:20,direction:"col",color:"dim",children:[C.jsx(ai,{className:"animate-spin w-6 h-6"}),C.jsx(pe,{variant:"sans",size:"xs",weight:"font-bold",tracking:"widest",uppercase:!0,children:"Agent Processing..."})]})})]})]},p.name)})})]}):C.jsxs(Ue,{height:"full",align:"center",justify:"center",surface:"default",radius:"3xl",padding:20,minHeight:500,className:"border-2 border-dashed text-center",children:[C.jsx(ee,{surface:"muted",padding:6,radius:"full",marginBottom:6,className:"text-text-dim/50",children:C.jsx(Ua,{className:"w-16 h-16"})}),C.jsx(pe,{variant:"sans",size:"xl",weight:"font-black",marginBottom:2,children:"Ready to Audit"}),C.jsx(pe,{variant:"sans",size:"sm",weight:"font-medium",color:"dim",maxWidth:"sm",marginX:"auto",children:"Enter a URL above to start the visual analysis across Mobile, Tablet, and Desktop."})]})})]})]})}export{KE as default};
