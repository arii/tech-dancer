import{A}from"./index-D9j7rkp4.js";const P=`---
type: post
draft: true
status: draft
...
`,x=Object.freeze(Object.defineProperty({__proto__:null,default:P},Symbol.toStringTag,{value:"Module"})),I=`---
type: post
draft: true
status: draft
...
`,D=Object.freeze(Object.defineProperty({__proto__:null,default:I},Symbol.toStringTag,{value:"Module"})),j=`---
type: post
draft: true
...
`,W=Object.freeze(Object.defineProperty({__proto__:null,default:j},Symbol.toStringTag,{value:"Module"})),B=`---
type: post
...
`,z=Object.freeze(Object.defineProperty({__proto__:null,default:B},Symbol.toStringTag,{value:"Module"})),M=`---
type: post
...
`,O=Object.freeze(Object.defineProperty({__proto__:null,default:M},Symbol.toStringTag,{value:"Module"})),E=`---
type: post
draft: false
status: published
...
`,F=Object.freeze(Object.defineProperty({__proto__:null,default:E},Symbol.toStringTag,{value:"Module"})),R=`---
type: post
...
`,G=Object.freeze(Object.defineProperty({__proto__:null,default:R},Symbol.toStringTag,{value:"Module"})),L=`---
type: post
draft: true
...
`,N=Object.freeze(Object.defineProperty({__proto__:null,default:L},Symbol.toStringTag,{value:"Module"})),H=`---
type: post
...
`,U=Object.freeze(Object.defineProperty({__proto__:null,default:H},Symbol.toStringTag,{value:"Module"})),q=`---
type: post
title: "General Health & Home Care for Dancers"
date: "2026-06-01"
author: "Ariel Anders"
category: "Health"
excerpt: "Master your post-event recovery routine with targeted foam-rolling techniques, muscle maintenance, and self-care strategies for the active West Coast Swing dancer."
...
## Post-Event Recovery & Maintenance
...
author: "Ariel Anders"
category: "Gear"
excerpt: "Functional dance wear, breathable layers, and styling basics for your next West Coast Swing practice or social."
...
## Building Your Social Dance Wardrobe

Functional dance wear should be comfortable, breathable, and stylish. If you're figuring out what to wear to your first WCS social, these non-merch basics are perfect for layering and creating your own unique look on the floor. Explore our full [curated social dance apparel and gear](/gear) catalog or check out our [lead and follow switch dynamics](/gear/2024-06-01-love-neon-switch-shirt) collection.
...
## Eliminating Dance Shoe Odor

Your shoes are your most important piece of equipment, but they are also the most prone to developing that dreaded funk. For years, I tried almost every remedy in the book: foot powders, deodorizing sprays, and even stuffing dryer sheets into my shoes after a long night of social dancing.

While some of these provided temporary relief, none addressed the root cause: deep-seated moisture buildup in the footbed. When sweat gets trapped inside your shoes during a multi-day event, it creates the perfect environment for microbial growth. An electric shoe dryer forces warm air through the material, stopping that growth before it starts. Pair this daily drying routine with proper suede brushing to keep the soles clean, and wear sweat-wicking socks to protect the interior lining.
...
### How do you get the smell out of dance shoes?
The most effective method is using a portable electric shoe dryer immediately after dancing. This eliminates the deep-seated moisture in the footbed and stops microbial growth before it starts, rather than just masking the odor with powders or sprays.

### Can you wash suede sole dance shoes?
You should never submerge suede soles in water. To clean them, use a wire suede brush to remove dirt and restore the nap of the leather. Keep moisture restricted to the interior lining.
...
For competitive West Coast Swing dancers, understanding the World Swing Dance Council (WSDC) points system is a crucial part of navigating Jack & Jill competitions.

How do WSDC points work? The WSDC system awards points to dancers who make the finals of registered Jack & Jill competitions. The number of points awarded is calculated based on your final placement and the tier size (total number of competitors) in your specific division.

### How Scoring Works in Prelims

Before you can earn points, you have to make the finals. In preliminary rounds, judges use a callback system evaluating timing, technique, and teamwork. Instead of assigning a numerical score, judges vote "Yes", "Alternate", or "No" for each competitor. Earn enough "Yes" votes, and you move on to the next round.

### Navigating the Novice Division

The Novice division is often the largest heat of the weekend, making it fiercely competitive. Flashy moves won't save poor timing. Solid fundamentals, clear partner connection, and dancing cleanly to the music are the most important criteria for judges trying to narrow down a massive field of dancers.

### Calculating Your Points & Leveling Up

Once you make the finals, the judges rank the competitors using a system called relative placement. Your final standing, combined with the event's tier size, determines the exact number of points added to your WSDC registry ID.
Accumulating these points is how you level up. If you feel you are consistently outperforming your current division but haven't hit the automatic advancement threshold, you can look into petitioning the chief judge at your next event. Keep in mind that points earned in Strictly Swing or Pro-Am divisions are tracked separately and do not count toward your Jack & Jill advancement.

## Frequently Asked Questions

### How are WSDC points calculated?
WSDC points are calculated using relative placement in the finals. The exact number of points awarded is determined by your final standing and the event's tier size, which is based on the total number of competitors in your division.
...
`,de=Object.freeze(Object.defineProperty({__proto__:null,default:ce},Symbol.toStringTag,{value:"Module"})),ue=`---
type: blog
...
`,he=Object.freeze(Object.defineProperty({__proto__:null,default:ue},Symbol.toStringTag,{value:"Module"})),pe=`---
type: study
...
`,Ce=Object.freeze(Object.defineProperty({__proto__:null,default:Ae},Symbol.toStringTag,{value:"Module"})),Pe=`---
type: resource
...
specs:
  ...
  "Tank Capacity": "120 ml (4.0 oz)"
  "Weight": "1.1 lbs (500 g)"
  "Continuous Steam": "8-10 Minutes"
---

## Competition ready, anywhere

Wrinkles ruin your competition outfits before you even step onto the floor. When you pull a tailored shirt or floor-length satin skirt out of a carry-on after six hours of travel, hotel irons present a terrifying risk: one wrong temperature setting can scorch delicate fabrics, melt synthetic mesh, or leave shiny press marks across dark cotton collars. A compact garment steamer eliminates those risks by relaxing fibers with safe, even heat.

For complete out-of-town event preparation, check out our [WCS competition travel checklist](/blog/2026-06-01-event-travel-packing) and browse our [full dance gear directory](/gear).

### Performance on delicate dance fabrics

Dance garments feature high-maintenance materials that rarely survive standard hotel iron soles. In testing across common West Coast Swing performance apparel, the steamer delivered consistent results:

* **Chiffon & Mesh:** Sheer sleeves and floating skirts smooth out almost instantly without water spotting or fiber heat distortion.
* **Satin & Silk Blends:** Relaxes heavy packing creases in flowy skirts without creating press shine or watermark stains.
* **Spandex & Synthetic Stretch:** Safely removes deep wrinkles from form-fitting tops and pants where direct metal contact risks melting elastic fibers.
* **Structured Cotton Collars:** Provides enough continuous steam flow to restore crispness to woven competition button-downs, keeping lines sharp under ballroom lighting.

### Packing and travel logistics

At just 1.1 pounds, the steamer adds minimal weight to carry-on luggage while taking up less space than a pair of dance shoes. Key logistical features include:

* **Dual-voltage compatibility:** Automatic 110V/240V switching allows global use at international swing events across Europe and Asia with only a plug adapter.
* **Spill-proof angle testing:** The internal baffle system prevents hot water spitting during horizontal touch-ups on flat surfaces or low hanging angles.
* **Tank capacity vs. weight:** The 120 ml reservoir yields 8 to 10 minutes of continuous steam—enough to press a full competition outfit (shirt, trousers, and vest or dress) on a single fill without adding bulk to your bag.

### Practical hotel hacks

When prepping in cramped hotel rooms between workshop tracks and prelims, efficiency is crucial:
...
`,xe=Object.freeze(Object.defineProperty({__proto__:null,default:Pe},Symbol.toStringTag,{value:"Module"})),Ie=`---
type: resource
...
`,De=Object.freeze(Object.defineProperty({__proto__:null,default:Ie},Symbol.toStringTag,{value:"Module"})),je=`---
type: resource
...
`,We=Object.freeze(Object.defineProperty({__proto__:null,default:je},Symbol.toStringTag,{value:"Module"})),Be=`---
type: resource
...
`,ze=Object.freeze(Object.defineProperty({__proto__:null,default:Be},Symbol.toStringTag,{value:"Module"})),Me=`---
type: resource
...
`,Oe=Object.freeze(Object.defineProperty({__proto__:null,default:Me},Symbol.toStringTag,{value:"Module"})),Ee=`---
type: resource
...
`,Fe=Object.freeze(Object.defineProperty({__proto__:null,default:Ee},Symbol.toStringTag,{value:"Module"})),Re=`---
type: resource
...
`,Ge=Object.freeze(Object.defineProperty({__proto__:null,default:Re},Symbol.toStringTag,{value:"Module"})),Le=`---
type: resource
...
`,Ne=Object.freeze(Object.defineProperty({__proto__:null,default:Le},Symbol.toStringTag,{value:"Module"})),He=`---
type: resource
...
`,Ue=Object.freeze(Object.defineProperty({__proto__:null,default:He},Symbol.toStringTag,{value:"Module"})),qe=`---
type: resource
...
verdict: "Stylish & Social"
updatedDate: "June 2024"
shopUrl: https://boomtick.printful.me/product/love-neon-tshirt-ask-me-to-lead
displayMode: "pair"
featuredSide: "back"
...
`,un=Object.freeze(Object.defineProperty({__proto__:null,default:dn},Symbol.toStringTag,{value:"Module"})),hn=`---
type: resource
...
`,pn=Object.freeze(Object.defineProperty({__proto__:null,default:hn},Symbol.toStringTag,{value:"Module"})),gn=`---
type: resource
...
`,Pn=Object.freeze(Object.defineProperty({__proto__:null,default:Cn},Symbol.toStringTag,{value:"Module"})),xn=`---
type: resource
...
`,In=Object.freeze(Object.defineProperty({__proto__:null,default:xn},Symbol.toStringTag,{value:"Module"})),Dn=`---
type: resource
...
`,jn=Object.freeze(Object.defineProperty({__proto__:null,default:Dn},Symbol.toStringTag,{value:"Module"})),Wn=`---
type: resource
...
`,Bn=Object.freeze(Object.defineProperty({__proto__:null,default:Wn},Symbol.toStringTag,{value:"Module"})),zn=`---
type: resource
...
`,Mn=Object.freeze(Object.defineProperty({__proto__:null,default:zn},Symbol.toStringTag,{value:"Module"})),On=`---
type: resource
...
`,En=Object.freeze(Object.defineProperty({__proto__:null,default:On},Symbol.toStringTag,{value:"Module"})),Fn=`---
type: resource
...
`,Rn=Object.freeze(Object.defineProperty({__proto__:null,default:Fn},Symbol.toStringTag,{value:"Module"})),Gn=`---
type: resource
...
`,Ln=Object.freeze(Object.defineProperty({__proto__:null,default:Gn},Symbol.toStringTag,{value:"Module"})),Nn=`---
type: resource
...
`,Hn=Object.freeze(Object.defineProperty({__proto__:null,default:Nn},Symbol.toStringTag,{value:"Module"})),Un=`---
type: resource
...
`,qn=Object.freeze(Object.defineProperty({__proto__:null,default:Un},Symbol.toStringTag,{value:"Module"})),Vn=`---
type: resource
id: "slot-era-mug"
...
shopUrl: "https://boomtick.printful.me/product/boomtick-slot-era-west-coast-swing-dancer-womens-fitted-racerback-tank-top"
author: "Ariel Anders"
date: "2024-06-01"
...
- **Direct Fulfillment**: Printed on demand and shipped directly to your door by Printful.

`,Kn=Object.freeze(Object.defineProperty({__proto__:null,default:Yn},Symbol.toStringTag,{value:"Module"})),Qn=`---
type: resource
...
`,$n=Object.freeze(Object.defineProperty({__proto__:null,default:Qn},Symbol.toStringTag,{value:"Module"}));function Xn(e){return e.startsWith(`\r
`)?2:e.startsWith(`
`)?1:0}function Zn(e){const a={},c=e.split(/\r?\n/),t=[{indent:-1,obj:a}];for(let s=0;s<c.length;s++){const p=c[s],n=p.trim();if(!n||n.startsWith("#"))continue;const d=p.search(/\S/);for(;t.length>1&&t[t.length-1].indent>=d;)t.pop();const h=t[t.length-1].obj;if(n.startsWith("- ")){const g=n.slice(2).trim(),l=g.indexOf(":");if(l!==-1){const i=g.slice(0,l).trim(),r=g.slice(l+1).trim();if(i!=="__proto__"&&i!=="constructor"&&i!=="prototype"){const k={};let f=r;r.startsWith('"')&&r.endsWith('"')||r.startsWith("'")&&r.endsWith("'")?f=r.slice(1,-1):r==="true"?f=!0:r==="false"?f=!1:!isNaN(Number(r))&&r!==""&&(f=Number(r)),k[i]=f,Array.isArray(h)&&h.push(k),t.push({indent:d+2,obj:k})}}else{let i=g;typeof i=="string"&&(i.startsWith('"')&&i.endsWith('"')||i.startsWith("'")&&i.endsWith("'"))&&(i=i.slice(1,-1)),Array.isArray(h)&&h.push(i)}continue}const y=n.indexOf(":");if(y===-1)continue;const u=n.slice(0,y).trim();if(u==="__proto__"||u==="constructor"||u==="prototype")continue;const o=n.slice(y+1).trim();if(!o){let g=!1;for(let i=s+1;i<c.length;i++){const r=c[i].trim();if(r&&!r.startsWith("#")){r.startsWith("- ")&&(g=!0);break}}const l=g?[]:{};Array.isArray(h)||(h[u]=l),t.push({indent:d,obj:l,key:u});continue}let m=o;o.startsWith("[")&&o.endsWith("]")?m=o.slice(1,-1).split(",").map(g=>{let l=g.trim();return(l.startsWith('"')&&l.endsWith('"')||l.startsWith("'")&&l.endsWith("'"))&&(l=l.slice(1,-1)),l}).filter(Boolean):o==="true"?m=!0:o==="false"?m=!1:!isNaN(Number(o))&&o!==""&&!o.includes("-")&&!o.includes(":")?m=Number(o):(o.startsWith('"')&&o.endsWith('"')||o.startsWith("'")&&o.endsWith("'"))&&(m=o.slice(1,-1)),Array.isArray(h)||(h[u]=m)}return a}function et(e){if(!e||typeof e!="string"||!e.startsWith("---"))return{data:{},content:e||""};const a=Xn(e.slice(3));if(a===0)return{data:{},content:e};const c=3+a,t=e.slice(c).match(/(?:^|\r?\n)---(?:\r?\n|$)/);if(!t||t.index===void 0)return{data:{},content:e};const s=c+t.index,p=e.slice(c,s).trim(),n=e.slice(s+t[0].length);try{const d=Zn(p);return{data:d&&typeof d=="object"?d:{},content:n}}catch(d){return console.error("Error parsing frontmatter:",d),{data:{},content:n}}}const b={posts:Object.assign({"/content/posts/2026-04-18-competition-metrics.md":x,"/content/posts/2026-04-18-financial-literacy-dancers.md":D,"/content/posts/2026-04-18-github-actions.md":W,"/content/posts/2026-04-18-halloween-costumes.md":z,"/content/posts/2026-04-18-make-shoe-dance.md":O,"/content/posts/2026-04-18-why-finals-are-hard.md":F,"/content/posts/2026-04-19-practical-tools-essentials.md":G,"/content/posts/2026-05-06-boomtick-and-b-the-rhythmic-architecture-of-west-coast-swing.md":N,"/content/posts/2026-06-01-event-travel-packing.md":U,"/content/posts/2026-06-01-general-health-home-care.md":V,"/content/posts/2026-06-01-outdoor-dancing.md":Y,"/content/posts/2026-06-01-power-charging.md":Q,"/content/posts/2026-06-01-practice-review-tech.md":X,"/content/posts/2026-06-01-practice-social-dance-apparel.md":ee,"/content/posts/2026-06-01-shoe-care-modification.md":te,"/content/posts/2026-06-01-theme-wear-costumes-accessories.md":oe,"/content/posts/2026-06-01-wcs-essentials.md":re,"/content/posts/2026-06-15-ultimate-wcs-event-survival-guide.md":le,"/content/posts/2026-06-16-wsdc-points-tier-calculation.md":de}),blogs:Object.assign({"/content/blog/2026-06-14-the-story-behind-the-merch-page.md":he}),studies:Object.assign({"/content/studies/2026-07-10-latest-version-check-skill.md":ge,"/content/studies/ai-devops-pipeline.md":fe,"/content/studies/confidently-incorrect-v4.md":be,"/content/studies/deployment-impact-analyzer.md":we,"/content/studies/wcs-navigator-architecture.md":_e,"/content/studies/wcs-scraper-initial-sync.md":Te}),resources:Object.assign({"/content/resources/2023-10-01-loop-earplugs.md":Ce,"/content/resources/2023-11-01-travel-steamer.md":xe,"/content/resources/2024-01-01-portable-speaker.md":De,"/content/resources/2024-06-01-alien-mask.md":We,"/content/resources/2024-06-01-charging-cables.md":ze,"/content/resources/2024-06-01-compression-cubes.md":Oe,"/content/resources/2024-06-01-crop-tops.md":Fe,"/content/resources/2024-06-01-fishnet-tights.md":Ge,"/content/resources/2024-06-01-foam-roller.md":Ne,"/content/resources/2024-06-01-green-bodysuit.md":Ue,"/content/resources/2024-06-01-light-up-suspenders.md":Ve,"/content/resources/2024-06-01-love-neon-follow-shirt.md":Ye,"/content/resources/2024-06-01-love-neon-lead-shirt.md":Qe,"/content/resources/2024-06-01-love-neon-switch-shirt.md":Xe,"/content/resources/2024-06-01-love-unisex-shirt.md":en,"/content/resources/2024-06-01-mesh-fishnet-top.md":tn,"/content/resources/2024-06-01-nerd-set.md":on,"/content/resources/2024-06-01-norcal-bear-tank.md":sn,"/content/resources/2024-06-01-norcal-bestcal-tshirt.md":cn,"/content/resources/2024-06-01-norcal-crop-top.md":un,"/content/resources/2024-06-01-norcal-gate-crop-hoodie.md":pn,"/content/resources/2024-06-01-norcal-pride-bear-shirt.md":mn,"/content/resources/2024-06-01-norcal-pride-gate-shirt.md":yn,"/content/resources/2024-06-01-portable-charger.md":vn,"/content/resources/2024-06-01-pumpkin-headbands.md":kn,"/content/resources/2024-06-01-pumpkin-stickers.md":Sn,"/content/resources/2024-06-01-rave-fan.md":An,"/content/resources/2024-06-01-reflective-crop-tops.md":Pn,"/content/resources/2024-06-01-running-belt.md":In,"/content/resources/2024-06-01-shoe-dryer.md":jn,"/content/resources/2024-06-01-sunscreen.md":Bn,"/content/resources/2024-06-01-travel-bottles.md":Mn,"/content/resources/2024-06-01-tripod.md":En,"/content/resources/2024-06-01-visor.md":Rn,"/content/resources/2024-06-01-war-eagle-shirt.md":Ln,"/content/resources/2026-04-12-suede-shoe-diy.md":Hn,"/content/resources/relavel-travel-bag.md":qn,"/content/resources/slot-era-mug.md":Jn,"/content/resources/slot-era-tank-top.md":Kn,"/content/resources/slot-era-tote-bag.md":$n})},nt=e=>e.split("/").pop()?.replace(".md","")||"";function tt(e){if(typeof e!="string")return;const a=e.toLowerCase();return["published","draft","planned"].includes(a)?a:void 0}function at(e){if(typeof e=="number")return e;if(typeof e=="string"){const a=parseInt(e.replace(/[^\d]/g,""),10);return isNaN(a)?void 0:a}}function it(e){if(!(e===""||e===void 0||e===null))return typeof e!="string"?e:e.startsWith("/")&&!e.startsWith(A)?`${A}${e}`:e}function _(e,a){const c=t=>Array.isArray(t)?t:[];return Object.entries(e).map(([t,s])=>{const p=typeof s=="string"?s:s.default,{data:n,content:d}=et(p),w=n.type||a,h=u=>{if(u!=="")return typeof u=="string"&&u.startsWith("/")?`${A}${u}`:u};return n.image=h(n.image),n.imageBack=h(n.imageBack),{...n,type:w,title:String(n.title||"Untitled"),category:String(n.category||"General"),excerpt:String(n.excerpt||n.description||""),date:String(n.date||""),author:String(n.author||"Ariel Anders").replace(/,?\s*PhD/i,"").trim(),tags:c(n.tags),affiliateIds:c(n.affiliateIds),seoTitle:n.seoTitle?String(n.seoTitle):void 0,seoDescription:n.seoDescription?String(n.seoDescription):void 0,imageAlt:n.imageAlt?String(n.imageAlt):void 0,imageFit:n.imageFit==="cover"||n.imageFit==="contain"?n.imageFit:void 0,unlisted:!!n.unlisted,status:tt(n.status),readTime:at(n.readTime),content:d||"",slug:nt(t)}}).filter(t=>typeof t=="object"&&t!==null&&"unlisted"in t&&t.unlisted===!0?!1:t.draft?t.type==="study"&&(t.status==="planned"||t.status==="draft"):!0).sort((t,s)=>{const p=t.date?new Date(t.date).getTime():0,n=s.date?new Date(s.date).getTime():0,d=Number.isNaN(p)?0:p;return(Number.isNaN(n)?0:n)-d})}let S=null,T=null;function v(){return S||(S={posts:_({...b.posts,...b.blogs},"post"),studies:_(b.studies,"study"),resources:_(b.resources,"resource")}),S}function C(){if(!T){const e=v();T={posts:new Map(e.posts.map(a=>[a.slug,a])),studies:new Map(e.studies.map(a=>[a.slug,a])),resources:new Map(e.resources.map(a=>[a.slug,a]))}}return T}const rt=()=>v().posts,st=()=>v().studies,lt=e=>C().posts.get(e),ct=()=>v().resources,dt=e=>C().resources.get(e),ut=(e,a)=>{if(e&&e.trim().length>0)return Math.max(1,Math.round(e.split(/\s+/).length/200));const c=a?.split(/\s+/).length??0;return Math.max(1,Math.round(c/20))};export{lt as a,ct as b,dt as c,st as d,rt as g,it as n,ut as r};
