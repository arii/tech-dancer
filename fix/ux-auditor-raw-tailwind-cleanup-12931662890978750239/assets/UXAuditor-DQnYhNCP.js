 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ni=new Qa("@firebase/auth");function H_(r,...e){Ni.logLevel<=Q.WARN&&Ni.warn(`Auth (${vr}): ${r}`,...e)}function _i(r,...e){Ni.logLevel<=Q.ERROR&&Ni.error(`Auth (${vr}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sn=new Qa("@firebase/firestore");function Wn(){return Sn.logLevel}function V(r,...e){if(Sn.logLevel<=Q.DEBUG){const t=e.map(oc);Sn.debug(`Firestore (${br}): ${r}`,...t)}}function ze(r,...e){if(Sn.logLevel<=Q.ERROR){const t=e.map(oc);Sn.error(`Firestore (${br}): ${r}`,...t)}}function Pn(r,...e){if(Sn.logLevel<=Q.WARN){const t=e.map(oc);Sn.warn(`Firestore (${br}): ${r}`,...t)}}function oc(r){if(typeof r=="string")return r;try{return(function(t){return JSON.stringify(t)})(r)}catch{return r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Fe{constructor(e){this.value=e}static empty(){return new Fe({mapValue:{}})}field(e){if(e.isEmpty())return this.value;{let t=this.value;for(let n=0;n<e.length-1;++n)if(t=(t.mapValue.fields||{})[e.get(n)],!Si(t))return null;return t=(t.mapValue.fields||{})[e.lastSegment()],t||null}}set(e,t){this.getFieldsMap(e.popLast())[e.lastSegment()]=cs(t)}setAll(e){let t=ge.emptyPath(),n={},s=[];e.forEach(((o,c)=>{if(!t.isImmediateParentOf(c)){const u=this.getFieldsMap(t);this.applyChanges(u,n,s),n={},s=[],t=c.popLast()}o?n[c.lastSegment()]=cs(o):s.push(c.lastSegment())}));const i=this.getFieldsMap(t);this.applyChanges(i,n,s)}delete(e){const t=this.field(e.popLast());Si(t)&&t.mapValue.fields&&delete t.mapValue.fields[e.lastSegment()]}isEqual(e){return pt(this.value,e.value)}getFieldsMap(e){let t=this.value;t.mapValue.fields||(t.mapValue={fields:{}});for(let n=0;n<e.length;++n){let s=t.mapValue.fields[e.get(n)];Si(s)&&s.mapValue.fields||(s={mapValue:{fields:{}}},t.mapValue.fields[e.get(n)]=s),t=s}return t.mapValue.fields}applyChanges(e,t,n){sn(t,((s,i)=>e[s]=i));for(const s of n)delete e[s]}clone(){return new Fe(cs(this.value))}}function Pf(r){const e=[];return sn(r.fields,((t,n)=>{const s=new ge([t]);if(Si(n)){const i=Pf(n.mapValue).fields;if(i.length===0)e.push(s);else for(const o of i)e.push(s.child(o))}else e.push(s)})),new Ge(e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cf{}class J extends Cf{constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}static create(e,t,n){return e.isKeyField()?t==="in"||t==="not-in"?this.createKeyFieldInFilter(e,t,n):new $T(e,t,n):t==="array-contains"?new HT(e,n):t==="in"?new Of(e,n):t==="not-in"?new WT(e,n):t==="array-contains-any"?new QT(e,n):new J(e,t,n)}static createKeyFieldInFilter(e,t,n){return t==="in"?new GT(e,n):new KT(e,n)}matches(e){const t=e.data.field(this.field);return this.op==="!="?t!==null&&t.nullValue===void 0&&this.matchesComparison(en(t,this.value)):t!==null&&Zt(this.value)===Zt(t)&&this.matchesComparison(en(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return e===0;case"!=":return e!==0;case">":return e>0;case">=":return e>=0;default:return F(47266,{operator:this.op})}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class oe extends Cf{constructor(e,t){super(),this.filters=e,this.op=t,this.Pe=null}static create(e,t){return new oe(e,t)}matches(e){return gr(this)?this.filters.find((t=>!t.matches(e)))===void 0:this.filters.find((t=>t.matches(e)))!==void 0}getFlattenedFilters(){return this.Pe!==null||(this.Pe=this.filters.reduce(((e,t)=>e.concat(t.getFlattenedFilters())),[])),this.Pe}getFilters(){return Object.assign([],this.filters)}}function gr(r){return r.op==="and"}function xa(r){return r.op==="or"}function _c(r){return Vf(r)&&gr(r)}function Vf(r){for(const e of r.filters)if(e instanceof oe)return!1;return!0}function ka(r){if(r instanceof J)return r.field.canonicalString()+r.op.toString()+pr(r.value);if(_c(r))return r.filters.map((e=>ka(e))).join(",");{const e=r.filters.map((t=>ka(t))).join(",");return`${r.op}(${e})`}}function xf(r,e){return r instanceof J?(function(n,s){return s instanceof J&&n.op===s.op&&n.field.isEqual(s.field)&&pt(n.value,s.value)})(r,e):r instanceof oe?(function(n,s){return s instanceof oe&&n.op===s.op&&n.filters.length===s.filters.length?n.filters.reduce(((i,o,c)=>i&&xf(o,s.filters[c])),!0):!1})(r,e):void F(19439)}function kf(r,e){const t=r.filters.concat(e);return oe.create(t,r.op)}function Df(r){return r instanceof J?(function(t){return`${t.field.canonicalString()} ${t.op} ${pr(t.value)}`})(r):r instanceof oe?(function(t){return t.op.toString()+" {"+t.getFilters().map(Df).join(" ,")+"}"})(r):"Filter"}class $T extends J{constructor(e,t,n){super(e,t,n),this.key=M.fromName(n.referenceValue)}matches(e){const t=M.comparator(e.key,this.key);return this.matchesComparison(t)}}class GT extends J{constructor(e,t){super(e,"in",t),this.keys=Nf("in",t)}matches(e){return this.keys.some((t=>t.isEqual(e.key)))}}class KT extends J{constructor(e,t){super(e,"not-in",t),this.keys=Nf("not-in",t)}matches(e){return!this.keys.some((t=>t.isEqual(e.key)))}}function Nf(r,e){return(e.arrayValue?.values||[]).map((t=>M.fromName(t.referenceValue)))}class HT extends J{constructor(e,t){super(e,"array-contains",t)}matches(e){const t=e.data.field(this.field);return bs(t)&&vs(t.arrayValue,this.value)}}class Of extends J{constructor(e,t){super(e,"in",t)}matches(e){const t=e.data.field(this.field);return t!==null&&vs(this.value.arrayValue,t)}}class WT extends J{constructor(e,t){super(e,"not-in",t)}matches(e){if(vs(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;const t=e.data.field(this.field);return t!==null&&t.nullValue===void 0&&!vs(this.value.arrayValue,t)}}class QT extends J{constructor(e,t){super(e,"array-contains-any",t)}matches(e){const t=e.data.field(this.field);return!(!bs(t)||!t.arrayValue.values)&&t.arrayValue.values.some((n=>vs(this.value.arrayValue,n)))}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rE=new me(M.comparator);function Je(){return rE}const Uf=new me(M.comparator);function Zr(...r){let e=Uf;for(const t of r)e=e.insert(t.key,t);return e}function Bf(r){let e=Uf;return r.forEach(((t,n)=>e=e.insert(t,n.overlayedDocument))),e}function lt(){return ls()}function jf(){return ls()}function ls(){return new Rt((r=>r.toString()),((r,e)=>r.isEqual(e)))}const sE=new me(M.comparator),iE=new ae(M.comparator);function W(...r){let e=iE;for(const t of r)e=e.add(t);return e}const oE=new ae($);function aE(){return oE}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pp(r){if(U(r instanceof J||r instanceof oe,20012),r instanceof J){if(r instanceof Of){const t=r.value.arrayValue?.values?.map((n=>J.create(r.field,"==",n)))||[];return oe.create(t,"or")}return r}const e=r.filters.map((t=>pp(t)));return oe.create(e,r.op)}function jE(r){if(r.getFilters().length===0)return[];const e=za(pp(r));return U(mp(e),7391),Ba(e)||ja(e)?[e]:e.getFilters()}function Ba(r){return r instanceof J}function ja(r){return r instanceof oe&&_c(r)}function mp(r){return Ba(r)||ja(r)||(function(t){if(t instanceof oe&&xa(t)){for(const n of t.getFilters())if(!Ba(n)&&!ja(n))return!1;return!0}return!1})(r)}function za(r){if(U(r instanceof J||r instanceof oe,34018),r instanceof J)return r;if(r.filters.length===1)return za(r.filters[0]);const e=r.filters.map((n=>za(n)));let t=oe.create(e,r.op);return t=Qi(t),mp(t)?t:(U(t instanceof oe,64498),U(gr(t),40251),U(t.filters.length>1,57927),t.filters.reduce(((n,s)=>bc(n,s))))}function bc(r,e){let t;return U(r instanceof J||r instanceof oe,38388),U(e instanceof J||e instanceof oe,25473),t=r instanceof J?e instanceof J?(function(s,i){return oe.create([s,i],"and")})(r,e):ph(r,e):e instanceof J?ph(e,r):(function(s,i){if(U(s.filters.length>0&&i.filters.length>0,48005),gr(s)&&gr(i))return kf(s,i.getFilters());const o=xa(s)?s:i,c=xa(s)?i:s,u=o.filters.map((h=>bc(h,c)));return oe.create(u,"or")})(r,e),Qi(t)}function ph(r,e){if(gr(e))return kf(e,r.getFilters());{const t=e.filters.map((n=>bc(r,n)));return oe.create(t,"or")}}function Qi(r){if(U(r instanceof J||r instanceof oe,11850),r instanceof J)return r;const e=r.getFilters();if(e.length===1)return Qi(e[0]);if(Vf(r))return r;const t=e.map((s=>Qi(s))),n=[];return t.forEach((s=>{s instanceof J?n.push(s):s instanceof oe&&(s.op===r.op?n.push(...s.filters):n.push(s))})),n.length===1?n[0]:oe.create(n,r.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vp{constructor(){this.changes=new Rt((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Ie.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const n=this.changes.get(t);return n!==void 0?v.resolve(n):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vc{constructor(e,t,n,s){this.targetId=e,this.fromCache=t,this.Ts=n,this.Es=s}static Is(e,t){let n=W(),s=W();for(const i of t.docChanges)switch(i.type){case 0:n=n.add(i.doc.key);break;case 1:s=s.add(i.doc.key)}return new Vc(e,t.fromCache,n,s)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class jc{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new k(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new ge(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
