import{A as ze}from"./index-tUgO_b_H.js";const gn=`---
type: post
draft: true
status: draft
...
<notice type="affiliate" id="loop-experience" />
`,zn=Object.freeze(Object.defineProperty({__proto__:null,default:Yn},Symbol.toStringTag,{value:"Module"})),Jn=`---
...
`),E=y!==-1,U=t.inFlow??e.flow??e.items.length===0;if(E||!U){let z=!1;if(E&&(_==="&"||_==="!")){let L=S.indexOf(" ");_==="&"&&L!==-1&&L<y&&S[L+1]==="!"&&(L=S.indexOf(" ",L+1)),(L===-1||y<L)&&(z=!0)}z||(A=`
${t.indent}`)}}else(S===""||S[0]===`
...
\r	`),Ye=n=>!n||si.has(n);class ii{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
