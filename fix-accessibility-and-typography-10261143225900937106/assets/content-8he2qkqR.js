import{A as Ye}from"./index-KGvwxJLb.js";const gn=`---
type: post
draft: true
status: draft
...
`,Un=Object.freeze(Object.defineProperty({__proto__:null,default:xn},Symbol.toStringTag,{value:"Module"})),Kn=`---
type: post
...
`,Wn=Object.freeze(Object.defineProperty({__proto__:null,default:Kn},Symbol.toStringTag,{value:"Module"})),qn=`---
type: post
...
`,Hn=Object.freeze(Object.defineProperty({__proto__:null,default:qn},Symbol.toStringTag,{value:"Module"})),Gn=`---
type: post
...
`,l+=2;a+=o,t[l+2]===" "&&(a+="\\"),l+=1,r=l+1}break;default:l+=1}return a=r?a+t.slice(r):t,s?a:Be(a,o,Ce,Me(e,!1))}function Ze(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
...
`)?ee(o,e):Oe(n,e,t,s);if(!r&&!d&&i!==T.PLAIN&&o.includes(`
`))return Oe(n,e,t,s);if(De(o)){if(l==="")return e.forceBlockIndent=!0,Oe(n,e,t,s);if(r&&l===c)return ee(o,e)}const u=o.replace(/\n+/g,`$&
${l}`);if(a){const h=f=>f.default&&f.tag!=="tag:yaml.org,2002:str"&&f.test?.test(u),{compat:m,tags:g}=e.doc.schema;if(g.some(h)||m?.some(h))return ee(o,e)}return r?u:Be(u,l,Rt,Me(e,!1))}function at(n,e,t,s){const{implicitKey:i,inFlow:o}=e,a=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)});let{type:r}=n;r!==T.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(a.value)&&(r=T.QUOTE_DOUBLE);const l=d=>{switch(d){case T.BLOCK_FOLDED:case T.BLOCK_LITERAL:return i||o?ee(a.value,e):Oe(a,e,t,s);case T.QUOTE_DOUBLE:return pe(a.value,e);case T.QUOTE_SINGLE:return Ze(a.value,e);case T.PLAIN:return ms(a,e,t,s);default:return null}};let c=l(r);if(c===null){const{defaultKeyType:d,defaultStringType:u}=e.options,h=i&&d||u;if(c=l(h),c===null)throw new Error(`Unsupported default string type ${h}`)}return c}function Ft(n,e){const t=Object.assign({blockQuote:!0,commentString:ds,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e);let s;switch(t.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:s,options:t}}function gs(n,e){if(e.tag){const i=n.filter(o=>o.tag===e.tag);if(i.length>0)return i.find(o=>o.format===e.format)??i[0]}let t,s;if(I(e)){s=e.value;let i=n.filter(o=>o.identify?.(s));if(i.length>1){const o=i.filter(a=>a.test);o.length>0&&(i=o)}t=i.find(o=>o.format===e.format)??i.find(o=>!o.format)}else s=e,t=n.find(i=>i.nodeClass&&s instanceof i.nodeClass);if(!t){const i=s?.constructor?.name??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${i} value`)}return t}function ys(n,e,{anchors:t,doc:s}){if(!s.directives)return"";const i=[],o=(I(n)||C(n))&&n.anchor;o&&jt(o)&&(t.add(o),i.push(`&${o}`));const a=n.tag??(e.default?null:e.tag);return a&&i.push(s.directives.tagString(a)),i.join(" ")}function se(n,e,t,s){if(N(n))return n.toString(e,t,s);if(ae(n)){if(e.doc.directives)return n.toString(e);if(e.resolvedAliases?.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i;const o=O(n)?n:e.doc.createNode(n,{onTagObj:l=>i=l});i??(i=gs(e.doc.schema.tags,o));const a=ys(o,i,e);a.length>0&&(e.indentAtStart=(e.indentAtStart??0)+a.length+1);const r=typeof i.stringify=="function"?i.stringify(o,e,t,s):I(o)?at(o,e,t,s):o.toString(e,t,s);return a?I(o)||r[0]==="{"||r[0]==="["?`${a} ${r}`:`${a}
${e.indent}${r}`:r}function bs({key:n,value:e},t,s,i){const{allNullValues:o,doc:a,indent:r,indentStep:l,options:{commentString:c,indentSeq:d,simpleKeys:u}}=t;let h=O(n)&&n.comment||null;if(u){if(h)throw new Error("With simple keys, key nodes cannot have comments");if(C(n)||!O(n)&&typeof n=="object"){const _="With simple keys, collection cannot be used as a key value";throw new Error(_)}}let m=!u&&(!n||h&&e==null&&!t.inFlow||C(n)||(I(n)?n.type===T.BLOCK_FOLDED||n.type===T.BLOCK_LITERAL:typeof n=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!m&&(u||!o),indent:r+l});let g=!1,f=!1,p=se(n,t,()=>g=!0,()=>f=!0);if(!m&&!t.inFlow&&p.length>1024){if(u)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");m=!0}if(t.inFlow){if(o||e==null)return g&&s&&s(),p===""?"?":m?`? ${p}`:p}else if(o&&!u||e==null&&m)return p=`? ${p}`,h&&!g?p+=G(p,t.indent,c(h)):f&&i&&i(),p;g&&(h=null),m?(h&&(p+=G(p,t.indent,c(h))),p=`? ${p}
...
`):A+=`
${t.indent}`}else if(!m&&C(e)){const _=S[0],y=S.indexOf(`
`),E=y!==-1,K=t.inFlow??e.flow??e.items.length===0;if(E||!K){let J=!1;if(E&&(_==="&"||_==="!")){let L=S.indexOf(" ");_==="&"&&L!==-1&&L<y&&S[L+1]==="!"&&(L=S.indexOf(" ",L+1)),(L===-1||y<L)&&(J=!0)}J||(A=`
${t.indent}`)}}else(S===""||S[0]===`
`)&&(A="");return p+=A+S,t.inFlow?v&&s&&s():k&&!v?p+=G(p,t.indent,c(k)):f&&i&&i(),p}function xt(n,e){(n==="debug"||n==="warn")&&console.warn(e)}const ve="<<",U={identify:n=>n===ve||typeof n=="symbol"&&n.description===ve,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new T(Symbol(ve)),{addToJSMap:Ut}),stringify:()=>ve},ws=(n,e)=>(U.identify(e)||I(e)&&(!e.type||e.type===T.PLAIN)&&U.identify(e.value))&&n?.doc.schema.tags.some(t=>t.tag===U.tag&&t.default);function Ut(n,e,t){const s=Kt(n,t);if(be(s))for(const i of s.items)We(n,e,i);else if(Array.isArray(s))for(const i of s)We(n,e,i);else We(n,e,s)}function We(n,e,t){const s=Kt(n,t);if(!ye(s))throw new Error("Merge sources must be maps or map aliases");const i=s.toJSON(null,n,Map);for(const[o,a]of i)e instanceof Map?e.has(o)||e.set(o,a):e instanceof Set?e.add(o):Object.prototype.hasOwnProperty.call(e,o)||Object.defineProperty(e,o,{value:a,writable:!0,enumerable:!0,configurable:!0});return e}function Kt(n,e){return n&&ae(e)?e.resolve(n.doc,n):e}function Wt(n,e,{key:t,value:s}){if(O(t)&&t.addToJSMap)t.addToJSMap(n,e,s);else if(ws(n,t))Ut(n,e,s);else{const i=M(t,"",n);if(e instanceof Map)e.set(i,M(s,i,n));else if(e instanceof Set)e.add(i);else{const o=ks(t,i,n),a=M(s,o,n);o in e?Object.defineProperty(e,o,{value:a,writable:!0,enumerable:!0,configurable:!0}):e[o]=a}}return e}function ks(n,e,t){if(e===null)return"";if(typeof e!="object")return String(e);if(O(n)&&t?.doc){const s=Ft(t.doc,{});s.anchors=new Set;for(const o of t.anchors.keys())s.anchors.add(o.anchor);s.inFlow=!0,s.inStringifyKey=!0;const i=n.toString(s);if(!t.mapKeyWarned){let o=JSON.stringify(i);o.length>40&&(o=o.substring(0,36)+'..."'),xt(t.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${o}. Set mapAsMap: true to use object keys.`),t.mapKeyWarned=!0}return i}return JSON.stringify(e)}function rt(n,e,t){const s=me(n,void 0,t),i=me(e,void 0,t);return new j(s,i)}class j{constructor(e,t=null){Object.defineProperty(this,D,{value:Lt}),this.key=e,this.value=t}clone(e){let{key:t,value:s}=this;return O(t)&&(t=t.clone(e)),O(s)&&(s=s.clone(e)),new j(t,s)}toJSON(e,t){const s=t?.mapAsMap?new Map:{};return Wt(t,s,this)}toString(e,t,s){return e?.doc?bs(this,e,t,s):JSON.stringify(this)}}function qt(n,e,t){return(e.inFlow??n.flow?Ss:vs)(n,e,t)}function vs({comment:n,items:e},t,{blockItemPrefix:s,flowChars:i,itemIndent:o,onChompKeep:a,onComment:r}){const{indent:l,options:{commentString:c}}=t,d=Object.assign({},t,{indent:o,type:null});let u=!1;const h=[];for(let g=0;g<e.length;++g){const f=e[g];let p=null;if(O(f))!u&&f.spaceBefore&&h.push(""),Ee(t,h,f.commentBefore,u),f.comment&&(p=f.comment);else if(N(f)){const w=O(f.key)?f.key:null;w&&(!u&&w.spaceBefore&&h.push(""),Ee(t,h,w.commentBefore,u))}u=!1;let b=se(f,d,()=>p=null,()=>u=!0);p&&(b+=G(b,o,c(p))),u&&p&&(u=!1),h.push(s+b)}let m;if(h.length===0)m=i.start+i.end;else{m=h[0];for(let g=1;g<h.length;++g){const f=h[g];m+=f?`
${l}${f}`:`
`}}return n?(m+=`
`+x(c(n),l),r&&r()):u&&a&&a(),m}function Ss({items:n},e,{flowChars:t,itemIndent:s}){const{indent:i,indentStep:o,flowCollectionPadding:a,options:{commentString:r}}=e;s+=o;const l=Object.assign({},e,{indent:s,inFlow:!0,type:null});let c=!1,d=0;const u=[];for(let g=0;g<n.length;++g){const f=n[g];let p=null;if(O(f))f.spaceBefore&&u.push(""),Ee(e,u,f.commentBefore,!1),f.comment&&(p=f.comment);else if(N(f)){const w=O(f.key)?f.key:null;w&&(w.spaceBefore&&u.push(""),Ee(e,u,w.commentBefore,!1),w.comment&&(c=!0));const k=O(f.value)?f.value:null;k?(k.comment&&(p=k.comment),k.commentBefore&&(c=!0)):f.value==null&&w?.comment&&(p=w.comment)}p&&(c=!0);let b=se(f,l,()=>p=null);c||(c=u.length>d||b.includes(`
...
`+E.comment:y.comment=E.comment);const J=new j(y,K);if(t.options.keepSourceTokens&&(J.srcToken=b),a){const L=c;ln(t,L.items,y)&&i(_,"DUPLICATE_KEY","Map keys must be unique"),L.items.push(J)}else{const L=new B(t.schema);L.flow=!0,L.items.push(J);const bt=(K??y).range;L.range=[y.range[0],bt[1],bt[2]],c.items.push(L)}u=K?K.range[2]:E.end}}const h=a?"}":"]",[m,...g]=s.end;let f=u;if(m?.source===h)f=m.offset+m.source.length;else{const p=r[0].toUpperCase()+r.substring(1),b=d?`${p} must end with a ${h}`:`${p} in block collection must be sufficiently indented and end with a ${h}`;i(u,d?"MISSING_CHAR":"BAD_INDENT",b),m&&m.source.length!==1&&g.unshift(m)}if(g.length>0){const p=ke(g,f,t.options.strict,i);p.comment&&(c.comment?c.comment+=`
`+p.comment:c.comment=p.comment),c.range=[s.offset,f,p.offset]}else c.range=[s.offset,f,f];return c}function Ve(n,e,t,s,i,o){const a=t.type==="block-map"?Rs(n,e,t,s,o):t.type==="block-seq"?Fs(n,e,t,s,o):xs(n,e,t,s,o),r=a.constructor;return i==="!"||i===r.tagName?(a.tag=r.tagName,a):(i&&(a.tag=i),a)}function Us(n,e,t,s,i){const o=s.tag,a=o?e.directives.tagName(o.source,h=>i(o,"TAG_RESOLVE_FAILED",h)):null;if(t.type==="block-seq"){const{anchor:h,newlineAfterProp:m}=s,g=h&&o?h.offset>o.offset?h:o:h??o;g&&(!m||m.offset<g.offset)&&i(g,"MISSING_CHAR","Missing newline after block sequence props")}const r=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!o||!a||a==="!"||a===B.tagName&&r==="map"||a===z.tagName&&r==="seq")return Ve(n,e,t,i,a);let l=e.schema.tags.find(h=>h.tag===a&&h.collection===r);if(!l){const h=e.schema.knownTags[a];if(h?.collection===r)e.schema.tags.push(Object.assign({},h,{default:!1})),l=h;else return h?i(o,"BAD_COLLECTION_TYPE",`${h.tag} used for ${r} collection, but expects ${h.collection??"scalar"}`,!0):i(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${a}`,!0),Ve(n,e,t,i,a)}const c=Ve(n,e,t,i,a,l),d=l.resolve?.(c,h=>i(o,"TAG_RESOLVE_FAILED",h),e.options)??c,u=O(d)?d:new T(d);return u.range=c.range,u.tag=a,l?.format&&(u.format=l.format),u}function Ks(n,e,t){const s=e.offset,i=Ws(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const o=i.mode===">"?T.BLOCK_FOLDED:T.BLOCK_LITERAL,a=e.source?qs(e.source):[];let r=a.length;for(let f=a.length-1;f>=0;--f){const p=a[f][1];if(p===""||p==="\r")r=f;else break}if(r===0){const f=i.chomp==="+"&&a.length>0?`
...
`:case"\r":case"	":return!0;default:return!1}}const Ct=new Set("0123456789ABCDEFabcdef"),ai=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Ae=new Set(",[]{}"),ri=new Set(` ,[]{}
