import{E as Fm,F as Um,H as Hu,I as Bm,J as Yh,K as Xh,r as ce,M as jm,O as qm,c as Dn,j as C,S as oe,l as zm,B as ae,q as fn,T as ge,G as $m,P as Gm,Q as Wu,U as ri}from"./index-qq5ulj2R.js";import{I as Ie}from"./Icon-C-vba5IQ.js";import{u as Km}from"./useQuery-jO_UrhHN.js";import{P as Hm}from"./PageHeader-B-doKXhk.js";import{S as Wm}from"./SEO-DWUvRuZV.js";import{R as Qm}from"./research-tools-Bj4YzRhk.js";import{E as Qu}from"./EmptyState-CSP6pgsV.js";import{C as Ju}from"./camera-Bdg7aPj5.js";import{T as Jm}from"./trash-2-BLnWjoZS.js";import{C as Ym}from"./chevron-right-xOXqwRlz.js";import{G as Xm}from"./github-B8LOcTD-.js";import"./suspense-BOgJ5oAo.js";var Zm=class extends Fm{#t;#r=void 0;#e;#n;constructor(r,e){super(),this.#t=r,this.setOptions(e),this.bindMethods(),this.#s()}bindMethods(){this.mutate=this.mutate.bind(this),this.reset=this.reset.bind(this)}setOptions(r){const e=this.options;this.options=this.#t.defaultMutationOptions(r),Um(this.options,e)||this.#t.getMutationCache().notify({type:"observerOptionsUpdated",mutation:this.#e,observer:this}),e?.mutationKey&&this.options.mutationKey&&Hu(e.mutationKey)!==Hu(this.options.mutationKey)?this.reset():this.#e?.state.status==="pending"&&this.#e.setOptions(this.options)}onUnsubscribe(){this.hasListeners()||this.#e?.removeObserver(this)}onMutationUpdate(r){this.#s(),this.#i(r)}getCurrentResult(){return this.#r}reset(){this.#e?.removeObserver(this),this.#e=void 0,this.#s(),this.#i()}mutate(r,e){return this.#n=e,this.#e?.removeObserver(this),this.#e=this.#t.getMutationCache().build(this.#t,this.options),this.#e.addObserver(this),this.#e.execute(r)}#s(){const r=this.#e?.state??Bm();this.#r={...r,isPending:r.status==="pending",isSuccess:r.status==="success",isError:r.status==="error",isIdle:r.status==="idle",mutate:this.mutate,reset:this.reset}}#i(r){Yh.batch(()=>{if(this.#n&&this.hasListeners()){const e=this.#r.variables,t=this.#r.context,n={client:this.#t,meta:this.options.meta,mutationKey:this.options.mutationKey};if(r?.type==="success"){try{this.#n.onSuccess?.(r.data,e,t,n)}catch(s){Promise.reject(s)}try{this.#n.onSettled?.(r.data,null,e,t,n)}catch(s){Promise.reject(s)}}else if(r?.type==="error"){try{this.#n.onError?.(r.error,e,t,n)}catch(s){Promise.reject(s)}try{this.#n.onSettled?.(void 0,r.error,e,t,n)}catch(s){Promise.reject(s)}}}this.listeners.forEach(e=>{e(this.#r)})})}};function eg(r,e){const t=Xh(),[n]=ce.useState(()=>new Zm(t,r));ce.useEffect(()=>{n.setOptions(r)},[n,r]);const s=ce.useSyncExternalStore(ce.useCallback(o=>n.subscribe(Yh.batchCalls(o)),[n]),()=>n.getCurrentResult(),()=>n.getCurrentResult()),i=ce.useCallback((o,c)=>{n.mutate(o,c).catch(jm)},[n]);if(s.error&&qm(n.options.throwOnError,[s.error]))throw s.error;return{...s,mutate:i,mutateAsync:s.mutate}}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mt=new Ga("@firebase/app"),r_="@firebase/app-compat",s_="@firebase/analytics-compat",i_="@firebase/analytics",o_="@firebase/app-check-compat",a_="@firebase/app-check",c_="@firebase/auth",u_="@firebase/auth-compat",l_="@firebase/database",h_="@firebase/data-connect",d_="@firebase/database-compat",f_="@firebase/functions",p_="@firebase/functions-compat",m_="@firebase/installations",g_="@firebase/installations-compat",__="@firebase/messaging",y_="@firebase/messaging-compat",I_="@firebase/performance",T_="@firebase/performance-compat",E_="@firebase/remote-config",w_="@firebase/remote-config-compat",v_="@firebase/storage",A_="@firebase/storage-compat",b_="@firebase/firestore",R_="@firebase/ai",S_="@firebase/firestore-compat",P_="firebase",C_="12.12.0";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const O_="firebase-heartbeat-database",M_=1,ls="firebase-heartbeat-store";let Yo=null;function pd(){return Yo||(Yo=Xg(O_,M_,{upgrade:(r,e)=>{switch(e){case 0:try{r.createObjectStore(ls)}catch(t){console.warn(t)}}}}).catch(r=>{throw qt.create("idb-open",{originalErrorMessage:r.message})})),Yo}async function L_(r){try{const t=(await pd()).transaction(ls),n=await t.objectStore(ls).get(md(r));return await t.done,n}catch(e){if(e instanceof Et)mt.warn(e.message);else{const t=qt.create("idb-get",{originalErrorMessage:e?.message});mt.warn(t.message)}}}async function sl(r,e){try{const n=(await pd()).transaction(ls,"readwrite");await n.objectStore(ls).put(e,md(r)),await n.done}catch(t){if(t instanceof Et)mt.warn(t.message);else{const n=qt.create("idb-set",{originalErrorMessage:t?.message});mt.warn(n.message)}}}function md(r){return`${r.name}!${r.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $_(r){ir(new vn("platform-logger",e=>new t_(e),"PRIVATE")),ir(new vn("heartbeat",e=>new B_(e),"PRIVATE")),zt(da,nl,r),zt(da,nl,"esm2020"),zt("fire-js","")}$_("");var G_="firebase",K_="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xi=new Ga("@firebase/auth");function W_(r,...e){xi.logLevel<=J.WARN&&xi.warn(`Auth (${Er}): ${r}`,...e)}function pi(r,...e){xi.logLevel<=J.ERROR&&xi.error(`Auth (${Er}): ${r}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gt(r,...e){throw Wa(r,...e)}function at(r,...e){return Wa(r,...e)}function yd(r,e,t){const n={...H_(),[e]:t};return new Ps("auth","Firebase",n).create(e,{appName:r.name})}function pt(r){return yd(r,"operation-not-supported-in-this-environment","Operations that alter the current user are not supported in conjunction with FirebaseServerApp")}function Wa(r,...e){if(typeof r!="string"){const t=e[0],n=[...e.slice(1)];return n[0]&&(n[0].appName=r.name),r._errorFactory.create(t,...n)}return _d.create(r,...e)}function q(r,e,...t){if(!r)throw Wa(e,...t)}function ht(r){const e="INTERNAL ASSERTION FAILED: "+r;throw pi(e),new Error(e)}function _t(r,e){r||ht(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ma(){return typeof self<"u"&&self.location?.href||""}function Q_(){return al()==="http:"||al()==="https:"}function al(){return typeof self<"u"&&self.location?.protocol||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Zn{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){q(e.idToken,"internal-error"),q(typeof e.idToken<"u","internal-error"),q(typeof e.refreshToken<"u","internal-error");const t="expiresIn"in e&&typeof e.expiresIn<"u"?Number(e.expiresIn):cl(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}updateFromIdToken(e){q(e.length!==0,"internal-error");const t=cl(e);this.updateTokensAndExpiration(e,null,t)}async getToken(e,t=!1){return!t&&this.accessToken&&!this.isExpired?this.accessToken:(q(this.refreshToken,e,"user-token-expired"),this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null)}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:s,expiresIn:i}=await cy(e,t);this.updateTokensAndExpiration(n,s,Number(i))}updateTokensAndExpiration(e,t,n){this.refreshToken=t||null,this.accessToken=e||null,this.expirationTime=Date.now()+n*1e3}static fromJSON(e,t){const{refreshToken:n,accessToken:s,expirationTime:i}=t,o=new Zn;return n&&(q(typeof n=="string","internal-error",{appName:e}),o.refreshToken=n),s&&(q(typeof s=="string","internal-error",{appName:e}),o.accessToken=s),i&&(q(typeof i=="number","internal-error",{appName:e}),o.expirationTime=i),o}toJSON(){return{refreshToken:this.refreshToken,accessToken:this.accessToken,expirationTime:this.expirationTime}}_assign(e){this.accessToken=e.accessToken,this.refreshToken=e.refreshToken,this.expirationTime=e.expirationTime}_clone(){return Object.assign(new Zn,this.toJSON())}_performRefresh(){return ht("not implemented")}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vy(r,e,t=!1){const{auth:n}=r;if(He(n.app))return Promise.reject(pt(n));const s="reauthenticate";try{const i=await hs(r,Md(n,s,e,r),t);q(i.idToken,n,"internal-error");const o=Ya(i.idToken);q(o,n,"internal-error");const{sub:c}=o;return q(r.uid===c,n,"user-mismatch"),yt._forOperation(r,s,i)}catch(i){throw i?.code==="auth/user-not-found"&&gt(n,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xy(r,e,t=!1){if(He(r.app))return Promise.reject(pt(r));const n="signIn",s=await Md(r,n,e),i=await yt._fromIdTokenResponse(r,n,s);return t||await r._updateCurrentUser(i.user),i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const In=-1;function so(r){return r==null}function ps(r){return r===0&&1/r==-1/0}function dT(r){return typeof r=="number"&&Number.isInteger(r)&&!ps(r)&&r<=Number.MAX_SAFE_INTEGER&&r>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dn="remoteDocuments",Ms="owner",Bn="owner",ms="mutationQueues",pT="userId",Ye="mutations",Dl="batchId",yn="userMutationsIndex",Nl=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pc(r,e){if(r.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ps(e)?"-0":e}}function qf(r){return{integerValue:""+r}}function uE(r,e){return dT(e)?qf(e):pc(r,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pp(r){if(F(r instanceof Y||r instanceof re,20012),r instanceof Y){if(r instanceof Of){const t=r.value.arrayValue?.values?.map((n=>Y.create(r.field,"==",n)))||[];return re.create(t,"or")}return r}const e=r.filters.map((t=>pp(t)));return re.create(e,r.op)}function qE(r){if(r.getFilters().length===0)return[];const e=Fa(pp(r));return F(mp(e),7391),Ma(e)||La(e)?[e]:e.getFilters()}function Ma(r){return r instanceof Y}function La(r){return r instanceof re&&fc(r)}function mp(r){return Ma(r)||La(r)||(function(t){if(t instanceof re&&Sa(t)){for(const n of t.getFilters())if(!Ma(n)&&!La(n))return!1;return!0}return!1})(r)}function Fa(r){if(F(r instanceof Y||r instanceof re,34018),r instanceof Y)return r;if(r.filters.length===1)return Fa(r.filters[0]);const e=r.filters.map((n=>Fa(n)));let t=re.create(e,r.op);return t=Ki(t),mp(t)?t:(F(t instanceof re,64498),F(pr(t),40251),F(t.filters.length>1,57927),t.filters.reduce(((n,s)=>Ec(n,s))))}function Ec(r,e){let t;return F(r instanceof Y||r instanceof re,38388),F(e instanceof Y||e instanceof re,25473),t=r instanceof Y?e instanceof Y?(function(s,i){return re.create([s,i],"and")})(r,e):dh(r,e):e instanceof Y?dh(e,r):(function(s,i){if(F(s.filters.length>0&&i.filters.length>0,48005),pr(s)&&pr(i))return kf(s,i.getFilters());const o=Sa(s)?s:i,c=Sa(s)?i:s,u=o.filters.map((h=>Ec(h,c)));return re.create(u,"or")})(r,e),Ki(t)}function dh(r,e){if(pr(e))return kf(e,r.getFilters());{const t=e.filters.map((n=>Ec(r,n)));return re.create(t,"or")}}function Ki(r){if(F(r instanceof Y||r instanceof re,11850),r instanceof Y)return r;const e=r.getFilters();if(e.length===1)return Ki(e[0]);if(Vf(r))return r;const t=e.map((s=>Ki(s))),n=[];return t.forEach((s=>{s instanceof Y?n.push(s):s instanceof re&&(s.op===r.op?n.push(...s.filters):n.push(s))})),n.length===1?n[0]:re.create(n,r.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _p(r,e,t){const n=r.store(Ye),s=r.store(ar),i=[],o=IDBKeyRange.only(t.batchId);let c=0;const u=n.ee({range:o},((f,m,E)=>(c++,E.delete())));i.push(u.next((()=>{F(c===1,47070,{batchId:t.batchId})})));const h=[];for(const f of t.mutations){const m=uf(e,f.key.path,t.batchId);i.push(s.delete(m)),h.push(f.key)}return A.waitFor(i).next((()=>h))}function Hi(r){if(!r)return 0;let e;if(r.document)e=r.document;else if(r.unknownDocument)e=r.unknownDocument;else{if(!r.noDocument)throw L(14731);e=r.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ia="RestConnection",Iw={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class Tw{get qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),s=encodeURIComponent(this.databaseId.database);this.Ko=t+"://"+e.host,this.Uo=`projects/${n}/databases/${s}`,this.$o=this.databaseId.database===Is?`project_id=${n}`:`project_id=${n}&database_id=${s}`}Wo(e,t,n,s,i){const o=Ba(),c=this.Qo(e,t.toUriEncodedString());x(ia,`Sending RPC '${e}' ${o}:`,c,n);const u={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(u,s,i);const{host:h}=new URL(c),f=Tr(h);return this.zo(e,c,u,n,f).then((m=>(x(ia,`Received RPC '${e}' ${o}: `,m),m)),(m=>{throw Rn(ia,`RPC '${e}' ${o} failed with error: `,m,"url: ",c,"request:",n),m}))}jo(e,t,n,s,i,o){return this.Wo(e,t,n,s,i)}Go(e,t,n){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+vr})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((s,i)=>e[i]=s)),n&&n.headers.forEach(((s,i)=>e[i]=s))}Qo(e,t){const n=Iw[e];let s=`${this.Ko}/v1/${t}:${n}`;return this.databaseInfo.apiKey&&(s=`${s}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),s}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kn="RemoteStore";class Vw{constructor(e,t,n,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ea=new Map,this.Ia=new Set,this.Ra=[],this.Aa=i,this.Aa.Mo((o=>{n.enqueueAndForget((async()=>{On(this)&&(x(kn,"Restarting streams for network reachability change."),await(async function(u){const h=G(u);h.Ia.add(4),await Bs(h),h.Va.set("Unknown"),h.Ia.delete(4),await To(h)})(this))}))})),this.Va=new Cw(n,s)}}async function To(r){if(On(r))for(const e of r.Ra)await e(!0)}async function Bs(r){for(const e of r.Ra)await e(!1)}function Dp(r,e){const t=G(r);t.Ea.has(e.targetId)||(t.Ea.set(e.targetId,e),xc(t)?Vc(t):Rr(t).O_()&&Cc(t,e))}function Pc(r,e){const t=G(r),n=Rr(t);t.Ea.delete(e),n.O_()&&Np(t,e),t.Ea.size===0&&(n.O_()?n.L_():On(t)&&t.Va.set("Unknown"))}function Cc(r,e){if(r.da.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(U.min())>0){const t=r.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Rr(r).Z_(e)}function Np(r,e){r.da.$e(e),Rr(r).X_(e)}function Vc(r){r.da=new EE({getRemoteKeysForTarget:e=>r.remoteSyncer.getRemoteKeysForTarget(e),At:e=>r.Ea.get(e)||null,ht:()=>r.datastore.serializer.databaseId}),Rr(r).start(),r.Va.ua()}function xc(r){return On(r)&&!Rr(r).x_()&&r.Ea.size>0}function On(r){return G(r).Ia.size===0}function Op(r){r.da=void 0}async function xw(r){r.Va.set("Online")}async function kw(r){r.Ea.forEach(((e,t)=>{Cc(r,e)}))}async function Dw(r,e){Op(r),xc(r)?(r.Va.ha(e),Vc(r)):r.Va.set("Unknown")}async function Nw(r,e,t){if(r.Va.set("Online"),e instanceof Xf&&e.state===2&&e.cause)try{await(async function(s,i){const o=i.cause;for(const c of i.targetIds)s.Ea.has(c)&&(await s.remoteSyncer.rejectListen(c,o),s.Ea.delete(c),s.da.removeTarget(c))})(r,e)}catch(n){x(kn,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Qi(r,n)}else if(e instanceof Ri?r.da.Xe(e):e instanceof Yf?r.da.st(e):r.da.tt(e),!t.isEqual(U.min()))try{const n=await Cp(r.localStore);t.compareTo(n)>=0&&await(function(i,o){const c=i.da.Tt(o);return c.targetChanges.forEach(((u,h)=>{if(u.resumeToken.approximateByteSize()>0){const f=i.Ea.get(h);f&&i.Ea.set(h,f.withResumeToken(u.resumeToken,o))}})),c.targetMismatches.forEach(((u,h)=>{const f=i.Ea.get(u);if(!f)return;i.Ea.set(u,f.withResumeToken(Ee.EMPTY_BYTE_STRING,f.snapshotVersion)),Np(i,u);const m=new ft(f.target,u,h,f.sequenceNumber);Cc(i,m)})),i.remoteSyncer.applyRemoteEvent(c)})(r,t)}catch(n){x(kn,"Failed to raise snapshot:",n),await Qi(r,n)}}async function Qi(r,e,t){if(!en(e))throw e;r.Ia.add(1),await Bs(r),r.Va.set("Offline"),t||(t=()=>Cp(r.localStore)),r.asyncQueue.enqueueRetryable((async()=>{x(kn,"Retrying IndexedDB access"),await t(),r.Ia.delete(1),await To(r)}))}function Mp(r,e){return e().catch((t=>Qi(r,t,e)))}async function js(r){const e=G(r),t=Xt(e);let n=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:In;for(;Ow(e);)try{const s=await mw(e.localStore,n);if(s===null){e.Ta.length===0&&t.L_();break}n=s.batchId,Mw(e,s)}catch(s){await Qi(e,s)}Lp(e)&&Fp(e)}function Ow(r){return On(r)&&r.Ta.length<10}function Mw(r,e){r.Ta.push(e);const t=Xt(r);t.O_()&&t.Y_&&t.ea(e.mutations)}function Lp(r){return On(r)&&!Xt(r).x_()&&r.Ta.length>0}function Fp(r){Xt(r).start()}async function Lw(r){Xt(r).ra()}async function Fw(r){const e=Xt(r);for(const t of r.Ta)e.ea(t.mutations)}async function Uw(r,e,t){const n=r.Ta.shift(),s=_c.from(n,e,t);await Mp(r,(()=>r.remoteSyncer.applySuccessfulWrite(s))),await js(r)}async function Bw(r,e){e&&Xt(r).Y_&&await(async function(n,s){if((function(o){return yE(o)&&o!==P.ABORTED})(s.code)){const i=n.Ta.shift();Xt(n).B_(),await Mp(n,(()=>n.remoteSyncer.rejectFailedWrite(i.batchId,s))),await js(n)}})(r,e),Lp(r)&&Fp(r)}async function Ch(r,e){const t=G(r);t.asyncQueue.verifyOperationInProgress(),x(kn,"RemoteStore received new credentials");const n=On(t);t.Ia.add(3),await Bs(t),n&&t.Va.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await To(t)}async function jw(r,e){const t=G(r);e?(t.Ia.delete(2),await To(t)):e||(t.Ia.add(2),await Bs(t),t.Va.set("Unknown"))}function Rr(r){return r.ma||(r.ma=(function(t,n,s){const i=G(t);return i.sa(),new Aw(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(r.datastore,r.asyncQueue,{Zo:xw.bind(null,r),Yo:kw.bind(null,r),t_:Dw.bind(null,r),H_:Nw.bind(null,r)}),r.Ra.push((async e=>{e?(r.ma.B_(),xc(r)?Vc(r):r.Va.set("Unknown")):(await r.ma.stop(),Op(r))}))),r.ma}function Xt(r){return r.fa||(r.fa=(function(t,n,s){const i=G(t);return i.sa(),new bw(n,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(r.datastore,r.asyncQueue,{Zo:()=>Promise.resolve(),Yo:Lw.bind(null,r),t_:Bw.bind(null,r),ta:Fw.bind(null,r),na:Uw.bind(null,r)}),r.Ra.push((async e=>{e?(r.fa.B_(),await js(r)):(await r.fa.stop(),r.Ta.length>0&&(x(kn,`Stopping write stream with ${r.Ta.length} pending writes`),r.Ta=[]))}))),r.fa}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Iv="ComponentProvider",Lh=new Map;function Tv(r,e,t,n,s){return new BT(r,e,t,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,Qp(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sm extends Dv{constructor(e){super(),this.firestore=e}convertBytes(e){return new We(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new _e(this.firestore,null,t)}}const zh="@firebase/firestore",$h="4.14.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
