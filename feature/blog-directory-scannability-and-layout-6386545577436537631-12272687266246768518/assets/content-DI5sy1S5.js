import{bW as m}from"./vendor-DD3MeM2b.js";import{A as h}from"./index-BRv4_8jA.js";const f=`---
type: post
draft: true
status: draft
...
`,P=Object.freeze(Object.defineProperty({__proto__:null,default:x},Symbol.toStringTag,{value:"Module"})),D=`---
type: post
draft: true
...
`,j=Object.freeze(Object.defineProperty({__proto__:null,default:D},Symbol.toStringTag,{value:"Module"})),B=`---
type: post
...
\`\`\`
`,re=Object.freeze(Object.defineProperty({__proto__:null,default:se},Symbol.toStringTag,{value:"Module"}));function le(e){const o=e.match(/^---\n([\s\S]+?)\n---\n([\s\S]*)$/);if(!o)return{data:{},content:e};const i=o[1],t=o[2];try{const a=m(i);return{data:a&&typeof a=="object"?a:{},content:t}}catch(a){return console.error("Error parsing frontmatter:",a),{data:{},content:t}}}const d={posts:Object.assign({"/content/posts/2026-04-18-competition-metrics.md":y,"/content/posts/2026-04-18-financial-literacy-dancers.md":w,"/content/posts/2026-04-18-github-actions.md":k,"/content/posts/2026-04-18-halloween-costumes.md":S,"/content/posts/2026-04-18-make-shoe-dance.md":A,"/content/posts/2026-04-18-why-finals-are-hard.md":I,"/content/posts/2026-04-19-practical-tools-essentials.md":P,"/content/posts/2026-05-06-boomtick-and-b-the-rhythmic-architecture-of-west-coast-swing.md":j,"/content/posts/2026-06-01-event-travel-packing.md":W,"/content/posts/2026-06-01-general-health-home-care.md":R,"/content/posts/2026-06-01-outdoor-dancing.md":O,"/content/posts/2026-06-01-power-charging.md":F,"/content/posts/2026-06-01-practice-review-tech.md":H,"/content/posts/2026-06-01-practice-social-dance-apparel.md":N,"/content/posts/2026-06-01-shoe-care-modification.md":U,"/content/posts/2026-06-01-theme-wear-costumes-accessories.md":Y,"/content/posts/2026-06-01-wcs-essentials.md":K}),blogs:Object.assign({"/content/blog/2026-06-14-the-story-behind-the-merch-page.md":$}),studies:Object.assign({"/content/studies/2026-07-10-latest-version-check-skill.md":Z,"/content/studies/ai-devops-pipeline.md":ne,"/content/studies/confidently-incorrect-v4.md":oe,"/content/studies/deployment-impact-analyzer.md":ie,"/content/studies/wcs-scraper-initial-sync.md":re})},ce=e=>e.split("/").pop()?.replace(".md","")||"";function de(e){if(typeof e!="string")return;const o=e.toLowerCase();return["published","draft","planned"].includes(o)?o:void 0}function he(e){if(typeof e=="number")return e;if(typeof e=="string"){const o=parseInt(e.replace(/[^\d]/g,""),10);return isNaN(o)?void 0:o}}function fe(e){if(!(e===""||e===void 0||e===null))return typeof e!="string"?e:e.startsWith("/")&&!e.startsWith(h)?`${h}${e}`:e}function g(e,o){const i=t=>Array.isArray(t)?t:[];return Object.entries(e).map(([t,a])=>{const r=typeof a=="string"?a:a.default,{data:n,content:c}=le(r),u=n.type||o,p=s=>{if(s!=="")return typeof s=="string"&&s.startsWith("/")?`${h}${s}`:s};return n.image=p(n.image),n.imageBack=p(n.imageBack),{...n,type:u,title:String(n.title||"Untitled"),category:String(n.category||"General"),excerpt:String(n.excerpt||""),date:String(n.date||""),author:String(n.author||""),tags:i(n.tags),affiliateIds:i(n.affiliateIds),seoTitle:n.seoTitle?String(n.seoTitle):void 0,seoDescription:n.seoDescription?String(n.seoDescription):void 0,imageAlt:n.imageAlt?String(n.imageAlt):void 0,imageFit:n.imageFit==="cover"||n.imageFit==="contain"?n.imageFit:void 0,featured:n.featured===!0||n.featured==="true",status:de(n.status),readTime:he(n.readTime),content:c||"",slug:ce(t)}}).filter(t=>t.draft?t.type==="study"&&(t.status==="planned"||t.status==="draft"):!0).sort((t,a)=>{const r=t.date?new Date(t.date).getTime():0,n=a.date?new Date(a.date).getTime():0,c=Number.isNaN(r)?0:r;return(Number.isNaN(n)?0:n)-c})}const l={posts:g({...d.posts,...d.blogs},"post"),studies:g(d.studies,"study")},ue={posts:new Map(l.posts.map(e=>[e.slug,e])),studies:new Map(l.studies.map(e=>[e.slug,e]))},ye=()=>l.posts,be=()=>l.studies,we=e=>ue.posts.get(e),ve=(e,o)=>{if(e&&e.trim().length>0)return Math.max(1,Math.round(e.split(/\s+/).length/200));const i=o?.split(/\s+/).length??0;return Math.max(1,Math.round(i/20))};export{we as a,be as b,ye as g,fe as n,ve as r};
