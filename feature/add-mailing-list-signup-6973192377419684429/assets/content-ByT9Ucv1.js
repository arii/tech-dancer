import{A}from"./index-Deamxkyk.js";const P=`---
type: post
draft: true
status: draft
...
`,O=Object.freeze(Object.defineProperty({__proto__:null,default:j},Symbol.toStringTag,{value:"Module"})),z=`---
type: post
...
`,M=Object.freeze(Object.defineProperty({__proto__:null,default:z},Symbol.toStringTag,{value:"Module"})),B=`---
type: post
...
`,E=Object.freeze(Object.defineProperty({__proto__:null,default:B},Symbol.toStringTag,{value:"Module"})),W=`---
type: post
draft: false
status: published
...
`,F=Object.freeze(Object.defineProperty({__proto__:null,default:W},Symbol.toStringTag,{value:"Module"})),R=`---
type: post
...
`,Oe=Object.freeze(Object.defineProperty({__proto__:null,default:je},Symbol.toStringTag,{value:"Module"})),ze=`---
type: resource
...
`,Me=Object.freeze(Object.defineProperty({__proto__:null,default:ze},Symbol.toStringTag,{value:"Module"})),Be=`---
type: resource
...
`,Ee=Object.freeze(Object.defineProperty({__proto__:null,default:Be},Symbol.toStringTag,{value:"Module"})),We=`---
type: resource
...
`,Fe=Object.freeze(Object.defineProperty({__proto__:null,default:We},Symbol.toStringTag,{value:"Module"})),Re=`---
type: resource
...
`,zn=Object.freeze(Object.defineProperty({__proto__:null,default:On},Symbol.toStringTag,{value:"Module"})),Mn=`---
type: resource
...
`,Bn=Object.freeze(Object.defineProperty({__proto__:null,default:Mn},Symbol.toStringTag,{value:"Module"})),En=`---
type: resource
...
`,Wn=Object.freeze(Object.defineProperty({__proto__:null,default:En},Symbol.toStringTag,{value:"Module"})),Fn=`---
type: resource
...
`,Jn=Object.freeze(Object.defineProperty({__proto__:null,default:Vn},Symbol.toStringTag,{value:"Module"}));function Yn(e){return e.startsWith(`\r
`)?2:e.startsWith(`
`)?1:0}function Kn(e){const a={},c=e.split(/\r?\n/),t=[{indent:-1,obj:a}];for(let s=0;s<c.length;s++){const p=c[s],n=p.trim();if(!n||n.startsWith("#"))continue;const d=p.search(/\S/);for(;t.length>1&&t[t.length-1].indent>=d;)t.pop();const h=t[t.length-1].obj;if(n.startsWith("- ")){const g=n.slice(2).trim(),l=g.indexOf(":");if(l!==-1){const i=g.slice(0,l).trim(),r=g.slice(l+1).trim();if(i!=="__proto__"&&i!=="constructor"&&i!=="prototype"){const k={};let f=r;r.startsWith('"')&&r.endsWith('"')||r.startsWith("'")&&r.endsWith("'")?f=r.slice(1,-1):r==="true"?f=!0:r==="false"?f=!1:!isNaN(Number(r))&&r!==""&&(f=Number(r)),k[i]=f,Array.isArray(h)&&h.push(k),t.push({indent:d+2,obj:k})}}else{let i=g;typeof i=="string"&&(i.startsWith('"')&&i.endsWith('"')||i.startsWith("'")&&i.endsWith("'"))&&(i=i.slice(1,-1)),Array.isArray(h)&&h.push(i)}continue}const y=n.indexOf(":");if(y===-1)continue;const u=n.slice(0,y).trim();if(u==="__proto__"||u==="constructor"||u==="prototype")continue;const o=n.slice(y+1).trim();if(!o){let g=!1;for(let i=s+1;i<c.length;i++){const r=c[i].trim();if(r&&!r.startsWith("#")){r.startsWith("- ")&&(g=!0);break}}const l=g?[]:{};Array.isArray(h)||(h[u]=l),t.push({indent:d,obj:l,key:u});continue}let m=o;o.startsWith("[")&&o.endsWith("]")?m=o.slice(1,-1).split(",").map(g=>{let l=g.trim();return(l.startsWith('"')&&l.endsWith('"')||l.startsWith("'")&&l.endsWith("'"))&&(l=l.slice(1,-1)),l}).filter(Boolean):o==="true"?m=!0:o==="false"?m=!1:!isNaN(Number(o))&&o!==""&&!o.includes("-")&&!o.includes(":")?m=Number(o):(o.startsWith('"')&&o.endsWith('"')||o.startsWith("'")&&o.endsWith("'"))&&(m=o.slice(1,-1)),Array.isArray(h)||(h[u]=m)}return a}function Qn(e){if(!e||typeof e!="string"||!e.startsWith("---"))return{data:{},content:e||""};const a=Yn(e.slice(3));if(a===0)return{data:{},content:e};const c=3+a,t=e.slice(c).match(/(?:^|\r?\n)---(?:\r?\n|$)/);if(!t||t.index===void 0)return{data:{},content:e};const s=c+t.index,p=e.slice(c,s).trim(),n=e.slice(s+t[0].length);try{const d=Kn(p);return{data:d&&typeof d=="object"?d:{},content:n}}catch(d){return console.error("Error parsing frontmatter:",d),{data:{},content:n}}}const b={posts:Object.assign({"/content/posts/2026-04-18-competition-metrics.md":x,"/content/posts/2026-04-18-financial-literacy-dancers.md":D,"/content/posts/2026-04-18-github-actions.md":O,"/content/posts/2026-04-18-halloween-costumes.md":M,"/content/posts/2026-04-18-make-shoe-dance.md":E,"/content/posts/2026-04-18-why-finals-are-hard.md":F,"/content/posts/2026-04-19-practical-tools-essentials.md":G,"/content/posts/2026-05-06-boomtick-and-b-the-rhythmic-architecture-of-west-coast-swing.md":H,"/content/posts/2026-06-01-event-travel-packing.md":U,"/content/posts/2026-06-01-general-health-home-care.md":V,"/content/posts/2026-06-01-outdoor-dancing.md":Y,"/content/posts/2026-06-01-power-charging.md":Q,"/content/posts/2026-06-01-practice-review-tech.md":X,"/content/posts/2026-06-01-practice-social-dance-apparel.md":ee,"/content/posts/2026-06-01-shoe-care-modification.md":te,"/content/posts/2026-06-01-theme-wear-costumes-accessories.md":oe,"/content/posts/2026-06-01-wcs-essentials.md":re}),blogs:Object.assign({"/content/blog/2026-06-14-the-story-behind-the-merch-page.md":le}),studies:Object.assign({"/content/studies/2026-07-10-latest-version-check-skill.md":de,"/content/studies/ai-devops-pipeline.md":he,"/content/studies/confidently-incorrect-v4.md":ge,"/content/studies/deployment-impact-analyzer.md":fe,"/content/studies/wcs-navigator-architecture.md":be,"/content/studies/wcs-scraper-initial-sync.md":we}),resources:Object.assign({"/content/resources/2023-10-01-loop-earplugs.md":_e,"/content/resources/2023-11-01-travel-steamer.md":Te,"/content/resources/2024-01-01-portable-speaker.md":Ce,"/content/resources/2024-06-01-alien-mask.md":xe,"/content/resources/2024-06-01-charging-cables.md":De,"/content/resources/2024-06-01-compression-cubes.md":Oe,"/content/resources/2024-06-01-crop-tops.md":Me,"/content/resources/2024-06-01-fishnet-tights.md":Ee,"/content/resources/2024-06-01-foam-roller.md":Fe,"/content/resources/2024-06-01-green-bodysuit.md":Ge,"/content/resources/2024-06-01-light-up-suspenders.md":He,"/content/resources/2024-06-01-love-neon-follow-shirt.md":Ue,"/content/resources/2024-06-01-love-neon-lead-shirt.md":Ve,"/content/resources/2024-06-01-love-neon-switch-shirt.md":Ye,"/content/resources/2024-06-01-love-unisex-shirt.md":Qe,"/content/resources/2024-06-01-mesh-fishnet-top.md":Xe,"/content/resources/2024-06-01-nerd-set.md":en,"/content/resources/2024-06-01-norcal-bear-tank.md":tn,"/content/resources/2024-06-01-norcal-bestcal-tshirt.md":on,"/content/resources/2024-06-01-norcal-crop-top.md":sn,"/content/resources/2024-06-01-norcal-gate-crop-hoodie.md":cn,"/content/resources/2024-06-01-norcal-pride-bear-shirt.md":un,"/content/resources/2024-06-01-norcal-pride-gate-shirt.md":pn,"/content/resources/2024-06-01-portable-charger.md":mn,"/content/resources/2024-06-01-pumpkin-headbands.md":yn,"/content/resources/2024-06-01-pumpkin-stickers.md":vn,"/content/resources/2024-06-01-rave-fan.md":kn,"/content/resources/2024-06-01-reflective-crop-tops.md":Sn,"/content/resources/2024-06-01-running-belt.md":An,"/content/resources/2024-06-01-shoe-dryer.md":Pn,"/content/resources/2024-06-01-sunscreen.md":In,"/content/resources/2024-06-01-travel-bottles.md":jn,"/content/resources/2024-06-01-tripod.md":zn,"/content/resources/2024-06-01-visor.md":Bn,"/content/resources/2024-06-01-war-eagle-shirt.md":Wn,"/content/resources/2026-04-12-suede-shoe-diy.md":Rn,"/content/resources/relavel-travel-bag.md":Ln,"/content/resources/slot-era-mug.md":Nn,"/content/resources/slot-era-tank-top.md":qn,"/content/resources/slot-era-tote-bag.md":Jn})},$n=e=>e.split("/").pop()?.replace(".md","")||"";function Xn(e){if(typeof e!="string")return;const a=e.toLowerCase();return["published","draft","planned"].includes(a)?a:void 0}function Zn(e){if(typeof e=="number")return e;if(typeof e=="string"){const a=parseInt(e.replace(/[^\d]/g,""),10);return isNaN(a)?void 0:a}}function nt(e){if(!(e===""||e===void 0||e===null))return typeof e!="string"?e:e.startsWith("/")&&!e.startsWith(A)?`${A}${e}`:e}function _(e,a){const c=t=>Array.isArray(t)?t:[];return Object.entries(e).map(([t,s])=>{const p=typeof s=="string"?s:s.default,{data:n,content:d}=Qn(p),w=n.type||a,h=u=>{if(u!=="")return typeof u=="string"&&u.startsWith("/")?`${A}${u}`:u};return n.image=h(n.image),n.imageBack=h(n.imageBack),{...n,type:w,title:String(n.title||"Untitled"),category:String(n.category||"General"),excerpt:String(n.excerpt||n.description||""),date:String(n.date||""),author:String(n.author||"Ariel Anders").replace(/,?\s*PhD/i,"").trim(),tags:c(n.tags),affiliateIds:c(n.affiliateIds),seoTitle:n.seoTitle?String(n.seoTitle):void 0,seoDescription:n.seoDescription?String(n.seoDescription):void 0,imageAlt:n.imageAlt?String(n.imageAlt):void 0,imageFit:n.imageFit==="cover"||n.imageFit==="contain"?n.imageFit:void 0,status:Xn(n.status),readTime:Zn(n.readTime),content:d||"",slug:$n(t)}}).filter(t=>t.draft?t.type==="study"&&(t.status==="planned"||t.status==="draft"):!0).sort((t,s)=>{const p=t.date?new Date(t.date).getTime():0,n=s.date?new Date(s.date).getTime():0,d=Number.isNaN(p)?0:p;return(Number.isNaN(n)?0:n)-d})}let S=null,T=null;function v(){return S||(S={posts:_({...b.posts,...b.blogs},"post"),studies:_(b.studies,"study"),resources:_(b.resources,"resource")}),S}function C(){if(!T){const e=v();T={posts:new Map(e.posts.map(a=>[a.slug,a])),studies:new Map(e.studies.map(a=>[a.slug,a])),resources:new Map(e.resources.map(a=>[a.slug,a]))}}return T}const tt=()=>v().posts,at=()=>v().studies,ot=e=>C().posts.get(e),it=()=>v().resources,rt=e=>C().resources.get(e),st=(e,a)=>{if(e&&e.trim().length>0)return Math.max(1,Math.round(e.split(/\s+/).length/200));const c=a?.split(/\s+/).length??0;return Math.max(1,Math.round(c/20))};export{ot as a,it as b,rt as c,at as d,tt as g,nt as n,st as r};
