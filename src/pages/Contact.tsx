...
export default function Contact() {
  ...
  return (
    <>
      <SEO
        title="Contact"
        description="Get in touch with Ariel Anders at boomtick.blog. Send your feedback, inquiries, or collaboration proposals regarding West Coast Swing and dance data."
      />
      <ContactFormView
        register={register}
        errors={errors}
