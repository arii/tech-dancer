    ...
    <Box width="full" maxWidth="container" marginX="auto" minWidth={0} overflow="x-clip" paddingX={{ base: 4, sm: 6, lg: 8 }} paddingY={12}>
      ...
      <Stack gap={24} maxWidth="7xl" marginX="auto">
        ...
        <Stack as="section" gap={6}>
          <Stack gap={2}>
            <Text as="h2" size="3xl" weight="bold" tracking="tight" color="main" wrap="balance">Our Core Services</Text>
        ...
        <Stack as="section" gap={6}>
          <Stack gap={2}>
            <Text as="h2" size="2xl" weight="bold" tracking="tight" color="main" wrap="balance">Feature Details</Text>
