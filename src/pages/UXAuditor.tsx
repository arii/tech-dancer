                    ...
                    <Box className="bg-surface rounded-lg shadow-sm border border-line overflow-hidden">
                      ...
                      <Stack direction={{ base: 'col', md: 'row' }} width="full">
                        ...
                        <Stack gap={6} padding={8} flex={1} minWidth="0" overflow="hidden">
                          {data ? (
                            <>
                              <Box className="bg-surface border border-line rounded-lg"
                                padding={5}>
                                <Box marginBottom={3}>
                              ...
                              <Stack gap={4}>
                                {data.improvements?.map((imp, idx) => (
                                  <Box key={idx} className="bg-surface rounded-lg border border-line shadow-sm hover:border-accent transition-all"
                                    padding={4}>
