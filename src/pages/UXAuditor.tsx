...
function ViewportAnalysisCard({ vp, data, activeReportUrl, overflow = "hidden", interactive, span }: ViewportAnalysisCardProps) {
  return (
    <Box className={cardVariants({ overflow, interactive, span })} minWidth={0}>
