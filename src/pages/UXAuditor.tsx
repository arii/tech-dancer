    ...
    <Stack gap={8} width="full">
      ...
      <Grid cols={{ base: 1, lg: 4 }} gap={8}>
        ...
        <Stack gap={4} span={{ lg: 1 }}>
          ...
          <Stack surface="surface" radius="lg" className="shadow-sm border border-line overflow-hidden divide-y divide-line">
            {reports.length === 0 && (
              <EmptyState
                compact
                    ...
                    <Box className="bg-surface rounded-lg shadow-sm border border-line overflow-hidden">
                      ...
                      <Stack direction={{ base: 'col', md: 'row' }} width="full">
                        ...
                        <Stack gap={6} padding={8} flex={1} minWidth="0" overflow="hidden">
                          {data ? (
                            <>
                              <Box surface="muted" border radius="lg" padding={5}>
                                <Box marginBottom={3}>
                              ...
                              <Stack gap={4}>
                                {data.improvements?.map((imp, idx) => (
                                  <Box key={idx} surface="surface" padding={4} radius="lg" className="border border-line shadow-sm hover:border-accent transition-all">
