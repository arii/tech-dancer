...
import {
  ...
  VIEWPORTS,
  ViewportAnalysis,
} from "@/features/ux-auditor/useUXAuditor";
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        style={{
          // impeccable-ignore - Dynamic scaling for iframe preview
            ...
            <>
              ...
              >
                ...
                <Text
                  ...
                  size="sm"
                  weight="font-medium"
                  className="leading-relaxed break-words block"
                >
                  "{data.summary}"
                </Text>
              </Box>
                  ...
                  >
                    ...
                    >
                      ...
                      <Text
                        ...
                        color="dim"
                        uppercase
                        title={`Severity level: ${imp.severity} out of 10 (1-10 scale)`}
                      >
                        SEV {imp.severity}
                      </Text>
                    </Box>
    ...
    <Stack gap={8} width="full">
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Icon
                icon={isAnalyzing ? RefreshCw : Camera}
                size="sm"
          ...
          <Stack gap={2}>
            ...
            <Text
              ...
              weight="font-medium"
            >
              ⚠️ API keys are stored in your browser's session storage. They are
              cleared when you close the tab. Plain-text storage is not fully
              secure; use only on trusted devices.
            </Text>
          </Stack>
          <Stack gap={1}>
            <Stack
            ...
            >
              ...
              <Box
                ...
                onChange={(e: ChangeEvent<HTMLInputElement>) =>
                  setSnapshotService(e.target.value)
                }
                onFocus={(e) => e.target.select()}
                className="bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main truncate text-sm"
                flex={1}
            ...
            <Text
              ...
              marginTop={1}
            >
              Use {"{url}"}, {"{width}"}, and {"{height}"} as placeholders.
              Example: https://api.service.com?url={"{url}"}&size={"{width}"}x
              {"{height}"}
            </Text>
          </Stack>
        </Stack>
      ...
      <Grid cols={{ base: 1, lg: 4 }} gap={8}>
        ...
        <Stack gap={4} span={{ lg: 1 }} minWidth={0}>
          ...
          <Stack
            className={`${cardVariants({ overflow: "hidden" })} divide-y divide-line`}
            minWidth={0}
          >
            {reports.length === 0 && (
              <EmptyState
            ...
            {reports.map((report) => (
              ...
              >
                ...
                >
                  <Icon
                    icon={
                      report.status === "completed" ? CheckCircle : RefreshCw
                    }
                    size="sm"
                  />
                </Box>
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  >
                    <Icon
                      icon={isCopiedMarkdown ? CheckCircle : Copy}
                      size="sm"
                    />
                  ...
                  <Box
                    ...
                    disabled={
                      activeReport.status !== "completed" || isExportingToGithub
                    }
                    display="flex"
                    align="center"
                    justify="center"
                  ...
                  >
                    <Icon
                      icon={isExportingToGithub ? RefreshCw : Github}
                      size="sm"
                      className={isExportingToGithub ? "animate-spin" : ""}
                    />
