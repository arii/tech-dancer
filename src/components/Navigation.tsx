...
export default function Navigation() {
  ...
  return (
    <>
      <MobileBottomNav />
      <Box as="nav" aria-label="Main Navigation" className="fixed inset-x-0 top-0 z-[130] h-16 border-b border-line bg-bg/95 backdrop-blur-xl" /* impeccable-ignore */ // impeccable-ignore>
