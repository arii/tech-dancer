...
export default function Navigation() {
  ...
  return (
    <>
      <MobileBottomNav />
      <Box as="nav" aria-label="Main Navigation" zIndex="top" className="fixed inset-x-0 top-0 h-16 w-full max-w-full border-b border-line bg-bg/95 backdrop-blur-xl">
