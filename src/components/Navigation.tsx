    ...
    <>
      ...
      >
        <Box as={NavLink} to="/" onClick={() => setIsOpen(false)}>
          <Text variant="mono" size="sm" weight="font-bold" uppercase className="text-accent-navy tracking-wider">TECH-DANCER</Text>
        </Box>
        <Box
          as="button"
        ...
        >
          <Box as={NavLink} to="/" className="group block mb-4">
            <Text 
              ...
              size="lg" 
              weight="font-bold" 
              uppercase className="text-accent-navy group-hover:text-accent transition-colors tracking-wider leading-none"
            >
              TECH-DANCER
            </Text>
          </Box>
