    ...
    <Box as="li" position="relative" className="group">
      <NavLink
        ...
        className={({ isActive }) => cn(
          ...
          isMobile
            ? (isActive ? "text-accent border-l-4 border-accent bg-accent/10" : "text-text-dim hover:text-accent-sky hover:bg-accent-sky/10 border-l-4 border-transparent cursor-pointer")
            : (isActive ? "text-accent bg-accent/10 border-l-4 border-accent" : "text-text-dim hover:text-accent-sky cursor-pointer hover:bg-surface-alt border-l-4 border-transparent")
        )}
      >
        {({ isActive }) => (
          <Box
