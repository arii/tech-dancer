    ...
    <Box as="li" position="relative" className="group">
      <NavLink
        ...
        className={({ isActive }) => cn(
          ...
          isMobile
            ? (isActive ? "text-accent border-l-4 border-accent bg-accent/10" : "text-text-dim hover:text-[#38bdf8] hover:bg-[#38bdf8]/[0.08] border-l-4 border-transparent cursor-pointer")
            : (isActive ? "text-accent bg-accent/10 border-l-4 border-accent" : "text-text-dim hover:text-[#38bdf8] cursor-pointer hover:bg-[#38bdf8]/[0.08] border-l-4 border-transparent")
        )}
      >
        {({ isActive }) => (
          <Box
