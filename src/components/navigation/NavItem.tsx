    ...
    <Box as="li" position="relative" className="group">
      <NavLink
        ...
        className={({ isActive }) => cn(
          ...
          isMobile
            ? (isActive ? "text-accent border-l-4 border-accent bg-accent/10" : "text-text-dim hover:text-accent hover:bg-surface-alt/50 border-l-4 border-transparent cursor-pointer active:bg-accent/5")
            : (isActive ? "text-accent bg-accent/10 border-l-4 border-accent" : "text-text-dim hover:text-accent cursor-pointer hover:bg-surface-alt border-l-4 border-transparent active:translate-x-0.5")
        )}
      >
        {({ isActive }) => (
          <Box
