    ...
    >
      ...
      <Box className="flex items-center gap-2">
        <button
          type="button"
          onClick={onClose}
          className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-line/70 bg-[#0b1024]/90 text-text-dim transition-colors hover:border-accent hover:text-accent"
        ...
        <Box
          ...
          onClick={onToggle}
          className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-line/70 bg-[#0b1024]/90 text-white transition-colors hover:border-accent hover:bg-bg/50 active:bg-accent/10"
