    ...
    >
      ...
      >
        ...
        >
          ...
          <Box padding={2} overflow="y-auto" maxHeight={{ base: "max-h-search-results-mobile", lg: "60vh" }} className="pb-safe-area">
            {results.length > 0 ? (
              <Stack gap={1}>
          ...
          <Box border="t" paddingX={5} paddingY={3} surface="alt" display="flex" justify="between" align="center" className="pb-safe-area-plus-12">
