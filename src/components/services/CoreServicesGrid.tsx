...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Let your customers book, pay, and get the information they need—automatically.",
    icon: CalendarDays,
  ...
  },
  {
    ...
    title: "Ecommerce",
    description:
      "Sell products, services, and digital downloads directly from your site.",
    icon: ShoppingBag,
  ...
  },
  {
    ...
    description:
      "Get discovered, build your audience, and turn visitors into loyal customers.",
    icon: TrendingUp,
  ...
  },
  {
    ...
    description:
      "Connect your tools and automate the repetitive work so you can focus on your craft.",
    icon: Settings,
    imageSrc: "/assets/services/digital-presence.png",
    features: [
...
export const CoreServicesGrid = () => {
  return (
    ...
    <Grid cols={{ base: 1, lg: 2 }} gap={6} align="start" asChild>
      <Accordion type="single" collapsible defaultValue="digital-presence">
                ...
                <Stack direction="row" align="start" gap={3}>
                  ...
                  <Stack gap={1} marginTop={1} className="text-left">
                    <Text
                      ...
                      size="xl"
                      weight="font-bold"
                      className="text-main text-balance"
                    >
                      {service.title}
                    </Text>
                    <Text
