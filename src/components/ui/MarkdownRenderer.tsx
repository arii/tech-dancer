      ...
      <ReactMarkdown
        components={{
          a: ({node: _node, href, ...props}) => {
            ...
            if (isInternal) {
              return <Link to={href || '#'} {...props} className="text-accent hover:underline" />;
            }
            return <a href={href} {...props} rel="noopener noreferrer" target="_blank" className="text-accent hover:underline" />;
          },
