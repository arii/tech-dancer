          ...
          h2: ({node: _node, ...props}) => (
            <Box marginTop={12} marginBottom={6} className="group [counter-increment:section]">
              <Text
                ...
                marginBottom={2}
                opacity={50}
                className="before:content-[counter(section,decimal-leading-zero)] before:mr-2"
              />
              <Text as="h2" variant="display" size="3xl" weight="font-bold" tracking="tight" className="normal-case" {...props} />
              <Box height="[1px]" width={12} marginTop={4} surface="accent" />
            </Box>
          )
        }}
      >
