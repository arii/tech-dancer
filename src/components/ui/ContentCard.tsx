      ...
      <Stack gap={5} padding={6} flex={1} justify="between">
        <Stack gap={4}>
          <Box display="flex" align="center" gap={3}>
            <Text variant="mono-uppercase" size="xs" color="dim" className="tracking-widest">
              {date}
            </Text>
            <Box className="w-1 h-1 rounded-full bg-line" />
            <Text variant="mono-uppercase" size="xs" color="dim" className="tracking-widest flex items-center gap-1">
        ...
        <Box display="flex" align="center" gap={2} paddingTop={6} className="border-t border-line mt-auto">
          <Text variant="mono-uppercase" size="xs" className="text-accent font-semibold  tracking-[0.15em]">
            Read {title}
          </Text>
