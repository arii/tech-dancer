...
export const MERCH_PRODUCTS: ProductCatalogItem[] = [
  {
    ...
    href: 'https://boomtick.printful.me/product/love-neon-tshirt-ask-me-to-follow',
    collections: ['lead-follow-switch', 'rainbow-pride'],
    roles: ['follow'],
    tags: ['West Coast Swing', 'Follower', 'Neon', 'Pride'],
    useCases: ['role-shirt', 'social-dance', 'pride'],
  ...
  },
  {
    ...
    href: 'https://boomtick.printful.me/product/love-neon-tshirt-ask-me-to-lead',
    collections: ['lead-follow-switch', 'rainbow-pride'],
    roles: ['lead'],
  ...
  },
  {
    ...
    href: 'https://boomtick.printful.me/product/war-eagle-oversized-high-neck-t-shirt',
    collections: ['norcal-bestcal'],
    tags: ['NorCal', 'Oversized', 'Dance Apparel', 'Streetwear'],
    useCases: ['social-dance', 'norcal'],
    disclosure: 'owned-printful',
  },
  {
    ...
    href: 'https://boomtick.printful.me/product/lead-follow-or-switch-love-shirt-in-neon',
    collections: ['lead-follow-switch', 'rainbow-pride'],
  ...
  },
  {
    ...
    href: 'https://boomtick.printful.me/product/mens-bear-tank-nor-cal-best-cal',
    collections: ['norcal-bestcal'],
    tags: ['NorCal', 'Tank Top', 'Workshop Wear', 'Summer'],
    useCases: ['workshop', 'social-dance', 'norcal'],
    disclosure: 'owned-printful',
  },
  {
    ...
    href: 'https://boomtick.printful.me/product/norcal-best-cal-cropped-top',
    collections: ['norcal-bestcal'],
    tags: ['NorCal', 'Cropped Top', 'Competition Wear', 'Breathable'],
    useCases: ['competition', 'norcal'],
    disclosure: 'owned-printful',
  },
  {
    ...
    href: 'https://boomtick.printful.me/product/norcal-bestcal-golden-gate-crop-hoodie',
    collections: ['norcal-bestcal'],
    tags: ['NorCal', 'Hoodie', 'Travel', 'Layering'],
    useCases: ['travel', 'warmup', 'norcal'],
    disclosure: 'owned-printful',
  },
  {
    ...
    href: 'https://boomtick.printful.me/product/norcal-bestcal-golden-gate-rainbow-pride-shirt',
    collections: ['norcal-bestcal', 'rainbow-pride'],
    tags: ['NorCal', 'Pride', 'Golden Gate', 'West Coast Swing'],
    useCases: ['social-dance', 'pride', 'norcal'],
    disclosure: 'owned-printful',
  },
  {
    ...
    href: 'https://boomtick.printful.me/product/norcal-best-cal-pride-california-bear-apparel',
    collections: ['norcal-bestcal', 'rainbow-pride'],
  ...
  },
  {
    ...
    href: 'https://boomtick.printful.me/product/unisex-t-shirt',
    collections: ['lead-follow-switch'],
    roles: ['lead', 'follow', 'switch'],
    tags: ['Gender Neutral', 'Unisex', 'Social Dance', 'Classic'],
    useCases: ['role-shirt', 'social-dance'],
    disclosure: 'owned-printful',
  },
  {
