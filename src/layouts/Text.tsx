...
export const Text = forwardRef<HTMLElement, TextProps>(
  ({ 
    ...
    const getTextVal = (val: string | number | boolean | undefined | null, prefix: string) => {
      if (!val) return ""
    ...
    return (
      <Box
        ...
        className={composeStyles(
          ...
          getResponsiveClasses(tracking, "", (v) => trackingTokens[v as keyof typeof trackingTokens] || getTextVal(v, "tracking")),
          ...
          getResponsiveClasses(leading, "", (v) => getTextVal(v, "leading")),
          className
        )}
        {...props}
      />
