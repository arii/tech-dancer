    ...
    return (
      <Box
        ...
        className={composeStyles(
          ...
          size && getResponsiveClasses(size as any, "", (s) => typeSizes[s as keyof typeof typeSizes]),
          getResponsiveClasses(weight as any, ""),
          getResponsiveClasses(align as any, "text-"),
          getResponsiveClasses(tracking as any, "", (v) => trackingTokens[v as keyof typeof trackingTokens] || resolveJIT(v as string | number, "tracking")),
          getResponsiveClasses(uppercase as any, "", (v) => v ? "uppercase" : "normal-case"),
          getResponsiveClasses(lowercase as any, "", (v) => v ? "lowercase" : "normal-case"),
          getResponsiveClasses(capitalize as any, "", (v) => v ? "capitalize" : "normal-case"),
          getResponsiveClasses(clamp as any, "", (v) => (typeof v === "number" ? `line-clamp-${v}` : (v ? "line-clamp-none" : ""))),
          getResponsiveClasses(truncate as any, "", (v) => v ? "truncate" : ""),
          getResponsiveClasses(leading as any, "", (v) => resolveJIT(v as string | number, "leading")),
          italic && "italic",
