    ...
    return (
      <Box
        ...
        className={composeStyles(
          ...
          size && getResponsiveClasses(size as ResponsiveProp<string | number | boolean | null | undefined>, "", (s) => typeSizes[s as keyof typeof typeSizes]),
          getResponsiveClasses(weight as ResponsiveProp<string | number | boolean | null | undefined>, ""),
          getResponsiveClasses(align as ResponsiveProp<string | number | boolean | null | undefined>, "text-"),
          getResponsiveClasses(tracking as ResponsiveProp<string | number | boolean | null | undefined>, "", (v) => trackingTokens[v as keyof typeof trackingTokens] || resolveJIT(v as string | number, "tracking")),
          getResponsiveClasses(uppercase as ResponsiveProp<string | number | boolean | null | undefined>, "", (v) => v ? "uppercase" : "normal-case"),
          getResponsiveClasses(lowercase as ResponsiveProp<string | number | boolean | null | undefined>, "", (v) => v ? "lowercase" : "normal-case"),
          getResponsiveClasses(capitalize as ResponsiveProp<string | number | boolean | null | undefined>, "", (v) => v ? "capitalize" : "normal-case"),
          getResponsiveClasses(clamp as ResponsiveProp<string | number | boolean | null | undefined>, "", (v) => (typeof v === "number" ? `line-clamp-${v}` : (v ? "line-clamp-none" : ""))),
          getResponsiveClasses(truncate as ResponsiveProp<string | number | boolean | null | undefined>, "", (v) => v ? "truncate" : ""),
          getResponsiveClasses(leading as ResponsiveProp<string | number | boolean | null | undefined>, "", (v) => resolveJIT(v as string | number, "leading")),
          italic && "italic",
