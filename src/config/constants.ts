...
const DEFAULT_DESCRIPTION = "The West Coast Swing Lifestyle Blog by BoomTick. Training tips, travel guides, and gear reviews for competitive West Coast Swing dancers, plus technical deep dives into building the platform with Dev Lab.";
