...
const DEFAULT_DESCRIPTION = "The West Coast Swing Lifestyle Blog by Tech Dancer. Training notes, event guides, and practical tools for competitive West Coast Swing dancers, plus technical deep dives into building the platform with DevAI.";
