...
const DEFAULT_DESCRIPTION = "The West Coast Swing Lifestyle Blog by Tech Dancer. Training notes, blog insights, and practical tools for West Coast Swing dancers, plus technical deep dives into building the platform with DevAI.";
