...
export const RESEARCH_TOOLS: ResearchTool[] = [
  ...
  },
  {
    ...
    description: 'Local LLM-powered PR auditing using GitHub Actions. Reviews code style and pattern consistency on every pull request, forming the foundation for RAG-grounded pipelines.',
