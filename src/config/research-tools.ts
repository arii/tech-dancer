...
export const RESEARCH_TOOLS: ResearchTool[] = [
  {
    ...
    description: 'Web Bluetooth heart-rate telemetry with Spotify API context. Full-stack DevAI orchestration for complex browser-based applications.',
  ...
  },
  {
    ...
    subtitle: 'DevAI tooling',
    description: 'Automated GitHub PR auditing built on a Gemini-driven CI/CD pipeline with Jules autonomous coding agent integration.',
