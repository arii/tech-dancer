...
export const RESEARCH_TOOLS: ResearchTool[] = [
  ...
  },
  {
    ...
    description: 'AI orchestration console for GitHub that audits PRs, analyzes workflow health, and automates issue generation for coding agents to unblock rapid development.',
  ...
  },
  {
    ...
    description: 'Repo-aware review workflow using local or hosted LLMs to audit code quality, pattern consistency, and CI failure context with structured guidance.',
  ...
  },
  {
    ...
    description: 'Static analysis tool that maps AST dependency paths and workspace scope to estimate PR impact before assigning review or test strategy.',
    category: 'DevAI System',
    status: 'Active',
  ...
  },
  {
    ...
    description: 'Automated regression and Lighthouse workflow for detecting layout drift, accessibility concerns, and UX regressions across mobile and desktop views.',
  ...
  },
  {
    ...
    description: 'High-performance data engineering pipeline transforming raw competitive dance records into Parquet formats for efficient RAG indexing and analytical queries.',
  ...
  },
  {
    ...
    description: 'Human-in-the-loop content engine combining RAG with structured prompt engineering to maintain brand-consistent editorial quality at scale.',
  ...
  },
  {
    ...
    description: 'Precision synchronization tool that extracts logistics from fragmented data sources to maintain high-fidelity automated schedule telemetry.',
