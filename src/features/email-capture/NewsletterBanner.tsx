...
export function NewsletterBanner() {
  ...
  return (
    <Box
      ...
      className="fixed inset-x-4 bottom-4 z-toast overflow-hidden border border-line/40 bg-surface/95 px-4 py-4 shadow-[0_-10px_40px_rgba(0,0,0,0.25)] backdrop-blur-xl md:px-6 md:py-5"
      radius="lg"
    >
      ...
      >
        <Stack direction="row" align="center" gap={3} className="w-full md:w-auto">
          <Box padding="compact" surface="accent" opacity={8} className="hidden sm:flex" display="flex" align="center" justify="center">
        ...
        <Box className="w-full md:w-auto md:min-w-[320px] md:max-w-[420px]">
          <EmailForm />
        </Box>
      </Stack>
    </Box>
