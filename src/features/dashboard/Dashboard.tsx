...
export default function Home() {
  ...
  return (
    <Box as="section">
      <SEO
        title="Home"
        description="BT.blog: Training tips, travel guides, and gear reviews for competitive West Coast Swing dancers, plus technical deep dives into building the platform with DevAI."
