            ...
            >
              ...
              <Box position="relative" zIndex={10}>
                ...
                <Stack gap={1}>
                  ...
                  <NavLink to="/gear" color="primary" className="text-sm font-bold hover:text-white transition-colors drop-shadow-sm">
                    Gear reviews →
                  </NavLink>
                </Stack>
              </Box>
            ...
            {/* Travel Better */}
              ...
              <Box position="relative" zIndex={10}>
                ...
                <Stack gap={1}>
                  ...
                  <NavLink to="/gear" color="secondary" className="text-sm font-bold hover:text-white transition-colors drop-shadow-sm">
                    Packing lists →
                  </NavLink>
                </Stack>
              </Box>
