...
function safeGetItem(key: string): string | null {
  try {
    ...
    console.warn('[useNavigatorStorage] Failed to read from localStorage:', key, err);
  }
  return null;
}
...
function safeSetItem(key: string, value: string): void {
  try {
    ...
    console.warn('[useNavigatorStorage] Failed to save to localStorage:', key, err);
  }
}
...
function safeRemoveItem(key: string): void {
  try {
    ...
    console.warn('[useNavigatorStorage] Failed to remove from localStorage:', key, err);
  }
}
