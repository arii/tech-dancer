...
import { UXAuditReport } from '../useUXAuditor';

interface AuditSidebarProps {
  reports: UXAuditReport[];
  activeReport: UXAuditReport | null;
  setActiveReport: (report: UXAuditReport) => void;
}

export function AuditSidebar({ reports, activeReport, setActiveReport }: AuditSidebarProps) {
  return (
