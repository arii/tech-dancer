...
import { ViewportAnalysis, VIEWPORTS } from '@/features/ux-auditor/useUXAuditor';
...
export function ViewportAnalysisCard({ vp, data, activeReportUrl }: { vp: typeof VIEWPORTS[0], data: ViewportAnalysis, activeReportUrl?: string }) {
  return (
