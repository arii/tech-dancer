      ...
      <Stack gap={12}>
        ...
        <Stack gap={8}>
          <Box paddingBottom={4} display="flex" justify="between" align="end" className="border-b border-slate-200">
            ...
            <Text variant="mono" size="xs" color="dim" weight="font-semibold" tracking="wide-editorial">{tools.length} TOOLS</Text>
          </Box>
        ...
        <Stack gap={8}>
          <Box paddingBottom={4} display="flex" justify="between" align="end" className="border-b border-slate-200">
            ...
            <Text variant="mono" size="xs" color="dim" weight="font-semibold" tracking="wide-editorial">{studies.length} ARTICLES</Text>
          </Box>
