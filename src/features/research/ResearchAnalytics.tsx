        ...
        <Stack gap={8}>
          ...
          {studies.length > 0 ? (
            ...
            <EmptyState
              ...
              description="The WCS Competition Data Scraper is currently ingesting and validating public datasets. Detailed studies on judge variance and performance metrics arrives once I complete the baseline analysis."
            />
          )}
        </Stack>
      </Stack>
