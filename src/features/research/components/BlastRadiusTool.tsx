...
import { GitBranch, Layers, Activity, FileCode } from 'lucide-react';
...
export function BlastRadiusTool() {
  return (
    <Stack gap={12}>
      <PageHeader
        label="DEVAI SYSTEM // ANALYSIS"
        title="Blast-Radius Analyzer"
        description="Static workspace dependency mapping and impact analysis."
        paddingBottom={0}
        border="none"
      />
          ...
          <Stack gap={4}>
            ...
            <Stack gap={2}>
              <Box display="flex" align="center" gap={3} padding={3} border radius="md" surface="surface">
                ...
                <Text variant="mono" size="xs">dev-tools/scope_check.py</Text>
                <Text variant="mono" size="micro" color="dim" marginLeft="auto">Impact Analyzer</Text>
              </Box>
              <Box display="flex" align="center" gap={3} padding={3} border radius="md" surface="surface">
                <FileCode size={16} className="text-accent" />
                <Text variant="mono" size="xs">dev-tools/workflow_summary.py</Text>
                <Text variant="mono" size="micro" color="dim" marginLeft="auto">SDLC Profiler</Text>
              </Box>
            </Stack>
          </Stack>
        </Stack>
