    ...
    return (
      <>
        ...
        <DetailLayout
          ...
          backLabel="Back to Research Lab"
        />
      </>
    );
  }
      ...
      <Box padding="panel" textAlign="center">
        <Stack gap={8} align="center">
          ...
          <Box as="button" onClick={() => navigate('/research')} className="hover:text-accent transition-colors">
            <Text variant="mono" size="xs">Back to Research Lab</Text>
          </Box>
        </Stack>
      </Box>
    );
    ...
    <Box as="section" padding="panel">
      ...
      <Stack gap={12}>
        ...
        >
          ...
          <Text variant="mono" size="xs" weight="font-bold" color="dim" className="group-hover:text-accent">Back to Research Lab</Text>
        </Box>
