    ...
    const items: TimelineItem[] = [
      {
        ...
        date: new Date(2023, 5, 10), // June 10th local
        endDate: new Date(2023, 5, 11), // June 11th local
      }
    ];
    ...
    const items: TimelineItem[] = [
      {
        ...
        date: new Date(2023, 1, 28), // Feb 28th local
        endDate: new Date(2023, 2, 1), // March 1st local
      }
    ];
    const ics = generateICS('WCS Event', items);
