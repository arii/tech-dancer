...
export function GearCard({
  ...
  return (
    <Box
      ...
      height="full"
      border
      className="group bg-surface hover:border-accent transition-all duration-300 rounded-none overflow-hidden"
    >
      ...
      <Stack gap={4} padding={5} flex={1} justify="between">
        <Stack gap={3}>
          <Box display="flex" align="center" justify="between" wrap>
            ...
            {verdict && (
              <Box surface="brand" paddingX={1.5} paddingY={0.5} border className="rounded-none border-line/10">
          ...
          {priceCategory && (
             <Box border surface="warning" paddingX={2} paddingY={0.5} width="fit">
               <Text variant="mono" size="micro" weight="font-bold" color="brand">{priceCategory}</Text>
             </Box>
          )}
        </Stack>
        ...
        <Stack gap={3} marginTop="auto">
          ...
          <Box display="flex" align="center" gap={2} paddingTop={4} className="border-t border-line/50">
            ...
            <Box height="[1px]" width={0} className="bg-accent group-hover:w-6 transition-all duration-500" />
