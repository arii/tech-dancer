...
export function GearCard({
  ...
  return (
    <Box
      ...
      border
      surface="default"
      className="group hover:border-accent transition-all duration-300 rounded-none overflow-hidden"
    >
      ...
      <Stack gap={4} padding={5} flex={1} justify="between">
        <Stack gap={3}>
          <Box display="flex" align="center" justify="between" wrap>
            ...
            {verdict && (
              <Box surface="brand" paddingX={1.5} paddingY={0.5} className="rounded-none border border-line/10">
          ...
          {priceCategory && (
             <Box border surface="accent" paddingX={2} paddingY={0.5} className="w-fit">
               <Text variant="mono" size="micro" weight="font-bold" className="text-accent">{priceCategory}</Text>
             </Box>
          )}
        </Stack>
        ...
        <Stack gap={3} marginTop="auto">
          ...
          <Box display="flex" align="center" gap={2} paddingTop={4} className="border-t border-line/50">
            ...
            <Box marginStart="auto" className="group-hover:translate-x-1 transition-transform duration-300">
              <svg
