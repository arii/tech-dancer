    ...
    <>
      ...
      {affiliateLinks.length > 0 && (
        <Stack gap={4} marginTop={8}>
          <Text variant="mono" size="tiny" weight="font-bold" intent="dim" uppercase className="tracking-widest border-b border-line" paddingBottom={2}>Where to Buy</Text>
          ...
          <Text variant="mono" size="micro" intent="dim" emphasis="low" className="leading-tight italic">
