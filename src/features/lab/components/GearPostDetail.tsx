  ...
  const headerExtras = (
    <ScoreGrid>
      ...
      <Stack gap={1} align="center" display={{ base: "none", md: "flex" }}>
        ...
        <Text variant="mono" size="tiny" weight="font-bold" uppercase>{post.updatedDate || post.date}</Text>
      </Stack>
    ...
    <>
      ...
      {affiliateLinks.length > 0 && (
        <Stack gap={4} marginTop={8}>
          <Text variant="mono" size="tiny" weight="font-bold" color="dim" uppercase paddingBottom={2} border="b" tracking="widest" className=" border-line">Where to Buy</Text>
