  ...
  return (
    <Stack gap={12}>
      ...
      {draft && (
        ...
        >
          <Stack gap={8}>
            <Box display="flex" justify="between" align="center" paddingBottom={4} border="b">
              <Box display="flex" align="center" gap={3}>
                 <FileText className="w-5 h-5 text-accent" />
                 <Text variant="mono" size="xs" weight="font-bold">DRAFT_OUTPUT.md</Text>
              </Box>
              <Box display="flex" gap={2}>
                <Box as="button" padding={2} className="hover:text-accent transition-colors rounded-sm" title="Copy to Clipboard">
                  <Check className="w-4 h-4" />
                </Box>
                <Box as="button" padding={2} className="hover:text-accent transition-colors rounded-sm" title="Export to GitHub">
            ...
            <Box border surface="accent" padding={6} display="flex" align="center" gap={4} className="bg-accent/5 border-dashed">
               ...
               <Box as="a" href="#" display="flex" align="center" gap={2} marginLeft="auto" className="text-accent hover:underline">
