    ...
    <Stack gap={12}>
      <Stack gap={4}>
        <Box display="flex" align="center" gap={3}>
           ...
           <Text variant="display" size="2xl" weight="font-black" color="brand">Drafting Engine</Text>
        </Box>
        <Text variant="body" color="dim" marginTop={1}>
        ...
        <Stack gap={6}>
          <Stack gap={2}>
            ...
            <Box
              ...
              padding={6}
              minHeight={40}
              className="w-full bg-surface border border-line font-sans text-sm focus:outline-none focus:border-accent transition-all resize-y"
          ...
          <Stack gap={8}>
            <Box display="flex" justify="between" align="center" border="b" paddingBottom={4}>
              ...
              <Box display="flex" gap={2}>
                <Box as="button" padding={2} emphasis="ghost" radius="industrial" className="transition-colors" title="Copy to Clipboard">
                  <Check className="w-4 h-4" />
                </Box>
                <Box as="button" padding={2} emphasis="ghost" radius="industrial" className="transition-colors" title="Export to GitHub">
            ...
            <Box border surface="accent" padding={6} display="flex" align="center" gap={4} className="bg-accent/5 border-dashed group">
               ...
               <Box as="a" href="#" display="flex" align="center" gap={2} marginLeft="auto" className="text-accent hover:underline hover:bg-line/10 transition-colors">
