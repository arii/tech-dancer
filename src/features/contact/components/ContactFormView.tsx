    ...
    <Box as="section" minHeight="[calc(100vh-64px)]">
      <Stack gap={12} maxWidth="3xl" marginX="auto">
        <PageHeader
          label="CONTACT"
          title="Get in Touch"
          description="Questions about West Coast Swing training, travel, tools, or data? Send a note and I'll reply soon."
          border="b"
        />
        ...
        <Stack gap={8}>
          <Stack gap={2}>
            ...
            <Text variant="body" size="base" color="main">
              Send blog ideas, event notes, practical tool suggestions, or anything you want featured on boomtick.blog.
            </Text>
          </Stack>
        ...
        <Stack id="newsletter-section" gap={8} paddingTop={12} border="t" borderColor="line/50">
          <Stack gap={2}>
            ...
            <Text variant="body" size="base" color="main">
              Prefer to just stay updated? Join the mailing list for monthly deep-dives into dance research, tools, and travel tips.
            </Text>
          </Stack>
          <Box maxWidth="md">
            <EmailForm />
