          ...
          <Grid cols={{ base: 1, lg: 12 }} gap={12}>
            <Stack gap={16} className="lg:col-span-8">
              <Box display={{ base: 'block', lg: 'none' }} marginBottom={8} maxWidth="md" marginX="auto" paddingX={4}>
                <Box border radius="lg" overflow="hidden" className="aspect-video shadow-inner" surface="alt">
                  <img
                    src={roboticistPhoto}
              ...
              <Stack gap={8} position="sticky" top={24}>
                <Box border radius="lg" overflow="hidden" display={{ base: 'none', lg: 'block' }} className="border-line/20 bg-surface shadow-2xl">
                  <img
                    ...
                    loading="lazy"
                    className="hover:border-accent hover:bg-accent/5 transition-all group active:scale-95 focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-4 focus-visible:ring-offset-bg focus-visible:outline-none"
                  />
                </Box>
