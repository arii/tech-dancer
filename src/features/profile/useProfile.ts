  ...
  const bio = {
    ...
    sections: [
      ...
      },
      {
        ...
        content: "I love maximizing credit card perks and hotel benefits, which helps me make the WSDC Registry lifestyle both high-end and entirely feasible. I'm known for my bright, fun outfits and my 'bougie on a budget' travel philosophy."
      }
    ],
    details: [
