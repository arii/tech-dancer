  ...
  sections: [
    {
      ...
      gallery: [
        { src: firstComp, alt: "Ariel Anders performing a WCS extension with technical precision during a competition" }
      ]
    },
    {
      id: "professional",
      ...
      gallery: [
        { src: monterey, alt: "Ariel Anders presenting on stage at Monterey Swing Fest, bridging technology and dance" }
      ],
      cards: [
        {
          icon: 'terminal',
    ...
    },
    {
      ...
      gallery: [
        { src: madJamAri, alt: "Ariel Anders social dancing with expression at the MADjam convention" }
      ]
    },
    {
      id: "wcs-love",
      ...
      gallery: [
        { src: glowBunny, alt: "Ariel Anders wearing a custom LED light-up bunny costume for a late-night social dance" }
      ],
      items: [
        {
          icon: 'star',
    ...
    },
    {
      ...
      gallery: [
        { src: wwwAri, alt: "Ariel Anders demonstrating an athletic connection during a high-energy session" }
      ]
    },
    {
      id: "education-focus",
