  ...
  return (
    <Box display="flex" direction={{ base: 'col', md: 'row' }} gap={{ base: 8, lg: 12 }} align="start">
      ...
      <Box flex={1} className="space-y-8" minWidth={0}>
        ...
        <Stack gap={6}>
          <Stack gap={3}>
            <Text variant="mono" size="xs" color="dim" weight="font-semibold" tracking="editorial-tight" uppercase>Connect</Text>
          ...
          <Box display="flex" direction="col" gap={4} marginTop={4}>
            {[
              ...
              >
                ...
                <Text variant="mono" size="xs" weight="font-semibold" tracking="editorial-tight" uppercase>{item.label}</Text>
              </Box>
            ))}
          </Box>
        </Stack>
