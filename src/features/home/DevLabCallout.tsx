  ...
  return (
    <Box border radius="md" padding={5} className="w-full max-w-full min-w-0">
      ...
      <Text variant="body" size="xs" color="dim" leading="relaxed" marginTop={3}>
        An active sandbox and live testing environment for AI-assisted engineering tools, RAG pipelines, and automated developer workflows. Explore live testbeds and telemetry systems.
      </Text>
