...
export const variants = {
  ...
  emphasis: {
    ...
    primary: "bg-accent text-white hover:bg-text-main transition-all duration-300 active:translate-y-[0px] hover:translate-y-[-2px] hover:shadow-[0_4px_12px_rgba(0,123,255,0.3)]",
  },
  radius: {
    none: "rounded-none",
