...
export const variants = {
  ...
  emphasis: {
    ...
    primary: "bg-accent text-white hover:bg-text-main transition-all duration-200 active:translate-y-[0px] hover:translate-y-[-2px] hover:shadow-[0_4px_12px_rgba(255,127,80,0.3)]",
  },
  radius: {
    none: "rounded-none",
