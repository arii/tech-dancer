 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Aa extends sf{constructor(e,t){super(),this.le=e,this.currentSequenceNumber=t}}function be(r,e){const t=K(r);return Ht.O(t.le,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ut{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new D(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new D(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return G(this._lat,e._lat)||G(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:ut._jsonSchemaVersion}}static fromJSON(e){if(Os(e,ut._jsonSchema))return new ut(e.latitude,e.longitude)}}ut._jsonSchemaVersion="firestore/geoPoint/1.0",ut._jsonSchema={type:Te("string",ut._jsonSchemaVersion),latitude:Te("number"),longitude:Te("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class nm extends Vv{constructor(e){super(),this.firestore=e}convertBytes(e){return new We(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new ge(this.firestore,null,t)}}const zh="@firebase/firestore",$h="4.14.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}),y+=`
`)}),y},_=async()=>{if(!H)return;V(!0);const y=encodeURIComponent(T()),w=encodeURIComponent(`UX Audit Findings: ${H.url}`);let g="https://github.com/new";try{const q=new URL(H.url);if(q.hostname.endsWith(".github.io")){const de=q.hostname.split(".")[0],we=q.pathname.split("/")[1];de&&we&&(g=`https://github.com/${de}/${we}/issues/new`)}}catch{}window.open(`${g}?title=${w}&body=${y}`,"_blank")},I=async()=>{const y=T();try{await navigator.clipboard.writeText(y),k(!0)}catch(w){console.error("Failed to copy markdown:",w)}},v=y=>{u(y),sessionStorage.setItem("ux-auditor-api-key",y)};return{user:e,reports:$,isAnalyzing:U.isPending,activeReport:H,setActiveReport:y=>s(y?.id||null),url:i,setUrl:o,customApiKey:c,setCustomApiKey:v,snapshotService:h,setSnapshotService:f,isCopiedMarkdown:S,isExportingToGithub:N,runUXAudit:te,exportToGithub:_,copyMarkdown:I,firebaseConfig:Nt}}const Kv={Mobile:C.jsx(Ie,{icon:Ym,size:"md"}),Tablet:C.jsx(Ie,{icon:cg,size:"md"}),Desktop:C.jsx(Ie,{icon:ig,size:"md"})};function Hv({suggestion:r}){const[e,t]=ae.useState(!1),[n,s]=ae.useState(!1);ae.useEffect(()=>{if(!e)return;const o=setTimeout(()=>{document.startViewTransition?document.startViewTransition(()=>t(!1)):t(!1)},2e3);return()=>clearTimeout(o)},[e]);const i=async()=>{s(!0);try{await navigator.clipboard.writeText(r),await new Promise(o=>setTimeout(o,400)),document.startViewTransition?document.startViewTransition(()=>{t(!0)}):t(!0)}catch(o){console.error("Failed to copy:",o)}finally{s(!1)}};return C.jsxs(oe,{as:"button",onClick:i,disabled:n,marginTop:2,display:"flex",align:"center",gap:1,paddingX:3,paddingY:1,radius:"md",surface:"default",border:!0,className:"hover:border-accent transition-colors hover:text-accent font-bold text-xs",children:[n?C.jsx(Ie,{icon:Jn,size:"xs",className:"animate-spin"}):e?C.jsx(Ie,{icon:ua,size:"xs",color:"accent"}):C.jsx(Ie,{icon:Yh,size:"xs"}),C.jsx("span",{children:n?"Copying...":e?"Copied!":"Copy Prompt"})]})}function Wv({url:r,width:e,height:t}){const n=ae.useRef(null),[s,i]=ae.useState(1),[o,c]=ae.useState(!0);return ae.useEffect(()=>{c(!0)},[r]),ae.useEffect(()=>{const u=()=>{if(n.current){const h=n.current.offsetWidth,f=n.current.offsetHeight,m=h/e,E=f/t;i(Math.min(m,E,1))}};return u(),window.addEventListener("resize",u),()=>window.removeEventListener("resize",u)},[e,t]),C.jsxs(oe,{ref:n,width:"full",height:"full",display:"flex",align:"center",justify:"center",overflow:"hidden",position:"relative",className:"bg-surface rounded-xl shadow-2xl border border-line",children:[o&&C.jsx(oe,{position:"absolute",inset:!0,display:"flex",align:"center",justify:"center",zIndex:"docked",surface:"muted",children:C.jsxs(ce,{align:"center",gap:3,children:[C.jsx(Ie,{icon:Jn,size:"md",className:"animate-spin text-accent"}),C.jsx(_e,{variant:"sans",size:"xs",color:"dim",weight:"font-bold",uppercase:!0,tracking:"wider",children:"Loading Preview..."})]})}),C.jsx(oe,{as:"iframe",src:r,title:"Viewport Preview",onLoad:()=>c(!1),width:e,height:t,className:"border-none bg-white origin-center",style:{transform:`scale(${s})`,width:`${e}px`,height:`${t}px`,minWidth:`${e}px`,minHeight:`${t}px`}}),C.jsx(oe,{position:"absolute",bottom:4,right:4,maxWidth:48,pointerEvents:"none",children:C.jsx(oe,{paddingX:2,paddingY:1,radius:"sm",border:!0,className:"bg-bg/80 backdrop-blur-sm",children:C.jsx(_e,{variant:"sans",size:"xs",color:"dim",children:"⚠️ Some sites block embedding via CORS."})})})]})}function uA(){const r=Hm.find(V=>V.id==="ux-auditor"),{reports:e,isAnalyzing:t,activeReport:n,setActiveReport:s,url:i,setUrl:o,customApiKey:c,setCustomApiKey:u,snapshotService:h,setSnapshotService:f,isCopiedMarkdown:m,isExportingToGithub:E,runUXAudit:S,exportToGithub:k,copyMarkdown:N}=Gv();return C.jsxs(ce,{gap:8,width:"full",children:[C.jsx(Km,{title:"Visual UX Auditor | Perception Telemetry System",description:"Run automated visual UX audits on any URL using multimodal AI. Identify usability issues and get improvement suggestions for Mobile, Tablet, and Desktop.",canonical:`${jm}${r?.canonicalPath||"/ux-auditor"}`}),C.jsxs(ce,{direction:{base:"col",md:"row"},align:{base:"start",md:"center"},justify:"between",gap:6,border:"b",paddingBottom:6,children:[C.jsx(oe,{children:C.jsx(Gm,{label:"Visual UX Auditor",title:"Multimodal AI Analysis",description:"Automated visual regression and UX improvement suggestions across viewports."})}),C.jsxs(ce,{gap:4,children:[C.jsxs(ce,{direction:"row",align:"center",gap:3,padding:2,className:un(),children:[C.jsx(oe,{as:"input",type:"text",value:i,title:i,onChange:V=>o(V.target.value),onFocus:V=>V.target.select(),className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main text-sm",width:{base:"full",sm:64,md:80},paddingX:4,paddingY:2,radius:"lg",placeholder:"https://...","aria-label":"URL to audit"}),C.jsxs(oe,{as:"button",onClick:()=>S(i),disabled:t,display:"flex",align:"center",gap:2,className:"bg-accent hover:opacity-solid text-bg font-bold transition-all disabled:opacity-muted",paddingX:6,paddingY:2,radius:"md",children:[t?C.jsx(Ie,{icon:Jn,size:"sm",className:"animate-spin"}):C.jsx(Ie,{icon:Ju,size:"sm"}),t?"Auditing...":"Start Audit"]})]}),C.jsxs(ce,{gap:2,children:[C.jsxs(ce,{direction:"row",align:"center",gap:3,padding:2,className:un(),children:[C.jsx(_e,{variant:"mono",size:"xs",color:"dim",paddingLeft:2,uppercase:!0,weight:"font-bold",children:"API KEY"}),C.jsx(oe,{as:"input",type:"password",value:c,onChange:V=>u(V.target.value),className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main truncate text-sm",flex:1,paddingX:4,paddingY:2,radius:"lg",placeholder:"OpenAI or Gemini API Key (optional override)","aria-label":"API Key"}),c&&C.jsx(oe,{as:"button",onClick:()=>u(""),display:"flex",align:"center",justify:"center",padding:2,radius:"md",className:"hover:bg-surface-alt text-dim hover:text-error transition-colors",title:"Clear API Key",children:C.jsx(Ie,{icon:Wm,size:"sm"})})]}),C.jsx(_e,{variant:"sans",size:"xs",color:"warning",paddingX:2,weight:"font-medium",children:"⚠️ API keys are stored in your browser's session storage. They are cleared when you close the tab. Plain-text storage is not fully secure; use only on trusted devices."})]}),C.jsxs(ce,{direction:"row",align:"center",gap:3,padding:2,className:un(),children:[C.jsx(_e,{variant:"mono",size:"xs",color:"dim",paddingLeft:2,uppercase:!0,weight:"font-bold",children:"SNAPSHOT SERVICE"}),C.jsx(oe,{as:"input",type:"text",value:h,onChange:V=>f(V.target.value),className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main truncate text-sm",flex:1,paddingX:4,paddingY:2,radius:"lg",placeholder:"Custom service URL with {url}, {width}, {height} (optional)","aria-label":"Snapshot Service URL"})]})]})]}),C.jsxs(qm,{cols:{base:1,lg:4},gap:8,children:[C.jsxs(ce,{gap:4,span:{lg:1},minWidth:0,children:[C.jsx(_e,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"widest",color:"dim",paddingX:1,children:"Audit History"}),C.jsxs(ce,{className:`${un({overflow:"hidden"})} divide-y divide-line`,minWidth:0,children:[e.length===0&&C.jsx(Qu,{compact:!0,title:"No history",icon:C.jsx(Ie,{icon:Jn,size:"sm",color:"muted"})}),e.map(V=>C.jsxs(ce,{as:"button",direction:"row",onClick:()=>s(V),width:"full",align:"center",gap:3,padding:4,className:zm({active:n?.id===V.id}),children:[C.jsx(oe,{width:9,height:9,radius:"full",surface:V.status==="completed"?"success":"warning",className:`${V.status!=="completed"?"animate-pulse":""} flex items-center justify-center`,shrink:0,children:V.status==="completed"?C.jsx(Ie,{icon:ua,size:"sm"}):C.jsx(Ie,{icon:Jn,size:"sm"})}),C.jsxs(oe,{flex:1,minWidth:"0",children:[C.jsx(_e,{variant:"sans",size:"sm",weight:"font-bold",className:"truncate block",children:V.url.replace("https://","")}),C.jsx(_e,{variant:"mono",size:"xs",weight:"font-medium",color:"dim",uppercase:!0,children:new Date(V.timestamp).toLocaleTimeString()})]}),C.jsx(Ie,{icon:Qm,size:"sm",color:"muted"})]},V.id))]})]}),C.jsx(ce,{gap:6,span:{lg:3},minWidth:0,children:n?C.jsxs(C.Fragment,{children:[C.jsxs(ce,{padding:6,className:un(),justify:"between",align:{base:"start",md:"center"},gap:6,direction:{base:"col",md:"row"},children:[C.jsxs(ce,{gap:1,minWidth:"0",flex:1,children:[C.jsx(_e,{variant:"sans",size:"xs",weight:"font-bold",color:"accent",uppercase:!0,tracking:"widest",display:"block",children:"Current Session"}),C.jsx(_e,{variant:"sans",size:"xl",weight:"font-black",className:"truncate block",title:n.url,children:n.url})]}),C.jsxs(ce,{direction:"row",gap:3,shrink:0,children:[C.jsxs(oe,{as:"button",onClick:N,display:"flex",align:"center",gap:2,className:Wu({variant:"default"}),surface:"muted",color:"dim",paddingX:4,paddingY:2,radius:"xl",children:[m?C.jsx(Ie,{icon:ua,size:"sm"}):C.jsx(Ie,{icon:Yh,size:"sm"}),m?"Copied":"Copy MD"]}),C.jsxs(oe,{as:"button",onClick:k,disabled:n.status!=="completed"||E,display:"flex",align:"center",gap:2,className:Wu({variant:"primary"}),paddingX:6,paddingY:2,radius:"xl",children:[E?C.jsx(Ie,{icon:Jn,size:"sm",className:"animate-spin"}):C.jsx(Ie,{icon:Jm,size:"sm"}),C.jsx("span",{className:"whitespace-nowrap",children:E?"Exporting...":"Export to GitHub Issue"})]})]})]}),C.jsx(ce,{gap:8,children:za.map(V=>{const $=n[`findings_${V.name.toLowerCase()}`];return C.jsxs(oe,{className:un({overflow:"hidden"}),children:[C.jsxs(ce,{padding:4,border:"b",direction:"row",align:"center",justify:"between",surface:"muted",children:[C.jsxs(ce,{direction:"row",align:"center",gap:3,children:[C.jsx(oe,{width:9,height:9,surface:"default",radius:"lg",shadow:"sm",color:"accent",display:"flex",align:"center",justify:"center",shrink:0,children:Kv[V.name]}),C.jsxs(_e,{variant:"sans",size:"base",weight:"font-bold",children:[V.name," Analysis"]})]}),C.jsxs(_e,{variant:"mono",size:"xs",weight:"font-bold",color:"dim",uppercase:!0,tracking:"widest",children:[V.width,"w × ",V.height,"h"]})]}),C.jsxs(ce,{direction:{base:"col",md:"row"},width:"full",children:[C.jsx(oe,{padding:8,surface:"muted",display:"flex",align:"center",justify:"center",border:{base:"b",md:"r"},minHeight:400,width:{base:"full",md:"41.666%"},children:n.url?C.jsx(Wv,{url:n.url,width:V.width,height:V.height}):C.jsxs(ce,{align:"center",justify:"center",color:"dim",className:"text-center",children:[C.jsx(oe,{marginBottom:2,children:C.jsx(Ie,{icon:rg,size:"2xl",color:"muted"})}),C.jsx(_e,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"wider",children:"Awaiting Frame..."})]})}),C.jsx(ce,{gap:6,padding:8,flex:1,minWidth:"0",overflow:"hidden",children:$?C.jsxs(C.Fragment,{children:[C.jsxs(oe,{surface:"alt",padding:5,className:"border border-line rounded-lg",children:[C.jsx(oe,{marginBottom:3,children:C.jsx(_e,{variant:"sans",size:"xs",weight:"font-black",color:"accent",uppercase:!0,display:"block",tracking:"widest",children:"Analysis Summary"})}),C.jsxs(_e,{variant:"sans",size:"sm",weight:"font-medium",className:"leading-relaxed break-words block",children:['"',$.summary,'"']})]}),C.jsx(ce,{gap:4,children:$.improvements?.map((U,j)=>C.jsxs(oe,{padding:4,className:un({interactive:!0}),children:[C.jsxs(oe,{display:"flex",justify:"between",align:"start",marginBottom:2,children:[C.jsxs(ce,{direction:"row",align:"center",gap:2,children:[C.jsx(oe,{width:2,height:2,radius:"full",className:U.severity>7?"bg-error shadow-sm":"bg-accent-purple shadow-sm"}),C.jsx(_e,{variant:"sans",size:"sm",weight:"font-black",children:U.element})]}),C.jsxs(_e,{variant:"mono",size:"xs",weight:"font-black",paddingX:2,paddingY:.5,radius:"full",surface:"muted",color:"dim",uppercase:!0,title:`Severity level: ${U.severity} out of 10 (1-10 scale)`,children:["SEV ",U.severity]})]}),C.jsx(_e,{variant:"sans",size:"xs",color:"dim",marginBottom:3,children:U.issue}),U.suggestion&&U.suggestion.trim()!==""&&C.jsx(oe,{surface:"muted",padding:3,radius:"lg",border:!0,children:C.jsxs(ce,{direction:{base:"col",sm:"row"},align:"start",gap:2,children:[C.jsx(_e,{variant:"sans",size:"xs",weight:"font-black",color:"accent",marginTop:.5,uppercase:!0,tracking:"widest",className:"shrink-0",children:"FIX"}),C.jsxs(oe,{flex:1,minWidth:"0",children:[C.jsx(_e,{variant:"sans",size:"xs",weight:"font-bold",className:"break-words whitespace-pre-wrap line-clamp-4",children:U.suggestion}),U.element==="Manual Audit Required"&&C.jsx(Hv,{suggestion:U.suggestion})]})]})})]},j))})]}):C.jsxs(ce,{gap:4,width:"full",children:[C.jsx(ri,{height:20,width:"full"}),C.jsxs(ce,{gap:2,children:[C.jsx(ri,{height:4,width:"full"}),C.jsx(ri,{height:4,width:"full"}),C.jsx(ri,{height:4,width:"3/4"})]})]})})]})]},V.name)})})]}):C.jsx(Qu,{minHeight:500,icon:C.jsx(Ie,{icon:Ju,size:"xl",color:"muted"}),title:"Ready to Audit",description:"Enter a URL above to start the visual analysis across Mobile, Tablet, and Desktop."})})]})]})}export{uA as default};
