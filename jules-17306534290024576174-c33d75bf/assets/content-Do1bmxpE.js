import{A as Je}from"./index-CTa9gltX.js";const mn=`---
type: post
draft: true
status: draft
...
`,In=Object.freeze(Object.defineProperty({__proto__:null,default:An},Symbol.toStringTag,{value:"Module"})),_n=`---
type: post
draft: false
status: published
...
`,Cn=Object.freeze(Object.defineProperty({__proto__:null,default:_n},Symbol.toStringTag,{value:"Module"})),On=`---
type: post
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let A=!1;const I=je(s,!0);a!=="folded"&&e!==T.BLOCK_FOLDED&&(I.onOverflow=()=>{A=!0});const y=De(`${w}${S}${g}`,c,Xe,I);if(!A)return`>${v}
