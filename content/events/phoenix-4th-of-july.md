...
theme:
  ...
  description: >
    Keep this guide focused on Scottsdale heat, resort walking, pool-party prep,
...
This is Scottsdale in July—temperatures will be well over 100°F. The guide here is practical: stay on top of your hydration, keep sunscreen ready for the pool parties, and have a plan for walking around the massive resort grounds. You can easily spend the entire weekend without leaving the AC if you choose, but the pool-party fireworks are a must-see.

Pack hydration support like Liquid I.V. to maintain electrolyte balance during intense workshop days. Portable fans are a life-saver on a crowded, hot dance floor or while waiting for the lazy river.
...
## Change Checklist
- [x] Verified 2026 dates (July 2-5).
- [x] Improved Phoenix 4th of July with resort / pool / heat specificity.
- [x] Set theme to "Red, White & Blue / Resort Weekend".
- [x] Focused gear on heat management, hydration, and pool prep.
- [x] Added "Heat and resort logistics" section.
