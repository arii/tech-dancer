...
description: Boogie by the Bay (BBTB) is the premier West Coast Swing event in Northern California. Hosted by the The Next Generation Swing Dance Club, it features top-tier competitions, workshops, and social dancing in a beautiful waterfront setting near SFO.
whyAttending: >
  BBTB is the highlight of the NorCal WCS calendar. The level of competition is exceptionally high, and the Sunday night show is always a must-watch.
theme:
...
- **BART:** You can take BART from SFO into downtown San Francisco if you want to explore the city before the event starts.
