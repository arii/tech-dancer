import{A as Qe}from"./index-BpmjAEBx.js";const mn=`---
type: post
draft: true
status: draft
...
`,qn=Object.freeze(Object.defineProperty({__proto__:null,default:zn},Symbol.toStringTag,{value:"Module"})),Kn=`---
type: post
...
`,Wn=Object.freeze(Object.defineProperty({__proto__:null,default:Kn},Symbol.toStringTag,{value:"Module"})),Gn=`---
type: post
...
`,hs=Object.freeze(Object.defineProperty({__proto__:null,default:fs},Symbol.toStringTag,{value:"Module"})),ps=`---
type: resource
...
`,ws=Object.freeze(Object.defineProperty({__proto__:null,default:bs},Symbol.toStringTag,{value:"Module"})),ks=`---
type: resource
...
`,vs=Object.freeze(Object.defineProperty({__proto__:null,default:ks},Symbol.toStringTag,{value:"Module"})),Ss=`---
type: resource
...
`,qs=Object.freeze(Object.defineProperty({__proto__:null,default:zs},Symbol.toStringTag,{value:"Module"})),Ks=`---
type: resource
draft: true
...
`,Ws=Object.freeze(Object.defineProperty({__proto__:null,default:Ks},Symbol.toStringTag,{value:"Module"})),Gs=`---
type: resource
...
`,Hs=Object.freeze(Object.defineProperty({__proto__:null,default:Gs},Symbol.toStringTag,{value:"Module"})),Vs=`---
type: resource
...
`,Js=Object.freeze(Object.defineProperty({__proto__:null,default:Vs},Symbol.toStringTag,{value:"Module"})),Ys=`---
type: resource
...
`,hi=Object.freeze(Object.defineProperty({__proto__:null,default:fi},Symbol.toStringTag,{value:"Module"})),pi=`---
type: resource
...
+(?!
|$)`,"g")}catch{tt=/\n+(?!\n|$)/g}function Ee({comment:n,type:e,value:t},s,i,o){const{blockQuote:r,commentString:a,lineWidth:l}=s.options;if(!r||/\n[\t ]+$/.test(t))return ee(t,s);const c=s.indent||(s.forceBlockIndent||xe(t)?"  ":""),h=r==="literal"?!0:r==="folded"||e===_.BLOCK_FOLDED?!1:e===_.BLOCK_LITERAL?!0:!Ni(t,l,c.length);if(!t)return h?`|
`:`>
...
${c}${w}${t}${g}`}function Ei(n,e,t,s){const{type:i,value:o}=n,{actualString:r,implicitKey:a,indent:l,indentStep:c,inFlow:h}=e;if(a&&o.includes(`
...
`))if(i===`
`){const{fold:o,offset:r}=fo(n,s);t+=o,s=r}else if(i==="\\"){let o=n[++s];const r=ho[o];if(r)t+=r;else if(o===`
...
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new he(de(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){const s=Object.assign({_directives:this.directives},this.options),i=new Ke(void 0,s);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}}const fn="\uFEFF",hn="",pn="",st="";function So(n){switch(n){case fn:return"byte-order-mark";case hn:return"doc-mode";case pn:return"flow-error-end";case st:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
