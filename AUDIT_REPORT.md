...
* [x] **[x] src/data/affiliates.json — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
### boomtick-pkg/ files
* [x] **[x] boomtick-pkg/.agents/AGENT_CONTRACT.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/.agents/INSTRUCTION_LAYERS.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/.agents/README.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] boomtick-pkg/.agents/workflows/REVIEW_INSTRUCTIONS.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/.agents/workflows/aggregate-prs.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/.agents/workflows/ai-slop-audit.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/.agents/workflows/review-pr.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/.agents/workflows/review-ux.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] boomtick-pkg/cli/plan-template.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] boomtick-pkg/cli/review_template.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] boomtick-pkg/cli/ux-audit.config.json — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] boomtick-pkg/cli/visual_guidelines.json — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] boomtick-pkg/mcp/README.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/mcp/docs/testing.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/mcp/package.json — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] boomtick-pkg/mcp/src/agents/conflict-scout.prompt.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/mcp/src/agents/pr-consolidation.prompt.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/mcp/src/agents/pr-writer.prompt.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/mcp/src/agents/repair-agent.prompt.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/mcp/src/agents/repo-context.prompt.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
* [x] **[x] boomtick-pkg/mcp/src/agents/verifier-agent.prompt.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] boomtick-pkg/mcp/src/evals/fixtures/merge-conflict-simple/README.md — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] boomtick-pkg/mcp/tsconfig.json — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* [x] **[x] scripts/amazon-image-map.tsv — Verified Clean** (No hallucinated compatibility layers, cargo-culted boilerplate, or non-functional abstractions found).
...
* **File:** `scripts/orchestrator/agent_2_orchestrator.py`
  * **The Slop:** Redundant local redefinitions of `run_cli`, `get_session_id`, and `wait_for_agent`.
  * **Why:** AI likely hallucinated the need for a self-contained script or drifted from the imported `utils.py`.
  * **Remediation:** Removed local redefinitions and utilized imported utilities. Verified via `grep` that there are no other callers in the codebase.

* **File:** `boomtick-pkg/cli/dev_tools/review_read_pass.py`
  * **The Slop:** Legacy hunk-level parser and static signal extraction kept for "backward compatibility" with non-existent legacy systems.
  * **Why:** AI cargo-culting patterns from larger, older codebases or hallucinating requirement for legacy support.
  * **Remediation:** Removed unused legacy parsing functions. Verified via `grep` that there are no other callers in the codebase.
...
* **File:** `src/lib/style-utils.ts`
  ...
  * **Why:** AI over-architecting a simple utility with excessive academic checks.
  * **Remediation:** Refactored to a concise regex-based implementation.

* **File:** `src/lib/merch/imageDisplay.ts`
  * **The Slop:** `legacyImageToMerchImages` wrapper function adding zero operational value.
  * **Why:** AI over-architecting simple data transformation into multiple layers of abstraction.
  * **Remediation:** Inlined the simple transformation logic.

* **File:** `boomtick-pkg/mcp/src/tools/github.issue_update.ts`
  * **The Slop:** Hallucinated backward compatibility layer for "client schema drift" handling camelCase/snake_case translation.
  * **Why:** AI hallucinating a drift issue between host and contract that should be handled by schema generation.
  * **Remediation:** Removed the translation fallback layer.
