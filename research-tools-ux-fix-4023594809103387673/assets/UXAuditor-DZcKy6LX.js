 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B_(r){tr(new En("platform-logger",e=>new Yg(e),"PRIVATE")),tr(new En("heartbeat",e=>new M_(e),"PRIVATE")),jt(ha,tl,r),jt(ha,tl,"esm2020"),jt("fire-js","")}B_("");var j_="firebase",q_="12.12.1";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function FI(r){switch(r){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function UI(r){tr(new En("auth",(e,{options:t})=>{const n=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=n.options;z(o&&!o.includes(":"),"invalid-api-key",{appName:n.name});const u={apiKey:o,authDomain:c,clientPlatform:r,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:Cd(r)},h=new dy(n,s,i,u);return yy(h,t),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,n)=>{e.getProvider("auth-internal").initialize()})),tr(new En("auth-internal",e=>{const t=xs(e.getProvider("auth").getImmediate());return(n=>new LI(n))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),jt(Tl,El,FI(r)),jt(Tl,El,"esm2020")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hn="remoteDocuments",Os="owner",Ln="owner",ps="mutationQueues",lT="userId",Ye="mutations",kl="batchId",gn="userMutationsIndex",Dl=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ii(r,e){return[r,Oe(e)]}function of(r,e,t){return[r,Oe(e),t]}const hT={},rr="documentMutations",Fi="remoteDocumentsV14",dT=["prefixPath","collectionGroup","readTime","documentId"],Ti="documentKeyIndex",fT=["prefixPath","collectionGroup","documentId"],af="collectionGroupIndex",pT=["collectionGroup","readTime","prefixPath","documentId"],ms="remoteDocumentGlobal",Ta="remoteDocumentGlobalKey",sr="targets",cf="queryTargetsIndex",mT=["canonicalId","targetId"],ir="targetDocuments",gT=["targetId","path"],ic="documentTargetsIndex",_T=["path","targetId"],Ui="targetGlobalKey",yn="targetGlobal",gs="collectionParents",yT=["collectionId","parent"],or="clientMetadata",IT="clientId",so="bundles",TT="bundleId",io="namedQueries",ET="name",oc="indexConfiguration",wT="indexId",Ea="collectionGroupIndex",vT="collectionGroup",ns="indexState",AT=["indexId","uid"],uf="sequenceNumberIndex",bT=["uid","sequenceNumber"],rs="indexEntries",RT=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],lf="documentKeyIndex",ST=["indexId","uid","orderedDocumentKey"],oo="documentOverlays",PT=["userId","collectionPath","documentId"],wa="collectionPathOverlayIndex",CT=["userId","collectionPath","largestBatchId"],hf="collectionGroupOverlayIndex",VT=["userId","collectionGroup","largestBatchId"],ac="globals",xT="name",df=[ps,Ye,rr,hn,sr,Os,yn,ir,or,ms,gs,so,io],kT=[...df,oo],ff=[ps,Ye,rr,Fi,sr,Os,yn,ir,or,ms,gs,so,io,oo],pf=ff,cc=[...pf,oc,ns,rs],DT=cc,mf=[...cc,ac],NT=mf;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
