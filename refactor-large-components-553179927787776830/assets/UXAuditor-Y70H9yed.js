 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Te(r,e){const t={typeString:r};return e&&(t.value=e),t}function Os(r,e){if(!rf(r))throw new k(P.INVALID_ARGUMENT,"JSON must be an object");let t;for(const n in e)if(e[n]){const s=e[n].typeString,i="value"in e[n]?{value:e[n].value}:void 0;if(!(n in r)){t=`JSON missing required field: '${n}'`;break}const o=r[n];if(s&&typeof o!==s){t=`JSON field '${n}' must be a ${s}.`;break}if(i!==void 0&&o!==i.value){t=`Expected '${n}' field to equal '${i.value}'`;break}}if(t)throw new k(P.INVALID_ARGUMENT,t);return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We{constructor(e){this._byteString=e}static fromBase64String(e){try{return new We(Ee.fromBase64String(e))}catch(t){throw new k(P.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new We(Ee.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}toJSON(){return{type:We._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(e){if(Os(e,We._jsonSchema))return We.fromBase64String(e.bytes)}}We._jsonSchemaVersion="firestore/bytes/1.0",We._jsonSchema={type:Te("string",We._jsonSchemaVersion),bytes:Te("string")};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lc{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new k(P.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new fe(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ut{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new k(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new k(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return $(this._lat,e._lat)||$(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:ut._jsonSchemaVersion}}static fromJSON(e){if(Os(e,ut._jsonSchema))return new ut(e.latitude,e.longitude)}}ut._jsonSchemaVersion="firestore/geoPoint/1.0",ut._jsonSchema={type:Te("string",ut._jsonSchemaVersion),latitude:Te("number"),longitude:Te("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ze{constructor(e){this._values=(e||[]).map((t=>t))}toArray(){return this._values.map((e=>e))}isEqual(e){return(function(n,s){if(n.length!==s.length)return!1;for(let i=0;i<n.length;++i)if(n[i]!==s[i])return!1;return!0})(this._values,e._values)}toJSON(){return{type:Ze._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(e){if(Os(e,Ze._jsonSchema)){if(Array.isArray(e.vectorValues)&&e.vectorValues.every((t=>typeof t=="number")))return new Ze(e.vectorValues);throw new k(P.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}}Ze._jsonSchemaVersion="firestore/vectorValue/1.0",Ze._jsonSchema={type:Te("string",Ze._jsonSchemaVersion),vectorValues:Te("object")};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`}),y+=`
`)}),y},_=async()=>{if(!H)return;O(!0);const y=encodeURIComponent(T()),E=encodeURIComponent(`UX Audit Findings: ${H.url}`);let g="https://github.com/new";try{const j=new URL(H.url);if(j.hostname.endsWith(".github.io")){const de=j.hostname.split(".")[0],we=j.pathname.split("/")[1];de&&we&&(g=`https://github.com/${de}/${we}/issues/new`)}}catch{}window.open(`${g}?title=${E}&body=${y}`,"_blank")},I=async()=>{const y=T();try{await navigator.clipboard.writeText(y),x(!0)}catch(E){console.error("Failed to copy markdown:",E)}},w=y=>{u(y),sessionStorage.setItem("ux-auditor-api-key",y)};return{user:e,reports:K,isAnalyzing:z.isPending,activeReport:H,setActiveReport:y=>s(y?.id||null),url:i,setUrl:o,customApiKey:c,setCustomApiKey:w,snapshotService:h,setSnapshotService:f,isCopiedMarkdown:S,isExportingToGithub:D,runUXAudit:te,exportToGithub:_,copyMarkdown:I,firebaseConfig:Nt}}const Yv=({customApiKey:r,setCustomApiKey:e,snapshotService:t,setSnapshotService:n})=>{const s=u=>e(u.target.value),i=()=>e(""),o=u=>n(u.target.value),c=u=>u.target.select();return C.jsxs(C.Fragment,{children:[C.jsxs(ae,{gap:2,children:[C.jsxs(ae,{direction:"row",align:"center",gap:3,padding:2,className:wn(),children:[C.jsx(ge,{variant:"mono",size:"xs",color:"dim",paddingLeft:2,uppercase:!0,weight:"font-bold",children:"API KEY"}),C.jsx(oe,{as:"input",id:"audit-api-key",name:"audit-api-key",type:"password",autoComplete:"new-password",value:r,onChange:s,onFocus:c,className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main truncate text-sm",flex:1,paddingX:4,paddingY:2,radius:"md",placeholder:"OpenAI or Gemini API Key (optional override)","aria-label":"API Key"}),r&&C.jsx(oe,{as:"button",onClick:i,display:"flex",align:"center",justify:"center",padding:2,radius:"md",className:"hover:bg-surface-alt text-dim hover:text-error transition-colors",title:"Clear API Key",children:C.jsx(Ie,{icon:Jp,size:"sm"})})]}),C.jsx(ge,{variant:"sans",size:"xs",color:"warning",paddingX:2,weight:"font-medium",children:"⚠️ API keys are stored in your browser's session storage. They are cleared when you close the tab. Plain-text storage is not fully secure; use only on trusted devices."})]}),C.jsxs(ae,{gap:1,children:[C.jsxs(ae,{direction:"row",align:"center",gap:3,padding:2,className:wn(),children:[C.jsx(ge,{variant:"mono",size:"xs",color:"dim",paddingLeft:2,uppercase:!0,weight:"font-bold",children:"SNAPSHOT SERVICE"}),C.jsx(oe,{as:"input",id:"audit-snapshot-url",name:"audit-snapshot-url",type:"url",autoComplete:"off",value:t,onChange:o,onFocus:c,className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main truncate text-sm",flex:1,paddingX:4,paddingY:2,radius:"md",placeholder:"Custom service URL with {url}, {width}, {height} (optional)","aria-label":"Snapshot Service URL"})]}),C.jsxs(ge,{variant:"sans",size:"xs",color:"dim",paddingX:2,marginTop:1,children:["Use ","{url}",", ","{width}",", and ","{height}"," as placeholders. Example: https://api.service.com?url=","{url}","&size=","{width}","x","{height}"]})]})]})},Xv=({url:r,setUrl:e,isAnalyzing:t,runUXAudit:n,customApiKey:s,setCustomApiKey:i,snapshotService:o,setSnapshotService:c})=>{const u=p=>e(p.target.value),h=p=>{p.preventDefault(),n(r)},f=p=>p.target.select();return C.jsxs(ae,{gap:4,as:"form",autoComplete:"off",onSubmit:h,children:[C.jsxs(ae,{direction:"row",align:"center",gap:3,padding:2,className:wn(),children:[C.jsx(oe,{as:"input",id:"audit-url",name:"audit-url",type:"url",autoComplete:"off",value:r,title:r,onChange:u,onFocus:f,className:"bg-bg border-none focus:ring-2 focus:ring-accent outline-none font-mono text-text-main text-sm",flex:1,minWidth:0,paddingX:4,paddingY:2,radius:"md",placeholder:"https://...","aria-label":"URL to audit"}),C.jsxs(oe,{as:"button",onClick:()=>n(r),disabled:t,display:"flex",align:"center",gap:2,className:"bg-accent hover:opacity-solid text-bg font-bold transition-all disabled:opacity-muted",paddingX:6,paddingY:2,radius:"md",children:[t?C.jsx(Ie,{icon:sr,size:"sm",className:"animate-spin"}):C.jsx(Ie,{icon:Yh,size:"sm"}),t?"Auditing...":"Start Audit"]})]}),C.jsx(Yv,{customApiKey:s,setCustomApiKey:i,snapshotService:o,setSnapshotService:c})]})},Zv=({reports:r,activeReport:e,setActiveReport:t})=>C.jsxs(ae,{gap:4,span:{lg:1},minWidth:0,children:[C.jsx(ge,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"widest",color:"dim",paddingX:1,children:"Audit History"}),C.jsxs(ae,{className:`${wn({overflow:"hidden"})} divide-y divide-line`,minWidth:0,children:[r.length===0&&C.jsx(Xh,{compact:!0,title:"No history",icon:C.jsx(Ie,{icon:sr,size:"sm",color:"muted"})}),r.map(n=>C.jsxs(ae,{as:"button",direction:"row",onClick:()=>t(n),width:"full",align:"center",gap:3,padding:4,className:zp({active:e?.id===n.id}),children:[C.jsx(oe,{width:9,height:9,radius:"full",surface:n.status==="completed"?"success":"warning",className:`${n.status!=="completed"?"animate-pulse":""} flex items-center justify-center`,shrink:0,children:n.status==="completed"?C.jsx(Ie,{icon:za,size:"sm"}):C.jsx(Ie,{icon:sr,size:"sm"})}),C.jsxs(oe,{flex:1,minWidth:"0",children:[C.jsx(ge,{variant:"sans",size:"sm",weight:"font-bold",className:"truncate block",children:n.url.replace("https://","")}),C.jsx(ge,{variant:"mono",size:"xs",weight:"font-medium",color:"dim",uppercase:!0,children:new Date(n.timestamp).toLocaleTimeString()})]}),C.jsx(Ie,{icon:Yp,size:"sm",color:"muted"})]},n.id))]})]}),eA=({url:r,width:e,height:t})=>{const n=ce.useRef(null),[s,i]=ce.useState(1),[o,c]=ce.useState(!0);return ce.useEffect(()=>{const u=()=>{if(n.current){const h=n.current.offsetWidth,f=n.current.offsetHeight,p=h/e,v=f/t;i(Math.min(p,v,1))}};return u(),window.addEventListener("resize",u),()=>window.removeEventListener("resize",u)},[e,t]),C.jsxs(oe,{ref:n,width:"full",height:"full",display:"flex",align:"center",justify:"center",overflow:"hidden",position:"relative",className:"bg-surface rounded-xl shadow-2xl border border-line",children:[o&&C.jsx(oe,{position:"absolute",inset:!0,display:"flex",align:"center",justify:"center",zIndex:"docked",surface:"muted",children:C.jsxs(ae,{align:"center",gap:3,children:[C.jsx(Ie,{icon:sr,size:"md",className:"animate-spin text-accent"}),C.jsx(ge,{variant:"sans",size:"xs",color:"dim",weight:"font-bold",uppercase:!0,tracking:"wider",children:"Loading Preview..."})]})}),C.jsx(oe,{as:"iframe",src:r,title:"Viewport Preview",onLoad:()=>c(!1),width:e,height:t,className:"border-none bg-white origin-center",style:{transform:`scale(${s})`,width:`${e}px`,height:`${t}px`,minWidth:`${e}px`,minHeight:`${t}px`}}),C.jsx(oe,{position:"absolute",bottom:4,right:4,maxWidth:48,pointerEvents:"none",children:C.jsx(oe,{paddingX:2,paddingY:1,radius:"sm",border:!0,className:"bg-bg/80 backdrop-blur-sm",children:C.jsx(ge,{variant:"sans",size:"xs",color:"dim",children:"⚠️ Some sites block embedding via CORS."})})})]})},tA=({suggestion:r})=>{const[e,t]=ce.useState(!1),[n,s]=ce.useState(!1);ce.useEffect(()=>{if(!e)return;const o=setTimeout(()=>{document.startViewTransition?document.startViewTransition(()=>t(!1)):t(!1)},2e3);return()=>clearTimeout(o)},[e]);const i=async()=>{s(!0);try{await navigator.clipboard.writeText(r),await new Promise(o=>setTimeout(o,400)),document.startViewTransition?document.startViewTransition(()=>{t(!0)}):t(!0)}catch(o){console.error("Failed to copy:",o)}finally{s(!1)}};return C.jsxs(oe,{as:"button",onClick:i,disabled:n,marginTop:2,display:"flex",align:"center",gap:1,paddingX:3,paddingY:1,radius:"md",surface:"default",border:!0,className:"hover:border-accent transition-colors hover:text-accent font-bold text-xs",children:[n?C.jsx(Ie,{icon:sr,size:"xs",className:"animate-spin"}):e?C.jsx(Ie,{icon:za,size:"xs",color:"accent"}):C.jsx(Ie,{icon:Zh,size:"xs"}),C.jsx("span",{children:n?"Copying...":e?"Copied!":"Copy Prompt"})]})},nA={Mobile:C.jsx(Ie,{icon:ug,size:"md"}),Tablet:C.jsx(Ie,{icon:hg,size:"md"}),Desktop:C.jsx(Ie,{icon:og,size:"md"})},rA=({vp:r,data:e,activeReportUrl:t})=>C.jsxs(oe,{className:wn({overflow:"hidden"}),minWidth:0,children:[C.jsxs(ae,{padding:4,border:"b",direction:"row",align:"center",justify:"between",surface:"muted",children:[C.jsxs(ae,{direction:"row",align:"center",gap:3,children:[C.jsx(oe,{width:9,height:9,surface:"default",radius:"md",shadow:"sm",color:"accent",display:"flex",align:"center",justify:"center",shrink:0,children:nA[r.name]}),C.jsxs(ge,{variant:"sans",size:"base",weight:"font-bold",children:[r.name," Analysis"]})]}),C.jsxs(ge,{variant:"mono",size:"xs",weight:"font-bold",color:"dim",uppercase:!0,tracking:"widest",children:[r.width,"w × ",r.height,"h"]})]}),C.jsxs(ae,{direction:{base:"col",md:"row"},width:"full",children:[C.jsx(oe,{padding:8,surface:"muted",display:"flex",align:"center",justify:"center",border:{base:"b",md:"r"},minHeight:400,width:{base:"full",md:"41.666%"},children:t?C.jsx(eA,{url:t,width:r.width,height:r.height},`${r.name}-${t}`):C.jsxs(ae,{align:"center",justify:"center",color:"dim",className:"text-center",children:[C.jsx(oe,{marginBottom:2,children:C.jsx(Ie,{icon:sg,size:"2xl",color:"muted"})}),C.jsx(ge,{variant:"sans",size:"xs",weight:"font-bold",uppercase:!0,tracking:"wider",children:"Awaiting Frame..."})]})}),C.jsx(ae,{gap:6,padding:8,flex:1,minWidth:"0",overflow:"hidden",children:e?C.jsxs(C.Fragment,{children:[C.jsxs(oe,{surface:"alt",padding:5,className:"border border-line rounded-lg",children:[C.jsx(oe,{marginBottom:3,children:C.jsx(ge,{variant:"sans",size:"xs",weight:"font-black",color:"accent",uppercase:!0,display:"block",tracking:"widest",children:"Analysis Summary"})}),C.jsxs(ge,{variant:"sans",size:"sm",weight:"font-medium",className:"leading-relaxed break-words block",children:['"',e.summary,'"']})]}),C.jsx(ae,{gap:4,children:e.improvements?.map((n,s)=>C.jsxs(oe,{padding:4,className:wn({interactive:!0}),children:[C.jsxs(oe,{display:"flex",justify:"between",align:"start",marginBottom:2,children:[C.jsxs(ae,{direction:"row",align:"center",gap:2,children:[C.jsx(oe,{width:2,height:2,radius:"full",className:n.severity>7?"bg-error shadow-sm":"bg-accent-purple shadow-sm"}),C.jsx(ge,{variant:"sans",size:"sm",weight:"font-black",children:n.element})]}),C.jsxs(ge,{variant:"mono",size:"xs",weight:"font-black",paddingX:2,paddingY:.5,radius:"full",surface:"muted",color:"dim",uppercase:!0,title:`Severity level: ${n.severity} out of 10 (1-10 scale)`,children:["SEV ",n.severity]})]}),C.jsx(ge,{variant:"sans",size:"xs",color:"dim",marginBottom:3,children:n.issue}),n.suggestion&&n.suggestion.trim()!==""&&C.jsx(oe,{surface:"muted",padding:3,radius:"md",border:!0,children:C.jsxs(ae,{direction:{base:"col",sm:"row"},align:"start",gap:2,minWidth:0,children:[C.jsx(ge,{variant:"sans",size:"xs",weight:"font-black",color:"accent",marginTop:.5,uppercase:!0,tracking:"widest",className:"shrink-0",children:"FIX"}),C.jsxs(oe,{flex:1,minWidth:"0",className:"overflow-hidden",children:[C.jsx(ge,{variant:"sans",size:"xs",weight:"font-bold",className:"break-all line-clamp-3",title:n.suggestion,children:n.suggestion}),n.element==="Manual Audit Required"&&C.jsx(tA,{suggestion:n.suggestion})]})]})})]},s))})]}):C.jsxs(ae,{gap:4,width:"full",children:[C.jsx(ri,{height:20,width:"full"}),C.jsxs(ae,{gap:2,children:[C.jsx(ri,{height:4,width:"full"}),C.jsx(ri,{height:4,width:"full"}),C.jsx(ri,{height:4,width:"3/4"})]})]})})]})]}),sA=({activeReport:r,copyMarkdown:e,isCopiedMarkdown:t,exportToGithub:n,isExportingToGithub:s})=>C.jsx(ae,{gap:6,span:{lg:3},minWidth:0,width:"full",style:{gridColumn:"span 3 / span 3"},children:r?C.jsxs(C.Fragment,{children:[C.jsxs(ae,{padding:6,className:wn(),justify:"between",align:{base:"start",md:"center"},gap:6,direction:{base:"col",md:"row"},children:[C.jsxs(ae,{gap:1,minWidth:"0",flex:1,children:[C.jsx(ge,{variant:"sans",size:"xs",weight:"font-bold",color:"accent",uppercase:!0,tracking:"widest",display:"block",children:"Current Session"}),C.jsx(ge,{variant:"sans",size:"xl",weight:"font-black",className:"truncate block",title:r.url,children:r.url})]}),C.jsxs(ae,{direction:{base:"col",sm:"row"},gap:3,shrink:0,width:{base:"full",sm:"auto"},align:{base:"stretch",sm:"center"},children:[C.jsxs(oe,{as:"button",onClick:e,display:"flex",align:"center",justify:"center",gap:2,className:Wu({variant:"default"}),surface:"muted",color:"dim",paddingX:4,paddingY:2,radius:"xl",width:{base:"full",sm:"auto"},children:[t?C.jsx(Ie,{icon:za,size:"sm"}):C.jsx(Ie,{icon:Zh,size:"sm"}),t?"Copied":"Copy MD"]}),C.jsxs(oe,{as:"button",onClick:n,disabled:r.status!=="completed"||s,display:"flex",align:"center",justify:"center",gap:2,className:Wu({variant:"primary"}),paddingX:6,paddingY:2,radius:"xl",width:{base:"full",sm:"auto"},children:[s?C.jsx(Ie,{icon:sr,size:"sm",className:"animate-spin"}):C.jsx(Ie,{icon:Xp,size:"sm"}),C.jsx("span",{className:"whitespace-nowrap",children:s?"Exporting...":"Export to GitHub Issue"})]})]})]}),C.jsx(ae,{gap:8,children:qa.map(i=>C.jsx(rA,{vp:i,data:r[`findings_${i.name.toLowerCase()}`],activeReportUrl:r.url},i.name))})]}):C.jsx(Xh,{minHeight:500,icon:C.jsx(Ie,{icon:Yh,size:"xl",color:"muted"}),title:"Ready to Audit",description:"Enter a URL above to start the visual analysis across Mobile, Tablet, and Desktop."})}),yA=()=>{const r=Qp.find(O=>O.id==="ux-auditor"),{reports:e,isAnalyzing:t,activeReport:n,setActiveReport:s,url:i,setUrl:o,customApiKey:c,setCustomApiKey:u,snapshotService:h,setSnapshotService:f,isCopiedMarkdown:p,isExportingToGithub:v,runUXAudit:S,exportToGithub:x,copyMarkdown:D}=Jv();return C.jsxs(ae,{gap:8,width:"full",children:[C.jsx(Wp,{title:"Visual UX Auditor | Perception Telemetry System",description:"Run automated visual UX audits on any URL using multimodal AI. Identify usability issues and get improvement suggestions for Mobile, Tablet, and Desktop.",canonical:`${$p}${r?.canonicalPath||"/ux-auditor"}`}),C.jsxs(ae,{direction:{base:"col",xl:"row"},align:{base:"stretch",xl:"center"},justify:"between",gap:6,border:"b",paddingBottom:6,children:[C.jsx(oe,{children:C.jsx(Hp,{label:"Visual UX Auditor",title:"Multimodal AI Analysis",description:"Automated visual regression and UX improvement suggestions across viewports."})}),C.jsx(Xv,{url:i,setUrl:o,isAnalyzing:t,runUXAudit:S,customApiKey:c,setCustomApiKey:u,snapshotService:h,setSnapshotService:f})]}),C.jsxs(Gp,{cols:{base:1,lg:4},gap:8,children:[C.jsx(Zv,{reports:e,activeReport:n,setActiveReport:s}),C.jsx(sA,{activeReport:n,copyMarkdown:D,isCopiedMarkdown:p,exportToGithub:x,isExportingToGithub:v})]})]})};export{yA as default};
