...
**Stats:** +8093/-182 across 17 file(s)
...
- `[A]` [scripts/audit_capture.py](https://github.com/arii/tech-dancer/pull/161/files) `+54/-0`
- `[M]` [src/components/ui/ContentCard.tsx](https://github.com/arii/tech-dancer/pull/161/files) `+38/-40`
- `[M]` [src/components/ui/FolioGrid.tsx](https://github.com/arii/tech-dancer/pull/161/files) `+2/-8`
...
- `[M]` [src/features/profile/ArielProfile.tsx](https://github.com/arii/tech-dancer/pull/161/files) `+60/-36`
...
+    content = content.replace("+8093/-182 across 17 file(s)", f"+{additions}/-{deletions} across {changed_files} file(s)")
...
### File: `scripts/audit_capture.py` +54/-0 (added)
...
### File: `src/components/ui/FolioGrid.tsx` +2/-8 (modified)
...
### File: `src/features/profile/ArielProfile.tsx` +60/-36 (modified)
