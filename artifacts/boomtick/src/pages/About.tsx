      ...
      <main className="flex-1 min-h-screen md:ml-56 px-4 sm:px-6 md:px-10 py-8 md:py-14">
        <section className="max-w-5xl">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-sm text-muted-foreground border-b border-border pb-6 mb-10">MIT roboticist, creator of arii.github.io, and WCS author</p>
          </motion.div>
          <div className="grid lg:grid-cols-[1.4fr_0.9fr] gap-10 items-start">
            <div className="space-y-10 max-w-3xl">
              ...
              <section><h2 className="text-2xl font-black mb-4">Financial Strategies for WCS</h2><p className="text-sm leading-7 text-foreground/72">I love maximizing credit card perks and hotel benefits, which helps make the WCS event lifestyle both high-end and feasible. The goal is to spend more energy dancing and less energy stressing over the logistics.</p></section>
