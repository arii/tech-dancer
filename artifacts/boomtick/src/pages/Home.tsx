          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.15 }} className="relative rounded-xl overflow-hidden grid grid-cols-1 lg:grid-cols-2 min-h-[280px]">
            <div className="relative bg-[#0a0718] flex flex-col justify-end p-6 sm:p-8 group overflow-hidden min-h-[260px]">
              ...
              <div className="relative z-10">
                ...
                ].map((link) => (<a key={link.label} href={link.href} className="text-sm text-primary hover:text-primary/80 font-semibold transition-colors" data-testid={`train-link-${link.label.toLowerCase().replace(/\s+/g, "-")}`}>{link.label}</a>))}</div>
              </div>
            </div>
            <div className="relative bg-[#0c0a1e] flex flex-col justify-end p-6 sm:p-8 group overflow-hidden border-l border-border min-h-[260px]">
              ...
              <div className="relative z-10">
                ...
                ].map((link) => (<a key={link.label} href={link.href} className="text-sm text-secondary hover:text-secondary/80 font-semibold transition-colors" data-testid={`travel-link-${link.label.toLowerCase().replace(/\s+/g, "-")}`}>{link.label}</a>))}</div>
              </div>
            </div>
          </motion.div>
        </section>
