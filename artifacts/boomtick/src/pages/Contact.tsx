      ...
      <main className="flex-1 min-h-screen md:ml-56 px-4 sm:px-6 md:px-10 py-8 md:py-14">
        <section className="max-w-5xl">
          ...
          <div className="border border-border bg-card rounded-xl p-6 md:p-8">
            ...
            <div className="grid gap-4 md:grid-cols-2"><input className="border border-border bg-background px-4 py-3 rounded-lg" placeholder="Your Name" /><input className="border border-border bg-background px-4 py-3 rounded-lg" placeholder="Your Email" /></div>
            <div className="mt-4"><input className="w-full border border-border bg-background px-4 py-3 rounded-lg" placeholder="Subject" /></div>
            <div className="mt-4"><textarea className="w-full min-h-40 border border-border bg-background px-4 py-3 rounded-lg" placeholder="Message" /></div>
