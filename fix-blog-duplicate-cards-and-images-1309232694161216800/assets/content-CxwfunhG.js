import{A as Ye}from"./index-CxcnK4Xk.js";const gn=`---
type: post
draft: true
status: draft
...
`);s=e,i=e+1,o=n[i]}return s}const Me=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),De=n=>/^(%|---|\.\.\.)/m.test(n);function us(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let o=0,a=0;o<i;++o)if(n[o]===`
...
`,l+=2;a+=o,t[l+2]===" "&&(a+="\\"),l+=1,r=l+1}break;default:l+=1}return a=r?a+t.slice(r):t,s?a:Be(a,o,Oe,Me(e,!1))}function Xe(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
`)||/[ \t]\n|\n[ \t]/.test(n))return pe(n,e);const t=e.indent||(De(n)?"  ":""),s="'"+n.replace(/'/g,"''").replace(/\n+/g,`$&
${t}`)+"'";return e.implicitKey?s:Be(s,t,Rt,Me(e,!1))}function ee(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=pe;else{const i=n.includes('"'),o=n.includes("'");i&&!o?s=Xe:o&&!i?s=pe:s=t?Xe:pe}return s(n,e)}let Ze;try{Ze=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{Ze=/\n+(?!\n|$)/g}function Ne({comment:n,type:e,value:t},s,i,o){const{blockQuote:a,commentString:r,lineWidth:l}=s.options;if(!a||/\n[\t ]+$/.test(t))return ee(t,s);const c=s.indent||(s.forceBlockIndent||De(t)?"  ":""),d=a==="literal"?!0:a==="folded"||e===T.BLOCK_FOLDED?!1:e===T.BLOCK_LITERAL?!0:!us(t,l,c.length);if(!t)return d?`|
`:`>
...
`&&(m=m.slice(0,-1)),m=m.replace(Ze,`$&${c}`));let f=!1,p,b=-1;for(p=0;p<t.length;++p){const S=t[p];if(S===" ")f=!0;else if(S===`
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let A=!1;const _=Me(s,!0);a!=="folded"&&e!==T.BLOCK_FOLDED&&(_.onOverflow=()=>{A=!0});const y=Be(`${w}${S}${m}`,c,Qe,_);if(!A)return`>${v}
${c}${y}`}return t=t.replace(/\n+/g,`$&${c}`),`|${v}
${c}${w}${t}${m}`}function hs(n,e,t,s){const{type:i,value:o}=n,{actualString:a,implicitKey:r,indent:l,indentStep:c,inFlow:d}=e;if(r&&o.includes(`
`)||d&&/[[\]{},]/.test(o))return ee(o,e);if(/^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(o))return r||d||!o.includes(`
`)?ee(o,e):Ne(n,e,t,s);if(!r&&!d&&i!==T.PLAIN&&o.includes(`
`))return Ne(n,e,t,s);if(De(o)){if(l==="")return e.forceBlockIndent=!0,Ne(n,e,t,s);if(r&&l===c)return ee(o,e)}const u=o.replace(/\n+/g,`$&
${l}`);if(a){const h=f=>f.default&&f.tag!=="tag:yaml.org,2002:str"&&f.test?.test(u),{compat:m,tags:g}=e.doc.schema;if(g.some(h)||m?.some(h))return ee(o,e)}return r?u:Be(u,l,Rt,Me(e,!1))}function ot(n,e,t,s){const{implicitKey:i,inFlow:o}=e,a=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)});let{type:r}=n;r!==T.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(a.value)&&(r=T.QUOTE_DOUBLE);const l=d=>{switch(d){case T.BLOCK_FOLDED:case T.BLOCK_LITERAL:return i||o?ee(a.value,e):Ne(a,e,t,s);case T.QUOTE_DOUBLE:return pe(a.value,e);case T.QUOTE_SINGLE:return Xe(a.value,e);case T.PLAIN:return hs(a,e,t,s);default:return null}};let c=l(r);if(c===null){const{defaultKeyType:d,defaultStringType:u}=e.options,h=i&&d||u;if(c=l(h),c===null)throw new Error(`Unsupported default string type ${h}`)}return c}function Ft(n,e){const t=Object.assign({blockQuote:!0,commentString:cs,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e);let s;switch(t.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:s,options:t}}function fs(n,e){if(e.tag){const i=n.filter(o=>o.tag===e.tag);if(i.length>0)return i.find(o=>o.format===e.format)??i[0]}let t,s;if(I(e)){s=e.value;let i=n.filter(o=>o.identify?.(s));if(i.length>1){const o=i.filter(a=>a.test);o.length>0&&(i=o)}t=i.find(o=>o.format===e.format)??i.find(o=>!o.format)}else s=e,t=n.find(i=>i.nodeClass&&s instanceof i.nodeClass);if(!t){const i=s?.constructor?.name??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${i} value`)}return t}function ds(n,e,{anchors:t,doc:s}){if(!s.directives)return"";const i=[],o=(I(n)||O(n))&&n.anchor;o&&jt(o)&&(t.add(o),i.push(`&${o}`));const a=n.tag??(e.default?null:e.tag);return a&&i.push(s.directives.tagString(a)),i.join(" ")}function se(n,e,t,s){if(C(n))return n.toString(e,t,s);if(ae(n)){if(e.doc.directives)return n.toString(e);if(e.resolvedAliases?.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i;const o=N(n)?n:e.doc.createNode(n,{onTagObj:l=>i=l});i??(i=fs(e.doc.schema.tags,o));const a=ds(o,i,e);a.length>0&&(e.indentAtStart=(e.indentAtStart??0)+a.length+1);const r=typeof i.stringify=="function"?i.stringify(o,e,t,s):I(o)?ot(o,e,t,s):o.toString(e,t,s);return a?I(o)||r[0]==="{"||r[0]==="["?`${a} ${r}`:`${a}
${e.indent}${r}`:r}function ps({key:n,value:e},t,s,i){const{allNullValues:o,doc:a,indent:r,indentStep:l,options:{commentString:c,indentSeq:d,simpleKeys:u}}=t;let h=N(n)&&n.comment||null;if(u){if(h)throw new Error("With simple keys, key nodes cannot have comments");if(O(n)||!N(n)&&typeof n=="object"){const _="With simple keys, collection cannot be used as a key value";throw new Error(_)}}let m=!u&&(!n||h&&e==null&&!t.inFlow||O(n)||(I(n)?n.type===T.BLOCK_FOLDED||n.type===T.BLOCK_LITERAL:typeof n=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!m&&(u||!o),indent:r+l});let g=!1,f=!1,p=se(n,t,()=>g=!0,()=>f=!0);if(!m&&!t.inFlow&&p.length>1024){if(u)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");m=!0}if(t.inFlow){if(o||e==null)return g&&s&&s(),p===""?"?":m?`? ${p}`:p}else if(o&&!u||e==null&&m)return p=`? ${p}`,h&&!g?p+=G(p,t.indent,c(h)):f&&i&&i(),p;g&&(h=null),m?(h&&(p+=G(p,t.indent,c(h))),p=`? ${p}
...
`+E.comment:y.comment=E.comment);const Y=new j(y,K);if(t.options.keepSourceTokens&&(Y.srcToken=b),a){const L=c;ln(t,L.items,y)&&i(_,"DUPLICATE_KEY","Map keys must be unique"),L.items.push(Y)}else{const L=new B(t.schema);L.flow=!0,L.items.push(Y);const yt=(K??y).range;L.range=[y.range[0],yt[1],yt[2]],c.items.push(L)}u=K?K.range[2]:E.end}}const h=a?"}":"]",[m,...g]=s.end;let f=u;if(m?.source===h)f=m.offset+m.source.length;else{const p=r[0].toUpperCase()+r.substring(1),b=d?`${p} must end with a ${h}`:`${p} in block collection must be sufficiently indented and end with a ${h}`;i(u,d?"MISSING_CHAR":"BAD_INDENT",b),m&&m.source.length!==1&&g.unshift(m)}if(g.length>0){const p=ke(g,f,t.options.strict,i);p.comment&&(c.comment?c.comment+=`
`+p.comment:c.comment=p.comment),c.range=[s.offset,f,p.offset]}else c.range=[s.offset,f,f];return c}function Ve(n,e,t,s,i,o){const a=t.type==="block-map"?Bs(n,e,t,s,o):t.type==="block-seq"?Ms(n,e,t,s,o):Ds(n,e,t,s,o),r=a.constructor;return i==="!"||i===r.tagName?(a.tag=r.tagName,a):(i&&(a.tag=i),a)}function $s(n,e,t,s,i){const o=s.tag,a=o?e.directives.tagName(o.source,h=>i(o,"TAG_RESOLVE_FAILED",h)):null;if(t.type==="block-seq"){const{anchor:h,newlineAfterProp:m}=s,g=h&&o?h.offset>o.offset?h:o:h??o;g&&(!m||m.offset<g.offset)&&i(g,"MISSING_CHAR","Missing newline after block sequence props")}const r=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!o||!a||a==="!"||a===B.tagName&&r==="map"||a===z.tagName&&r==="seq")return Ve(n,e,t,i,a);let l=e.schema.tags.find(h=>h.tag===a&&h.collection===r);if(!l){const h=e.schema.knownTags[a];if(h?.collection===r)e.schema.tags.push(Object.assign({},h,{default:!1})),l=h;else return h?i(o,"BAD_COLLECTION_TYPE",`${h.tag} used for ${r} collection, but expects ${h.collection??"scalar"}`,!0):i(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${a}`,!0),Ve(n,e,t,i,a)}const c=Ve(n,e,t,i,a,l),d=l.resolve?.(c,h=>i(o,"TAG_RESOLVE_FAILED",h),e.options)??c,u=N(d)?d:new T(d);return u.range=c.range,u.tag=a,l?.format&&(u.format=l.format),u}function Rs(n,e,t){const s=e.offset,i=Fs(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const o=i.mode===">"?T.BLOCK_FOLDED:T.BLOCK_LITERAL,a=e.source?qs(e.source):[];let r=a.length;for(let f=a.length-1;f>=0;--f){const p=a[f][1];if(p===""||p==="\r")r=f;else break}if(r===0){const f=i.chomp==="+"&&a.length>0?`
...
`&&(u+=`
`);break;default:u+=`
`}const g=s+i.length+e.source.length;return{value:u,type:o,comment:i.comment,range:[s,g,g]}}function Fs({offset:n,props:e},t,s){if(e[0].type!=="block-scalar-header")return s(e[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:i}=e[0],o=i[0];let a=0,r="",l=-1;for(let h=1;h<i.length;++h){const m=i[h];if(!r&&(m==="-"||m==="+"))r=m;else{const g=Number(m);!a&&g?a=g:l===-1&&(l=n+h)}}l!==-1&&s(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,d="",u=i.length;for(let h=1;h<e.length;++h){const m=e[h];switch(m.type){case"space":c=!0;case"newline":u+=m.source.length;break;case"comment":t&&!c&&s(m,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),u+=m.source.length,d=m.source.substring(1);break;case"error":s(m,"UNEXPECTED_TOKEN",m.message),u+=m.source.length;break;default:{const g=`Unexpected token in block scalar header: ${m.type}`;s(m,"UNEXPECTED_TOKEN",g);const f=m.source;f&&typeof f=="string"&&(u+=f.length)}}}return{mode:o,indent:a,chomp:r,comment:d,length:u}}function qs(n){const e=n.split(/\n( *)/),t=e[0],s=t.match(/^( *)/),o=[s?.[1]?[s[1],t.slice(s[1].length)]:["",t]];for(let a=1;a<e.length;a+=2)o.push([e[a],e[a+1]]);return o}function Us(n,e,t){const{offset:s,type:i,source:o,end:a}=n;let r,l;const c=(h,m,g)=>t(s+h,m,g);switch(i){case"scalar":r=T.PLAIN,l=Ks(o,c);break;case"single-quoted-scalar":r=T.QUOTE_SINGLE,l=xs(o,c);break;case"double-quoted-scalar":r=T.QUOTE_DOUBLE,l=Ws(o,c);break;default:return t(n,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[s,s+o.length,s+o.length]}}const d=s+o.length,u=ke(a,d,e,t);return{value:l,type:r,comment:u.comment,range:[s,d,u.offset]}}function Ks(n,e){let t="";switch(n[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${n[0]}`;break}case"@":case"`":{t=`reserved character ${n[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),cn(n)}function xs(n,e){return(n[n.length-1]!=="'"||n.length===1)&&e(n.length,"MISSING_CHAR","Missing closing 'quote"),cn(n.slice(1,-1)).replace(/''/g,"'")}function cn(n){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
