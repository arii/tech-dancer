...
# Agent setup script for the BoomTick repo (Decoupled, PyPI-based).
...
install_python_deps() {
  ...
  log "Ensuring pip, setuptools, and wheel are up to date..."
  ...
  if [ -f "requirements-dev.txt" ]; then
    log "Installing local development python requirements..."
...
main() {
  ...
  echo "=== BoomTick Agent Environment Setup (Decoupled) ==="
