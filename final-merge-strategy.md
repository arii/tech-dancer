...
4. **Merge PR 3223:** (`chore(deps): Update playwright requirement from >=1.60.0 to >=1.61.0 in /etl`)
   - **Blocker:** Must resolve CI failures (Failed (**Deployment Impact Analysis**)) before merging.
...
9. **Merge PR 3216:** (`feat: Aggregate consolidation of PRs 3186, 3188, and 3190`)
   - **Blocker:** Must resolve CI failures (Failed (**Lint & Type Check (root)**, **Build & E2E**, **Anti-Pattern Audit**, **resolve-conflicts**)) before merging.
...
10. **Merge PR 3220:** (`fix: restore missing resolve_conflicts_headless and sync PRService signature`)
   - **Blocker:** Must resolve CI failures (Failed (**Build & E2E**, **Anti-Pattern Audit**, **resolve-conflicts**)) before merging.
...
12. **Merge PR 3202:** (`Refactor: Cleanup legacy boomtick-mcp and dev-tools references`)
   - **Blocker:** Must resolve CI failures (Failed (**Deployment Impact Analysis**, **Security Scan (semgrep)**)) before merging.
