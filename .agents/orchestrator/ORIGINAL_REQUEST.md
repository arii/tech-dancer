...
Please orchestrate the autonomous repair of all open PRs with merge conflicts in the tech-dancer repository by following the instructions in ./ORIGINAL_REQUEST.md.

Specifically:
1. Ensure your own workspace folder is ./.agents/orchestrator and save your plan.md, progress.md, and context.md there.
