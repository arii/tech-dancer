import{A as Qe}from"./index-Dw3TL29_.js";const yn=`---
type: post
draft: true
status: draft
...
${c}${w}${t}${g}`}function Di(n,e,t,s){const{type:i,value:o}=n,{actualString:r,implicitKey:a,indent:l,indentStep:c,inFlow:f}=e;if(a&&o.includes(`
...
`:`
`)+(o.substring(1)||" "),t=!0,s=!1;break;case"%":n[i+1]?.[0]!=="#"&&(i+=1),t=!1;break;default:t||(s=!0),t=!1}}return{comment:e,afterEmptyLine:s}}class So{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,s,i,o)=>{const r=de(t);o?this.warnings.push(new eo(r,s,i)):this.errors.push(new fe(r,s,i))},this.directives=new D({version:e.version||"1.2"}),this.options=e}decorate(e,t){const{comment:s,afterEmptyLine:i}=Ct(this.prelude);if(s){const o=e.contents;if(t)e.comment=e.comment?`${e.comment}
