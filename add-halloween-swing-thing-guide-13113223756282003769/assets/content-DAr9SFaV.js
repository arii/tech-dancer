import{A as Qe}from"./index-By1lG_2v.js";const yn=`---
type: post
draft: true
...
`,Dn=Object.freeze(Object.defineProperty({__proto__:null,default:Cn},Symbol.toStringTag,{value:"Module"})),On=`---
type: post
...
`,Mn=Object.freeze(Object.defineProperty({__proto__:null,default:Bn},Symbol.toStringTag,{value:"Module"})),Fn=`---
type: resource
...
`,Ds=Object.freeze(Object.defineProperty({__proto__:null,default:Cs},Symbol.toStringTag,{value:"Module"})),Os=`---
type: resource
...
`,Ms=Object.freeze(Object.defineProperty({__proto__:null,default:Bs},Symbol.toStringTag,{value:"Module"})),Fs=`---
type: resource
...
`);s=e,i=e+1,a=n[i]}return s}const Fe=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),Re=n=>/^(%|---|\.\.\.)/m.test(n);function Ni(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let a=0,o=0;a<i;++a)if(n[a]===`
...
+(?!
|$)`,"g")}catch{tt=/\n+(?!\n|$)/g}function Ne({comment:n,type:e,value:t},s,i,a){const{blockQuote:o,commentString:r,lineWidth:l}=s.options;if(!o||/\n[\t ]+$/.test(t))return te(t,s);const c=s.indent||(s.forceBlockIndent||Re(t)?"  ":""),f=o==="literal"?!0:o==="folded"||e===_.BLOCK_FOLDED?!1:e===_.BLOCK_LITERAL?!0:!Ni(t,l,c.length);if(!t)return f?`|
`:`>
...
${s}`:s;else if(i||e.directives.docStart||!a)e.commentBefore=s;else if(C(a)&&!a.flow&&a.items.length>0){let o=a.items[0];O(o)&&(o=o.key);const r=o.commentBefore;o.commentBefore=r?`${s}
...
${t.comment}`:t.comment}this.doc.range[2]=t.offset;break}default:this.errors.push(new fe(de(e),"UNEXPECTED_TOKEN",`Unsupported token ${e.type}`))}}*end(e=!1,t=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(e){const s=Object.assign({_directives:this.directives},this.options),i=new qe(void 0,s);this.atDirectives&&this.onError(t,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,t,t],this.decorate(i,!1),yield i}}}const fn="\uFEFF",pn="",gn="",st="";function _o(n){switch(n){case fn:return"byte-order-mark";case pn:return"doc-mode";case gn:return"flow-error-end";case st:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
...
\r	`),Ye=n=>!n||Ao.has(n);class Io{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
