import{A as Ye}from"./index-BeojYs0j.js";const mn=`---
type: post
draft: true
status: draft
...
#### 2. IT Band
The Iliotibial band runs along the outside of the thigh. This is often the most sensitive area for dancers due to the lateral movements in WCS. Lie on your side with the roller just below the hip and roll down to just above the knee.
...
Consistency is key to effective recovery. Following a structured workflow after a social dance or a full event weekend can significantly reduce your "recovery lag."
...
I recommend using a hydration multiplier like Liquid I.V. before bed and immediately upon waking. This helps combat the dehydration that leads to muscle cramping and the "event fog" many dancers experience on Monday morning.
