...
sed -i "s/const formatMerchItem = (item: any)/import { BoomTickMerchItem } from '@/lib/types/resources';\nimport { AffiliateGearItem } from '@/lib/types/resources';\nimport { Post, Event } from '@/lib/types/content';\n\nconst formatMerchItem = (item: BoomTickMerchItem)/g" src/pages/Resources.tsx
...
sed -i "s/const formatGearItem = (item: any)/import { AffiliateGearItem } from '@/lib/types/resources';\n\nconst formatGearItem = (item: AffiliateGearItem)/g" src/pages/Gear.tsx
