...
run_check "shared" "PYTHONPATH=\"boomtick-pkg/cli\" python3 -m dev_tools.cli gh --help"
run_check "shared" "PYTHONPATH=\"boomtick-pkg/cli\" python3 -m dev_tools.cli jules --help"

run_check "ai-slop-audit.md" "python3 .agents/scripts/audit-ai-slop.py"

run_check "dev-tools-cli-guide.md" "PYTHONPATH=\"boomtick-pkg/cli\" python3 -m dev_tools.cli gh pre-submit --help"
run_check "dev-tools-cli-guide.md" "PYTHONPATH=\"boomtick-pkg/cli\" python3 -m dev_tools.cli gh audit-pr --help"
run_check "dev-tools-cli-guide.md" "PYTHONPATH=\"boomtick-pkg/cli\" python3 -m dev_tools.cli gh validate-issue --help"

run_check "review-pr.md" "PYTHONPATH=\"boomtick-pkg/cli\" python3 -m dev_tools.cli gh audit-pr 2821 --fetch"
