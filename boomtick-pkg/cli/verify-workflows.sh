...
run_check "ai-slop-audit.md" "python3 boomtick-pkg/.agents/scripts/audit-ai-slop.py"
...
run_check "review-pr.md" "PYTHONPATH=boomtick-pkg/cli:boomtick-pkg/cli/dev_tools python3 boomtick-pkg/cli/dev_tools/td_cli.py gh audit-pr 2821 --fetch --dry-run"
