...
class Orchestrator:
    ...
    def evaluate_pr_heuristics(self, pr: Dict[str, Any], diff: str, checks: Dict[str, Any]) -> str:
        ...
        if is_python:
            ...
            feedback += "  - *Fix:* Ensure `python3 -m pytest tests/` passes. Update CLI unit tests if extending `dev-tools`.\n"
    ...
    def pre_submit_checks(self) -> Dict[str, Any]:
        ...
        run_step("Version Downgrade Check", [sys.executable, "-m", "dev_tools.cli", "gh", "verify-versions"])
