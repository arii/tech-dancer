...
class Orchestrator:
    ...
    def evaluate_pr_heuristics(self, pr: Dict[str, Any], diff: str, checks: Dict[str, Any]) -> str:
        ...
        if pr.get('mergeable') is False:
            ...
            feedback += f"  - *Fix:* Pull `{base_branch_name}` into your branch, resolve the conflicts (e.g., via `td-cli gh conflicts`), and force push.\n"
    ...
    def pre_submit_checks(self) -> Dict[str, Any]:
        ...
        run_step("Version Downgrade Check", ["td-cli", "gh", "verify-versions"])
