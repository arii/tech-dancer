...
def main():
    ...
    env_output = run_command(["bash", "boomtick-pkg/cli/dev_tools/verify.sh"])
    ...
    pr_context_file = f"boomtick-pkg/cli/dev_tools/logs/reviews/pr-context-{pr_number}.md"
    pr_summary = ""
    ci_status = ""
    failure_logs = ""
    ...
    plan_path = f"boomtick-pkg/cli/dev_tools/logs/workflows/workflow-plan-pr-{pr_number}.md"
...
`boomtick-pkg/cli/dev_tools/logs/reviews/pr-review-{pr_number}.md`
