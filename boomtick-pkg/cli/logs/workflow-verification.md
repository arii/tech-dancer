...
Generated: 2026-06-28T19:39:40Z
...
| ai-slop-audit.md | `python3 .agents/scripts/audit-ai-slop.py` | ⚠️ warn |
...
| review-pr.md | `python3 dev-tools/td_cli.py gh audit-pr 2821 --fetch` | ⚠️ warn |
| review-ux.md | `npx playwright --version` | ✅ pass |
| review-ux.md | `node scripts/detect-antipatterns.mjs --help` | ⚠️ warn |
