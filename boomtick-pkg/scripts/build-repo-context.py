    ...
    try:
        ...
        def collect_commands(cmd, prefix=""):
            ...
            if isinstance(cmd, click.Group):
                ...
                usage = f"python3 -m dev_tools.cli {cmd_name}"
                if req_flags:
        ...
        schema_authority_payload = {
            "tool_name": "td_cli",
            "schema_authority": "This file is the single source of truth for the td_cli tool. Consult before every CLI call. Takes precedence over examples in AGENTS.md or any agent-specific instruction file.",
            ...
            "base_command": "python3 -m dev_tools.cli",
            "never_do": [
                ...
                "Do not run the CLI without checking this schema first",
