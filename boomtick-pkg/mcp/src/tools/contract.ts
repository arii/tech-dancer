...
export const JulesSendMessageInputSchema = z.object({ "sessionId": z.string().describe("The unique ID of the Jules session."), "message": z.string().describe("The message content to send.") });
