import{A as Qe}from"./index-n3zpouoP.js";const yn=`---
type: post
draft: true
status: draft
...
`,Ln=Object.freeze(Object.defineProperty({__proto__:null,default:En},Symbol.toStringTag,{value:"Module"})),Dn=`---
type: resource
...
`,jn=Object.freeze(Object.defineProperty({__proto__:null,default:Dn},Symbol.toStringTag,{value:"Module"})),Bn=`---
type: resource
...
`,Ls=Object.freeze(Object.defineProperty({__proto__:null,default:Es},Symbol.toStringTag,{value:"Module"})),Ds=`---
type: resource
...
`,js=Object.freeze(Object.defineProperty({__proto__:null,default:Ds},Symbol.toStringTag,{value:"Module"})),Bs=`---
type: resource
...
\`\`\`
`,ei=Object.freeze(Object.defineProperty({__proto__:null,default:Zs},Symbol.toStringTag,{value:"Module"})),it=Symbol.for("yaml.alias"),Xe=Symbol.for("yaml.document"),z=Symbol.for("yaml.map"),Et=Symbol.for("yaml.pair"),R=Symbol.for("yaml.scalar"),re=Symbol.for("yaml.seq"),M=Symbol.for("yaml.node.type"),ae=n=>!!n&&typeof n=="object"&&n[M]===it,De=n=>!!n&&typeof n=="object"&&n[M]===Xe,be=n=>!!n&&typeof n=="object"&&n[M]===z,N=n=>!!n&&typeof n=="object"&&n[M]===Et,O=n=>!!n&&typeof n=="object"&&n[M]===R,we=n=>!!n&&typeof n=="object"&&n[M]===re;function I(n){if(n&&typeof n=="object")switch(n[M]){case z:case re:return!0}return!1}function C(n){if(n&&typeof n=="object")switch(n[M]){case it:case z:case R:case re:return!0}return!1}const Lt=n=>(O(n)||I(n))&&!!n.anchor,W=Symbol("break visit"),ti=Symbol("skip children"),pe=Symbol("remove node");function le(n,e){const t=ni(e);De(n)?X(null,n.contents,t,Object.freeze([n]))===pe&&(n.contents=null):X(null,n,t,Object.freeze([]))}le.BREAK=W;le.SKIP=ti;le.REMOVE=pe;function X(n,e,t,s){const i=si(n,e,t,s);if(C(i)||N(i))return ii(n,s,i),X(n,i,t,s);if(typeof i!="symbol"){if(I(e)){s=Object.freeze(s.concat(e));for(let o=0;o<e.items.length;++o){const r=X(o,e.items[o],t,s);if(typeof r=="number")o=r-1;else{if(r===W)return W;r===pe&&(e.items.splice(o,1),o-=1)}}}else if(N(e)){s=Object.freeze(s.concat(e));const o=X("key",e.key,t,s);if(o===W)return W;o===pe&&(e.key=null);const r=X("value",e.value,t,s);if(r===W)return W;r===pe&&(e.value=null)}}return i}function ni(n){return typeof n=="object"&&(n.Collection||n.Node||n.Value)?Object.assign({Alias:n.Node,Map:n.Node,Scalar:n.Node,Seq:n.Node},n.Value&&{Map:n.Value,Scalar:n.Value,Seq:n.Value},n.Collection&&{Map:n.Collection,Seq:n.Collection},n):n}function si(n,e,t,s){if(typeof t=="function")return t(n,e,s);if(be(e))return t.Map?.(n,e,s);if(we(e))return t.Seq?.(n,e,s);if(N(e))return t.Pair?.(n,e,s);if(O(e))return t.Scalar?.(n,e,s);if(ae(e))return t.Alias?.(n,e,s)}function ii(n,e,t){const s=e[e.length-1];if(I(s))s.items[n]=t;else if(N(s))n==="key"?s.key=t:s.value=t;else if(De(s))s.contents=t;else{const i=ae(s)?"alias":"scalar";throw new Error(`Cannot replace node with ${i} parent`)}}const oi={"!":"%21",",":"%2C","[":"%5B","]":"%5D","{":"%7B","}":"%7D"},ri=n=>n.replace(/[!,[\]{}]/g,e=>oi[e]);class L{constructor(e,t){this.docStart=null,this.docEnd=!1,this.yaml=Object.assign({},L.defaultYaml,e),this.tags=Object.assign({},L.defaultTags,t)}clone(){const e=new L(this.yaml,this.tags);return e.docStart=this.docStart,e}atDocument(){const e=new L(this.yaml,this.tags);switch(this.yaml.version){case"1.1":this.atNextDocument=!0;break;case"1.2":this.atNextDocument=!1,this.yaml={explicit:L.defaultYaml.explicit,version:"1.2"},this.tags=Object.assign({},L.defaultTags);break}return e}add(e,t){this.atNextDocument&&(this.yaml={explicit:L.defaultYaml.explicit,version:"1.1"},this.tags=Object.assign({},L.defaultTags),this.atNextDocument=!1);const s=e.trim().split(/[ \t]+/),i=s.shift();switch(i){case"%TAG":{if(s.length!==2&&(t(0,"%TAG directive should contain exactly two parts"),s.length<2))return!1;const[o,r]=s;return this.tags[o]=r,!0}case"%YAML":{if(this.yaml.explicit=!0,s.length!==1)return t(0,"%YAML directive should contain exactly one part"),!1;const[o]=s;if(o==="1.1"||o==="1.2")return this.yaml.version=o,!0;{const r=/^\d+\.\d+$/.test(o);return t(6,`Unsupported YAML version ${o}`,r),!1}}default:return t(0,`Unknown directive ${i}`,!0),!1}}tagName(e,t){if(e==="!")return"!";if(e[0]!=="!")return t(`Not a valid tag: ${e}`),null;if(e[1]==="<"){const r=e.slice(2,-1);return r==="!"||r==="!!"?(t(`Verbatim tags aren't resolved, so ${e} is invalid.`),null):(e[e.length-1]!==">"&&t("Verbatim tags must end with a >"),r)}const[,s,i]=e.match(/^(.*!)([^!]*)$/s);i||t(`The ${e} tag has no suffix`);const o=this.tags[s];if(o)try{return o+decodeURIComponent(i)}catch(r){return t(String(r)),null}return s==="!"?e:(t(`Could not resolve tag: ${e}`),null)}tagString(e){for(const[t,s]of Object.entries(this.tags))if(e.startsWith(s))return t+ri(e.substring(s.length));return e[0]==="!"?e:`!<${e}>`}toString(e){const t=this.yaml.explicit?[`%YAML ${this.yaml.version||"1.2"}`]:[],s=Object.entries(this.tags);let i;if(e&&s.length>0&&C(e.contents)){const o={};le(e.contents,(r,a)=>{C(a)&&a.tag&&(o[a.tag]=!0)}),i=Object.keys(o)}else i=[];for(const[o,r]of s)o==="!!"&&r==="tag:yaml.org,2002:"||(!e||i.some(a=>a.startsWith(r)))&&t.push(`%TAG ${o} ${r}`);return t.join(`
`)}}L.defaultYaml={explicit:!1,version:"1.2"};L.defaultTags={"!!":"tag:yaml.org,2002:"};function Dt(n){if(/[\x00-\x19\s,[\]{}]/.test(n)){const t=`Anchor must not contain whitespace or control characters: ${JSON.stringify(n)}`;throw new Error(t)}return!0}function jt(n){const e=new Set;return le(n,{Value(t,s){s.anchor&&e.add(s.anchor)}}),e}function Bt(n,e){for(let t=1;;++t){const s=`${n}${t}`;if(!e.has(s))return s}}function ai(n,e){const t=[],s=new Map;let i=null;return{onAnchor:o=>{t.push(o),i??(i=jt(n));const r=Bt(e,i);return i.add(r),r},setAnchors:()=>{for(const o of t){const r=s.get(o);if(typeof r=="object"&&r.anchor&&(O(r.node)||I(r.node)))r.node.anchor=r.anchor;else{const a=new Error("Failed to resolve repeated object (this should not happen)");throw a.source=o,a}}},sourceObjects:s}}function Z(n,e,t,s){if(s&&typeof s=="object")if(Array.isArray(s))for(let i=0,o=s.length;i<o;++i){const r=s[i],a=Z(n,s,String(i),r);a===void 0?delete s[i]:a!==r&&(s[i]=a)}else if(s instanceof Map)for(const i of Array.from(s.keys())){const o=s.get(i),r=Z(n,s,i,o);r===void 0?s.delete(i):r!==o&&s.set(i,r)}else if(s instanceof Set)for(const i of Array.from(s)){const o=Z(n,s,i,i);o===void 0?s.delete(i):o!==i&&(s.delete(i),s.add(o))}else for(const[i,o]of Object.entries(s)){const r=Z(n,s,i,o);r===void 0?delete s[i]:r!==o&&(s[i]=r)}return n.call(e,t,s)}function B(n,e,t){if(Array.isArray(n))return n.map((s,i)=>B(s,String(i),t));if(n&&typeof n.toJSON=="function"){if(!t||!Lt(n))return n.toJSON(e,t);const s={aliasCount:0,count:1,res:void 0};t.anchors.set(n,s),t.onCreate=o=>{s.res=o,delete t.onCreate};const i=n.toJSON(e,t);return t.onCreate&&t.onCreate(i),i}return typeof n=="bigint"&&!t?.keep?Number(n):n}class ot{constructor(e){Object.defineProperty(this,M,{value:e})}clone(){const e=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return this.range&&(e.range=this.range.slice()),e}toJS(e,{mapAsMap:t,maxAliasCount:s,onAnchor:i,reviver:o}={}){if(!De(e))throw new TypeError("A document argument is required");const r={anchors:new Map,doc:e,keep:!0,mapAsMap:t===!0,mapKeyWarned:!1,maxAliasCount:typeof s=="number"?s:100},a=B(this,"",r);if(typeof i=="function")for(const{count:l,res:c}of r.anchors.values())i(c,l);return typeof o=="function"?Z(o,{"":a},"",a):a}}class rt extends ot{constructor(e){super(it),this.source=e,Object.defineProperty(this,"tag",{set(){throw new Error("Alias nodes cannot have tags")}})}resolve(e,t){if(t?.maxAliasCount===0)throw new ReferenceError("Alias resolution is disabled");let s;t?.aliasResolveCache?s=t.aliasResolveCache:(s=[],le(e,{Node:(o,r)=>{(ae(r)||Lt(r))&&s.push(r)}}),t&&(t.aliasResolveCache=s));let i;for(const o of s){if(o===this)break;o.anchor===this.source&&(i=o)}return i}toJSON(e,t){if(!t)return{source:this.source};const{anchors:s,doc:i,maxAliasCount:o}=t,r=this.resolve(i,t);if(!r){const l=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new ReferenceError(l)}let a=s.get(r);if(a||(B(r,null,t),a=s.get(r)),a?.res===void 0){const l="This should not happen: Alias anchor was not resolved?";throw new ReferenceError(l)}if(o>=0&&(a.count+=1,a.aliasCount===0&&(a.aliasCount=Ie(i,r,s)),a.count*a.aliasCount>o)){const l="Excessive alias count indicates a resource exhaustion attack";throw new ReferenceError(l)}return a.res}toString(e,t,s){const i=`*${this.source}`;if(e){if(Dt(this.source),e.options.verifyAliasOrder&&!e.anchors.has(this.source)){const o=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new Error(o)}if(e.implicitKey)return`${i} `}return i}}function Ie(n,e,t){if(ae(e)){const s=e.resolve(n),i=t&&s&&t.get(s);return i?i.count*i.aliasCount:0}else if(I(e)){let s=0;for(const i of e.items){const o=Ie(n,i,t);o>s&&(s=o)}return s}else if(N(e)){const s=Ie(n,e.key,t),i=Ie(n,e.value,t);return Math.max(s,i)}return 1}const Mt=n=>!n||typeof n!="function"&&typeof n!="object";class _ extends ot{constructor(e){super(R),this.value=e}toJSON(e,t){return t?.keep?this.value:B(this.value,e,t)}toString(){return String(this.value)}}_.BLOCK_FOLDED="BLOCK_FOLDED";_.BLOCK_LITERAL="BLOCK_LITERAL";_.PLAIN="PLAIN";_.QUOTE_DOUBLE="QUOTE_DOUBLE";_.QUOTE_SINGLE="QUOTE_SINGLE";const li="tag:yaml.org,2002:";function ci(n,e,t){if(e){const s=t.filter(o=>o.tag===e),i=s.find(o=>!o.format)??s[0];if(!i)throw new Error(`Tag ${e} not found`);return i}return t.find(s=>s.identify?.(n)&&!s.format)}function me(n,e,t){if(De(n)&&(n=n.contents),C(n))return n;if(N(n)){const u=t.schema[z].createNode?.(t.schema,null,t);return u.items.push(n),u}(n instanceof String||n instanceof Number||n instanceof Boolean||typeof BigInt<"u"&&n instanceof BigInt)&&(n=n.valueOf());const{aliasDuplicateObjects:s,onAnchor:i,onTagObj:o,schema:r,sourceObjects:a}=t;let l;if(s&&n&&typeof n=="object"){if(l=a.get(n),l)return l.anchor??(l.anchor=i(n)),new rt(l.anchor);l={anchor:null,node:null},a.set(n,l)}e?.startsWith("!!")&&(e=li+e.slice(2));let c=ci(n,e,r.tags);if(!c){if(n&&typeof n.toJSON=="function"&&(n=n.toJSON()),!n||typeof n!="object"){const u=new _(n);return l&&(l.node=u),u}c=n instanceof Map?r[z]:Symbol.iterator in Object(n)?r[re]:r[z]}o&&(o(c),delete t.onTagObj);const h=c?.createNode?c.createNode(t.schema,n,t):typeof c?.nodeClass?.from=="function"?c.nodeClass.from(t.schema,n,t):new _(n);return e?h.tag=e:c.default||(h.tag=c.tag),l&&(l.node=h),h}function Pe(n,e,t){let s=t;for(let i=e.length-1;i>=0;--i){const o=e[i];if(typeof o=="number"&&Number.isInteger(o)&&o>=0){const r=[];r[o]=s,s=r}else s=new Map([[o,s]])}return me(s,void 0,{aliasDuplicateObjects:!1,keepUndefined:!1,onAnchor:()=>{throw new Error("This should not happen, please report a bug.")},schema:n,sourceObjects:new Map})}const de=n=>n==null||typeof n=="object"&&!!n[Symbol.iterator]().next().done;class $t extends ot{constructor(e,t){super(e),Object.defineProperty(this,"schema",{value:t,configurable:!0,enumerable:!1,writable:!0})}clone(e){const t=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return e&&(t.schema=e),t.items=t.items.map(s=>C(s)||N(s)?s.clone(e):s),this.range&&(t.range=this.range.slice()),t}addIn(e,t){if(de(e))this.add(t);else{const[s,...i]=e,o=this.get(s,!0);if(I(o))o.addIn(i,t);else if(o===void 0&&this.schema)this.set(s,Pe(this.schema,i,t));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}deleteIn(e){const[t,...s]=e;if(s.length===0)return this.delete(t);const i=this.get(t,!0);if(I(i))return i.deleteIn(s);throw new Error(`Expected YAML collection at ${t}. Remaining path: ${s}`)}getIn(e,t){const[s,...i]=e,o=this.get(s,!0);return i.length===0?!t&&O(o)?o.value:o:I(o)?o.getIn(i,t):void 0}hasAllNullValues(e){return this.items.every(t=>{if(!N(t))return!1;const s=t.value;return s==null||e&&O(s)&&s.value==null&&!s.commentBefore&&!s.comment&&!s.tag})}hasIn(e){const[t,...s]=e;if(s.length===0)return this.has(t);const i=this.get(t,!0);return I(i)?i.hasIn(s):!1}setIn(e,t){const[s,...i]=e;if(i.length===0)this.set(s,t);else{const o=this.get(s,!0);if(I(o))o.setIn(i,t);else if(o===void 0&&this.schema)this.set(s,Pe(this.schema,i,t));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}}const ui=n=>n.replace(/^(?!$)(?: $)?/gm,"#");function x(n,e){return/^\n+$/.test(n)?n.substring(1):e?n.replace(/^(?! *$)/gm,e):n}const G=(n,e,t)=>n.endsWith(`
`)?x(t,e):t.includes(`
`)?`
`+x(t,e):(n.endsWith(" ")?"":" ")+t,Ft="flow",Ze="block",Ce="quoted";function je(n,e,t="flow",{indentAtStart:s,lineWidth:i=80,minContentWidth:o=20,onFold:r,onOverflow:a}={}){if(!i||i<0)return n;i<o&&(o=0);const l=Math.max(1+o,1+i-e.length);if(n.length<=l)return n;const c=[],h={};let u=i-e.length;typeof s=="number"&&(s>i-Math.max(2,o)?c.push(0):u=i-s);let f,g,m=!1,d=-1,p=-1,b=-1;t===Ze&&(d=kt(n,d,e.length),d!==-1&&(u=d+l));for(let k;k=n[d+=1];){if(t===Ce&&k==="\\"){switch(p=d,n[d+1]){case"x":d+=3;break;case"u":d+=5;break;case"U":d+=9;break;default:d+=1}b=d}if(k===`
`)t===Ze&&(d=kt(n,d,e.length)),u=d+e.length+l,f=void 0;else{if(k===" "&&g&&g!==" "&&g!==`
`&&g!=="	"){const v=n[d+1];v&&v!==" "&&v!==`
`&&v!=="	"&&(f=d)}if(d>=u)if(f)c.push(f),u=f+l,f=void 0;else if(t===Ce){for(;g===" "||g==="	";)g=k,k=n[d+=1],m=!0;const v=d>b+1?d-2:p-1;if(h[v])return n;c.push(v),h[v]=!0,u=v+l,f=void 0}else m=!0}g=k}if(m&&a&&a(),c.length===0)return n;r&&r();let w=n.slice(0,c[0]);for(let k=0;k<c.length;++k){const v=c[k],S=c[k+1]||n.length;v===0?w=`
${e}${n.slice(0,S)}`:(t===Ce&&h[v]&&(w+=`${n[v]}\\`),w+=`
${e}${n.slice(v+1,S)}`)}return w}function kt(n,e,t){let s=e,i=e+1,o=n[i];for(;o===" "||o==="	";)if(e<i+t)o=n[++e];else{do o=n[++e];while(o&&o!==`
`);s=e,i=e+1,o=n[i]}return s}const Be=(n,e)=>({indentAtStart:e?n.indent.length:n.indentAtStart,lineWidth:n.options.lineWidth,minContentWidth:n.options.minContentWidth}),Me=n=>/^(%|---|\.\.\.)/m.test(n);function fi(n,e,t){if(!e||e<0)return!1;const s=e-t,i=n.length;if(i<=s)return!1;for(let o=0,r=0;o<i;++o)if(n[o]===`
`){if(o-r>s)return!0;if(r=o+1,i-r<=s)return!1}return!0}function ge(n,e){const t=JSON.stringify(n);if(e.options.doubleQuotedAsJSON)return t;const{implicitKey:s}=e,i=e.options.doubleQuotedMinMultiLineLength,o=e.indent||(Me(n)?"  ":"");let r="",a=0;for(let l=0,c=t[l];c;c=t[++l])if(c===" "&&t[l+1]==="\\"&&t[l+2]==="n"&&(r+=t.slice(a,l)+"\\ ",l+=1,a=l,c="\\"),c==="\\")switch(t[l+1]){case"u":{r+=t.slice(a,l);const h=t.substr(l+2,4);switch(h){case"0000":r+="\\0";break;case"0007":r+="\\a";break;case"000b":r+="\\v";break;case"001b":r+="\\e";break;case"0085":r+="\\N";break;case"00a0":r+="\\_";break;case"2028":r+="\\L";break;case"2029":r+="\\P";break;default:h.substr(0,2)==="00"?r+="\\x"+h.substr(2):r+=t.substr(l,6)}l+=5,a=l+1}break;case"n":if(s||t[l+2]==='"'||t.length<i)l+=1;else{for(r+=t.slice(a,l)+`

`;t[l+2]==="\\"&&t[l+3]==="n"&&t[l+4]!=='"';)r+=`
`,l+=2;r+=o,t[l+2]===" "&&(r+="\\"),l+=1,a=l+1}break;default:l+=1}return r=a?r+t.slice(a):t,s?r:je(r,o,Ce,Be(e,!1))}function et(n,e){if(e.options.singleQuote===!1||e.implicitKey&&n.includes(`
`)||/[ \t]\n|\n[ \t]/.test(n))return ge(n,e);const t=e.indent||(Me(n)?"  ":""),s="'"+n.replace(/'/g,"''").replace(/\n+/g,`$&
${t}`)+"'";return e.implicitKey?s:je(s,t,Ft,Be(e,!1))}function ee(n,e){const{singleQuote:t}=e.options;let s;if(t===!1)s=ge;else{const i=n.includes('"'),o=n.includes("'");i&&!o?s=et:o&&!i?s=ge:s=t?et:ge}return s(n,e)}let tt;try{tt=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{tt=/\n+(?!\n|$)/g}function Ne({comment:n,type:e,value:t},s,i,o){const{blockQuote:r,commentString:a,lineWidth:l}=s.options;if(!r||/\n[\t ]+$/.test(t))return ee(t,s);const c=s.indent||(s.forceBlockIndent||Me(t)?"  ":""),h=r==="literal"?!0:r==="folded"||e===_.BLOCK_FOLDED?!1:e===_.BLOCK_LITERAL?!0:!fi(t,l,c.length);if(!t)return h?`|
`:`>
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${c}`);let T=!1;const A=Be(s,!0);r!=="folded"&&e!==_.BLOCK_FOLDED&&(A.onOverflow=()=>{T=!0});const y=je(`${w}${S}${g}`,c,Ze,A);if(!T)return`>${v}
...
`)?ee(o,e):Ne(n,e,t,s);if(!a&&!h&&i!==_.PLAIN&&o.includes(`
`))return Ne(n,e,t,s);if(Me(o)){if(l==="")return e.forceBlockIndent=!0,Ne(n,e,t,s);if(a&&l===c)return ee(o,e)}const u=o.replace(/\n+/g,`$&
${l}`);if(r){const f=d=>d.default&&d.tag!=="tag:yaml.org,2002:str"&&d.test?.test(u),{compat:g,tags:m}=e.doc.schema;if(m.some(f)||g?.some(f))return ee(o,e)}return a?u:je(u,l,Ft,Be(e,!1))}function at(n,e,t,s){const{implicitKey:i,inFlow:o}=e,r=typeof n.value=="string"?n:Object.assign({},n,{value:String(n.value)});let{type:a}=n;a!==_.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(r.value)&&(a=_.QUOTE_DOUBLE);const l=h=>{switch(h){case _.BLOCK_FOLDED:case _.BLOCK_LITERAL:return i||o?ee(r.value,e):Ne(r,e,t,s);case _.QUOTE_DOUBLE:return ge(r.value,e);case _.QUOTE_SINGLE:return et(r.value,e);case _.PLAIN:return di(r,e,t,s);default:return null}};let c=l(a);if(c===null){const{defaultKeyType:h,defaultStringType:u}=e.options,f=i&&h||u;if(c=l(f),c===null)throw new Error(`Unsupported default string type ${f}`)}return c}function Rt(n,e){const t=Object.assign({blockQuote:!0,commentString:ui,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},n.schema.toStringOptions,e);let s;switch(t.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:n,flowCollectionPadding:t.flowCollectionPadding?" ":"",indent:"",indentStep:typeof t.indent=="number"?" ".repeat(t.indent):"  ",inFlow:s,options:t}}function hi(n,e){if(e.tag){const i=n.filter(o=>o.tag===e.tag);if(i.length>0)return i.find(o=>o.format===e.format)??i[0]}let t,s;if(O(e)){s=e.value;let i=n.filter(o=>o.identify?.(s));if(i.length>1){const o=i.filter(r=>r.test);o.length>0&&(i=o)}t=i.find(o=>o.format===e.format)??i.find(o=>!o.format)}else s=e,t=n.find(i=>i.nodeClass&&s instanceof i.nodeClass);if(!t){const i=s?.constructor?.name??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${i} value`)}return t}function pi(n,e,{anchors:t,doc:s}){if(!s.directives)return"";const i=[],o=(O(n)||I(n))&&n.anchor;o&&Dt(o)&&(t.add(o),i.push(`&${o}`));const r=n.tag??(e.default?null:e.tag);return r&&i.push(s.directives.tagString(r)),i.join(" ")}function ie(n,e,t,s){if(N(n))return n.toString(e,t,s);if(ae(n)){if(e.doc.directives)return n.toString(e);if(e.resolvedAliases?.has(n))throw new TypeError("Cannot stringify circular structure without alias nodes");e.resolvedAliases?e.resolvedAliases.add(n):e.resolvedAliases=new Set([n]),n=n.resolve(e.doc)}let i;const o=C(n)?n:e.doc.createNode(n,{onTagObj:l=>i=l});i??(i=hi(e.doc.schema.tags,o));const r=pi(o,i,e);r.length>0&&(e.indentAtStart=(e.indentAtStart??0)+r.length+1);const a=typeof i.stringify=="function"?i.stringify(o,e,t,s):O(o)?at(o,e,t,s):o.toString(e,t,s);return r?O(o)||a[0]==="{"||a[0]==="["?`${r} ${a}`:`${r}
${e.indent}${a}`:a}function gi({key:n,value:e},t,s,i){const{allNullValues:o,doc:r,indent:a,indentStep:l,options:{commentString:c,indentSeq:h,simpleKeys:u}}=t;let f=C(n)&&n.comment||null;if(u){if(f)throw new Error("With simple keys, key nodes cannot have comments");if(I(n)||!C(n)&&typeof n=="object"){const A="With simple keys, collection cannot be used as a key value";throw new Error(A)}}let g=!u&&(!n||f&&e==null&&!t.inFlow||I(n)||(O(n)?n.type===_.BLOCK_FOLDED||n.type===_.BLOCK_LITERAL:typeof n=="object"));t=Object.assign({},t,{allNullValues:!1,implicitKey:!g&&(u||!o),indent:a+l});let m=!1,d=!1,p=ie(n,t,()=>m=!0,()=>d=!0);if(!g&&!t.inFlow&&p.length>1024){if(u)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");g=!0}if(t.inFlow){if(o||e==null)return m&&s&&s(),p===""?"?":g?`? ${p}`:p}else if(o&&!u||e==null&&g)return p=`? ${p}`,f&&!m?p+=G(p,t.indent,c(f)):d&&i&&i(),p;m&&(f=null),g?(f&&(p+=G(p,t.indent,c(f))),p=`? ${p}
...
`+A:y.comment=A,T.comment=T.comment.substring(A.length+1)}}if(!r&&!v&&!T.found){const A=S?n(t,S,T,i):e(t,T.end,v,null,T,i);c.items.push(A),u=A.range[2],Ge(S)&&i(A.range,"BLOCK_IN_FLOW",We)}else{t.atKey=!0;const A=T.end,y=k?n(t,k,T,i):e(t,A,w,null,T,i);Ge(k)&&i(y.range,"BLOCK_IN_FLOW",We),t.atKey=!1;const P=oe(v??[],{flow:a,indicator:"map-value-ind",next:S,offset:y.range[2],onError:i,parentIndent:s.indent,startOnNewline:!1});if(P.found){if(!r&&!T.found&&t.options.strict){if(v)for(const E of v){if(E===P.found)break;if(E.type==="newline"){i(E,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}T.start<P.found.offset-1024&&i(P.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else S&&("source"in S&&S.source?.[0]===":"?i(S,"MISSING_CHAR",`Missing space after : in ${a}`):i(P.start,"MISSING_CHAR",`Missing , or : between ${a} items`));const q=S?n(t,S,P,i):P.found?e(t,P.end,v,null,P,i):null;q?Ge(S)&&i(q.range,"BLOCK_IN_FLOW",We):P.comment&&(y.comment?y.comment+=`
`+P.comment:y.comment=P.comment);const J=new D(y,q);if(t.options.keepSourceTokens&&(J.srcToken=b),r){const E=c;ln(t,E.items,y)&&i(A,"DUPLICATE_KEY","Map keys must be unique"),E.items.push(J)}else{const E=new j(t.schema);E.flow=!0,E.items.push(J);const wt=(q??y).range;E.range=[y.range[0],wt[1],wt[2]],c.items.push(E)}u=q?q.range[2]:P.end}}const f=r?"}":"]",[g,...m]=s.end;let d=u;if(g?.source===f)d=g.offset+g.source.length;else{const p=a[0].toUpperCase()+a.substring(1),b=h?`${p} must end with a ${f}`:`${p} in block collection must be sufficiently indented and end with a ${f}`;i(u,h?"MISSING_CHAR":"BAD_INDENT",b),g&&g.source.length!==1&&m.unshift(g)}if(m.length>0){const p=ve(m,d,t.options.strict,i);p.comment&&(c.comment?c.comment+=`
`+p.comment:c.comment=p.comment),c.range=[s.offset,d,p.offset]}else c.range=[s.offset,d,d];return c}function He(n,e,t,s,i,o){const r=t.type==="block-map"?Bi(n,e,t,s,o):t.type==="block-seq"?Mi(n,e,t,s,o):$i(n,e,t,s,o),a=r.constructor;return i==="!"||i===a.tagName?(r.tag=a.tagName,r):(i&&(r.tag=i),r)}function Fi(n,e,t,s,i){const o=s.tag,r=o?e.directives.tagName(o.source,f=>i(o,"TAG_RESOLVE_FAILED",f)):null;if(t.type==="block-seq"){const{anchor:f,newlineAfterProp:g}=s,m=f&&o?f.offset>o.offset?f:o:f??o;m&&(!g||g.offset<m.offset)&&i(m,"MISSING_CHAR","Missing newline after block sequence props")}const a=t.type==="block-map"?"map":t.type==="block-seq"?"seq":t.start.source==="{"?"map":"seq";if(!o||!r||r==="!"||r===j.tagName&&a==="map"||r===V.tagName&&a==="seq")return He(n,e,t,i,r);let l=e.schema.tags.find(f=>f.tag===r&&f.collection===a);if(!l){const f=e.schema.knownTags[r];if(f?.collection===a)e.schema.tags.push(Object.assign({},f,{default:!1})),l=f;else return f?i(o,"BAD_COLLECTION_TYPE",`${f.tag} used for ${a} collection, but expects ${f.collection??"scalar"}`,!0):i(o,"TAG_RESOLVE_FAILED",`Unresolved tag: ${r}`,!0),He(n,e,t,i,r)}const c=He(n,e,t,i,r,l),h=l.resolve?.(c,f=>i(o,"TAG_RESOLVE_FAILED",f),e.options)??c,u=C(h)?h:new _(h);return u.range=c.range,u.tag=r,l?.format&&(u.format=l.format),u}function Ri(n,e,t){const s=e.offset,i=xi(e,n.options.strict,t);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const o=i.mode===">"?_.BLOCK_FOLDED:_.BLOCK_LITERAL,r=e.source?Ui(e.source):[];let a=r.length;for(let d=r.length-1;d>=0;--d){const p=r[d][1];if(p===""||p==="\r")a=d;else break}if(a===0){const d=i.chomp==="+"&&r.length>0?`
...
`&&(u+=`
`);break;default:u+=`
`}const m=s+i.length+e.source.length;return{value:u,type:o,comment:i.comment,range:[s,m,m]}}function xi({offset:n,props:e},t,s){if(e[0].type!=="block-scalar-header")return s(e[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:i}=e[0],o=i[0];let r=0,a="",l=-1;for(let f=1;f<i.length;++f){const g=i[f];if(!a&&(g==="-"||g==="+"))a=g;else{const m=Number(g);!r&&m?r=m:l===-1&&(l=n+f)}}l!==-1&&s(l,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let c=!1,h="",u=i.length;for(let f=1;f<e.length;++f){const g=e[f];switch(g.type){case"space":c=!0;case"newline":u+=g.source.length;break;case"comment":t&&!c&&s(g,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),u+=g.source.length,h=g.source.substring(1);break;case"error":s(g,"UNEXPECTED_TOKEN",g.message),u+=g.source.length;break;default:{const m=`Unexpected token in block scalar header: ${g.type}`;s(g,"UNEXPECTED_TOKEN",m);const d=g.source;d&&typeof d=="string"&&(u+=d.length)}}}return{mode:o,indent:r,chomp:a,comment:h,length:u}}function Ui(n){const e=n.split(/\n( *)/),t=e[0],s=t.match(/^( *)/),o=[s?.[1]?[s[1],t.slice(s[1].length)]:["",t]];for(let r=1;r<e.length;r+=2)o.push([e[r],e[r+1]]);return o}function qi(n,e,t){const{offset:s,type:i,source:o,end:r}=n;let a,l;const c=(f,g,m)=>t(s+f,g,m);switch(i){case"scalar":a=_.PLAIN,l=Ki(o,c);break;case"single-quoted-scalar":a=_.QUOTE_SINGLE,l=zi(o,c);break;case"double-quoted-scalar":a=_.QUOTE_DOUBLE,l=Wi(o,c);break;default:return t(n,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[s,s+o.length,s+o.length]}}const h=s+o.length,u=ve(r,h,e,t);return{value:l,type:a,comment:u.comment,range:[s,h,u.offset]}}function Ki(n,e){let t="";switch(n[0]){case"	":t="a tab character";break;case",":t="flow indicator character ,";break;case"%":t="directive indicator character %";break;case"|":case">":{t=`block scalar indicator ${n[0]}`;break}case"@":case"`":{t=`reserved character ${n[0]}`;break}}return t&&e(0,"BAD_SCALAR_START",`Plain value cannot start with ${t}`),cn(n)}function zi(n,e){return(n[n.length-1]!=="'"||n.length===1)&&e(n.length,"MISSING_CHAR","Missing closing 'quote"),cn(n.slice(1,-1)).replace(/''/g,"'")}function cn(n){let e,t;try{e=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),t=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
`,"sy")}catch{e=/(.*?)[ \t]*\r?\n/sy,t=/[ \t]*(.*?)[ \t]*\r?\n/sy}let s=e.exec(n);if(!s)return n;let i=s[1],o=" ",r=e.lastIndex;for(t.lastIndex=r;s=t.exec(n);)s[1]===""?o===`
`?i+=o:o=`
`:(i+=o+s[1],o=" "),r=t.lastIndex;const a=/[ \t]*(.*)/sy;return a.lastIndex=r,s=a.exec(n),i+o+(s?.[1]??"")}function Wi(n,e){let t="";for(let s=1;s<n.length-1;++s){const i=n[s];if(!(i==="\r"&&n[s+1]===`
`))if(i===`
`){const{fold:o,offset:r}=Gi(n,s);t+=o,s=r}else if(i==="\\"){let o=n[++s];const r=Hi[o];if(r)t+=r;else if(o===`
`)for(o=n[s+1];o===" "||o==="	";)o=n[++s+1];else if(o==="\r"&&n[s+1]===`
`)for(o=n[++s+1];o===" "||o==="	";)o=n[++s+1];else if(o==="x"||o==="u"||o==="U"){const a=o==="x"?2:o==="u"?4:8;t+=Vi(n,s+1,a,e),s+=a}else{const a=n.substr(s-1,2);e(s-1,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),t+=a}}else if(i===" "||i==="	"){const o=s;let r=n[s+1];for(;r===" "||r==="	";)r=n[++s+1];r!==`
`&&!(r==="\r"&&n[s+2]===`
`)&&(t+=s>o?n.slice(o,s+1):i)}else t+=i}return(n[n.length-1]!=='"'||n.length===1)&&e(n.length,"MISSING_CHAR",'Missing closing "quote'),t}function Gi(n,e){let t="",s=n[e+1];for(;(s===" "||s==="	"||s===`
`||s==="\r")&&!(s==="\r"&&n[e+2]!==`
`);)s===`
`&&(t+=`
`),e+=1,s=n[e+1];return t||(t=" "),{fold:t,offset:e}}const Hi={0:"\0",a:"\x07",b:"\b",e:"\x1B",f:"\f",n:`
`,r:"\r",t:"	",v:"\v",N:"",_:" ",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function Vi(n,e,t,s){const i=n.substr(e,t),r=i.length===t&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;try{return String.fromCodePoint(r)}catch{const a=n.substr(e-2,t+2);return s(e-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),a}}function un(n,e,t,s){const{value:i,type:o,comment:r,range:a}=e.type==="block-scalar"?Ri(n,e,s):qi(e,n.options.strict,s),l=t?n.directives.tagName(t.source,u=>s(t,"TAG_RESOLVE_FAILED",u)):null;let c;n.options.stringKeys&&n.atKey?c=n.schema[R]:l?c=Ji(n.schema,i,l,t,s):e.type==="scalar"?c=Yi(n,i,e,s):c=n.schema[R];let h;try{const u=c.resolve(i,f=>s(t??e,"TAG_RESOLVE_FAILED",f),n.options);h=O(u)?u:new _(u)}catch(u){const f=u instanceof Error?u.message:String(u);s(t??e,"TAG_RESOLVE_FAILED",f),h=new _(i)}return h.range=a,h.source=i,o&&(h.type=o),l&&(h.tag=l),c.format&&(h.format=c.format),r&&(h.comment=r),h}function Ji(n,e,t,s,i){if(t==="!")return n[R];const o=[];for(const a of n.tags)if(!a.collection&&a.tag===t)if(a.default&&a.test)o.push(a);else return a;for(const a of o)if(a.test?.test(e))return a;const r=n.knownTags[t];return r&&!r.collection?(n.tags.push(Object.assign({},r,{default:!1,test:void 0})),r):(i(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${t}`,t!=="tag:yaml.org,2002:str"),n[R])}function Yi({atKey:n,directives:e,schema:t},s,i,o){const r=t.tags.find(a=>(a.default===!0||n&&a.default==="key")&&a.test?.test(s))||t[R];if(t.compat){const a=t.compat.find(l=>l.default&&l.test?.test(s))??t[R];if(r.tag!==a.tag){const l=e.tagString(r.tag),c=e.tagString(a.tag),h=`Value may be parsed as either ${l} or ${c}`;o(i,"TAG_RESOLVE_FAILED",h,!0)}}return r}function Qi(n,e,t){if(e){t??(t=e.length);for(let s=t-1;s>=0;--s){let i=e[s];switch(i.type){case"space":case"comment":case"newline":n-=i.source.length;continue}for(i=e[++s];i?.type==="space";)n+=i.source.length,i=e[++s];break}}return n}const Xi={composeNode:fn,composeEmptyNode:bt};function fn(n,e,t,s){const i=n.atKey,{spaceBefore:o,comment:r,anchor:a,tag:l}=t;let c,h=!0;switch(e.type){case"alias":c=Zi(n,e,s),(a||l)&&s(e,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":c=un(n,e,l,s),a&&(c.anchor=a.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{c=Fi(Xi,n,e,t,s),a&&(c.anchor=a.source.substring(1))}catch(u){const f=u instanceof Error?u.message:String(u);s(e,"RESOURCE_EXHAUSTION",f)}break;default:{const u=e.type==="error"?e.message:`Unsupported token (type: ${e.type})`;s(e,"UNEXPECTED_TOKEN",u),h=!1}}return c??(c=bt(n,e.offset,void 0,null,t,s)),a&&c.anchor===""&&s(a,"BAD_ALIAS","Anchor cannot be an empty string"),i&&n.options.stringKeys&&(!O(c)||typeof c.value!="string"||c.tag&&c.tag!=="tag:yaml.org,2002:str")&&s(l??e,"NON_STRING_KEY","With stringKeys, all keys must be strings"),o&&(c.spaceBefore=!0),r&&(e.type==="scalar"&&e.source===""?c.comment=r:c.commentBefore=r),n.options.keepSourceTokens&&h&&(c.srcToken=e),c}function bt(n,e,t,s,{spaceBefore:i,comment:o,anchor:r,tag:a,end:l},c){const h={type:"scalar",offset:Qi(e,t,s),indent:-1,source:""},u=un(n,h,a,c);return r&&(u.anchor=r.source.substring(1),u.anchor===""&&c(r,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(u.spaceBefore=!0),o&&(u.comment=o,u.range[2]=l),u}function Zi({options:n},{offset:e,source:t,end:s},i){const o=new rt(t.substring(1));o.source===""&&i(e,"BAD_ALIAS","Alias cannot be an empty string"),o.source.endsWith(":")&&i(e+t.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);const r=e+t.length,a=ve(s,r,n.strict,i);return o.range=[e,r,a.offset],a.comment&&(o.comment=a.comment),o}function eo(n,e,{offset:t,start:s,value:i,end:o},r){const a=Object.assign({_directives:e},n),l=new qe(void 0,a),c={atKey:!1,atRoot:!0,directives:l.directives,options:l.options,schema:l.schema},h=oe(s,{indicator:"doc-start",next:i??o?.[0],offset:t,onError:r,parentIndent:0,startOnNewline:!0});h.found&&(l.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!h.hasNewline&&r(h.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),l.contents=i?fn(c,i,h,r):bt(c,h.end,s,null,h,r);const u=l.contents.range[2],f=ve(o,u,!1,r);return f.comment&&(l.comment=f.comment),l.range=[t,u,f.offset],l}function fe(n){if(typeof n=="number")return[n,n+1];if(Array.isArray(n))return n.length===2?n:[n[0],n[1]];const{offset:e,source:t}=n;return[e,e+(typeof t=="string"?t.length:1)]}function It(n){let e="",t=!1,s=!1;for(let i=0;i<n.length;++i){const o=n[i];switch(o[0]){case"#":e+=(e===""?"":s?`

`:`
`)+(o.substring(1)||" "),t=!0,s=!1;break;case"%":n[i+1]?.[0]!=="#"&&(i+=1),t=!1;break;default:t||(s=!0),t=!1}}return{comment:e,afterEmptyLine:s}}class to{constructor(e={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(t,s,i,o)=>{const r=fe(t);o?this.warnings.push(new ji(r,s,i)):this.errors.push(new he(r,s,i))},this.directives=new L({version:e.version||"1.2"}),this.options=e}decorate(e,t){const{comment:s,afterEmptyLine:i}=It(this.prelude);if(s){const o=e.contents;if(t)e.comment=e.comment?`${e.comment}
...
`:case"\r":case"	":return!0;default:return!1}}const Ct=new Set("0123456789ABCDEFabcdef"),so=new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),Ae=new Set(",[]{}"),io=new Set(` ,[]{}
\r	`),Ve=n=>!n||io.has(n);class oo{constructor(){this.atEnd=!1,this.blockScalarIndent=-1,this.blockScalarKeep=!1,this.buffer="",this.flowKey=!1,this.flowLevel=0,this.indentNext=0,this.indentValue=0,this.lineEndPos=null,this.next=null,this.pos=0}*lex(e,t=!1){if(e){if(typeof e!="string")throw TypeError("source is not a string");this.buffer=this.buffer?this.buffer+e:e,this.lineEndPos=null}this.atEnd=!t;let s=this.next??"stream";for(;s&&(t||this.hasChars(1));)s=yield*this.parseNext(s)}atLineEnd(){let e=this.pos,t=this.buffer[e];for(;t===" "||t==="	";)t=this.buffer[++e];return!t||t==="#"||t===`
...
`)+1;for(;t!==0;)this.onNewLine(this.offset+t),t=this.source.indexOf(`
`,t)+1}return{type:e,offset:this.offset,indent:this.indent,source:this.source}}startBlockValue(e){switch(this.type){case"alias":case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":return this.flowScalar(this.type);case"block-scalar-header":return{type:"block-scalar",offset:this.offset,indent:this.indent,props:[this.sourceToken],source:""};case"flow-map-start":case"flow-seq-start":return{type:"flow-collection",offset:this.offset,indent:this.indent,start:this.sourceToken,items:[],end:[]};case"seq-item-ind":return{type:"block-seq",offset:this.offset,indent:this.indent,items:[{start:[this.sourceToken]}]};case"explicit-key-ind":{this.onKeyLine=!0;const t=Oe(e),s=Q(t);return s.push(this.sourceToken),{type:"block-map",offset:this.offset,indent:this.indent,items:[{start:s,explicitKey:!0}]}}case"map-value-ind":{this.onKeyLine=!0;const t=Oe(e),s=Q(t);return{type:"block-map",offset:this.offset,indent:this.indent,items:[{start:s,key:null,sep:[this.sourceToken]}]}}}return null}atIndentedComment(e,t){return this.type!=="comment"||this.indent<=t?!1:e.every(s=>s.type==="newline"||s.type==="space")}*documentEnd(e){this.type!=="doc-mode"&&(e.end?e.end.push(this.sourceToken):e.end=[this.sourceToken],this.type==="newline"&&(yield*this.pop()))}*lineEnd(e){switch(this.type){case"comma":case"doc-start":case"doc-end":case"flow-seq-end":case"flow-map-end":case"map-value-ind":yield*this.pop(),yield*this.step();break;case"newline":this.onKeyLine=!1;case"space":case"comment":default:e.end?e.end.push(this.sourceToken):e.end=[this.sourceToken],this.type==="newline"&&(yield*this.pop())}}}function lo(n){const e=n.prettyErrors!==!1;return{lineCounter:n.lineCounter||e&&new ro||null,prettyErrors:e}}function co(n,e={}){const{lineCounter:t,prettyErrors:s}=lo(e),i=new ao(t?.addNewLine),o=new to(e);let r=null;for(const a of o.compose(i.parse(n),!0,n.length))if(!r)r=a;else if(r.options.logLevel!=="silent"){r.errors.push(new he(a.range.slice(0,2),"MULTIPLE_DOCS","Source contains multiple documents; please use YAML.parseAllDocuments()"));break}return s&&t&&(r.errors.forEach(At(n,t)),r.warnings.forEach(At(n,t))),r}function uo(n,e,t){let s;const i=co(n,t);if(!i)return null;if(i.warnings.forEach(o=>xt(i.options.logLevel,o)),i.errors.length>0){if(i.options.logLevel!=="silent")throw i.errors[0];i.errors=[]}return i.toJS(Object.assign({reviver:s},t))}function fo(n){const e=n.match(/^---\n([\s\S]+?)\n---\n([\s\S]*)$/);if(!e)return{data:Object.create(null),content:n};const t=e[1],s=e[2];try{const i=uo(t),o=Object.create(null);return i&&typeof i=="object"&&Object.assign(o,i),{data:o,content:s}}catch(i){return console.error("Error parsing frontmatter:",i),{data:Object.create(null),content:s}}}const Je={posts:Object.assign({"/content/posts/2026-04-18-competition-metrics.md":bn,"/content/posts/2026-04-18-financial-literacy-dancers.md":kn,"/content/posts/2026-04-18-github-actions.md":Sn,"/content/posts/2026-04-18-halloween-costumes.md":Tn,"/content/posts/2026-04-18-make-shoe-dance.md":On,"/content/posts/2026-04-18-why-finals-are-hard.md":Cn,"/content/posts/2026-04-19-gear-essentials.md":Pn,"/content/posts/2026-05-06-boomtick-and-b-the-rhythmic-architecture-of-west-coast-swing.md":Ln}),resources:Object.assign({"/content/resources/2023-10-01-loop-earplugs.md":jn,"/content/resources/2023-11-01-travel-steamer.md":Mn,"/content/resources/2024-01-01-portable-speaker.md":Fn,"/content/resources/2024-06-01-alien-mask.md":xn,"/content/resources/2024-06-01-charging-cables.md":qn,"/content/resources/2024-06-01-compression-cubes.md":zn,"/content/resources/2024-06-01-crop-tops.md":Gn,"/content/resources/2024-06-01-fishnet-tights.md":Vn,"/content/resources/2024-06-01-foam-roller.md":Yn,"/content/resources/2024-06-01-green-bodysuit.md":Xn,"/content/resources/2024-06-01-light-up-suspenders.md":es,"/content/resources/2024-06-01-love-neon-follow-shirt.md":ns,"/content/resources/2024-06-01-love-neon-lead-shirt.md":is,"/content/resources/2024-06-01-love-neon-switch-shirt.md":rs,"/content/resources/2024-06-01-love-unisex-shirt.md":ls,"/content/resources/2024-06-01-mesh-fishnet-top.md":us,"/content/resources/2024-06-01-nerd-set.md":ds,"/content/resources/2024-06-01-norcal-bear-tank.md":ps,"/content/resources/2024-06-01-norcal-bestcal-tshirt.md":ms,"/content/resources/2024-06-01-norcal-crop-top.md":bs,"/content/resources/2024-06-01-norcal-gate-crop-hoodie.md":ks,"/content/resources/2024-06-01-norcal-pride-bear-shirt.md":Ss,"/content/resources/2024-06-01-norcal-pride-gate-shirt.md":Ts,"/content/resources/2024-06-01-portable-charger.md":Os,"/content/resources/2024-06-01-pumpkin-headbands.md":Cs,"/content/resources/2024-06-01-pumpkin-stickers.md":Ps,"/content/resources/2024-06-01-rave-fan.md":Ls,"/content/resources/2024-06-01-reflective-crop-tops.md":js,"/content/resources/2024-06-01-running-belt.md":Ms,"/content/resources/2024-06-01-shoe-dryer.md":Fs,"/content/resources/2024-06-01-sunscreen.md":xs,"/content/resources/2024-06-01-travel-bottles.md":qs,"/content/resources/2024-06-01-tripod.md":zs,"/content/resources/2024-06-01-visor.md":Gs,"/content/resources/2024-06-01-war-eagle-shirt.md":Vs,"/content/resources/2026-04-12-suede-shoe-diy.md":Ys}),studies:Object.assign({"/content/studies/ai-devops-pipeline.md":Xs,"/content/studies/wcs-scraper-initial-sync.md":ei})},ho=n=>n.split("/").pop()?.replace(".md","")||"";function po(n){if(typeof n!="string")return;const e=n.toLowerCase();return["published","draft","planned"].includes(e)?e:void 0}function go(n){if(typeof n=="number")return n;if(typeof n=="string"){const e=parseInt(n.replace(/[^\d]/g,""),10);return isNaN(e)?void 0:e}}function yo(n){if(!(n===""||n===void 0||n===null))return typeof n!="string"?n:n.startsWith("/")&&!n.startsWith(Qe)?`${Qe}${n}`:n}function Ye(n,e){const t=s=>Array.isArray(s)?s:[];return Object.entries(n).map(([s,i])=>{const o=typeof i=="string"?i:i.default,{data:r,content:a}=fo(o),l=r.type||e,c=u=>{if(u!=="")return typeof u=="string"&&u.startsWith("/")?`${Qe}${u}`:u};return r.image=c(r.image),r.imageBack=c(r.imageBack),{...r,type:l,title:String(r.title||"Untitled"),category:String(r.category||"General"),excerpt:String(r.excerpt||""),date:String(r.date||""),author:String(r.author||""),tags:t(r.tags),affiliateIds:t(r.affiliateIds),internalSku:r.internalSku?String(r.internalSku):r.sku?String(r.sku):void 0,priceCategory:r.priceCategory?String(r.priceCategory):void 0,seoTitle:r.seoTitle?String(r.seoTitle):void 0,seoDescription:r.seoDescription?String(r.seoDescription):void 0,imageAlt:r.imageAlt?String(r.imageAlt):void 0,productType:r.productType?String(r.productType):void 0,fulfillmentType:r.fulfillmentType?String(r.fulfillmentType):void 0,provider:r.provider?String(r.provider):void 0,shippingPolicySummary:r.shippingPolicySummary?String(r.shippingPolicySummary):void 0,returnPolicySummary:r.returnPolicySummary?String(r.returnPolicySummary):void 0,affiliateProvider:r.affiliateProvider?String(r.affiliateProvider):void 0,affiliateDisclosure:r.affiliateDisclosure?String(r.affiliateDisclosure):void 0,priceDisplayPolicy:r.priceDisplayPolicy?String(r.priceDisplayPolicy):void 0,availabilityDisplayPolicy:r.availabilityDisplayPolicy?String(r.availabilityDisplayPolicy):void 0,recommendedFor:t(r.recommendedFor),printfulProductId:r.printfulProductId?String(r.printfulProductId):void 0,printfulVariantIds:t(r.printfulVariantIds),status:po(r.status),readTime:go(r.readTime),content:a||"",slug:ho(s)}}).filter(s=>s.draft?s.type==="study"&&(s.status==="planned"||s.status==="draft"):!0).sort((s,i)=>{const o=s.date?new Date(s.date).getTime():0,r=i.date?new Date(i.date).getTime():0,a=Number.isNaN(o)?0:o;return(Number.isNaN(r)?0:r)-a})}const se={posts:Ye(Je.posts,"post"),resources:Ye(Je.resources,"resource"),studies:Ye(Je.studies,"study")},mn={posts:new Map(se.posts.map(n=>[n.slug,n])),resources:new Map(se.resources.map(n=>[n.slug,n])),studies:new Map(se.studies.map(n=>[n.slug,n]))},bo=()=>se.posts,wo=()=>se.resources,ko=()=>se.studies,vo=n=>mn.posts.get(n),So=n=>mn.resources.get(n),_o=(n,e)=>{if(n&&n.trim().length>0)return Math.max(1,Math.round(n.split(/\s+/).length/200));const t=e?.split(/\s+/).length??0;return Math.max(1,Math.round(t/20))};export{vo as a,wo as b,So as c,ko as d,bo as g,yo as n,_o as r};
